var app=angular.module("tnApp",["ui.router","ngResource","ngTable","tnApp.controllers","tnApp.services","highcharts-ng","ngAnimate","ParseServices"]);if(angular.module("tnApp").run(function($rootScope,$window,$timeout){var userAgent;userAgent=-1!=window.navigator.userAgent.indexOf("Safari")&&-1==window.navigator.userAgent.indexOf("Chrome")?"safari":-1!=window.navigator.userAgent.indexOf("Firefox")&&-1==window.navigator.userAgent.indexOf("Safari")?"firefox":-1!=window.navigator.userAgent.indexOf("Chrome")&&-1==window.navigator.userAgent.indexOf("Firefox")?"chrome":"unknown";var browser=userAgent;$rootScope.browser=browser,$rootScope.userAgent=userAgent,Parse.initialize("XFukCIc6giByefQZjvKjvRQdyaID0OqseAdLYGE4","TfVbMHnjFPVGfUIFCVCeVr3SWgrgEr5uoxrBSSvz"),$rootScope.createRoles=function(){var accountRole=new Parse.ACL;accountRole.setPublicReadAccess(!0),accountRole.setRoleWriteAccess("Admin",!0);var userRole=new Parse.Role("User",accountRole),adminRole=new Parse.Role("Admin",accountRole),RoleObject=Parse.Object.extend("_Role"),userRoleQuery=new Parse.Query(RoleObject),adminRoleQuery=new Parse.Query(RoleObject),queryRoleObject=new Parse.Query.or(userRoleQuery,adminRoleQuery);userRoleQuery.equalTo("name","User"),adminRoleQuery.equalTo("name","Admin");var saveUsers={user:function(){userRole.save(null,{success:function(){},error:function(userRole){JSON.stringify(userRole,null,4)}}).then(function(){})},admin:function(){adminRole.save(null,{success:function(){},error:function(adminRole){JSON.stringify(adminRole,null,4)}})}};queryRoleObject.find({success:function(results){for(var user=!1,admin=!1,i=0;i<results.length;i++){{var object=results[i],name=object.get("name");object.id,object.updatedAt}"Admin"===name?admin=!0:"User"===name&&(user=!0)}0==results.length?(saveUsers.user(),saveUsers.admin()):0!=results.length&&results.length<=1&&(admin?user||saveUsers.user():saveUsers.admin())},error:function(error){alert("Error: "+error.code+" "+error.message)}})},$rootScope.checkAdmin=function(){var techNinjaAdminID="587154828096319",query=new Parse.Query($rootScope.Users);query.equalTo("email","phreelyfe@gmail.com"),"Phree Lyfe"===$rootScope.sessionUserName&&query.find({success:function(results){for(var i=0;i<results.length;i++){var object=results[i],fbAuthDataString=JSON.stringify(object.get("authData")),fbAuthDataObject=JSON.parse(fbAuthDataString);fbAuthDataObject.facebook.id===techNinjaAdminID||null===fbAuthDataObject.facebook.id||""===fbAuthDataObject.facebook.id}},error:function(error){alert("Error: "+error.code+" "+error.message)}})},$rootScope.reloadWindow=function(){$timeout(function(){$window.location.reload()},200)},$rootScope.collectFacebookData=function(user){FB.api("/me",function(response){var object=response;user.set("username",object.name),user.set("firstName",object.first_name),user.set("lastName",object.last_name),user.set("email",object.email),user.save()}),FB.api("/me/picture",{type:"normal"},function(response){var object=response;user.set("profilePic",object.data.url),user.save()})};var User=Parse.User.extend({});$rootScope.ParseUser=User,$rootScope.sessionUser=Parse.User.current(),$rootScope.sessionUser&&($rootScope.sessionUserName=Parse.User.current().get("username"),$rootScope.createRoles()),$rootScope.sessionUser&&($rootScope.currentUsername=Parse.User.current().get("username"),$rootScope.sessionUserId=$rootScope.sessionUser.id),"Phree Lyfe"==$rootScope.currentUsername?($rootScope.techNinjaAdminName=$rootScope.currentUsername,$rootScope.techNinjaAdmin=!0):$rootScope.techNinjaAdmin=!1;Parse.Object.extend("User"),Parse.Object.extend("Post"),Parse.Object.extend("Comment"),Parse.Object.extend("_Role")}),angular.module("tnApp.controllers",["tnApp.services"]).controller("AppCtrl",function($scope){$scope.alias="Tech Ninja App",$scope.test="I can't think of anything cool to put here",$scope.title="The Greatest App I Ever Wrote",$scope.list=[{name:"Bryan",gender:"his",height:"170cm",weight:"174Lbs",goal:"Become an expert coder",date:"1st of January, 2014"},{name:"Bernice",gender:"her",height:"120cm",weight:"90Lbs",goal:"Own an amazing sports car",date:"39th of Apruary, 2014"}],$scope.message="Happy Thanks Giving!",$scope.alert=function(){alert("You've Hit the AppCtrl Alert Button")}}),app.directive("modalbox",function(){return{template:"",restrict:"EA",link:function(scope,elem,attrs){console.warn("ModalBox.Directive - scope, elem, attrs",scope,elem,attrs),elem.on("click",function(e){$("#SOMETHING").click(),console.log("Clicked That!",e)})}}}),app.directive("portfoliofiler",function(){return{restrict:"A",link:function(scope,elem){console.log("WORKING FROM PORTOFOLIO FILTER",elem);var filterList={init:function(){$("#portfoliolist").mixitup({targetSelector:".portfolio",filterSelector:".filter",effects:["fade"],easing:"snap",onMixEnd:filterList.hoverEffect()})},hoverEffect:function(){$("#portfoliolist .portfolio").hover(function(){$(this).find(".label").stop().animate({bottom:0},200,"easeOutQuad"),$(this).find("img").stop().animate({top:-30},500,"easeOutQuad")},function(){$(this).find(".label").stop().animate({bottom:-40},200,"easeInQuad"),$(this).find("img").stop().animate({top:0},300,"easeOutQuad")})}};filterList.init()}}}),app.directive("portfoliohover",function(){return{restrict:"EA",link:function(scope,elem){elem.hover(function(){$(elem).find(".label").stop().animate({bottom:0},200,"easeOutQuad"),$(elem).find("img").stop().animate({top:-30},500,"easeOutQuad")},function(){$(elem).find(".label").stop().animate({bottom:-40},200,"easeInQuad"),$(elem).find("img").stop().animate({top:0},300,"easeOutQuad")})}}}),app.directive("scroll",function($window){return function(scope,element,attrs){angular.element($window).bind("scroll",function(){var animations,elem,pageYOffset=this.pageYOffset,windowBottom=this.pageYOffset+this.innerHeight-0,elemName=(this.innerHeight,this.innerWidth,attrs.id),elemHeight=element.height(),elemWidth=element.width();animations=attrs.scroll.split(" "),elem={name:elemName||attrs.$$element[0].className,height:elemHeight,width:elemWidth,top:element[0].offsetTop,bottom:element[0].offsetHeight,animateIn:animations[0],animateOut:animations[1]},windowBottom>elem.top&&pageYOffset<elem.top+elem.height?attrs.inView=!0:pageYOffset<elem.top&&pageYOffset>elem.top+elem.height&&(attrs.inView=!1),attrs.inView&&attrs.scroll.indexOf(animations.map(function(val){return val}))<=-1?element.addClass(elem.animateIn):attrs.inView&&attrs.scroll.indexOf(animations.map(function(val){return val}))>=0||!attrs.inView&&attrs.scroll.indexOf(animations.map(function(val){return val}))>=0&&(element.removeClass(elem.animateIn)&&element.removeClass(elem.animateOut)&&element.removeClass(elem.animateOut),console.log("attempted to remove element class")),scope.$apply()})}}),angular.module("phonecatFilters",[]).filter("checkmark",function(){return function(input){return input?"✓":"✘"}}),String.prototype.capitalize=function(){return this.replace(/(^|\s)([a-z])/g,function(m,p1,p2){return p1+p2.toUpperCase()})},String.prototype.contains=function(it){return-1!=this.indexOf(it)},$.prototype.tn=function(input){return console.log("Ran Custom Prototype"),angular.element(input)},$.__proto__.tn=function(input){return console.log("Ran Custom Prototype"),angular.element(input)},app.config(function($stateProvider,$urlRouterProvider,$locationProvider,$urlMatcherFactoryProvider){$stateProvider.state("home",{url:"","abstract":!0,views:{"navigation@":{templateUrl:"./template/layout/navigation/navigation.html",controller:"NavCtrl"},"footer@":{templateUrl:"./template/layout/footer/footer.html",controller:"FooterCtrl"},"copyright@":{templateUrl:"./template/layout/copyright/copyright.html",controller:"CopyrightCtrl"}}}).state("home.index",{url:"/",views:{"body@":{templateUrl:"./template/html/home/home.html",controller:"HomeCtrl"}}}).state("home.about",{url:"/about",views:{"body@":{templateUrl:"./template/html/about/about.html",controller:"AboutCtrl"}}}).state("home.contact",{url:"/contact",views:{"body@":{templateUrl:"./template/html/contact/contact.html",controller:"ContactCtrl"}}}).state("home.portfolio",{url:"/portfolio",views:{"body@":{templateUrl:"./template/html/portfolio/portfolio.html",controller:"PortfolioCtrl"}}}).state("home.services",{url:"/services",views:{"body@":{templateUrl:"./template/html/services/services.html",controller:"ServiceCtrl"}}}).state("home.support",{url:"/support",views:{"body@":{templateUrl:"./template/html/support/support.html",controller:"SupportCtrl"}}}).state("home.login",{url:"/login",views:{"body@":{templateUrl:"./template/html/login/login.html",controller:"LoginCtrl"}}}).state("home.login.create",{url:"/create",views:{"body@":{templateUrl:"./template/html/login/login.create.html",controller:"LoginCtrl"}}}).state("profile",{url:"/profile","abstract":!0,views:{"navigation@":{templateUrl:"./template/layout/navigation/navigation.html",controller:"NavCtrl"},"body@":{templateUrl:"./template/layout/profile/profile.layout.html",controller:"ProfileCtrl"},"footer@":{templateUrl:"./template/layout/footer/footer.html",controller:"FooterCtrl"},"copyright@":{templateUrl:"./template/layout/copyright/copyright.html",controller:"CopyrightCtrl"}}}).state("profile.main",{url:"",views:{"profile@messages":{templateUrl:"./template/html/profile/profile.main.html",controller:"ProfileCtrl"}}}).state("profile.messages",{url:"/messages",views:{"profile@messages":{templateUrl:"./template/html/profile/profile.messages.html",controller:"ProfileCtrl"}}}).state("profile.messages.text",{url:"/text",views:{"profile@text":{templateUrl:"./template/html/profile/profile.messages.text.html",controller:"ProfileCtrl"}}}).state("profile.messages.talk",{url:"/talk",views:{"profile@talk":{templateUrl:"./template/html/profile/profile.messages.talk.html",controller:"ProfileCtrl"}}}).state("profile.messages.video",{url:"/video",views:{"profile@video":{templateUrl:"./template/html/profile/profile.messages.video.html",controller:"ProfileCtrl"}}}).state("profile.support",{url:"/support",views:{"profile@support":{templateUrl:"./template/layout/profile/profile.support.layout.html",controller:"SupportTicketCtrl",resolve:{objectId:["$stateParams",function($stateParams){return $stateParams}]}},"profile@ticketList":{templateUrl:"./template/html/profile/profile.support.ticket.list.html",controller:"SupportTicketDetailsCtrl"},"support@ticketMenu":{templateUrl:"./template/html/profile/profile.support.ticket.create.html",controller:"SupportTicketDetailsCtrl"}}}).state("profile.support.tickets",{url:"/ticket/:objectId",views:{"support@tickets":{templateUrl:"./template/html/profile/profile.support.ticket.details.html",controller:"SupportTicketDetailsCtrl"}}}).state("profile.todos",{url:"/todos",views:{"profile@todos":{templateUrl:"./template/html/profile/profile.todos.html",controller:"ProfileCtrl"}}}).state("profile.settings",{url:"/settings",views:{"profile@settings":{templateUrl:"./template/html/profile/profile.settings.html",controller:"ProfileCtrl"}}}).state("home.laws",{url:"/laws",views:{"body@":{templateUrl:"./template/html/laws/laws.html",controller:""}}}),$urlMatcherFactoryProvider.strictMode(!1),$urlRouterProvider.otherwise("/"),$urlRouterProvider.rule(function($injector,$location){var path=$location.url();return"/"===path[path.length-1]||path.indexOf("/?")>-1?(console.log($locationProvider),void alert("Yo! First Bubble")):path.indexOf("?")>-1?(alert("Yo! 2nd Bubble"),path.replace("?","/?")):path+"/"}),$locationProvider.html5Mode(!0),$locationProvider.hashPrefix("#")}),angular.module("FacebookLogin",[]).factory("FBLogin",["$rootScope",function(){var FBLogin={};return FBLogin.checkExistingEmail=function(email){var myEmail=email,query=new Parse.Query(Parse.User);query.exists("email"),query.find({success:function(response){for(i=0;i<response.length;i++){var object=response[i];return object.get("email")==myEmail?(console.log("Email Already Exists - Linking Accounts"),!0):(console.log("Email DOES NOT Exist"),!1)}},error:function(){console.log("Error")}})},FBLogin.linkFacebook=function(user){Parse.FacebookUtils.isLinked(user)||Parse.FacebookUtils.link(user,null,{success:function(){console.log("Woohoo, user logged in with Facebook!")},error:function(){console.log("User cancelled the Facebook login or did not fully authorize.")}})},FBLogin.unlinkFacebook=function(user){Parse.FacebookUtils.unlink(user,{success:function(){alert("The user is no longer associated with their Facebook account.")}})},FBLogin}]),angular.module("ParseServices",[]).factory("LoginService",["$state","$rootScope","$window",function($state,$rootScope){var Login={};return Login.createUser=function(userDetails){{var user=new Parse.User;userDetails.length}user.set("username",userDetails.username),console.log("Setting Parse.User "+userDetails.username),user.set("password",userDetails.password),console.log("Setting Parse.User "+userDetails.password),user.set("firstName",userDetails.firstName),console.log("Setting Parse.User "+userDetails.firstName),user.set("lastName",userDetails.lastName),console.log("Setting Parse.User "+userDetails.lastName),user.set("email",userDetails.email),console.log("Setting Parse.User "+userDetails.email),user.signUp(null,{success:function(){console.log("Redirecting You To Home State"),$state.go("home.login")},error:function(user,error){alert("Error: "+error.code+" "+error.message)}})},Login.login=function(username,password){Parse.User.logIn(username,password,{success:function(){console.log("Success! Parse has logged in the user: "+username),$rootScope.reloadWindow(),$state.transitionTo("profile.main")},error:function(user,error){console.log(user,error)}})},Login.logOut=function(){console.log("I heard your request to logout"),$rootScope.sessionUser?($rootScope.ParseUser.logOut(),console.log("User Logged Out"),$state.go("home.index"),$rootScope.reloadWindow()):(console.log("Please Login"),$state.go("login"))},Login.makeAdmin=function(){$rootScope.sessionUser&&$rootScope.techNinjaAdmin?(console.log("Making: "+$rootScope.techNinjaAdminName+" admin"),console.log("Tech Ninja Admin variable is: ",$rootScope.techNinjaAdmin)):(console.log("User: "+$rootScope.techNinjaAdminName+" is not an admin"),console.log("Tech Ninja Admin variable is: ",$rootScope.techNinjaAdmin))},Login}]),angular.module("tnApp.services",[]).service("Socket",["$state","$rootScope","$window","$q",function(){return io.connect("https://tech-ninja.herokuapp.com")}]),angular.module("tnApp.controllers").controller("AboutCtrl",function($scope,$location,$anchorScroll,$timeout,portfolioList){function createChart(){console.log("Creating Chart"),setTimeout(function(){twttr.widgets.load()},300)}$scope.alias="AboutCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",$scope.portfolioList=portfolioList,$scope.scrollTo=function(id){$location.path("/services"),$location.hash(id),$timeout(function(){$anchorScroll()},500)},$('a[data-toggle="tooltip"]').tooltip({animated:"fade",placement:"right"}),$scope.modalPopup=function(item){var modalTitle=$(".modal-title"),modalBody=$(".modal-body"),modalFooter=$(".modal-footer");console.log("ITEM",item),modalTitle.html(item.title),modalBody.html("<img src='"+item.imgSrc+"' alt='"+item.alt+"' class='img-responsive'>'"+item.body+"'</img>"),modalFooter.html("<a class='text-center' href='"+item.url+"'><div><span id='visit-site'>Visit Website - </span>"+item.title+"</div></a>")},$(".modal-btn").on("click",function(e){console.log("Clicked",e),e.preventDefault();var modalTitle=$(".modal-title"),modalBody=$(".modal-body"),modalFooter=$(".modal-footer"),img=new Image,imageTitle=e.target.attributes.alt.value;$(img).addClass("img-responsive"),img.onload=function(){},img.src=e.target.src,modalTitle.html(imageTitle),modalBody.html(img),modalFooter.html("<button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>")});var $window=$(window),didScroll=!1,fired=0,skillsTop=$("#slogan").offset().top-1e3;$window.on("scroll",function(){didScroll=!0});var watch=setInterval(function(){0>=fired&&didScroll&&1==$("#twitter-feed").is(":visible")&&(didScroll=!1,$window.scrollTop()>=skillsTop&&(createChart(),fired++,clearInterval(watch)))},250)}),angular.module("tnApp.controllers").controller("ContactCtrl",function($scope){if($scope.alias="ContactCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",document.getElementById("contact-page")){var submitBtn=$("#submit");submitBtn.on("click",function(e){console.log("Clicked");var formData={companyName:$("#company-name").val(),currentWebsite:$("#curren-website").val(),designation:$("#designation").val(),firstName:$("#first-name").val(),lastName:$("#last-name").val(),phoneNumber:$("#phone").val(),mobileNumber:$("#mobile").val(),email:$("#email").val(),city:$("#city").val(),country:$("#country").val(),purpose:$("#purpose").val(),businessDescription:$("#business-description").val(),competitors:$("#competitors").val(),usp:$("#usp").val(),demographics:$("#target-demographics").val(),sitesEnjoyed:$("#sites-enjoyed").val(),sitesNotEnjoyed:$("#sites-not-enjoyed").val(),functionality:$("#functionality").val(),webManagement:$("#web-management").val(),keywordResearch:$("#keyword-research").val(),contentResearch:$("#content-research").val(),timeInvestment:$("#time-investment").val(),feedback:$("#feedback").val()},DB=Parse.Object.extend("SiteContactForm"),saveForm=new DB;return formData.firstName&&formData.lastName&&formData.phoneNumber&&formData.email&&formData.city&&formData.purpose?(e.preventDefault(),void saveForm.save(formData).then(function(){window.location.href="../../index.html"})):void console.warn("You've Missed Some info")})}}),angular.module("tnApp.controllers").controller("HomeCtrl",function($scope){function createChart(){console.log("Creating Chart"),setTimeout(function(){$("#reports-chart").highcharts(barOptions)},300)}$scope.alias="HomeCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller";var wow=new WOW({boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0});wow.init(),$("#teaser-window").parallax("30%",.4,{}),$("#consultation").parallax("50%",.4,{});var testimonial=$(".testimony-slide"),elipsis=150;testimonial.each(function(pos,item){item.innerHTML=item.innerHTML.substr(0,elipsis)+"..."}),$("#portfolio-slideshow").flexslider({animation:"fade",animationSpeed:1e3,slideshowSpeed:4e3,touch:!0,itemWidth:200,itemMargin:1,minItems:3,maxItems:9,move:0,useCSS:!0}),$("#testimony-slideshow").flexslider({animation:"slide",animationSpeed:1e3,slideshowSpeed:5e3,touch:!0,itemWidth:600,useCSS:!0,controlNav:!0,maxItems:1});var barOptions={chart:{type:"column",options3d:{enabled:!0,alpha:15,beta:15,viewDistance:25,depth:40},marginTop:80,marginRight:40},title:{text:"Reports For Days!"},xAxis:{categories:["Apples","Oranges","Pears","Grapes","Bananas"]},yAxis:{allowDecimals:!1,min:0,title:{text:"Hover Over The Graph!"}},tooltip:{headerFormat:"<b>{point.key}</b><br>",pointFormat:'<span style="color:{series.color}">●</span> {series.name}: {point.y} / {point.stackTotal}'},plotOptions:{column:{stacking:"normal",depth:40}},series:[{name:"John",data:[5,3,4,7,2],stack:"male"},{name:"Joe",data:[3,4,4,2,5],stack:"male"},{name:"Jane",data:[2,5,6,2,1],stack:"female"},{name:"Janet",data:[3,0,4,4,3],stack:"female"}],exporting:{enabled:!1},credits:{enabled:!1}};$scope.barOptions=barOptions;var $window=$(window),didScroll=!1,fired=0,skillsTop=$("#reports-point-right").offset().top-600;$window.on("scroll",function(){didScroll=!0});var watch=setInterval(function(){0>=fired&&didScroll&&1==$("#reports-point-right").is(":visible")&&(didScroll=!1,$window.scrollTop()>=skillsTop&&(createChart(),fired++,clearInterval(watch)))},250)}),angular.module("tnApp.controllers").controller("LoginCtrl",["$scope","$state","$rootScope","LoginService",function($scope,$state,$rootScope,Login){$scope.alias="Login Controller",$scope.currentUsername=$rootScope.currentUser,$scope.username=$rootScope.sessionUserName||"User Name",$scope.password="password",$scope.firstName="First Name",$scope.lastName="Last Name",$scope.email="email@mail.com",$scope.userDetails=[{username:$scope.username,password:$scope.password,firstName:$scope.firstName,lastName:$scope.lastName,email:$scope.email}],$scope.createUser=function(){return $scope.userDetails.push({username:$scope.username,password:$scope.password,firstName:$scope.firstName,lastName:$scope.lastName,email:$scope.email}),console.log("Passing Parse Test User to Login.JS using data: ",$scope.userDetails),Login.createUser($scope.userDetails)},$scope.login=function(username,password){return Login.login(username,password)},$scope.createUser=function(username,firstName,lastName,email,password){var user={};return user.username=username,user.firstName=firstName,user.lastName=lastName,user.email=email,user.password=password,console.log("Running Create With Data",user),Login.createUser(user)},$scope.alert=function(){console.log("You've hit the LoginCtrl alert button"),console.log(ParseUser),console.log(Login)},$scope.makeAdmin=function(){return console.log($rootScope.sessionUserName,"is requesting Admin Axx"),console.log("Here's your Parse.User.current() object:",$rootScope.sessionUser),Login.makeAdmin()}}]),angular.module("tnApp.controllers").controller("PortfolioCtrl",["$scope","portfolioList",function($scope,PortfolioList){$scope.alias="PortfolioCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",$scope.categories=["Soft","Elements"],$scope.portfolioList=PortfolioList,$(".modal-btn").on("click",function(e){e.preventDefault();var modalTitle=$(".modal-title"),modalBody=$(".modal-body"),modalFooter=$(".modal-footer"),img=new Image,imageTitle=e.target.attributes.alt.value;$(img).addClass("img-responsive"),img.onload=function(){},img.src=e.target.src,modalTitle.html(imageTitle),modalBody.html(img),modalFooter.html("<button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>")})}]),angular.module("tnApp.services").service("portfolioList",function(){var portfolioList=[{title:"Annies Repurpose","data-cat":"web",imgSrc:"assets/banners/portfolio/annies-repurpose.png",url:"#",alt:"Annies Repurpose Inc.",body:"Hey here is some body for the site - Annies Repurpose Inc. - Enjoy!"},{title:"BlueBook Business","data-cat":"web logo card",imgSrc:"assets/banners/portfolio/bluebook.png",url:"#",alt:"BlueBook Business",body:"Hey here is some body for the site - BlueBook Business - Enjoy!"},{title:"EvolutionX Diesel","data-cat":"web",imgSrc:"assets/banners/portfolio/evox.png",url:"#",alt:"EvolutionX Diesel Performance",body:"Hey here is some body for the site - EvolutionX Diesel Performance - Enjoy!"},{title:"Trenderz Hub Inc.","data-cat":"web logo card",imgSrc:"assets/banners/portfolio/trenderzhub.png",url:"#",alt:"Trenderz Hub Inc.",body:"Hey here is some body for the site - logo #5 - Enjoy!"},{title:"Nitrotech Energy","data-cat":"web",imgSrc:"assets/banners/portfolio/nitrotech.png",url:"#",alt:"Nitrotech Energy Services",body:"Hey here is some body for the site - Nitrotech Energy Services - Enjoy!"},{title:"RoomXI Entertainment","data-cat":"web",imgSrc:"assets/banners/portfolio/roomxi.png",url:"#",alt:"RoomXI.com",body:"Hey here is some body for the site - RoomXI.com - Enjoy!"},{title:"Smoke Em Diesel","data-cat":"code app",imgSrc:"assets/banners/portfolio/smoke-em.png",url:"#",alt:"Smoke Em Diesel",body:"Hey here is some body for the site - Smoke Em Diesel - Enjoy!"},{title:"DFC Diesel","data-cat":"code",imgSrc:"assets/banners/portfolio/dfc-diesel.png",url:"#",alt:"logo #5",body:"Hey here is some body for the site - logo #5 - Enjoy!"},{title:"Uncle Bear Spices","data-cat":"code",imgSrc:"assets/banners/portfolio/uncle-bear-spices.png",url:"#",alt:"Uncle Bear Spices",body:"Hey here is some body for the site - Uncle Bear Spices - Enjoy!"},{title:"Spacantik","data-cat":"web code",imgSrc:"assets/banners/portfolio/spacantik.png",url:"#",alt:"Spacantik",body:"Hey here is some body for the site - Spacantik - Enjoy!"}];return portfolioList}),angular.module("tnApp.controllers").controller("SupportTicketCtrl",["$scope","$state","$rootScope","ngTableParams","SupportTickets","TicketService",function($scope,$state,$rootScope,Table,Ticket,Messages){$scope.alias="Support Ticket Controller",$scope.ticketInView=function(){var location=window.location.pathname;return location.contains("ticket")?!0:!1};var params={where:{postedBy:Parse.User.current().get("username")}},query=Messages;query.get(params,function(res){$scope.supportTickets=res.results,$scope.ticketThread=res.results[0].supportTickets}),$scope.createTicket=function(subject,body){var today=new Date,ticketSubject=(today.getDate(),today.getMonth()+1,today.getFullYear(),subject),ticketBody=[],body={createdAt:today,ticketBody:body,replyFrom:Parse.User.current().get("username")};ticketBody.push(body);var params={postedBy:Parse.User.current().get("username"),ticketSubject:ticketSubject,ticketBody:ticketBody,ticketStatus:"open"};JSON.stringify(params),query.post(params,function(res){console.log("Post Ticket ",res),$(".close").length>0&&$(".close").click(),console.warn("Hope that this updated with new message!",$scope.supportTickets)})},$scope.updateTicket=function(){},$scope.deleteTicket=function(stateParams){console.log("StateParams ObjectId",stateParams)}}]),angular.module("tnApp.controllers").controller("SupportTicketDetailsCtrl",["TicketService","$scope","$stateParams",function(Tickets,$scope,$stateParams){$scope.stateParamsObjectId=$stateParams.objectId,$scope.message="Product Detail Controller",$scope.currentTicket=[],$scope.deleteTicket=function(){console.log("Current Ticket",$scope.currentTicket)},console.log("Clicked!");var query=Tickets;query.get({objectId:$scope.stateParamsObjectId,postedBy:Parse.User.current().get("username")},function(res){window.console.log(res,"Got Ticket Details"),$scope.data=res,$scope.currentTicket.push(res)})}]),angular.module("tnApp.services").factory("TicketService",["$http","$q","$resource","$templateCache",function($http,$q,$resource){$q.defer();return $http.defaults.transformRequest.push(function(data,headersGetter){return headersGetter()["X-Parse-Application-Id"]="XFukCIc6giByefQZjvKjvRQdyaID0OqseAdLYGE4",headersGetter()["X-Parse-REST-API-Key"]="MzBDFQGOZfhMe0Md3WksUPGbpzTzoJlqe8WAVtIc",headersGetter().Accept="application/json",headersGetter()["Content-Type"]="application/json",data}),$resource("https://api.parse.com/1/classes/SupportTickets/:objectId/:userName:format",{objectId:"@objectId",userName:"@userName"},{update:{method:"PUT"},getAllTickets:{method:"GET",cache:!0},post:{method:"POST"},find:{method:"GET",isArray:!1},nab:{method:"GET",isArray:!1}})}]),angular.module("tnApp.services").service("SupportTickets",["$http","$q","$resource",function($http,$q){var Ticket={};return Ticket.get=function(){var User=Parse.Object.extend("User"),query=new Parse.Query(User);query.exists("supportTicket");var deferred=$q.defer();return query.find({success:function(res){console.log(res,"Found Some Stuff In DB"),deferred.resolve(res)},error:function(res,err){console.warn(res,err)}}),deferred.promise},Ticket}]),angular.module("tnApp.controllers").controller("ServiceCtrl",function($scope){$scope.alias="Services Controller",$scope.title="Service Page Controller",$scope.message="Yo Yo Son, this is the service page!"}),angular.module("tnApp.controllers").controller("SupportCtrl",["$scope","$rootScope","Socket",function($scope,$rootScope,IO){$scope.getLocation=function(){var location=window.location.pathname;return console.log("Sent Location of: ",location),location},$scope.alias="SupportCtrl",$scope.title="Support Controller",$scope.message="Can You Believe I'm Using Angular!",$scope.test="This is the support controller";var user,icons,userName=$rootScope.sessionUserName||"Guest 12345";if(icons="<i class='icon-ios'></i>",user="<div id='support-admin'>Rahim: Admin"+icons+"</div>",window.document.getElementById("support-page")){var sendBtn=$("#send-btn"),message=$("#message"),chatWindow=window.document.getElementById("chat"),usersOnlineContainer=window.document.getElementById("users"),modalBtn=$("<a class='modal-btn' data-toggle='modal' data-target='#user-modal'></a>");modalBtn.on("click",function(e){{var userName=e.target.innerText,modalTitle=$(".modal-title"),modalBody=$(".modal-body");$(".modal-footer")}modalTitle.html(userName),modalBody.html("<div>USER FEATURES COMMING SOON!</div>")}),message.keyup(function(e){13==e.keyCode&&(console.log("Enter Key Detected"),sendBtn.click())}),sendBtn.on("click",function(){var bit,supportUserName,message=$("#message").val();console.log("Message",message),null===message||"undefined"===message||""===message?console.log("Please enter a valid message"):(supportUserName=userName,supportUserName=supportUserName.toLowerCase().capitalize(),bit="<div class='"+supportUserName.replace(/[^A-Z0-9]/gi,"")+"bit'>"+supportUserName+": "+message+"</div>",IO.emit("chatMessage",{message:$("#message").val(),sender:userName}),$("#chat").append(bit),$("#message").val(""),$(chatWindow)[0].scrollTop=$(chatWindow)[0].scrollHeight,$("#message").focus())}),IO.on("response",function(message){$("#chat").append($('<div id="'+message.userName.replace(/[^A-Z0-9]/gi,"")+'">'+message.userName+": "+JSON.stringify(message.message)+" </div>")),console.log("Got Response",message)}),IO.on("connect",function(){IO.emit("adduser",userName),setTimeout(function(){console.log("Emit Add User",userName)},1500),IO.emit("getAll"),console.log("==========\nEmit getAll\n=========="),IO.on("disconnect",function(message){console.warn("Disconnected from host with message: ",message);var userContainer=$("#"+userName.replace(/[^A-Z0-9]/gi,""));console.log("DELETING YOUR STATUS CONTAINER",userContainer),userContainer.remove()})}),IO.on("listAll",function(all){console.log(all,"All Data from server");for(user in all.usersOnline){var usersOnline='<div id="'+user.replace(/[^A-Z0-9]/gi,"")+'" class="user">'+user+"</div>";console.log("Outputting user: ",user),$(usersOnlineContainer).html(),$(modalBtn).append(usersOnline),$(usersOnlineContainer).append(modalBtn)}}),IO.on("listRooms",function(rooms){console.log(rooms,"Rooms List from server")}),IO.on("listUsers",function(users){console.log(users,"Users List from server")}),IO.on("news",function(message){console.warn("Message From SERVER: ",message)})}}]),angular.module("tnApp.controllers").controller("CopyrightCtrl",["$scope","Socket",function($scope){$scope.alias="CopyrightCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",$scope.getLocation=function(){var location=window.location.pathname;return location}}]),angular.module("tnApp.controllers").controller("FooterCtrl",function($scope,$location,$timeout,$anchorScroll){$scope.alias="FooterCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",$scope.scrollTo=function(id){console.log("Clicked ScrollTo"),$location.hash(""),$anchorScroll(id),console.log("ID",id)};var footerContactFormBtn=$("#footer-contact-us-submit");footerContactFormBtn.on("click",function(e){var footerContactName=($("#footer-contact-us-form"),$("#footer-contact-us-name")),footerContactEmail=$("#footer-contact-us-email"),footerContactMessage=$("#footer-contact-us-message"),DB=Parse.Object.extend("SiteContactForm"),saveForm=new DB;return footerContactName.val()&&footerContactEmail.val()&&footerContactMessage.val()?(e.preventDefault(),void saveForm.save({leadName:footerContactName.val(),leadEmail:footerContactEmail.val(),message:footerContactMessage.val()}).then(function(res){console.log("Response",res),window.location.reload()})):void console.warn("You've Missed Some info")
})}),angular.module("tnApp.controllers").controller("NavCtrl",["$scope","$rootScope","LoginService","Socket",function($scope,$rootScope,Login,Socket){$scope.alias="NavCtrl",$scope.title="Nav Controller",$scope.message="Can You Believe It's Almost Christmas!",$scope.test="This is the main controller",$scope.urls=[{sref:"home",url:"/home",name:"Home"},{sref:"home.about",url:"/about",name:"About"},{sref:"home.portfolio",url:"/portfolio",name:"Portfolio"},{sref:"home.services",url:"/services",name:"Services"},{sref:"home.support",url:"/support",name:"Support"},{sref:"home.contact",url:"/contact",name:"Contact"}],$rootScope.sessionUser&&$scope.urls.push({sref:"profile.main",url:"/profile",name:"Profile"}),$("#menu-links").on("click",function(){$(".navbar-toggle").click()}),$scope.logOut=function(){return console.log("Session User",$rootScope.sessionUser),Socket.disconnect(),Login.logOut($rootScope.sessionUser)};$("#signin"),$(".not-a-member")}]),angular.module("tnApp.controllers").controller("ProfileCtrl",["$scope","$state","$rootScope","LoginService",function($scope){$scope.alias="Profile Controller",(null!=Parse.User.current()||Parse.User.current())&&($scope.currentUser={username:Parse.User.current().get("username"),firstName:Parse.User.current().get("firstName"),lastName:Parse.User.current().get("lastName"),email:Parse.User.current().get("email")}),console.log("CURRENT USER",$scope.currentUser)}]),app.factory("GetProducts",["$http","$q","$resource","$templateCache",function($http,$q,$resource){$q.defer();return $http.defaults.transformRequest.push(function(data,headersGetter){return headersGetter()["X-Parse-Application-Id"]="XFukCIc6giByefQZjvKjvRQdyaID0OqseAdLYGE4",headersGetter()["X-Parse-REST-API-Key"]="MzBDFQGOZfhMe0Md3WksUPGbpzTzoJlqe8WAVtIc",headersGetter().Accept="application/json",headersGetter()["Content-Type"]="application/json",data}),$resource("https://api.parse.com/1/classes/FastTech/:id/:params:format",{id:"@id",params:"@params"},{update:{method:"PUT"},grab:{method:"GET",cache:!0},find:{method:"GET",isArray:!1,params:{objectId:"LtET4bS9h4"}},nab:{method:"GET",isArray:!1}})}]),app.filter("startFrom",function(){return function(input,start){if(angular.isArray(input)){var st=parseInt(start,10);return isNaN(st)&&(st=0),input.slice(st)}return input}}),app.controller("ProductsCtrl",["GetProducts","$scope","ngTableParams",function(Products,$scope,Table){$scope.message="Products Controller",console.log("Getting products ..."),$scope.tableParams=new Table({page:1,count:10},{getData:function($defer,params){var query=Products;query.grab(function(res){$scope.data=res.results.slice((params.page()-1)*params.count(),params.page()*params.count()),window.console.log($scope.data,"Data Object")})}})}]),app.controller("ItemDetailsCtrl",["GetProducts","$scope","$stateParams",function(Products,$scope,$stateParams){$scope.getItem=$stateParams.objectId,$scope.message="Product Detail Controller",console.log($stateParams,"State Params");var query=Products;query.get({id:$scope.getItem},function(res){window.console.log(res,"Response From Server"),$scope.data=res,$scope.objectId=res.objectId,$scope.title=res.title,$scope.description=res.description,$scope.price=res.price,$scope.specs=res.specs,Array.prototype.forEach.call($scope.specs,function(spec){for(var bit in spec)if(spec.hasOwnProperty(bit)){var obj=spec[bit];for(var prop in obj)obj.hasOwnProperty(prop)&&($scope[prop]=obj[prop])}})}),$scope.parseConst=function(){console.log("Clicked Parse Constraint Button");var pre=encodeURIComponent(JSON.stringify("where=")),params={price:{$lte:10,$gte:9}};params=encodeURIComponent(JSON.stringify(params)),pre+=params,console.log("Pre",pre),query.nab(pre,function(res){console.log(res,"response from server")})}}]),"undefined"==typeof jQuery)throw new Error("Bootstrap's JavaScript requires jQuery");if(+function($){"use strict";function transitionEnd(){var el=document.createElement("bootstrap"),transEndEventNames={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var name in transEndEventNames)if(void 0!==el.style[name])return{end:transEndEventNames[name]};return!1}$.fn.emulateTransitionEnd=function(duration){var called=!1,$el=this;$(this).one("bsTransitionEnd",function(){called=!0});var callback=function(){called||$($el).trigger($.support.transition.end)};return setTimeout(callback,duration),this},$(function(){$.support.transition=transitionEnd(),$.support.transition&&($.event.special.bsTransitionEnd={bindType:$.support.transition.end,delegateType:$.support.transition.end,handle:function(e){return $(e.target).is(this)?e.handleObj.handler.apply(this,arguments):void 0}})})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.alert");data||$this.data("bs.alert",data=new Alert(this)),"string"==typeof option&&data[option].call($this)})}var dismiss='[data-dismiss="alert"]',Alert=function(el){$(el).on("click",dismiss,this.close)};Alert.VERSION="3.2.0",Alert.prototype.close=function(e){function removeElement(){$parent.detach().trigger("closed.bs.alert").remove()}var $this=$(this),selector=$this.attr("data-target");selector||(selector=$this.attr("href"),selector=selector&&selector.replace(/.*(?=#[^\s]*$)/,""));var $parent=$(selector);e&&e.preventDefault(),$parent.length||($parent=$this.hasClass("alert")?$this:$this.parent()),$parent.trigger(e=$.Event("close.bs.alert")),e.isDefaultPrevented()||($parent.removeClass("in"),$.support.transition&&$parent.hasClass("fade")?$parent.one("bsTransitionEnd",removeElement).emulateTransitionEnd(150):removeElement())};var old=$.fn.alert;$.fn.alert=Plugin,$.fn.alert.Constructor=Alert,$.fn.alert.noConflict=function(){return $.fn.alert=old,this},$(document).on("click.bs.alert.data-api",dismiss,Alert.prototype.close)}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.button"),options="object"==typeof option&&option;data||$this.data("bs.button",data=new Button(this,options)),"toggle"==option?data.toggle():option&&data.setState(option)})}var Button=function(element,options){this.$element=$(element),this.options=$.extend({},Button.DEFAULTS,options),this.isLoading=!1};Button.VERSION="3.2.0",Button.DEFAULTS={loadingText:"loading..."},Button.prototype.setState=function(state){var d="disabled",$el=this.$element,val=$el.is("input")?"val":"html",data=$el.data();state+="Text",null==data.resetText&&$el.data("resetText",$el[val]()),$el[val](null==data[state]?this.options[state]:data[state]),setTimeout($.proxy(function(){"loadingText"==state?(this.isLoading=!0,$el.addClass(d).attr(d,d)):this.isLoading&&(this.isLoading=!1,$el.removeClass(d).removeAttr(d))},this),0)},Button.prototype.toggle=function(){var changed=!0,$parent=this.$element.closest('[data-toggle="buttons"]');if($parent.length){var $input=this.$element.find("input");"radio"==$input.prop("type")&&($input.prop("checked")&&this.$element.hasClass("active")?changed=!1:$parent.find(".active").removeClass("active")),changed&&$input.prop("checked",!this.$element.hasClass("active")).trigger("change")}changed&&this.$element.toggleClass("active")};var old=$.fn.button;$.fn.button=Plugin,$.fn.button.Constructor=Button,$.fn.button.noConflict=function(){return $.fn.button=old,this},$(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(e){var $btn=$(e.target);$btn.hasClass("btn")||($btn=$btn.closest(".btn")),Plugin.call($btn,"toggle"),e.preventDefault()})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.carousel"),options=$.extend({},Carousel.DEFAULTS,$this.data(),"object"==typeof option&&option),action="string"==typeof option?option:options.slide;data||$this.data("bs.carousel",data=new Carousel(this,options)),"number"==typeof option?data.to(option):action?data[action]():options.interval&&data.pause().cycle()})}var Carousel=function(element,options){this.$element=$(element).on("keydown.bs.carousel",$.proxy(this.keydown,this)),this.$indicators=this.$element.find(".carousel-indicators"),this.options=options,this.paused=this.sliding=this.interval=this.$active=this.$items=null,"hover"==this.options.pause&&this.$element.on("mouseenter.bs.carousel",$.proxy(this.pause,this)).on("mouseleave.bs.carousel",$.proxy(this.cycle,this))};Carousel.VERSION="3.2.0",Carousel.DEFAULTS={interval:5e3,pause:"hover",wrap:!0},Carousel.prototype.keydown=function(e){switch(e.which){case 37:this.prev();break;case 39:this.next();break;default:return}e.preventDefault()},Carousel.prototype.cycle=function(e){return e||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval($.proxy(this.next,this),this.options.interval)),this},Carousel.prototype.getItemIndex=function(item){return this.$items=item.parent().children(".item"),this.$items.index(item||this.$active)},Carousel.prototype.to=function(pos){var that=this,activeIndex=this.getItemIndex(this.$active=this.$element.find(".item.active"));return pos>this.$items.length-1||0>pos?void 0:this.sliding?this.$element.one("slid.bs.carousel",function(){that.to(pos)}):activeIndex==pos?this.pause().cycle():this.slide(pos>activeIndex?"next":"prev",$(this.$items[pos]))},Carousel.prototype.pause=function(e){return e||(this.paused=!0),this.$element.find(".next, .prev").length&&$.support.transition&&(this.$element.trigger($.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this},Carousel.prototype.next=function(){return this.sliding?void 0:this.slide("next")},Carousel.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")},Carousel.prototype.slide=function(type,next){var $active=this.$element.find(".item.active"),$next=next||$active[type](),isCycling=this.interval,direction="next"==type?"left":"right",fallback="next"==type?"first":"last",that=this;if(!$next.length){if(!this.options.wrap)return;$next=this.$element.find(".item")[fallback]()}if($next.hasClass("active"))return this.sliding=!1;var relatedTarget=$next[0],slideEvent=$.Event("slide.bs.carousel",{relatedTarget:relatedTarget,direction:direction});if(this.$element.trigger(slideEvent),!slideEvent.isDefaultPrevented()){if(this.sliding=!0,isCycling&&this.pause(),this.$indicators.length){this.$indicators.find(".active").removeClass("active");var $nextIndicator=$(this.$indicators.children()[this.getItemIndex($next)]);$nextIndicator&&$nextIndicator.addClass("active")}var slidEvent=$.Event("slid.bs.carousel",{relatedTarget:relatedTarget,direction:direction});return $.support.transition&&this.$element.hasClass("slide")?($next.addClass(type),$next[0].offsetWidth,$active.addClass(direction),$next.addClass(direction),$active.one("bsTransitionEnd",function(){$next.removeClass([type,direction].join(" ")).addClass("active"),$active.removeClass(["active",direction].join(" ")),that.sliding=!1,setTimeout(function(){that.$element.trigger(slidEvent)},0)}).emulateTransitionEnd(1e3*$active.css("transition-duration").slice(0,-1))):($active.removeClass("active"),$next.addClass("active"),this.sliding=!1,this.$element.trigger(slidEvent)),isCycling&&this.cycle(),this}};var old=$.fn.carousel;$.fn.carousel=Plugin,$.fn.carousel.Constructor=Carousel,$.fn.carousel.noConflict=function(){return $.fn.carousel=old,this},$(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(e){var href,$this=$(this),$target=$($this.attr("data-target")||(href=$this.attr("href"))&&href.replace(/.*(?=#[^\s]+$)/,""));if($target.hasClass("carousel")){var options=$.extend({},$target.data(),$this.data()),slideIndex=$this.attr("data-slide-to");slideIndex&&(options.interval=!1),Plugin.call($target,options),slideIndex&&$target.data("bs.carousel").to(slideIndex),e.preventDefault()}}),$(window).on("load",function(){$('[data-ride="carousel"]').each(function(){var $carousel=$(this);Plugin.call($carousel,$carousel.data())})})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.collapse"),options=$.extend({},Collapse.DEFAULTS,$this.data(),"object"==typeof option&&option);!data&&options.toggle&&"show"==option&&(option=!option),data||$this.data("bs.collapse",data=new Collapse(this,options)),"string"==typeof option&&data[option]()})}var Collapse=function(element,options){this.$element=$(element),this.options=$.extend({},Collapse.DEFAULTS,options),this.transitioning=null,this.options.parent&&(this.$parent=$(this.options.parent)),this.options.toggle&&this.toggle()};Collapse.VERSION="3.2.0",Collapse.DEFAULTS={toggle:!0},Collapse.prototype.dimension=function(){var hasWidth=this.$element.hasClass("width");return hasWidth?"width":"height"},Collapse.prototype.show=function(){if(!this.transitioning&&!this.$element.hasClass("in")){var startEvent=$.Event("show.bs.collapse");if(this.$element.trigger(startEvent),!startEvent.isDefaultPrevented()){var actives=this.$parent&&this.$parent.find("> .panel > .in");if(actives&&actives.length){var hasData=actives.data("bs.collapse");if(hasData&&hasData.transitioning)return;Plugin.call(actives,"hide"),hasData||actives.data("bs.collapse",null)}var dimension=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[dimension](0),this.transitioning=1;var complete=function(){this.$element.removeClass("collapsing").addClass("collapse in")[dimension](""),this.transitioning=0,this.$element.trigger("shown.bs.collapse")};if(!$.support.transition)return complete.call(this);var scrollSize=$.camelCase(["scroll",dimension].join("-"));this.$element.one("bsTransitionEnd",$.proxy(complete,this)).emulateTransitionEnd(350)[dimension](this.$element[0][scrollSize])}}},Collapse.prototype.hide=function(){if(!this.transitioning&&this.$element.hasClass("in")){var startEvent=$.Event("hide.bs.collapse");if(this.$element.trigger(startEvent),!startEvent.isDefaultPrevented()){var dimension=this.dimension();this.$element[dimension](this.$element[dimension]())[0].offsetHeight,this.$element.addClass("collapsing").removeClass("collapse").removeClass("in"),this.transitioning=1;var complete=function(){this.transitioning=0,this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};return $.support.transition?void this.$element[dimension](0).one("bsTransitionEnd",$.proxy(complete,this)).emulateTransitionEnd(350):complete.call(this)}}},Collapse.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var old=$.fn.collapse;$.fn.collapse=Plugin,$.fn.collapse.Constructor=Collapse,$.fn.collapse.noConflict=function(){return $.fn.collapse=old,this},$(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(e){var href,$this=$(this),target=$this.attr("data-target")||e.preventDefault()||(href=$this.attr("href"))&&href.replace(/.*(?=#[^\s]+$)/,""),$target=$(target),data=$target.data("bs.collapse"),option=data?"toggle":$this.data(),parent=$this.attr("data-parent"),$parent=parent&&$(parent);data&&data.transitioning||($parent&&$parent.find('[data-toggle="collapse"][data-parent="'+parent+'"]').not($this).addClass("collapsed"),$this[$target.hasClass("in")?"addClass":"removeClass"]("collapsed")),Plugin.call($target,option)})}(jQuery),+function($){"use strict";function clearMenus(e){e&&3===e.which||($(backdrop).remove(),$(toggle).each(function(){var $parent=getParent($(this)),relatedTarget={relatedTarget:this};$parent.hasClass("open")&&($parent.trigger(e=$.Event("hide.bs.dropdown",relatedTarget)),e.isDefaultPrevented()||$parent.removeClass("open").trigger("hidden.bs.dropdown",relatedTarget))}))}function getParent($this){var selector=$this.attr("data-target");selector||(selector=$this.attr("href"),selector=selector&&/#[A-Za-z]/.test(selector)&&selector.replace(/.*(?=#[^\s]*$)/,""));var $parent=selector&&$(selector);return $parent&&$parent.length?$parent:$this.parent()}function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.dropdown");data||$this.data("bs.dropdown",data=new Dropdown(this)),"string"==typeof option&&data[option].call($this)})}var backdrop=".dropdown-backdrop",toggle='[data-toggle="dropdown"]',Dropdown=function(element){$(element).on("click.bs.dropdown",this.toggle)};Dropdown.VERSION="3.2.0",Dropdown.prototype.toggle=function(e){var $this=$(this);if(!$this.is(".disabled, :disabled")){var $parent=getParent($this),isActive=$parent.hasClass("open");if(clearMenus(),!isActive){"ontouchstart"in document.documentElement&&!$parent.closest(".navbar-nav").length&&$('<div class="dropdown-backdrop"/>').insertAfter($(this)).on("click",clearMenus);var relatedTarget={relatedTarget:this};if($parent.trigger(e=$.Event("show.bs.dropdown",relatedTarget)),e.isDefaultPrevented())return;$this.trigger("focus"),$parent.toggleClass("open").trigger("shown.bs.dropdown",relatedTarget)}return!1}},Dropdown.prototype.keydown=function(e){if(/(38|40|27)/.test(e.keyCode)){var $this=$(this);if(e.preventDefault(),e.stopPropagation(),!$this.is(".disabled, :disabled")){var $parent=getParent($this),isActive=$parent.hasClass("open");if(!isActive||isActive&&27==e.keyCode)return 27==e.which&&$parent.find(toggle).trigger("focus"),$this.trigger("click");var desc=" li:not(.divider):visible a",$items=$parent.find('[role="menu"]'+desc+', [role="listbox"]'+desc);if($items.length){var index=$items.index($items.filter(":focus"));38==e.keyCode&&index>0&&index--,40==e.keyCode&&index<$items.length-1&&index++,~index||(index=0),$items.eq(index).trigger("focus")}}}};var old=$.fn.dropdown;$.fn.dropdown=Plugin,$.fn.dropdown.Constructor=Dropdown,$.fn.dropdown.noConflict=function(){return $.fn.dropdown=old,this},$(document).on("click.bs.dropdown.data-api",clearMenus).on("click.bs.dropdown.data-api",".dropdown form",function(e){e.stopPropagation()}).on("click.bs.dropdown.data-api",toggle,Dropdown.prototype.toggle).on("keydown.bs.dropdown.data-api",toggle+', [role="menu"], [role="listbox"]',Dropdown.prototype.keydown)}(jQuery),+function($){"use strict";function Plugin(option,_relatedTarget){return this.each(function(){var $this=$(this),data=$this.data("bs.modal"),options=$.extend({},Modal.DEFAULTS,$this.data(),"object"==typeof option&&option);data||$this.data("bs.modal",data=new Modal(this,options)),"string"==typeof option?data[option](_relatedTarget):options.show&&data.show(_relatedTarget)})}var Modal=function(element,options){this.options=options,this.$body=$(document.body),this.$element=$(element),this.$backdrop=this.isShown=null,this.scrollbarWidth=0,this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,$.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};Modal.VERSION="3.2.0",Modal.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},Modal.prototype.toggle=function(_relatedTarget){return this.isShown?this.hide():this.show(_relatedTarget)},Modal.prototype.show=function(_relatedTarget){var that=this,e=$.Event("show.bs.modal",{relatedTarget:_relatedTarget});this.$element.trigger(e),this.isShown||e.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.$body.addClass("modal-open"),this.setScrollbar(),this.escape(),this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',$.proxy(this.hide,this)),this.backdrop(function(){var transition=$.support.transition&&that.$element.hasClass("fade");that.$element.parent().length||that.$element.appendTo(that.$body),that.$element.show().scrollTop(0),transition&&that.$element[0].offsetWidth,that.$element.addClass("in").attr("aria-hidden",!1),that.enforceFocus();var e=$.Event("shown.bs.modal",{relatedTarget:_relatedTarget});transition?that.$element.find(".modal-dialog").one("bsTransitionEnd",function(){that.$element.trigger("focus").trigger(e)}).emulateTransitionEnd(300):that.$element.trigger("focus").trigger(e)}))},Modal.prototype.hide=function(e){e&&e.preventDefault(),e=$.Event("hide.bs.modal"),this.$element.trigger(e),this.isShown&&!e.isDefaultPrevented()&&(this.isShown=!1,this.$body.removeClass("modal-open"),this.resetScrollbar(),this.escape(),$(document).off("focusin.bs.modal"),this.$element.removeClass("in").attr("aria-hidden",!0).off("click.dismiss.bs.modal"),$.support.transition&&this.$element.hasClass("fade")?this.$element.one("bsTransitionEnd",$.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal())},Modal.prototype.enforceFocus=function(){$(document).off("focusin.bs.modal").on("focusin.bs.modal",$.proxy(function(e){this.$element[0]===e.target||this.$element.has(e.target).length||this.$element.trigger("focus")},this))},Modal.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on("keyup.dismiss.bs.modal",$.proxy(function(e){27==e.which&&this.hide()},this)):this.isShown||this.$element.off("keyup.dismiss.bs.modal")},Modal.prototype.hideModal=function(){var that=this;this.$element.hide(),this.backdrop(function(){that.$element.trigger("hidden.bs.modal")})},Modal.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},Modal.prototype.backdrop=function(callback){var that=this,animate=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var doAnimate=$.support.transition&&animate;if(this.$backdrop=$('<div class="modal-backdrop '+animate+'" />').appendTo(this.$body),this.$element.on("click.dismiss.bs.modal",$.proxy(function(e){e.target===e.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus.call(this.$element[0]):this.hide.call(this))},this)),doAnimate&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!callback)return;doAnimate?this.$backdrop.one("bsTransitionEnd",callback).emulateTransitionEnd(150):callback()}else if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");var callbackRemove=function(){that.removeBackdrop(),callback&&callback()};$.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one("bsTransitionEnd",callbackRemove).emulateTransitionEnd(150):callbackRemove()}else callback&&callback()},Modal.prototype.checkScrollbar=function(){document.body.clientWidth>=window.innerWidth||(this.scrollbarWidth=this.scrollbarWidth||this.measureScrollbar())},Modal.prototype.setScrollbar=function(){var bodyPad=parseInt(this.$body.css("padding-right")||0,10);this.scrollbarWidth&&this.$body.css("padding-right",bodyPad+this.scrollbarWidth)},Modal.prototype.resetScrollbar=function(){this.$body.css("padding-right","")},Modal.prototype.measureScrollbar=function(){var scrollDiv=document.createElement("div");scrollDiv.className="modal-scrollbar-measure",this.$body.append(scrollDiv);var scrollbarWidth=scrollDiv.offsetWidth-scrollDiv.clientWidth;return this.$body[0].removeChild(scrollDiv),scrollbarWidth};var old=$.fn.modal;$.fn.modal=Plugin,$.fn.modal.Constructor=Modal,$.fn.modal.noConflict=function(){return $.fn.modal=old,this},$(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(e){var $this=$(this),href=$this.attr("href"),$target=$($this.attr("data-target")||href&&href.replace(/.*(?=#[^\s]+$)/,"")),option=$target.data("bs.modal")?"toggle":$.extend({remote:!/#/.test(href)&&href},$target.data(),$this.data());$this.is("a")&&e.preventDefault(),$target.one("show.bs.modal",function(showEvent){showEvent.isDefaultPrevented()||$target.one("hidden.bs.modal",function(){$this.is(":visible")&&$this.trigger("focus")})}),Plugin.call($target,option,this)})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.tooltip"),options="object"==typeof option&&option;(data||"destroy"!=option)&&(data||$this.data("bs.tooltip",data=new Tooltip(this,options)),"string"==typeof option&&data[option]())})}var Tooltip=function(element,options){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null,this.init("tooltip",element,options)};Tooltip.VERSION="3.2.0",Tooltip.DEFAULTS={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:!1,container:!1,viewport:{selector:"body",padding:0}},Tooltip.prototype.init=function(type,element,options){this.enabled=!0,this.type=type,this.$element=$(element),this.options=this.getOptions(options),this.$viewport=this.options.viewport&&$(this.options.viewport.selector||this.options.viewport);for(var triggers=this.options.trigger.split(" "),i=triggers.length;i--;){var trigger=triggers[i];if("click"==trigger)this.$element.on("click."+this.type,this.options.selector,$.proxy(this.toggle,this));else if("manual"!=trigger){var eventIn="hover"==trigger?"mouseenter":"focusin",eventOut="hover"==trigger?"mouseleave":"focusout";this.$element.on(eventIn+"."+this.type,this.options.selector,$.proxy(this.enter,this)),this.$element.on(eventOut+"."+this.type,this.options.selector,$.proxy(this.leave,this))}}this.options.selector?this._options=$.extend({},this.options,{trigger:"manual",selector:""}):this.fixTitle()},Tooltip.prototype.getDefaults=function(){return Tooltip.DEFAULTS},Tooltip.prototype.getOptions=function(options){return options=$.extend({},this.getDefaults(),this.$element.data(),options),options.delay&&"number"==typeof options.delay&&(options.delay={show:options.delay,hide:options.delay}),options},Tooltip.prototype.getDelegateOptions=function(){var options={},defaults=this.getDefaults();return this._options&&$.each(this._options,function(key,value){defaults[key]!=value&&(options[key]=value)}),options},Tooltip.prototype.enter=function(obj){var self=obj instanceof this.constructor?obj:$(obj.currentTarget).data("bs."+this.type);return self||(self=new this.constructor(obj.currentTarget,this.getDelegateOptions()),$(obj.currentTarget).data("bs."+this.type,self)),clearTimeout(self.timeout),self.hoverState="in",self.options.delay&&self.options.delay.show?void(self.timeout=setTimeout(function(){"in"==self.hoverState&&self.show()},self.options.delay.show)):self.show()},Tooltip.prototype.leave=function(obj){var self=obj instanceof this.constructor?obj:$(obj.currentTarget).data("bs."+this.type);return self||(self=new this.constructor(obj.currentTarget,this.getDelegateOptions()),$(obj.currentTarget).data("bs."+this.type,self)),clearTimeout(self.timeout),self.hoverState="out",self.options.delay&&self.options.delay.hide?void(self.timeout=setTimeout(function(){"out"==self.hoverState&&self.hide()},self.options.delay.hide)):self.hide()},Tooltip.prototype.show=function(){var e=$.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(e);var inDom=$.contains(document.documentElement,this.$element[0]);if(e.isDefaultPrevented()||!inDom)return;var that=this,$tip=this.tip(),tipId=this.getUID(this.type);this.setContent(),$tip.attr("id",tipId),this.$element.attr("aria-describedby",tipId),this.options.animation&&$tip.addClass("fade");var placement="function"==typeof this.options.placement?this.options.placement.call(this,$tip[0],this.$element[0]):this.options.placement,autoToken=/\s?auto?\s?/i,autoPlace=autoToken.test(placement);autoPlace&&(placement=placement.replace(autoToken,"")||"top"),$tip.detach().css({top:0,left:0,display:"block"}).addClass(placement).data("bs."+this.type,this),this.options.container?$tip.appendTo(this.options.container):$tip.insertAfter(this.$element);var pos=this.getPosition(),actualWidth=$tip[0].offsetWidth,actualHeight=$tip[0].offsetHeight;if(autoPlace){var orgPlacement=placement,$parent=this.$element.parent(),parentDim=this.getPosition($parent);placement="bottom"==placement&&pos.top+pos.height+actualHeight-parentDim.scroll>parentDim.height?"top":"top"==placement&&pos.top-parentDim.scroll-actualHeight<0?"bottom":"right"==placement&&pos.right+actualWidth>parentDim.width?"left":"left"==placement&&pos.left-actualWidth<parentDim.left?"right":placement,$tip.removeClass(orgPlacement).addClass(placement)}var calculatedOffset=this.getCalculatedOffset(placement,pos,actualWidth,actualHeight);this.applyPlacement(calculatedOffset,placement);var complete=function(){that.$element.trigger("shown.bs."+that.type),that.hoverState=null};$.support.transition&&this.$tip.hasClass("fade")?$tip.one("bsTransitionEnd",complete).emulateTransitionEnd(150):complete()}},Tooltip.prototype.applyPlacement=function(offset,placement){var $tip=this.tip(),width=$tip[0].offsetWidth,height=$tip[0].offsetHeight,marginTop=parseInt($tip.css("margin-top"),10),marginLeft=parseInt($tip.css("margin-left"),10);isNaN(marginTop)&&(marginTop=0),isNaN(marginLeft)&&(marginLeft=0),offset.top=offset.top+marginTop,offset.left=offset.left+marginLeft,$.offset.setOffset($tip[0],$.extend({using:function(props){$tip.css({top:Math.round(props.top),left:Math.round(props.left)})}},offset),0),$tip.addClass("in");var actualWidth=$tip[0].offsetWidth,actualHeight=$tip[0].offsetHeight;"top"==placement&&actualHeight!=height&&(offset.top=offset.top+height-actualHeight);var delta=this.getViewportAdjustedDelta(placement,offset,actualWidth,actualHeight);delta.left?offset.left+=delta.left:offset.top+=delta.top;var arrowDelta=delta.left?2*delta.left-width+actualWidth:2*delta.top-height+actualHeight,arrowPosition=delta.left?"left":"top",arrowOffsetPosition=delta.left?"offsetWidth":"offsetHeight";$tip.offset(offset),this.replaceArrow(arrowDelta,$tip[0][arrowOffsetPosition],arrowPosition)},Tooltip.prototype.replaceArrow=function(delta,dimension,position){this.arrow().css(position,delta?50*(1-delta/dimension)+"%":"")},Tooltip.prototype.setContent=function(){var $tip=this.tip(),title=this.getTitle();$tip.find(".tooltip-inner")[this.options.html?"html":"text"](title),$tip.removeClass("fade in top bottom left right")},Tooltip.prototype.hide=function(){function complete(){"in"!=that.hoverState&&$tip.detach(),that.$element.trigger("hidden.bs."+that.type)}var that=this,$tip=this.tip(),e=$.Event("hide.bs."+this.type);return this.$element.removeAttr("aria-describedby"),this.$element.trigger(e),e.isDefaultPrevented()?void 0:($tip.removeClass("in"),$.support.transition&&this.$tip.hasClass("fade")?$tip.one("bsTransitionEnd",complete).emulateTransitionEnd(150):complete(),this.hoverState=null,this)},Tooltip.prototype.fixTitle=function(){var $e=this.$element;($e.attr("title")||"string"!=typeof $e.attr("data-original-title"))&&$e.attr("data-original-title",$e.attr("title")||"").attr("title","")},Tooltip.prototype.hasContent=function(){return this.getTitle()},Tooltip.prototype.getPosition=function($element){$element=$element||this.$element;var el=$element[0],isBody="BODY"==el.tagName;return $.extend({},"function"==typeof el.getBoundingClientRect?el.getBoundingClientRect():null,{scroll:isBody?document.documentElement.scrollTop||document.body.scrollTop:$element.scrollTop(),width:isBody?$(window).width():$element.outerWidth(),height:isBody?$(window).height():$element.outerHeight()},isBody?{top:0,left:0}:$element.offset())},Tooltip.prototype.getCalculatedOffset=function(placement,pos,actualWidth,actualHeight){return"bottom"==placement?{top:pos.top+pos.height,left:pos.left+pos.width/2-actualWidth/2}:"top"==placement?{top:pos.top-actualHeight,left:pos.left+pos.width/2-actualWidth/2}:"left"==placement?{top:pos.top+pos.height/2-actualHeight/2,left:pos.left-actualWidth}:{top:pos.top+pos.height/2-actualHeight/2,left:pos.left+pos.width}},Tooltip.prototype.getViewportAdjustedDelta=function(placement,pos,actualWidth,actualHeight){var delta={top:0,left:0};if(!this.$viewport)return delta;var viewportPadding=this.options.viewport&&this.options.viewport.padding||0,viewportDimensions=this.getPosition(this.$viewport);if(/right|left/.test(placement)){var topEdgeOffset=pos.top-viewportPadding-viewportDimensions.scroll,bottomEdgeOffset=pos.top+viewportPadding-viewportDimensions.scroll+actualHeight;topEdgeOffset<viewportDimensions.top?delta.top=viewportDimensions.top-topEdgeOffset:bottomEdgeOffset>viewportDimensions.top+viewportDimensions.height&&(delta.top=viewportDimensions.top+viewportDimensions.height-bottomEdgeOffset)
}else{var leftEdgeOffset=pos.left-viewportPadding,rightEdgeOffset=pos.left+viewportPadding+actualWidth;leftEdgeOffset<viewportDimensions.left?delta.left=viewportDimensions.left-leftEdgeOffset:rightEdgeOffset>viewportDimensions.width&&(delta.left=viewportDimensions.left+viewportDimensions.width-rightEdgeOffset)}return delta},Tooltip.prototype.getTitle=function(){var title,$e=this.$element,o=this.options;return title=$e.attr("data-original-title")||("function"==typeof o.title?o.title.call($e[0]):o.title)},Tooltip.prototype.getUID=function(prefix){do prefix+=~~(1e6*Math.random());while(document.getElementById(prefix));return prefix},Tooltip.prototype.tip=function(){return this.$tip=this.$tip||$(this.options.template)},Tooltip.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")},Tooltip.prototype.validate=function(){this.$element[0].parentNode||(this.hide(),this.$element=null,this.options=null)},Tooltip.prototype.enable=function(){this.enabled=!0},Tooltip.prototype.disable=function(){this.enabled=!1},Tooltip.prototype.toggleEnabled=function(){this.enabled=!this.enabled},Tooltip.prototype.toggle=function(e){var self=this;e&&(self=$(e.currentTarget).data("bs."+this.type),self||(self=new this.constructor(e.currentTarget,this.getDelegateOptions()),$(e.currentTarget).data("bs."+this.type,self))),self.tip().hasClass("in")?self.leave(self):self.enter(self)},Tooltip.prototype.destroy=function(){clearTimeout(this.timeout),this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var old=$.fn.tooltip;$.fn.tooltip=Plugin,$.fn.tooltip.Constructor=Tooltip,$.fn.tooltip.noConflict=function(){return $.fn.tooltip=old,this}}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.popover"),options="object"==typeof option&&option;(data||"destroy"!=option)&&(data||$this.data("bs.popover",data=new Popover(this,options)),"string"==typeof option&&data[option]())})}var Popover=function(element,options){this.init("popover",element,options)};if(!$.fn.tooltip)throw new Error("Popover requires tooltip.js");Popover.VERSION="3.2.0",Popover.DEFAULTS=$.extend({},$.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),Popover.prototype=$.extend({},$.fn.tooltip.Constructor.prototype),Popover.prototype.constructor=Popover,Popover.prototype.getDefaults=function(){return Popover.DEFAULTS},Popover.prototype.setContent=function(){var $tip=this.tip(),title=this.getTitle(),content=this.getContent();$tip.find(".popover-title")[this.options.html?"html":"text"](title),$tip.find(".popover-content").empty()[this.options.html?"string"==typeof content?"html":"append":"text"](content),$tip.removeClass("fade top bottom left right in"),$tip.find(".popover-title").html()||$tip.find(".popover-title").hide()},Popover.prototype.hasContent=function(){return this.getTitle()||this.getContent()},Popover.prototype.getContent=function(){var $e=this.$element,o=this.options;return $e.attr("data-content")||("function"==typeof o.content?o.content.call($e[0]):o.content)},Popover.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")},Popover.prototype.tip=function(){return this.$tip||(this.$tip=$(this.options.template)),this.$tip};var old=$.fn.popover;$.fn.popover=Plugin,$.fn.popover.Constructor=Popover,$.fn.popover.noConflict=function(){return $.fn.popover=old,this}}(jQuery),+function($){"use strict";function ScrollSpy(element,options){var process=$.proxy(this.process,this);this.$body=$("body"),this.$scrollElement=$($(element).is("body")?window:element),this.options=$.extend({},ScrollSpy.DEFAULTS,options),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",process),this.refresh(),this.process()}function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.scrollspy"),options="object"==typeof option&&option;data||$this.data("bs.scrollspy",data=new ScrollSpy(this,options)),"string"==typeof option&&data[option]()})}ScrollSpy.VERSION="3.2.0",ScrollSpy.DEFAULTS={offset:10},ScrollSpy.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)},ScrollSpy.prototype.refresh=function(){var offsetMethod="offset",offsetBase=0;$.isWindow(this.$scrollElement[0])||(offsetMethod="position",offsetBase=this.$scrollElement.scrollTop()),this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight();var self=this;this.$body.find(this.selector).map(function(){var $el=$(this),href=$el.data("target")||$el.attr("href"),$href=/^#./.test(href)&&$(href);return $href&&$href.length&&$href.is(":visible")&&[[$href[offsetMethod]().top+offsetBase,href]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){self.offsets.push(this[0]),self.targets.push(this[1])})},ScrollSpy.prototype.process=function(){var i,scrollTop=this.$scrollElement.scrollTop()+this.options.offset,scrollHeight=this.getScrollHeight(),maxScroll=this.options.offset+scrollHeight-this.$scrollElement.height(),offsets=this.offsets,targets=this.targets,activeTarget=this.activeTarget;if(this.scrollHeight!=scrollHeight&&this.refresh(),scrollTop>=maxScroll)return activeTarget!=(i=targets[targets.length-1])&&this.activate(i);if(activeTarget&&scrollTop<=offsets[0])return activeTarget!=(i=targets[0])&&this.activate(i);for(i=offsets.length;i--;)activeTarget!=targets[i]&&scrollTop>=offsets[i]&&(!offsets[i+1]||scrollTop<=offsets[i+1])&&this.activate(targets[i])},ScrollSpy.prototype.activate=function(target){this.activeTarget=target,$(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var selector=this.selector+'[data-target="'+target+'"],'+this.selector+'[href="'+target+'"]',active=$(selector).parents("li").addClass("active");active.parent(".dropdown-menu").length&&(active=active.closest("li.dropdown").addClass("active")),active.trigger("activate.bs.scrollspy")};var old=$.fn.scrollspy;$.fn.scrollspy=Plugin,$.fn.scrollspy.Constructor=ScrollSpy,$.fn.scrollspy.noConflict=function(){return $.fn.scrollspy=old,this},$(window).on("load.bs.scrollspy.data-api",function(){$('[data-spy="scroll"]').each(function(){var $spy=$(this);Plugin.call($spy,$spy.data())})})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.tab");data||$this.data("bs.tab",data=new Tab(this)),"string"==typeof option&&data[option]()})}var Tab=function(element){this.element=$(element)};Tab.VERSION="3.2.0",Tab.prototype.show=function(){var $this=this.element,$ul=$this.closest("ul:not(.dropdown-menu)"),selector=$this.data("target");if(selector||(selector=$this.attr("href"),selector=selector&&selector.replace(/.*(?=#[^\s]*$)/,"")),!$this.parent("li").hasClass("active")){var previous=$ul.find(".active:last a")[0],e=$.Event("show.bs.tab",{relatedTarget:previous});if($this.trigger(e),!e.isDefaultPrevented()){var $target=$(selector);this.activate($this.closest("li"),$ul),this.activate($target,$target.parent(),function(){$this.trigger({type:"shown.bs.tab",relatedTarget:previous})})}}},Tab.prototype.activate=function(element,container,callback){function next(){$active.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),element.addClass("active"),transition?(element[0].offsetWidth,element.addClass("in")):element.removeClass("fade"),element.parent(".dropdown-menu")&&element.closest("li.dropdown").addClass("active"),callback&&callback()}var $active=container.find("> .active"),transition=callback&&$.support.transition&&$active.hasClass("fade");transition?$active.one("bsTransitionEnd",next).emulateTransitionEnd(150):next(),$active.removeClass("in")};var old=$.fn.tab;$.fn.tab=Plugin,$.fn.tab.Constructor=Tab,$.fn.tab.noConflict=function(){return $.fn.tab=old,this},$(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(e){e.preventDefault(),Plugin.call($(this),"show")})}(jQuery),+function($){"use strict";function Plugin(option){return this.each(function(){var $this=$(this),data=$this.data("bs.affix"),options="object"==typeof option&&option;data||$this.data("bs.affix",data=new Affix(this,options)),"string"==typeof option&&data[option]()})}var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options),this.$target=$(this.options.target).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this)),this.$element=$(element),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};Affix.VERSION="3.2.0",Affix.RESET="affix affix-top affix-bottom",Affix.DEFAULTS={offset:0,target:window},Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$target.scrollTop(),position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop},Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)},Affix.prototype.checkPosition=function(){if(this.$element.is(":visible")){var scrollHeight=$(document).height(),scrollTop=this.$target.scrollTop(),position=this.$element.offset(),offset=this.options.offset,offsetTop=offset.top,offsetBottom=offset.bottom;"object"!=typeof offset&&(offsetBottom=offsetTop=offset),"function"==typeof offsetTop&&(offsetTop=offset.top(this.$element)),"function"==typeof offsetBottom&&(offsetBottom=offset.bottom(this.$element));var affix=null!=this.unpin&&scrollTop+this.unpin<=position.top?!1:null!=offsetBottom&&position.top+this.$element.height()>=scrollHeight-offsetBottom?"bottom":null!=offsetTop&&offsetTop>=scrollTop?"top":!1;if(this.affixed!==affix){null!=this.unpin&&this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:""),e=$.Event(affixType+".bs.affix");this.$element.trigger(e),e.isDefaultPrevented()||(this.affixed=affix,this.unpin="bottom"==affix?this.getPinnedOffset():null,this.$element.removeClass(Affix.RESET).addClass(affixType).trigger($.Event(affixType.replace("affix","affixed"))),"bottom"==affix&&this.$element.offset({top:scrollHeight-this.$element.height()-offsetBottom}))}}};var old=$.fn.affix;$.fn.affix=Plugin,$.fn.affix.Constructor=Affix,$.fn.affix.noConflict=function(){return $.fn.affix=old,this},$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this),data=$spy.data();data.offset=data.offset||{},data.offsetBottom&&(data.offset.bottom=data.offsetBottom),data.offsetTop&&(data.offset.top=data.offsetTop),Plugin.call($spy,data)})})}(jQuery),"undefined"==typeof jQuery)throw new Error("Bootstrap's JavaScript requires jQuery");+function(t){"use strict";function e(){var t=document.createElement("bootstrap"),e={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var i in e)if(void 0!==t.style[i])return{end:e[i]};return!1}t.fn.emulateTransitionEnd=function(e){var i=!1,o=this;t(this).one("bsTransitionEnd",function(){i=!0});var s=function(){i||t(o).trigger(t.support.transition.end)};return setTimeout(s,e),this},t(function(){t.support.transition=e(),t.support.transition&&(t.event.special.bsTransitionEnd={bindType:t.support.transition.end,delegateType:t.support.transition.end,handle:function(e){return t(e.target).is(this)?e.handleObj.handler.apply(this,arguments):void 0}})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var i=t(this),s=i.data("bs.alert");s||i.data("bs.alert",s=new o(this)),"string"==typeof e&&s[e].call(i)})}var i='[data-dismiss="alert"]',o=function(e){t(e).on("click",i,this.close)};o.VERSION="3.2.0",o.prototype.close=function(e){function i(){n.detach().trigger("closed.bs.alert").remove()}var o=t(this),s=o.attr("data-target");s||(s=o.attr("href"),s=s&&s.replace(/.*(?=#[^\s]*$)/,""));var n=t(s);e&&e.preventDefault(),n.length||(n=o.hasClass("alert")?o:o.parent()),n.trigger(e=t.Event("close.bs.alert")),e.isDefaultPrevented()||(n.removeClass("in"),t.support.transition&&n.hasClass("fade")?n.one("bsTransitionEnd",i).emulateTransitionEnd(150):i())};var s=t.fn.alert;t.fn.alert=e,t.fn.alert.Constructor=o,t.fn.alert.noConflict=function(){return t.fn.alert=s,this},t(document).on("click.bs.alert.data-api",i,o.prototype.close)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.button"),n="object"==typeof e&&e;s||o.data("bs.button",s=new i(this,n)),"toggle"==e?s.toggle():e&&s.setState(e)})}var i=function(e,o){this.$element=t(e),this.options=t.extend({},i.DEFAULTS,o),this.isLoading=!1};i.VERSION="3.2.0",i.DEFAULTS={loadingText:"loading..."},i.prototype.setState=function(e){var i="disabled",o=this.$element,s=o.is("input")?"val":"html",n=o.data();e+="Text",null==n.resetText&&o.data("resetText",o[s]()),o[s](null==n[e]?this.options[e]:n[e]),setTimeout(t.proxy(function(){"loadingText"==e?(this.isLoading=!0,o.addClass(i).attr(i,i)):this.isLoading&&(this.isLoading=!1,o.removeClass(i).removeAttr(i))},this),0)},i.prototype.toggle=function(){var t=!0,e=this.$element.closest('[data-toggle="buttons"]');if(e.length){var i=this.$element.find("input");"radio"==i.prop("type")&&(i.prop("checked")&&this.$element.hasClass("active")?t=!1:e.find(".active").removeClass("active")),t&&i.prop("checked",!this.$element.hasClass("active")).trigger("change")}t&&this.$element.toggleClass("active")};var o=t.fn.button;t.fn.button=e,t.fn.button.Constructor=i,t.fn.button.noConflict=function(){return t.fn.button=o,this},t(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(i){var o=t(i.target);o.hasClass("btn")||(o=o.closest(".btn")),e.call(o,"toggle"),i.preventDefault()})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.carousel"),n=t.extend({},i.DEFAULTS,o.data(),"object"==typeof e&&e),r="string"==typeof e?e:n.slide;s||o.data("bs.carousel",s=new i(this,n)),"number"==typeof e?s.to(e):r?s[r]():n.interval&&s.pause().cycle()})}var i=function(e,i){this.$element=t(e).on("keydown.bs.carousel",t.proxy(this.keydown,this)),this.$indicators=this.$element.find(".carousel-indicators"),this.options=i,this.paused=this.sliding=this.interval=this.$active=this.$items=null,"hover"==this.options.pause&&this.$element.on("mouseenter.bs.carousel",t.proxy(this.pause,this)).on("mouseleave.bs.carousel",t.proxy(this.cycle,this))};i.VERSION="3.2.0",i.DEFAULTS={interval:5e3,pause:"hover",wrap:!0},i.prototype.keydown=function(t){switch(t.which){case 37:this.prev();break;case 39:this.next();break;default:return}t.preventDefault()},i.prototype.cycle=function(e){return e||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval(t.proxy(this.next,this),this.options.interval)),this},i.prototype.getItemIndex=function(t){return this.$items=t.parent().children(".item"),this.$items.index(t||this.$active)},i.prototype.to=function(e){var i=this,o=this.getItemIndex(this.$active=this.$element.find(".item.active"));return e>this.$items.length-1||0>e?void 0:this.sliding?this.$element.one("slid.bs.carousel",function(){i.to(e)}):o==e?this.pause().cycle():this.slide(e>o?"next":"prev",t(this.$items[e]))},i.prototype.pause=function(e){return e||(this.paused=!0),this.$element.find(".next, .prev").length&&t.support.transition&&(this.$element.trigger(t.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this},i.prototype.next=function(){return this.sliding?void 0:this.slide("next")},i.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")},i.prototype.slide=function(e,i){var o=this.$element.find(".item.active"),s=i||o[e](),n=this.interval,r="next"==e?"left":"right",a="next"==e?"first":"last",l=this;if(!s.length){if(!this.options.wrap)return;s=this.$element.find(".item")[a]()}if(s.hasClass("active"))return this.sliding=!1;var h=s[0],p=t.Event("slide.bs.carousel",{relatedTarget:h,direction:r});if(this.$element.trigger(p),!p.isDefaultPrevented()){if(this.sliding=!0,n&&this.pause(),this.$indicators.length){this.$indicators.find(".active").removeClass("active");var c=t(this.$indicators.children()[this.getItemIndex(s)]);c&&c.addClass("active")}var d=t.Event("slid.bs.carousel",{relatedTarget:h,direction:r});return t.support.transition&&this.$element.hasClass("slide")?(s.addClass(e),s[0].offsetWidth,o.addClass(r),s.addClass(r),o.one("bsTransitionEnd",function(){s.removeClass([e,r].join(" ")).addClass("active"),o.removeClass(["active",r].join(" ")),l.sliding=!1,setTimeout(function(){l.$element.trigger(d)},0)}).emulateTransitionEnd(1e3*o.css("transition-duration").slice(0,-1))):(o.removeClass("active"),s.addClass("active"),this.sliding=!1,this.$element.trigger(d)),n&&this.cycle(),this}};var o=t.fn.carousel;t.fn.carousel=e,t.fn.carousel.Constructor=i,t.fn.carousel.noConflict=function(){return t.fn.carousel=o,this},t(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(i){var o,s=t(this),n=t(s.attr("data-target")||(o=s.attr("href"))&&o.replace(/.*(?=#[^\s]+$)/,""));if(n.hasClass("carousel")){var r=t.extend({},n.data(),s.data()),a=s.attr("data-slide-to");a&&(r.interval=!1),e.call(n,r),a&&n.data("bs.carousel").to(a),i.preventDefault()}}),t(window).on("load",function(){t('[data-ride="carousel"]').each(function(){var i=t(this);e.call(i,i.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.collapse"),n=t.extend({},i.DEFAULTS,o.data(),"object"==typeof e&&e);!s&&n.toggle&&"show"==e&&(e=!e),s||o.data("bs.collapse",s=new i(this,n)),"string"==typeof e&&s[e]()})}var i=function(e,o){this.$element=t(e),this.options=t.extend({},i.DEFAULTS,o),this.transitioning=null,this.options.parent&&(this.$parent=t(this.options.parent)),this.options.toggle&&this.toggle()};i.VERSION="3.2.0",i.DEFAULTS={toggle:!0},i.prototype.dimension=function(){var t=this.$element.hasClass("width");return t?"width":"height"},i.prototype.show=function(){if(!this.transitioning&&!this.$element.hasClass("in")){var i=t.Event("show.bs.collapse");if(this.$element.trigger(i),!i.isDefaultPrevented()){var o=this.$parent&&this.$parent.find("> .panel > .in");if(o&&o.length){var s=o.data("bs.collapse");if(s&&s.transitioning)return;e.call(o,"hide"),s||o.data("bs.collapse",null)}var n=this.dimension();this.$element.removeClass("collapse").addClass("collapsing")[n](0),this.transitioning=1;var r=function(){this.$element.removeClass("collapsing").addClass("collapse in")[n](""),this.transitioning=0,this.$element.trigger("shown.bs.collapse")};if(!t.support.transition)return r.call(this);var a=t.camelCase(["scroll",n].join("-"));this.$element.one("bsTransitionEnd",t.proxy(r,this)).emulateTransitionEnd(350)[n](this.$element[0][a])}}},i.prototype.hide=function(){if(!this.transitioning&&this.$element.hasClass("in")){var e=t.Event("hide.bs.collapse");if(this.$element.trigger(e),!e.isDefaultPrevented()){var i=this.dimension();this.$element[i](this.$element[i]())[0].offsetHeight,this.$element.addClass("collapsing").removeClass("collapse").removeClass("in"),this.transitioning=1;var o=function(){this.transitioning=0,this.$element.trigger("hidden.bs.collapse").removeClass("collapsing").addClass("collapse")};return t.support.transition?void this.$element[i](0).one("bsTransitionEnd",t.proxy(o,this)).emulateTransitionEnd(350):o.call(this)}}},i.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()};var o=t.fn.collapse;t.fn.collapse=e,t.fn.collapse.Constructor=i,t.fn.collapse.noConflict=function(){return t.fn.collapse=o,this},t(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(i){var o,s=t(this),n=s.attr("data-target")||i.preventDefault()||(o=s.attr("href"))&&o.replace(/.*(?=#[^\s]+$)/,""),r=t(n),a=r.data("bs.collapse"),l=a?"toggle":s.data(),h=s.attr("data-parent"),p=h&&t(h);a&&a.transitioning||(p&&p.find('[data-toggle="collapse"][data-parent="'+h+'"]').not(s).addClass("collapsed"),s[r.hasClass("in")?"addClass":"removeClass"]("collapsed")),e.call(r,l)})}(jQuery),+function(t){"use strict";function e(e){e&&3===e.which||(t(s).remove(),t(n).each(function(){var o=i(t(this)),s={relatedTarget:this};o.hasClass("open")&&(o.trigger(e=t.Event("hide.bs.dropdown",s)),e.isDefaultPrevented()||o.removeClass("open").trigger("hidden.bs.dropdown",s))}))}function i(e){var i=e.attr("data-target");i||(i=e.attr("href"),i=i&&/#[A-Za-z]/.test(i)&&i.replace(/.*(?=#[^\s]*$)/,""));var o=i&&t(i);return o&&o.length?o:e.parent()}function o(e){return this.each(function(){var i=t(this),o=i.data("bs.dropdown");o||i.data("bs.dropdown",o=new r(this)),"string"==typeof e&&o[e].call(i)})}var s=".dropdown-backdrop",n='[data-toggle="dropdown"]',r=function(e){t(e).on("click.bs.dropdown",this.toggle)};r.VERSION="3.2.0",r.prototype.toggle=function(o){var s=t(this);if(!s.is(".disabled, :disabled")){var n=i(s),r=n.hasClass("open");if(e(),!r){"ontouchstart"in document.documentElement&&!n.closest(".navbar-nav").length&&t('<div class="dropdown-backdrop"/>').insertAfter(t(this)).on("click",e);var a={relatedTarget:this};if(n.trigger(o=t.Event("show.bs.dropdown",a)),o.isDefaultPrevented())return;s.trigger("focus"),n.toggleClass("open").trigger("shown.bs.dropdown",a)}return!1}},r.prototype.keydown=function(e){if(/(38|40|27)/.test(e.keyCode)){var o=t(this);if(e.preventDefault(),e.stopPropagation(),!o.is(".disabled, :disabled")){var s=i(o),r=s.hasClass("open");if(!r||r&&27==e.keyCode)return 27==e.which&&s.find(n).trigger("focus"),o.trigger("click");var a=" li:not(.divider):visible a",l=s.find('[role="menu"]'+a+', [role="listbox"]'+a);if(l.length){var h=l.index(l.filter(":focus"));38==e.keyCode&&h>0&&h--,40==e.keyCode&&h<l.length-1&&h++,~h||(h=0),l.eq(h).trigger("focus")}}}};var a=t.fn.dropdown;t.fn.dropdown=o,t.fn.dropdown.Constructor=r,t.fn.dropdown.noConflict=function(){return t.fn.dropdown=a,this},t(document).on("click.bs.dropdown.data-api",e).on("click.bs.dropdown.data-api",".dropdown form",function(t){t.stopPropagation()}).on("click.bs.dropdown.data-api",n,r.prototype.toggle).on("keydown.bs.dropdown.data-api",n+', [role="menu"], [role="listbox"]',r.prototype.keydown)}(jQuery),+function(t){"use strict";function e(e,o){return this.each(function(){var s=t(this),n=s.data("bs.modal"),r=t.extend({},i.DEFAULTS,s.data(),"object"==typeof e&&e);n||s.data("bs.modal",n=new i(this,r)),"string"==typeof e?n[e](o):r.show&&n.show(o)})}var i=function(e,i){this.options=i,this.$body=t(document.body),this.$element=t(e),this.$backdrop=this.isShown=null,this.scrollbarWidth=0,this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,t.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};i.VERSION="3.2.0",i.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},i.prototype.toggle=function(t){return this.isShown?this.hide():this.show(t)},i.prototype.show=function(e){var i=this,o=t.Event("show.bs.modal",{relatedTarget:e});this.$element.trigger(o),this.isShown||o.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.$body.addClass("modal-open"),this.setScrollbar(),this.escape(),this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',t.proxy(this.hide,this)),this.backdrop(function(){var o=t.support.transition&&i.$element.hasClass("fade");i.$element.parent().length||i.$element.appendTo(i.$body),i.$element.show().scrollTop(0),o&&i.$element[0].offsetWidth,i.$element.addClass("in").attr("aria-hidden",!1),i.enforceFocus();var s=t.Event("shown.bs.modal",{relatedTarget:e});o?i.$element.find(".modal-dialog").one("bsTransitionEnd",function(){i.$element.trigger("focus").trigger(s)}).emulateTransitionEnd(300):i.$element.trigger("focus").trigger(s)}))},i.prototype.hide=function(e){e&&e.preventDefault(),e=t.Event("hide.bs.modal"),this.$element.trigger(e),this.isShown&&!e.isDefaultPrevented()&&(this.isShown=!1,this.$body.removeClass("modal-open"),this.resetScrollbar(),this.escape(),t(document).off("focusin.bs.modal"),this.$element.removeClass("in").attr("aria-hidden",!0).off("click.dismiss.bs.modal"),t.support.transition&&this.$element.hasClass("fade")?this.$element.one("bsTransitionEnd",t.proxy(this.hideModal,this)).emulateTransitionEnd(300):this.hideModal())},i.prototype.enforceFocus=function(){t(document).off("focusin.bs.modal").on("focusin.bs.modal",t.proxy(function(t){this.$element[0]===t.target||this.$element.has(t.target).length||this.$element.trigger("focus")},this))},i.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on("keyup.dismiss.bs.modal",t.proxy(function(t){27==t.which&&this.hide()},this)):this.isShown||this.$element.off("keyup.dismiss.bs.modal")},i.prototype.hideModal=function(){var t=this;this.$element.hide(),this.backdrop(function(){t.$element.trigger("hidden.bs.modal")})},i.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},i.prototype.backdrop=function(e){var i=this,o=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var s=t.support.transition&&o;if(this.$backdrop=t('<div class="modal-backdrop '+o+'" />').appendTo(this.$body),this.$element.on("click.dismiss.bs.modal",t.proxy(function(t){t.target===t.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus.call(this.$element[0]):this.hide.call(this))},this)),s&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!e)return;s?this.$backdrop.one("bsTransitionEnd",e).emulateTransitionEnd(150):e()}else if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");var n=function(){i.removeBackdrop(),e&&e()};t.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one("bsTransitionEnd",n).emulateTransitionEnd(150):n()}else e&&e()},i.prototype.checkScrollbar=function(){document.body.clientWidth>=window.innerWidth||(this.scrollbarWidth=this.scrollbarWidth||this.measureScrollbar())},i.prototype.setScrollbar=function(){var t=parseInt(this.$body.css("padding-right")||0,10);this.scrollbarWidth&&this.$body.css("padding-right",t+this.scrollbarWidth)},i.prototype.resetScrollbar=function(){this.$body.css("padding-right","")},i.prototype.measureScrollbar=function(){var t=document.createElement("div");t.className="modal-scrollbar-measure",this.$body.append(t);var e=t.offsetWidth-t.clientWidth;return this.$body[0].removeChild(t),e};var o=t.fn.modal;t.fn.modal=e,t.fn.modal.Constructor=i,t.fn.modal.noConflict=function(){return t.fn.modal=o,this},t(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(i){var o=t(this),s=o.attr("href"),n=t(o.attr("data-target")||s&&s.replace(/.*(?=#[^\s]+$)/,"")),r=n.data("bs.modal")?"toggle":t.extend({remote:!/#/.test(s)&&s},n.data(),o.data());o.is("a")&&i.preventDefault(),n.one("show.bs.modal",function(t){t.isDefaultPrevented()||n.one("hidden.bs.modal",function(){o.is(":visible")&&o.trigger("focus")})}),e.call(n,r,this)})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.tooltip"),n="object"==typeof e&&e;(s||"destroy"!=e)&&(s||o.data("bs.tooltip",s=new i(this,n)),"string"==typeof e&&s[e]())})}var i=function(t,e){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null,this.init("tooltip",t,e)};i.VERSION="3.2.0",i.DEFAULTS={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:!1,container:!1,viewport:{selector:"body",padding:0}},i.prototype.init=function(e,i,o){this.enabled=!0,this.type=e,this.$element=t(i),this.options=this.getOptions(o),this.$viewport=this.options.viewport&&t(this.options.viewport.selector||this.options.viewport);for(var s=this.options.trigger.split(" "),n=s.length;n--;){var r=s[n];if("click"==r)this.$element.on("click."+this.type,this.options.selector,t.proxy(this.toggle,this));else if("manual"!=r){var a="hover"==r?"mouseenter":"focusin",l="hover"==r?"mouseleave":"focusout";this.$element.on(a+"."+this.type,this.options.selector,t.proxy(this.enter,this)),this.$element.on(l+"."+this.type,this.options.selector,t.proxy(this.leave,this))}}this.options.selector?this._options=t.extend({},this.options,{trigger:"manual",selector:""}):this.fixTitle()},i.prototype.getDefaults=function(){return i.DEFAULTS},i.prototype.getOptions=function(e){return e=t.extend({},this.getDefaults(),this.$element.data(),e),e.delay&&"number"==typeof e.delay&&(e.delay={show:e.delay,hide:e.delay}),e},i.prototype.getDelegateOptions=function(){var e={},i=this.getDefaults();return this._options&&t.each(this._options,function(t,o){i[t]!=o&&(e[t]=o)}),e},i.prototype.enter=function(e){var i=e instanceof this.constructor?e:t(e.currentTarget).data("bs."+this.type);return i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data("bs."+this.type,i)),clearTimeout(i.timeout),i.hoverState="in",i.options.delay&&i.options.delay.show?void(i.timeout=setTimeout(function(){"in"==i.hoverState&&i.show()},i.options.delay.show)):i.show()},i.prototype.leave=function(e){var i=e instanceof this.constructor?e:t(e.currentTarget).data("bs."+this.type);return i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data("bs."+this.type,i)),clearTimeout(i.timeout),i.hoverState="out",i.options.delay&&i.options.delay.hide?void(i.timeout=setTimeout(function(){"out"==i.hoverState&&i.hide()},i.options.delay.hide)):i.hide()},i.prototype.show=function(){var e=t.Event("show.bs."+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(e);var i=t.contains(document.documentElement,this.$element[0]);if(e.isDefaultPrevented()||!i)return;var o=this,s=this.tip(),n=this.getUID(this.type);this.setContent(),s.attr("id",n),this.$element.attr("aria-describedby",n),this.options.animation&&s.addClass("fade");var r="function"==typeof this.options.placement?this.options.placement.call(this,s[0],this.$element[0]):this.options.placement,a=/\s?auto?\s?/i,l=a.test(r);l&&(r=r.replace(a,"")||"top"),s.detach().css({top:0,left:0,display:"block"}).addClass(r).data("bs."+this.type,this),this.options.container?s.appendTo(this.options.container):s.insertAfter(this.$element);var h=this.getPosition(),p=s[0].offsetWidth,c=s[0].offsetHeight;if(l){var d=r,f=this.$element.parent(),u=this.getPosition(f);r="bottom"==r&&h.top+h.height+c-u.scroll>u.height?"top":"top"==r&&h.top-u.scroll-c<0?"bottom":"right"==r&&h.right+p>u.width?"left":"left"==r&&h.left-p<u.left?"right":r,s.removeClass(d).addClass(r)}var g=this.getCalculatedOffset(r,h,p,c);this.applyPlacement(g,r);var v=function(){o.$element.trigger("shown.bs."+o.type),o.hoverState=null};t.support.transition&&this.$tip.hasClass("fade")?s.one("bsTransitionEnd",v).emulateTransitionEnd(150):v()}},i.prototype.applyPlacement=function(e,i){var o=this.tip(),s=o[0].offsetWidth,n=o[0].offsetHeight,r=parseInt(o.css("margin-top"),10),a=parseInt(o.css("margin-left"),10);isNaN(r)&&(r=0),isNaN(a)&&(a=0),e.top=e.top+r,e.left=e.left+a,t.offset.setOffset(o[0],t.extend({using:function(t){o.css({top:Math.round(t.top),left:Math.round(t.left)})}},e),0),o.addClass("in");var l=o[0].offsetWidth,h=o[0].offsetHeight;"top"==i&&h!=n&&(e.top=e.top+n-h);var p=this.getViewportAdjustedDelta(i,e,l,h);p.left?e.left+=p.left:e.top+=p.top;var c=p.left?2*p.left-s+l:2*p.top-n+h,d=p.left?"left":"top",f=p.left?"offsetWidth":"offsetHeight";o.offset(e),this.replaceArrow(c,o[0][f],d)},i.prototype.replaceArrow=function(t,e,i){this.arrow().css(i,t?50*(1-t/e)+"%":"")},i.prototype.setContent=function(){var t=this.tip(),e=this.getTitle();t.find(".tooltip-inner")[this.options.html?"html":"text"](e),t.removeClass("fade in top bottom left right")
},i.prototype.hide=function(){function e(){"in"!=i.hoverState&&o.detach(),i.$element.trigger("hidden.bs."+i.type)}var i=this,o=this.tip(),s=t.Event("hide.bs."+this.type);return this.$element.removeAttr("aria-describedby"),this.$element.trigger(s),s.isDefaultPrevented()?void 0:(o.removeClass("in"),t.support.transition&&this.$tip.hasClass("fade")?o.one("bsTransitionEnd",e).emulateTransitionEnd(150):e(),this.hoverState=null,this)},i.prototype.fixTitle=function(){var t=this.$element;(t.attr("title")||"string"!=typeof t.attr("data-original-title"))&&t.attr("data-original-title",t.attr("title")||"").attr("title","")},i.prototype.hasContent=function(){return this.getTitle()},i.prototype.getPosition=function(e){e=e||this.$element;var i=e[0],o="BODY"==i.tagName;return t.extend({},"function"==typeof i.getBoundingClientRect?i.getBoundingClientRect():null,{scroll:o?document.documentElement.scrollTop||document.body.scrollTop:e.scrollTop(),width:o?t(window).width():e.outerWidth(),height:o?t(window).height():e.outerHeight()},o?{top:0,left:0}:e.offset())},i.prototype.getCalculatedOffset=function(t,e,i,o){return"bottom"==t?{top:e.top+e.height,left:e.left+e.width/2-i/2}:"top"==t?{top:e.top-o,left:e.left+e.width/2-i/2}:"left"==t?{top:e.top+e.height/2-o/2,left:e.left-i}:{top:e.top+e.height/2-o/2,left:e.left+e.width}},i.prototype.getViewportAdjustedDelta=function(t,e,i,o){var s={top:0,left:0};if(!this.$viewport)return s;var n=this.options.viewport&&this.options.viewport.padding||0,r=this.getPosition(this.$viewport);if(/right|left/.test(t)){var a=e.top-n-r.scroll,l=e.top+n-r.scroll+o;a<r.top?s.top=r.top-a:l>r.top+r.height&&(s.top=r.top+r.height-l)}else{var h=e.left-n,p=e.left+n+i;h<r.left?s.left=r.left-h:p>r.width&&(s.left=r.left+r.width-p)}return s},i.prototype.getTitle=function(){var t,e=this.$element,i=this.options;return t=e.attr("data-original-title")||("function"==typeof i.title?i.title.call(e[0]):i.title)},i.prototype.getUID=function(t){do t+=~~(1e6*Math.random());while(document.getElementById(t));return t},i.prototype.tip=function(){return this.$tip=this.$tip||t(this.options.template)},i.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".tooltip-arrow")},i.prototype.validate=function(){this.$element[0].parentNode||(this.hide(),this.$element=null,this.options=null)},i.prototype.enable=function(){this.enabled=!0},i.prototype.disable=function(){this.enabled=!1},i.prototype.toggleEnabled=function(){this.enabled=!this.enabled},i.prototype.toggle=function(e){var i=this;e&&(i=t(e.currentTarget).data("bs."+this.type),i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data("bs."+this.type,i))),i.tip().hasClass("in")?i.leave(i):i.enter(i)},i.prototype.destroy=function(){clearTimeout(this.timeout),this.hide().$element.off("."+this.type).removeData("bs."+this.type)};var o=t.fn.tooltip;t.fn.tooltip=e,t.fn.tooltip.Constructor=i,t.fn.tooltip.noConflict=function(){return t.fn.tooltip=o,this}}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.popover"),n="object"==typeof e&&e;(s||"destroy"!=e)&&(s||o.data("bs.popover",s=new i(this,n)),"string"==typeof e&&s[e]())})}var i=function(t,e){this.init("popover",t,e)};if(!t.fn.tooltip)throw new Error("Popover requires tooltip.js");i.VERSION="3.2.0",i.DEFAULTS=t.extend({},t.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),i.prototype=t.extend({},t.fn.tooltip.Constructor.prototype),i.prototype.constructor=i,i.prototype.getDefaults=function(){return i.DEFAULTS},i.prototype.setContent=function(){var t=this.tip(),e=this.getTitle(),i=this.getContent();t.find(".popover-title")[this.options.html?"html":"text"](e),t.find(".popover-content").empty()[this.options.html?"string"==typeof i?"html":"append":"text"](i),t.removeClass("fade top bottom left right in"),t.find(".popover-title").html()||t.find(".popover-title").hide()},i.prototype.hasContent=function(){return this.getTitle()||this.getContent()},i.prototype.getContent=function(){var t=this.$element,e=this.options;return t.attr("data-content")||("function"==typeof e.content?e.content.call(t[0]):e.content)},i.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")},i.prototype.tip=function(){return this.$tip||(this.$tip=t(this.options.template)),this.$tip};var o=t.fn.popover;t.fn.popover=e,t.fn.popover.Constructor=i,t.fn.popover.noConflict=function(){return t.fn.popover=o,this}}(jQuery),+function(t){"use strict";function e(i,o){var s=t.proxy(this.process,this);this.$body=t("body"),this.$scrollElement=t(t(i).is("body")?window:i),this.options=t.extend({},e.DEFAULTS,o),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",s),this.refresh(),this.process()}function i(i){return this.each(function(){var o=t(this),s=o.data("bs.scrollspy"),n="object"==typeof i&&i;s||o.data("bs.scrollspy",s=new e(this,n)),"string"==typeof i&&s[i]()})}e.VERSION="3.2.0",e.DEFAULTS={offset:10},e.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)},e.prototype.refresh=function(){var e="offset",i=0;t.isWindow(this.$scrollElement[0])||(e="position",i=this.$scrollElement.scrollTop()),this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight();var o=this;this.$body.find(this.selector).map(function(){var o=t(this),s=o.data("target")||o.attr("href"),n=/^#./.test(s)&&t(s);return n&&n.length&&n.is(":visible")&&[[n[e]().top+i,s]]||null}).sort(function(t,e){return t[0]-e[0]}).each(function(){o.offsets.push(this[0]),o.targets.push(this[1])})},e.prototype.process=function(){var t,e=this.$scrollElement.scrollTop()+this.options.offset,i=this.getScrollHeight(),o=this.options.offset+i-this.$scrollElement.height(),s=this.offsets,n=this.targets,r=this.activeTarget;if(this.scrollHeight!=i&&this.refresh(),e>=o)return r!=(t=n[n.length-1])&&this.activate(t);if(r&&e<=s[0])return r!=(t=n[0])&&this.activate(t);for(t=s.length;t--;)r!=n[t]&&e>=s[t]&&(!s[t+1]||e<=s[t+1])&&this.activate(n[t])},e.prototype.activate=function(e){this.activeTarget=e,t(this.selector).parentsUntil(this.options.target,".active").removeClass("active");var i=this.selector+'[data-target="'+e+'"],'+this.selector+'[href="'+e+'"]',o=t(i).parents("li").addClass("active");o.parent(".dropdown-menu").length&&(o=o.closest("li.dropdown").addClass("active")),o.trigger("activate.bs.scrollspy")};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on("load.bs.scrollspy.data-api",function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.tab");s||o.data("bs.tab",s=new i(this)),"string"==typeof e&&s[e]()})}var i=function(e){this.element=t(e)};i.VERSION="3.2.0",i.prototype.show=function(){var e=this.element,i=e.closest("ul:not(.dropdown-menu)"),o=e.data("target");if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){var s=i.find(".active:last a")[0],n=t.Event("show.bs.tab",{relatedTarget:s});if(e.trigger(n),!n.isDefaultPrevented()){var r=t(o);this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){e.trigger({type:"shown.bs.tab",relatedTarget:s})})}}},i.prototype.activate=function(e,i,o){function s(){n.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),e.addClass("active"),r?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu")&&e.closest("li.dropdown").addClass("active"),o&&o()}var n=i.find("> .active"),r=o&&t.support.transition&&n.hasClass("fade");r?n.one("bsTransitionEnd",s).emulateTransitionEnd(150):s(),n.removeClass("in")};var o=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=i,t.fn.tab.noConflict=function(){return t.fn.tab=o,this},t(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(i){i.preventDefault(),e.call(t(this),"show")})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),s=o.data("bs.affix"),n="object"==typeof e&&e;s||o.data("bs.affix",s=new i(this,n)),"string"==typeof e&&s[e]()})}var i=function(e,o){this.options=t.extend({},i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};i.VERSION="3.2.0",i.RESET="affix affix-top affix-bottom",i.DEFAULTS={offset:0,target:window},i.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(i.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},i.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},i.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=t(document).height(),o=this.$target.scrollTop(),s=this.$element.offset(),n=this.options.offset,r=n.top,a=n.bottom;"object"!=typeof n&&(a=r=n),"function"==typeof r&&(r=n.top(this.$element)),"function"==typeof a&&(a=n.bottom(this.$element));var l=null!=this.unpin&&o+this.unpin<=s.top?!1:null!=a&&s.top+this.$element.height()>=e-a?"bottom":null!=r&&r>=o?"top":!1;if(this.affixed!==l){null!=this.unpin&&this.$element.css("top","");var h="affix"+(l?"-"+l:""),p=t.Event(h+".bs.affix");this.$element.trigger(p),p.isDefaultPrevented()||(this.affixed=l,this.unpin="bottom"==l?this.getPinnedOffset():null,this.$element.removeClass(i.RESET).addClass(h).trigger(t.Event(h.replace("affix","affixed"))),"bottom"==l&&this.$element.offset({top:e-this.$element.height()-a}))}}};var o=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=i,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var i=t(this),o=i.data();o.offset=o.offset||{},o.offsetBottom&&(o.offset.bottom=o.offsetBottom),o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)})})}(jQuery);try{window.FB||function(window){var __w,__t,self=window,document=window.document,setTimeout=window.setTimeout,setInterval=window.setInterval,clearTimeout=window.clearTimeout,clearInterval=window.clearInterval;__t=function(a){return a[0]},__w=function(a){return a};var require,__d;!function(a){var b={},c={},d=["global","require","requireDynamic","requireLazy","module","exports"];require=function(e,f){if(c.hasOwnProperty(e))return c[e];if(!b.hasOwnProperty(e)){if(f)return null;throw new Error("Module "+e+" has not been defined")}for(var j,g=b[e],h=g.deps,i=g.factory.length,k=[],l=0;i>l;l++){switch(h[l]){case"module":j=g;break;case"exports":j=g.exports;break;case"global":j=a;break;case"require":j=require;break;case"requireDynamic":j=require;break;case"requireLazy":j=null;break;default:j=require.call(null,h[l])}k.push(j)}return g.factory.apply(a,k),c[e]=g.exports,g.exports},__d=function(e,f,g,h){"function"==typeof g?(b[e]={factory:g,deps:d.concat(f),exports:{}},3===h&&require.call(null,e)):c[e]=g}}(this),__d("ES5ArrayPrototype",[],function(a,b,c,d,e){var g={};g.map=function(h,i){if("function"!=typeof h)throw new TypeError;var j,k=this.length,l=new Array(k);for(j=0;k>j;++j)j in this&&(l[j]=h.call(i,this[j],j,this));return l},g.forEach=function(h,i){g.map.call(this,h,i)},g.filter=function(h,i){if("function"!=typeof h)throw new TypeError;var j,k,l=this.length,m=[];for(j=0;l>j;++j)j in this&&(k=this[j],h.call(i,k,j,this)&&m.push(k));return m},g.every=function(h,i){if("function"!=typeof h)throw new TypeError;for(var j=new Object(this),k=j.length,l=0;k>l;l++)if(l in j&&!h.call(i,j[l],l,j))return!1;return!0},g.some=function(h,i){if("function"!=typeof h)throw new TypeError;for(var j=new Object(this),k=j.length,l=0;k>l;l++)if(l in j&&h.call(i,j[l],l,j))return!0;return!1},g.indexOf=function(h,i){var j=this.length;for(i|=0,0>i&&(i+=j);j>i;i++)if(i in this&&this[i]===h)return i;return-1},e.exports=g},null),__d("ES5FunctionPrototype",[],function(a,b,c,d,e){var g={};g.bind=function(h){function k(){return i.apply(h,j.concat(Array.prototype.slice.call(arguments)))}if("function"!=typeof this)throw new TypeError("Bind must be called on a function");var i=this,j=Array.prototype.slice.call(arguments,1);return k.displayName="bound:"+(i.displayName||i.name||"(?)"),k.toString=function(){return"bound: "+i},k},e.exports=g},null),__d("ES5StringPrototype",[],function(a,b,c,d,e){var g={};g.trim=function(){if(null==this)throw new TypeError("String.prototype.trim called on null or undefined");return String.prototype.replace.call(this,/^\s+|\s+$/g,"")},g.startsWith=function(h){var i=String(this);if(null==this)throw new TypeError("String.prototype.startsWith called on null or undefined");var j=arguments.length>1?Number(arguments[1]):0;isNaN(j)&&(j=0);var k=Math.min(Math.max(j,0),i.length);return i.indexOf(String(h),j)==k},g.endsWith=function(h){var i=String(this);if(null==this)throw new TypeError("String.prototype.endsWith called on null or undefined");var j=i.length,k=String(h),l=arguments.length>1?Number(arguments[1]):j;isNaN(l)&&(l=0);var m=Math.min(Math.max(l,0),j),n=m-k.length;return 0>n?!1:i.lastIndexOf(k,n)==n},g.contains=function(h){if(null==this)throw new TypeError("String.prototype.contains called on null or undefined");var i=String(this),j=arguments.length>1?Number(arguments[1]):0;return isNaN(j)&&(j=0),-1!=i.indexOf(String(h),j)},g.repeat=function(h){if(null==this)throw new TypeError("String.prototype.repeat called on null or undefined");var i=String(this),j=h?Number(h):0;if(isNaN(j)&&(j=0),0>j||1/0===j)throw RangeError();if(1===j)return i;if(0===j)return"";for(var k="";j;)1&j&&(k+=i),(j>>=1)&&(i+=i);return k},e.exports=g},null),__d("ES5Array",[],function(a,b,c,d,e){var g={};g.isArray=function(h){return"[object Array]"==Object.prototype.toString.call(h)},e.exports=g},null),__d("ie8DontEnum",[],function(a,b,c,d,e){var g=["toString","toLocaleString","valueOf","hasOwnProperty","isPrototypeOf","prototypeIsEnumerable","constructor"],h={}.hasOwnProperty,i=function(){};({toString:!0}).propertyIsEnumerable("toString")&&(i=function(j,k){for(var l=0;l<g.length;l++){var m=g[l];h.call(j,m)&&k(m)}}),e.exports=i},null),__d("ES5Object",["ie8DontEnum"],function(a,b,c,d,e,f,g){function j(){}var h={}.hasOwnProperty,i={};i.create=function(k){var l=typeof k;if("object"!=l&&"function"!=l)throw new TypeError("Object prototype may only be a Object or null");return j.prototype=k,new j},i.keys=function(k){var l=typeof k;if("object"!=l&&"function"!=l||null===k)throw new TypeError("Object.keys called on non-object");var m=[];for(var n in k)h.call(k,n)&&m.push(n);return g(k,function(o){return m.push(o)}),m},e.exports=i},null),__d("ES5Date",[],function(a,b,c,d,e){var g={};g.now=function(){return(new Date).getTime()},e.exports=g},null),__d("JSON3",[],function(a,b,c,d,e){(function(){var h,i,j,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ca,da,ea,g={}.toString,k=e.exports={},l='{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}',ba=new Date(-0xc782b5b800cec);try{ba=-109252==ba.getUTCFullYear()&&0===ba.getUTCMonth()&&1==ba.getUTCDate()&&10==ba.getUTCHours()&&37==ba.getUTCMinutes()&&6==ba.getUTCSeconds()&&708==ba.getUTCMilliseconds()}catch(fa){}if(ba||(ca=Math.floor,da=[0,31,59,90,120,151,181,212,243,273,304,334],ea=function(ga,ha){return da[ha]+365*(ga-1970)+ca((ga-1969+(ha=+(ha>1)))/4)-ca((ga-1901+ha)/100)+ca((ga-1601+ha)/400)}),"object"==typeof JSON&&JSON&&(k.stringify=JSON.stringify,k.parse=JSON.parse),m="function"==typeof k.stringify&&!ea){(ba=function(){return 1}).toJSON=ba;try{m="0"===k.stringify(0)&&"0"===k.stringify(new Number)&&'""'==k.stringify(new String)&&k.stringify(g)===j&&k.stringify(j)===j&&k.stringify()===j&&"1"===k.stringify(ba)&&"[1]"==k.stringify([ba])&&"[null]"==k.stringify([j])&&"null"==k.stringify(null)&&"[null,null,null]"==k.stringify([j,g,null])&&k.stringify({result:[ba,!0,!1,null,"\x00\b\n\f\r	"]})==l&&"1"===k.stringify(null,ba)&&"[\n 1,\n 2\n]"==k.stringify([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==k.stringify(new Date(-864e13))&&'"+275760-09-13T00:00:00.000Z"'==k.stringify(new Date(864e13))&&'"-000001-01-01T00:00:00.000Z"'==k.stringify(new Date(-621987552e5))&&'"1969-12-31T23:59:59.999Z"'==k.stringify(new Date(-1))}catch(fa){m=!1}}if("function"==typeof k.parse)try{if(0===k.parse("0")&&!k.parse(!1)&&(ba=k.parse(l),r=5==ba.A.length&&1==ba.A[0])){try{r=!k.parse('"	"')}catch(fa){}if(r)try{r=1!=k.parse("01")}catch(fa){}}}catch(fa){r=!1}ba=l=null,m&&r||((h={}.hasOwnProperty)||(h=function(ga){var ia,ha={};return(ha.__proto__=null,ha.__proto__={toString:1},ha).toString!=g?h=function(ja){var ka=this.__proto__,la=ja in(this.__proto__=null,this);return this.__proto__=ka,la}:(ia=ha.constructor,h=function(ja){var ka=(this.constructor||ia).prototype;return ja in this&&!(ja in ka&&this[ja]===ka[ja])}),ha=null,h.call(this,ga)}),i=function(ga,ha){var ja,ka,la,ma,ia=0;(ja=function(){this.valueOf=0}).prototype.valueOf=0,ka=new ja;for(la in ka)h.call(ka,la)&&ia++;return ja=ka=null,ia?ma=2==ia?function(na,oa){var ra,pa={},qa="[object Function]"==g.call(na);for(ra in na)qa&&"prototype"==ra||h.call(pa,ra)||!(pa[ra]=1)||!h.call(na,ra)||oa(ra)}:function(na,oa){var qa,ra,pa="[object Function]"==g.call(na);for(qa in na)pa&&"prototype"==qa||!h.call(na,qa)||(ra="constructor"===qa)||oa(qa);(ra||h.call(na,qa="constructor"))&&oa(qa)}:(ka=["valueOf","toString","toLocaleString","propertyIsEnumerable","isPrototypeOf","hasOwnProperty","constructor"],ma=function(na,oa){var qa,ra,pa="[object Function]"==g.call(na);for(qa in na)pa&&"prototype"==qa||!h.call(na,qa)||oa(qa);for(ra=ka.length;qa=ka[--ra];h.call(na,qa)&&oa(qa));}),ma(ga,ha)},m||(n={"\\":"\\\\",'"':'\\"',"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","	":"\\t"},o=function(ga,ha){return("000000"+(ha||0)).slice(-ga)},p=function(ga){for(var ja,ha='"',ia=0;ja=ga.charAt(ia);ia++)ha+='\\"\b\f\n\r	'.indexOf(ja)>-1?n[ja]:" ">ja?"\\u00"+o(2,ja.charCodeAt(0).toString(16)):ja;return ha+'"'},q=function(ga,ha,ia,ja,ka,la,ma){var oa,pa,qa,ra,sa,ta,ua,va,wa,xa,ya,za,ab,bb,cb,na=ha[ga];if("object"==typeof na&&na)if(oa=g.call(na),"[object Date]"!=oa||h.call(na,"toJSON"))"function"==typeof na.toJSON&&("[object Number]"!=oa&&"[object String]"!=oa&&"[object Array]"!=oa||h.call(na,"toJSON"))&&(na=na.toJSON(ga));else if(na>-1/0&&1/0>na){if(ea){for(ra=ca(na/864e5),pa=ca(ra/365.2425)+1970-1;ea(pa+1,0)<=ra;pa++);for(qa=ca((ra-ea(pa,0))/30.42);ea(pa,qa+1)<=ra;qa++);ra=1+ra-ea(pa,qa),sa=(na%864e5+864e5)%864e5,ta=ca(sa/36e5)%24,ua=ca(sa/6e4)%60,va=ca(sa/1e3)%60,wa=sa%1e3}else pa=na.getUTCFullYear(),qa=na.getUTCMonth(),ra=na.getUTCDate(),ta=na.getUTCHours(),ua=na.getUTCMinutes(),va=na.getUTCSeconds(),wa=na.getUTCMilliseconds();na=(0>=pa||pa>=1e4?(0>pa?"-":"+")+o(6,0>pa?-pa:pa):o(4,pa))+"-"+o(2,qa+1)+"-"+o(2,ra)+"T"+o(2,ta)+":"+o(2,ua)+":"+o(2,va)+"."+o(3,wa)+"Z"}else na=null;if(ia&&(na=ia.call(ha,ga,na)),null===na)return"null";if(oa=g.call(na),"[object Boolean]"==oa)return""+na;if("[object Number]"==oa)return na>-1/0&&1/0>na?""+na:"null";if("[object String]"==oa)return p(na);if("object"==typeof na){for(ab=ma.length;ab--;)if(ma[ab]===na)throw TypeError();if(ma.push(na),xa=[],bb=la,la+=ka,"[object Array]"==oa){for(za=0,ab=na.length;ab>za;cb||(cb=!0),za++)ya=q(za,na,ia,ja,ka,la,ma),xa.push(ya===j?"null":ya);return cb?ka?"[\n"+la+xa.join(",\n"+la)+"\n"+bb+"]":"["+xa.join(",")+"]":"[]"}return i(ja||na,function(db){var eb=q(db,na,ia,ja,ka,la,ma);eb!==j&&xa.push(p(db)+":"+(ka?" ":"")+eb),cb||(cb=!0)}),cb?ka?"{\n"+la+xa.join(",\n"+la)+"\n"+bb+"}":"{"+xa.join(",")+"}":"{}"}},k.stringify=function(ga,ha,ia){var ja,ka,la,ma,na,oa;if("function"==typeof ha||"object"==typeof ha&&ha)if("[object Function]"==g.call(ha))ka=ha;else if("[object Array]"==g.call(ha))for(la={},ma=0,na=ha.length;na>ma;oa=ha[ma++],("[object String]"==g.call(oa)||"[object Number]"==g.call(oa))&&(la[oa]=1));if(ia)if("[object Number]"==g.call(ia)){if((ia-=ia%1)>0)for(ja="",ia>10&&(ia=10);ja.length<ia;ja+=" ");}else"[object String]"==g.call(ia)&&(ja=ia.length<=10?ia:ia.slice(0,10));return q("",(oa={},oa[""]=ga,oa),ka,la,ja,"",[])}),r||(s=String.fromCharCode,t={"\\":"\\",'"':'"',"/":"/",b:"\b",t:"	",n:"\n",f:"\f",r:"\r"},u=function(){throw z=aa=null,SyntaxError()},v=function(){for(var ia,ja,ka,la,ma,ga=aa,ha=ga.length;ha>z;)if(ia=ga.charAt(z),"	\r\n ".indexOf(ia)>-1)z++;else{if("{}[]:,".indexOf(ia)>-1)return z++,ia;if('"'==ia){for(ja="@",z++;ha>z;)if(ia=ga.charAt(z)," ">ia)u();else if("\\"==ia)if(ia=ga.charAt(++z),'\\"/btnfr'.indexOf(ia)>-1)ja+=t[ia],z++;else if("u"==ia){for(ka=++z,la=z+4;la>z;z++)ia=ga.charAt(z),ia>="0"&&"9">=ia||ia>="a"&&"f">=ia||ia>="A"&&"F">=ia||u();ja+=s("0x"+ga.slice(ka,z))}else u();else{if('"'==ia)break;ja+=ia,z++}if('"'==ga.charAt(z))return z++,ja;u()}else{if(ka=z,"-"==ia&&(ma=!0,ia=ga.charAt(++z)),ia>="0"&&"9">=ia){for("0"==ia&&(ia=ga.charAt(z+1),ia>="0"&&"9">=ia)&&u(),ma=!1;ha>z&&(ia=ga.charAt(z),ia>="0"&&"9">=ia);z++);if("."==ga.charAt(z)){for(la=++z;ha>la&&(ia=ga.charAt(la),ia>="0"&&"9">=ia);la++);la==z&&u(),z=la}if(ia=ga.charAt(z),"e"==ia||"E"==ia){for(ia=ga.charAt(++z),("+"==ia||"-"==ia)&&z++,la=z;ha>la&&(ia=ga.charAt(la),ia>="0"&&"9">=ia);la++);la==z&&u(),z=la}return+ga.slice(ka,z)}if(ma&&u(),"true"==ga.slice(z,z+4))return z+=4,!0;if("false"==ga.slice(z,z+5))return z+=5,!1;if("null"==ga.slice(z,z+4))return z+=4,null;u()}}return"$"},w=function(ga){var ha,ia;if("$"==ga&&u(),"string"==typeof ga){if("@"==ga.charAt(0))return ga.slice(1);if("["==ga){for(ha=[];ga=v(),"]"!=ga;ia||(ia=!0))ia&&(","==ga?(ga=v(),"]"==ga&&u()):u()),","==ga&&u(),ha.push(w(ga));return ha}if("{"==ga){for(ha={};ga=v(),"}"!=ga;ia||(ia=!0))ia&&(","==ga?(ga=v(),"}"==ga&&u()):u()),(","==ga||"string"!=typeof ga||"@"!=ga.charAt(0)||":"!=v())&&u(),ha[ga.slice(1)]=w(v());return ha}u()}return ga},y=function(ga,ha,ia){var ja=x(ga,ha,ia);ja===j?delete ga[ha]:ga[ha]=ja},x=function(ga,ha,ia){var ka,ja=ga[ha];if("object"==typeof ja&&ja)if("[object Array]"==g.call(ja))for(ka=ja.length;ka--;)y(ja,ka,ia);else i(ja,function(la){y(ja,la,ia)});return ia.call(ga,ha,ja)},k.parse=function(ga,ha){z=0,aa=ga;var ia=w(v());return"$"!=v()&&u(),z=aa=null,ha&&"[object Function]"==g.call(ha)?x((ba={},ba[""]=ia,ba),"",ha):ia}))}).call(this)},null),__d("ES6Object",["ie8DontEnum"],function(a,b,c,d,e,f,g){var h={}.hasOwnProperty,i={assign:function(j){for(var k=[],l=1,m=arguments.length;m>l;l++)k.push(arguments[l]);if(null==j)throw new TypeError("Object.assign target cannot be null or undefined");j=Object(j);for(var n=0;n<k.length;n++){var o=k[n];if(null!=o){o=Object(o);for(var p in o)h.call(o,p)&&(j[p]=o[p]);g(o,function(q){return j[q]=o[q]})}}return j}};e.exports=i},null),__d("ES6ArrayPrototype",[],function(a,b,c,d,e){var g={find:function(h,i){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof h)throw new TypeError("predicate must be a function");var j=g.findIndex.call(this,h,i);return-1===j?void 0:this[j]},findIndex:function(h,i){if(null==this)throw new TypeError("Array.prototype.findIndex called on null or undefined");if("function"!=typeof h)throw new TypeError("predicate must be a function");for(var j=Object(this),k=j.length>>>0,l=0;k>l;l++)if(h.call(i,j[l],l,j))return l;return-1}};e.exports=g},null),__d("ES6DatePrototype",[],function(a,b,c,d,e){function g(i){return(10>i?"0":"")+i}var h={toISOString:function(){if(!isFinite(this))throw new Error("Invalid time value");var i=this.getUTCFullYear();return i=(0>i?"-":i>9999?"+":"")+("00000"+Math.abs(i)).slice(i>=0&&9999>=i?-4:-6),i+"-"+g(this.getUTCMonth()+1)+"-"+g(this.getUTCDate())+"T"+g(this.getUTCHours())+":"+g(this.getUTCMinutes())+":"+g(this.getUTCSeconds())+"."+(this.getUTCMilliseconds()/1e3).toFixed(3).slice(2,5)+"Z"}};e.exports=h},null),__d("ES6Number",[],function(a,b,c,d,e){var g={isFinite:function(h){return"number"==typeof h&&isFinite(h)},isNaN:function(h){return"number"==typeof h&&isNaN(h)}};e.exports=g},null),__d("ES",["ES5ArrayPrototype","ES5FunctionPrototype","ES5StringPrototype","ES5Array","ES5Object","ES5Date","JSON3","ES6Object","ES6ArrayPrototype","ES6DatePrototype","ES6Number"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q){function v(x){for(var y in x)if(x.hasOwnProperty(y)){var z=x[y],aa=y.split("."),ba=2==aa.length?window[aa[0]][aa[1]]:window[y];for(var ca in z)if(z.hasOwnProperty(ca)){var da=ba[ca];s[y+"."+ca]=da&&/\{\s+\[native code\]\s\}/.test(da)?da:z[ca]}}}function w(x,y,z){for(var aa=[],ba=3,ca=arguments.length;ca>ba;ba++)aa.push(arguments[ba]);var da=z?r.call(x).slice(8,-1)+".prototype":x,ea=s[da+"."+y]||x[y];return"function"==typeof ea?ea.apply(x,aa):void 0}var r={}.toString,s={"JSON.stringify":m.stringify,"JSON.parse":m.parse},t={"Array.prototype":g,"Function.prototype":h,"String.prototype":i,Object:k,Array:j,Date:l},u={Object:n,"Array.prototype":o,"Date.prototype":p,Number:q};v(t),v(u),e.exports=w},null);var ES=require("ES");__d("JSSDKRuntimeConfig",[],{locale:"en_US",rtl:!1,revision:"1594576"}),__d("JSSDKConfig",[],{bustCache:!0,tagCountLogRate:.01,errorHandling:{rate:4},usePluginPipe:!0,features:{allow_non_canvas_app_events:!1,event_subscriptions_log:{rate:.01,value:1e4},should_force_single_dialog_instance:!0,kill_fragment:!0,xfbml_profile_pic_server:!0,error_handling:{rate:4},e2e_ping_tracking:{rate:1e-6},xd_timeout:{rate:4,value:3e4},use_bundle:!0,launch_payment_dialog_via_pac:{rate:100},plugin_tags_blacklist:["recommendations_bar"],should_log_response_error:!0},api:{mode:"warn",whitelist:["AppEvents","AppEvents.EventNames","AppEvents.ParameterNames","AppEvents.activateApp","AppEvents.logEvent","AppEvents.logPurchase","Canvas","Canvas.Prefetcher","Canvas.Prefetcher.addStaticResource","Canvas.Prefetcher.setCollectionMode","Canvas.getPageInfo","Canvas.hideFlashElement","Canvas.scrollTo","Canvas.setAutoGrow","Canvas.setDoneLoading","Canvas.setSize","Canvas.setUrlHandler","Canvas.showFlashElement","Canvas.startTimer","Canvas.stopTimer","Event","Event.subscribe","Event.unsubscribe","Music.flashCallback","Music.init","Music.send","Payment","Payment.cancelFlow","Payment.continueFlow","Payment.init","Payment.lockForProcessing","Payment.parse","Payment.setSize","Payment.unlockForProcessing","ThirdPartyProvider","ThirdPartyProvider.init","ThirdPartyProvider.sendData","UA","UA.nativeApp","XFBML","XFBML.RecommendationsBar","XFBML.RecommendationsBar.markRead","XFBML.parse","addFriend","api","getAccessToken","getAuthResponse","getLoginStatus","getUserID","init","login","logout","publish","share","ui"]},initSitevars:{enableMobileComments:1,iframePermissions:{read_stream:!1,manage_mailbox:!1,manage_friendlists:!1,read_mailbox:!1,publish_checkins:!0,status_update:!0,photo_upload:!0,video_upload:!0,sms:!1,create_event:!0,rsvp_event:!0,offline_access:!0,email:!0,xmpp_login:!1,create_note:!0,share_item:!0,export_stream:!1,publish_stream:!0,publish_likes:!0,ads_management:!1,contact_email:!0,access_private_data:!1,read_insights:!1,read_requests:!1,read_friendlists:!0,manage_pages:!1,physical_login:!1,manage_groups:!1,read_deals:!1}}}),__d("UrlMapConfig",[],{www:"www.facebook.com",m:"m.facebook.com",connect:"connect.facebook.net",business:"business.facebook.com",api_https:"api.facebook.com",api_read_https:"api-read.facebook.com",graph_https:"graph.facebook.com",fbcdn_http:"fbstatic-a.akamaihd.net",fbcdn_https:"fbstatic-a.akamaihd.net",cdn_http:"static.ak.facebook.com",cdn_https:"s-static.ak.facebook.com"}),__d("JSSDKXDConfig",[],{XdUrl:"/connect/xd_arbiter.php?version=41",XdBundleUrl:"/connect/xd_arbiter/DU1Ia251o0y.js?version=41",Flash:{path:"https://connect.facebook.net/rsrc.php/v1/yW/r/yOZN1vHw3Z_.swf"},useCdn:!0}),__d("JSSDKCssConfig",[],{rules:'.fb_hidden{position:absolute;top:-10000px;z-index:10001}.fb_invisible{display:none}.fb_reset{background:none;border:0;border-spacing:0;color:#000;cursor:auto;direction:ltr;font-family:"lucida grande", tahoma, verdana, arial, sans-serif;font-size:11px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:1;margin:0;overflow:visible;padding:0;text-align:left;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;visibility:visible;white-space:normal;word-spacing:normal}.fb_reset>div{overflow:hidden}.fb_link img{border:none}\n.fb_dialog{background:rgba(82, 82, 82, .7);position:absolute;top:-10000px;z-index:10001}.fb_reset .fb_dialog_legacy{overflow:visible}.fb_dialog_advanced{padding:10px;-moz-border-radius:8px;-webkit-border-radius:8px;border-radius:8px}.fb_dialog_content{background:#fff;color:#333}.fb_dialog_close_icon{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yq/r/IE9JII6Z1Ys.png) no-repeat scroll 0 0 transparent;_background-image:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yL/r/s816eWC-2sl.gif);cursor:pointer;display:block;height:15px;position:absolute;right:18px;top:17px;width:15px}.fb_dialog_mobile .fb_dialog_close_icon{top:5px;left:5px;right:auto}.fb_dialog_padding{background-color:transparent;position:absolute;width:1px;z-index:-1}.fb_dialog_close_icon:hover{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yq/r/IE9JII6Z1Ys.png) no-repeat scroll 0 -15px transparent;_background-image:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yL/r/s816eWC-2sl.gif)}.fb_dialog_close_icon:active{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yq/r/IE9JII6Z1Ys.png) no-repeat scroll 0 -30px transparent;_background-image:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yL/r/s816eWC-2sl.gif)}.fb_dialog_loader{background-color:#f6f7f8;border:1px solid #606060;font-size:24px;padding:20px}.fb_dialog_top_left,.fb_dialog_top_right,.fb_dialog_bottom_left,.fb_dialog_bottom_right{height:10px;width:10px;overflow:hidden;position:absolute}.fb_dialog_top_left{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/ye/r/8YeTNIlTZjm.png) no-repeat 0 0;left:-10px;top:-10px}.fb_dialog_top_right{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/ye/r/8YeTNIlTZjm.png) no-repeat 0 -10px;right:-10px;top:-10px}.fb_dialog_bottom_left{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/ye/r/8YeTNIlTZjm.png) no-repeat 0 -20px;bottom:-10px;left:-10px}.fb_dialog_bottom_right{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/ye/r/8YeTNIlTZjm.png) no-repeat 0 -30px;right:-10px;bottom:-10px}.fb_dialog_vert_left,.fb_dialog_vert_right,.fb_dialog_horiz_top,.fb_dialog_horiz_bottom{position:absolute;background:#525252;filter:alpha(opacity=70);opacity:.7}.fb_dialog_vert_left,.fb_dialog_vert_right{width:10px;height:100%}.fb_dialog_vert_left{margin-left:-10px}.fb_dialog_vert_right{right:0;margin-right:-10px}.fb_dialog_horiz_top,.fb_dialog_horiz_bottom{width:100%;height:10px}.fb_dialog_horiz_top{margin-top:-10px}.fb_dialog_horiz_bottom{bottom:0;margin-bottom:-10px}.fb_dialog_iframe{line-height:0}.fb_dialog_content .dialog_title{background:#6d84b4;border:1px solid #3a5795;color:#fff;font-size:14px;font-weight:bold;margin:0}.fb_dialog_content .dialog_title>span{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/yd/r/Cou7n-nqK52.gif) no-repeat 5px 50%;float:left;padding:5px 0 7px 26px}body.fb_hidden{-webkit-transform:none;height:100%;margin:0;overflow:visible;position:absolute;top:-10000px;left:0;width:100%}.fb_dialog.fb_dialog_mobile.loading{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/ya/r/3rhSv5V8j3o.gif) white no-repeat 50% 50%;min-height:100%;min-width:100%;overflow:hidden;position:absolute;top:0;z-index:10001}.fb_dialog.fb_dialog_mobile.loading.centered{max-height:590px;min-height:590px;max-width:500px;min-width:500px}#fb-root #fb_dialog_ipad_overlay{background:rgba(0, 0, 0, .45);position:absolute;left:0;top:0;width:100%;min-height:100%;z-index:10000}#fb-root #fb_dialog_ipad_overlay.hidden{display:none}.fb_dialog.fb_dialog_mobile.loading iframe{visibility:hidden}.fb_dialog_content .dialog_header{-webkit-box-shadow:white 0 1px 1px -1px inset;background:-webkit-gradient(linear, 0% 0%, 0% 100%, from(#738ABA), to(#2C4987));border-bottom:1px solid;border-color:#1d4088;color:#fff;font:14px Helvetica, sans-serif;font-weight:bold;text-overflow:ellipsis;text-shadow:rgba(0, 30, 84, .296875) 0 -1px 0;vertical-align:middle;white-space:nowrap}.fb_dialog_content .dialog_header table{-webkit-font-smoothing:subpixel-antialiased;height:43px;width:100%}.fb_dialog_content .dialog_header td.header_left{font-size:12px;padding-left:5px;vertical-align:middle;width:60px}.fb_dialog_content .dialog_header td.header_right{font-size:12px;padding-right:5px;vertical-align:middle;width:60px}.fb_dialog_content .touchable_button{background:-webkit-gradient(linear, 0% 0%, 0% 100%, from(#4966A6), color-stop(.5, #355492), to(#2A4887));border:1px solid #2f477a;-webkit-background-clip:padding-box;-webkit-border-radius:3px;-webkit-box-shadow:rgba(0, 0, 0, .117188) 0 1px 1px inset, rgba(255, 255, 255, .167969) 0 1px 0;display:inline-block;margin-top:3px;max-width:85px;line-height:18px;padding:4px 12px;position:relative}.fb_dialog_content .dialog_header .touchable_button input{border:none;background:none;color:#fff;font:12px Helvetica, sans-serif;font-weight:bold;margin:2px -12px;padding:2px 6px 3px 6px;text-shadow:rgba(0, 30, 84, .296875) 0 -1px 0}.fb_dialog_content .dialog_header .header_center{color:#fff;font-size:16px;font-weight:bold;line-height:18px;text-align:center;vertical-align:middle}.fb_dialog_content .dialog_content{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/y9/r/jKEcVPZFk-2.gif) no-repeat 50% 50%;border:1px solid #555;border-bottom:0;border-top:0;height:150px}.fb_dialog_content .dialog_footer{background:#f6f7f8;border:1px solid #555;border-top-color:#ccc;height:40px}#fb_dialog_loader_close{float:left}.fb_dialog.fb_dialog_mobile .fb_dialog_close_button{text-shadow:rgba(0, 30, 84, .296875) 0 -1px 0}.fb_dialog.fb_dialog_mobile .fb_dialog_close_icon{visibility:hidden}\n.fb_iframe_widget{display:inline-block;position:relative}.fb_iframe_widget span{display:inline-block;position:relative;text-align:justify}.fb_iframe_widget iframe{position:absolute}.fb_iframe_widget_fluid_desktop,.fb_iframe_widget_fluid_desktop span,.fb_iframe_widget_fluid_desktop iframe{max-width:100%}.fb_iframe_widget_fluid_desktop iframe{min-width:220px;position:relative}.fb_iframe_widget_lift{z-index:1}.fb_hide_iframes iframe{position:relative;left:-10000px}.fb_iframe_widget_loader{position:relative;display:inline-block}.fb_iframe_widget_fluid{display:inline}.fb_iframe_widget_fluid span{width:100%}.fb_iframe_widget_loader iframe{min-height:32px;z-index:2;zoom:1}.fb_iframe_widget_loader .FB_Loader{background:url(https://fbstatic-a.akamaihd.net/rsrc.php/v2/y9/r/jKEcVPZFk-2.gif) no-repeat;height:32px;width:32px;margin-left:-16px;position:absolute;left:50%;z-index:4}',components:["css:fb.css.base","css:fb.css.dialog","css:fb.css.iframewidget"]}),__d("ApiClientConfig",[],{FlashRequest:{swfUrl:"https://connect.facebook.net/rsrc.php/v1/yd/r/mxzow1Sdmxr.swf"}}),__d("JSSDKCanvasPrefetcherConfig",[],{blacklist:[0x83d70a64a992],sampleRate:500}),__d("JSSDKPluginPipeConfig",[],{threshold:0,enabledApps:{209753825810663:1,187288694643718:1}}),__d("QueryString",[],function(a,b,c,d,e){function g(k){var l=[];
return ES(ES("Object","keys",!1,k).sort(),"forEach",!0,function(m){var n=k[m];if("undefined"!=typeof n)return null===n?void l.push(m):void l.push(encodeURIComponent(m)+"="+encodeURIComponent(n))}),l.join("&")}function h(k,l){var m={};if(""===k)return m;for(var n=k.split("&"),o=0;o<n.length;o++){var p=n[o].split("=",2),q=decodeURIComponent(p[0]);if(l&&m.hasOwnProperty(q))throw new URIError("Duplicate key: "+q);m[q]=2===p.length?decodeURIComponent(p[1]):null}return m}function i(k,l){return k+(~ES(k,"indexOf",!0,"?")?"&":"?")+("string"==typeof l?l:j.encode(l))}var j={encode:g,decode:h,appendToUrl:i};e.exports=j},null),__d("ManagedError",[],function(a,b,c,d,e){function g(h,i){Error.prototype.constructor.call(this,h),this.message=h,this.innerError=i}g.prototype=new Error,g.prototype.constructor=g,e.exports=g},null),__d("AssertionError",["ManagedError"],function(a,b,c,d,e,f,g){function h(){g.prototype.constructor.apply(this,arguments)}h.prototype=new g,h.prototype.constructor=h,e.exports=h},null),__d("sprintf",[],function(a,b,c,d,e){function g(h){for(var i=[],j=1,k=arguments.length;k>j;j++)i.push(arguments[j]);var l=0;return h.replace(/%s/g,function(){return i[l++]})}e.exports=g},null),__d("Assert",["AssertionError","sprintf"],function(a,b,c,d,e,f,g,h){function i(n,o){if("boolean"!=typeof n||!n)throw new g(o);return n}function j(n,o,p){var q;if(void 0===o)q="undefined";else if(null===o)q="null";else{var r=Object.prototype.toString.call(o);q=/\s(\w*)/.exec(r)[1].toLowerCase()}return i(-1!==ES(n,"indexOf",!0,q),p||h("Expression is of type %s, not %s",q,n)),o}function k(n,o,p){return i(o instanceof n,p||"Expression not instance of type"),o}function l(n,o){m["is"+n]=o,m["maybe"+n]=function(p,q){null!=p&&o(p,q)}}var m={isInstanceOf:k,isTrue:i,isTruthy:function(n,o){return i(!!n,o)},type:j,define:function(n,o){n=n.substring(0,1).toUpperCase()+n.substring(1).toLowerCase(),l(n,function(p,q){i(o(p),q)})}};ES(["Array","Boolean","Date","Function","Null","Number","Object","Regexp","String","Undefined"],"forEach",!0,function(n){l(n,ES(j,"bind",!0,null,n.toLowerCase()))}),e.exports=m},null),__d("Type",["Assert"],function(a,b,c,d,e,f,g){function h(){var l=this.__mixins;if(l)for(var m=0;m<l.length;m++)l[m].apply(this,arguments)}function i(l,m){if(m instanceof l)return!0;if(m instanceof h)for(var n=0;n<m.__mixins.length;n++)if(m.__mixins[n]==l)return!0;return!1}function j(l,m){var n=l.prototype;ES("Array","isArray",!1,m)||(m=[m]);for(var o=0;o<m.length;o++){var p=m[o];"function"==typeof p&&(n.__mixins.push(p),p=p.prototype),ES(ES("Object","keys",!1,p),"forEach",!0,function(q){n[q]=p[q]})}}function k(l,m,n){function p(){}var o=m&&m.hasOwnProperty("constructor")?m.constructor:function(){this.parent.apply(this,arguments)};if(g.isFunction(o),l&&l.prototype instanceof h==!1)throw new Error("parent type does not inherit from Type");return l=l||h,p.prototype=l.prototype,o.prototype=new p,m&&ES("Object","assign",!1,o.prototype,m),o.prototype.constructor=o,o.parent=l,o.prototype.__mixins=l.prototype.__mixins?Array.prototype.slice.call(l.prototype.__mixins):[],n&&j(o,n),o.prototype.parent=function(){this.parent=l.prototype.parent,l.apply(this,arguments)},o.prototype.parentCall=function(q){return l.prototype[q].apply(this,Array.prototype.slice.call(arguments,1))},o.extend=function(q,r){return k(this,q,r)},o}ES("Object","assign",!1,h.prototype,{instanceOf:function(l){return i(l,this)}}),ES("Object","assign",!1,h,{extend:function(l,m){return"function"==typeof l?k.apply(null,arguments):k(null,l,m)},instanceOf:i}),e.exports=h},null),__d("ObservableMixin",[],function(a,b,c,d,e){function g(){this.__observableEvents={}}g.prototype={inform:function(h){for(var i=Array.prototype.slice.call(arguments,1),j=Array.prototype.slice.call(this.getSubscribers(h)),k=0;k<j.length;k++)if(null!==j[k])try{j[k].apply(this,i)}catch(l){setTimeout(function(){throw l},0)}return this},getSubscribers:function(h){return this.__observableEvents[h]||(this.__observableEvents[h]=[])},clearSubscribers:function(h){return h&&(this.__observableEvents[h]=[]),this},clearAllSubscribers:function(){return this.__observableEvents={},this},subscribe:function(h,i){var j=this.getSubscribers(h);return j.push(i),this},unsubscribe:function(h,i){for(var j=this.getSubscribers(h),k=0;k<j.length;k++)if(j[k]===i){j.splice(k,1);break}return this},monitor:function(h,i){if(!i()){var j=ES(function(){i.apply(i,arguments)&&this.unsubscribe(h,j)},"bind",!0,this);this.subscribe(h,j)}return this}},e.exports=g},null),__d("sdk.Model",["Type","ObservableMixin"],function(a,b,c,d,e,f,g,h){var i=g.extend({constructor:function(j){this.parent();var k={},l=this;ES(ES("Object","keys",!1,j),"forEach",!0,function(m){k[m]=j[m],l["set"+m]=function(n){return n===k[m]?this:(k[m]=n,l.inform(m+".change",n),l)},l["get"+m]=function(){return k[m]}})}},h);e.exports=i},null),__d("sdk.Runtime",["sdk.Model","JSSDKRuntimeConfig"],function(a,b,c,d,e,f,g,h){var i={UNKNOWN:0,PAGETAB:1,CANVAS:2,PLATFORM:4},j=new g({AccessToken:"",ClientID:"",CookieUserID:"",Environment:i.UNKNOWN,Initialized:!1,IsVersioned:!1,KidDirectedSite:void 0,Locale:h.locale,LoginStatus:void 0,Revision:h.revision,Rtl:h.rtl,Scope:void 0,Secure:void 0,UseCookie:!1,UserID:"",Version:void 0});ES("Object","assign",!1,j,{ENVIRONMENTS:i,isEnvironment:function(k){var l=this.getEnvironment();return(k|l)===l},isCanvasEnvironment:function(){return this.isEnvironment(i.CANVAS)||this.isEnvironment(i.PAGETAB)}}),function(){var k=/app_runner/.test(window.name)?i.PAGETAB:/iframe_canvas/.test(window.name)?i.CANVAS:i.UNKNOWN;(k|i.PAGETAB)===k&&(k|=i.CANVAS),j.setEnvironment(k)}(),e.exports=j},null),__d("sdk.Cookie",["QueryString","sdk.Runtime"],function(a,b,c,d,e,f,g,h){function j(m,n,o){m+=h.getClientID();var p=i&&"."!==i;p&&(document.cookie=m+"=; expires=Wed, 04 Feb 2004 08:00:00 GMT;",document.cookie=m+"=; expires=Wed, 04 Feb 2004 08:00:00 GMT;domain="+location.hostname+";");var q=new Date(o).toGMTString();document.cookie=m+"="+n+(n&&0===o?"":"; expires="+q)+"; path=/"+(p?"; domain="+i:"")}function k(m){m+=h.getClientID();var n=new RegExp("\\b"+m+"=([^;]*)\\b");return n.test(document.cookie)?RegExp.$1:null}var i=null,l={setDomain:function(m){i=m;var n=g.encode({base_domain:i&&"."!==i?i:""}),o=new Date;o.setFullYear(o.getFullYear()+1),j("fbm_",n,o.getTime())},getDomain:function(){return i},loadMeta:function(){var m=k("fbm_");if(m){var n=g.decode(m);return i||(i=n.base_domain),n}},loadSignedRequest:function(){return k("fbsr_")},setSignedRequestCookie:function(m,n){if(!m)throw new Error("Value passed to Cookie.setSignedRequestCookie was empty.");j("fbsr_",m,n)},clearSignedRequestCookie:function(){j("fbsr_","",0)},setRaw:j};e.exports=l},null),__d("wrapFunction",[],function(a,b,c,d,e){function h(i,j,k){return j=j||"default",function(){var l=j in g?g[j](i,k):i;return l.apply(this,arguments)}}var g={};h.setWrapper=function(i,j){j=j||"default",g[j]=i},e.exports=h},null),__d("DOMEventListener",["wrapFunction"],function(a,b,c,d,e,f,g){var h,i;window.addEventListener?(h=function(k,l,m){m.wrapper=g(m,"entry","DOMEventListener.add "+l),k.addEventListener(l,m.wrapper,!1)},i=function(k,l,m){k.removeEventListener(l,m.wrapper,!1)}):window.attachEvent?(h=function(k,l,m){m.wrapper=g(m,"entry","DOMEventListener.add "+l),k.attachEvent("on"+l,m.wrapper)},i=function(k,l,m){k.detachEvent("on"+l,m.wrapper)}):i=h=function(){};var j={add:function(k,l,m){return h(k,l,m),{remove:function(){i(k,l,m),k=null}}},remove:i};e.exports=j},null),__d("sdk.UA",[],function(a,b,c,d,e){function n(p){return ES(p.split("."),"map",!0,function(q){return parseFloat(q)})}var g=navigator.userAgent,h={iphone:/\b(iPhone|iP[ao]d)/.test(g),ipad:/\b(iP[ao]d)/.test(g),android:/Android/i.test(g),nativeApp:/FBAN\/\w+;/i.test(g)},i=/Mobile/i.test(g),j={ie:"",firefox:"",chrome:"",webkit:"",osx:""},k=/(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(g);if(k&&(j.ie=k[1]?parseFloat(k[1]):k[4]?parseFloat(k[4]):"",j.firefox=k[2]||"",j.webkit=k[3]||"",k[3])){var l=/(?:Chrome\/(\d+\.\d+))/.exec(g);j.chrome=l?l[1]:""}var m=/(?:Mac OS X (\d+(?:[._]\d+)?))/.exec(g);m&&(j.osx=m[1]);var o={};ES(ES("Object","keys",!1,j),"map",!0,function(p){o[p]=function(){return parseFloat(j[p])},o[p].getVersionParts=function(){return n(j[p])}}),ES(ES("Object","keys",!1,h),"map",!0,function(p){o[p]=function(){return h[p]}}),o.mobile=function(){return h.iphone||h.ipad||h.android||i},e.exports=o},null),__d("getBlankIframeSrc",["sdk.UA"],function(a,b,c,d,e,f,g){function h(){return g.ie()<10?"javascript:false":"about:blank"}e.exports=h},null),__d("guid",[],function(a,b,c,d,e){function g(){return"f"+(Math.random()*(1<<30)).toString(16).replace(".","")}e.exports=g},null),__d("UserAgent_DEPRECATED",[],function(a,b,c,d,e){function w(){if(!g){g=!0;var y=navigator.userAgent,z=/(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(y),aa=/(Mac OS X)|(Windows)|(Linux)/.exec(y);if(s=/\b(iPhone|iP[ao]d)/.exec(y),t=/\b(iP[ao]d)/.exec(y),q=/Android/i.exec(y),u=/FBAN\/\w+;/i.exec(y),v=/Mobile/i.exec(y),r=!!/Win64/.exec(y),z){h=z[1]?parseFloat(z[1]):z[5]?parseFloat(z[5]):0/0,h&&document&&document.documentMode&&(h=document.documentMode);var ba=/(?:Trident\/(\d+.\d+))/.exec(y);m=ba?parseFloat(ba[1])+4:h,i=z[2]?parseFloat(z[2]):0/0,j=z[3]?parseFloat(z[3]):0/0,k=z[4]?parseFloat(z[4]):0/0,k?(z=/(?:Chrome\/(\d+\.\d+))/.exec(y),l=z&&z[1]?parseFloat(z[1]):0/0):l=0/0}else h=i=j=l=k=0/0;if(aa){if(aa[1]){var ca=/(?:Mac OS X (\d+(?:[._]\d+)?))/.exec(y);n=ca?parseFloat(ca[1].replace("_",".")):!0}else n=!1;o=!!aa[2],p=!!aa[3]}else n=o=p=!1}}var h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,g=!1,x={ie:function(){return w()||h},ieCompatibilityMode:function(){return w()||m>h},ie64:function(){return x.ie()&&r},firefox:function(){return w()||i},opera:function(){return w()||j},webkit:function(){return w()||k},safari:function(){return x.webkit()},chrome:function(){return w()||l},windows:function(){return w()||o},osx:function(){return w()||n},linux:function(){return w()||p},iphone:function(){return w()||s},mobile:function(){return w()||s||t||q||v},nativeApp:function(){return w()||u},android:function(){return w()||q},ipad:function(){return w()||t}};e.exports=x},null),__d("hasNamePropertyBug",["guid","UserAgent_DEPRECATED"],function(a,b,c,d,e,f,g,h){function j(){var l=document.createElement("form"),m=l.appendChild(document.createElement("input"));return m.name=g(),i=m!==l.elements[m.name],l=m=null,i}function k(){return"undefined"==typeof i?j():i}var i=h.ie()?void 0:!1;e.exports=k},null),__d("sdk.createIframe",["DOMEventListener","getBlankIframeSrc","guid","hasNamePropertyBug"],function(a,b,c,d,e,f,g,h,i,j){function k(l){l=ES("Object","assign",!1,{},l);var m,n=l.name||i(),o=l.root,p=l.style||{border:"none"},q=l.url,r=l.onload,s=l.onerror;j()?m=document.createElement('<iframe name="'+n+'"/>'):(m=document.createElement("iframe"),m.name=n),delete l.style,delete l.name,delete l.url,delete l.root,delete l.onload,delete l.onerror;var t=ES("Object","assign",!1,{frameBorder:0,allowTransparency:!0,scrolling:"no"},l);t.width&&(m.width=t.width+"px"),t.height&&(m.height=t.height+"px"),delete t.height,delete t.width;for(var u in t)t.hasOwnProperty(u)&&m.setAttribute(u,t[u]);if(ES("Object","assign",!1,m.style,p),m.src=h(),o.appendChild(m),r)var v=g.add(m,"load",function(){v.remove(),r()});if(s)var w=g.add(m,"error",function(){w.remove(),s()});return m.src=q,m}e.exports=k},null),__d("DOMWrapper",[],function(a,b,c,d,e){var g,h,i={setRoot:function(j){g=j},getRoot:function(){return g||document.body},setWindow:function(j){h=j},getWindow:function(){return h||self}};e.exports=i},null),__d("eprintf",[],function(a,b,c,d,e){var g=function(h){var i=ES(Array.prototype.slice.call(arguments),"map",!0,function(l){return String(l)}),j=h.split("%s").length-1;if(j!==i.length-1)return g("eprintf args number mismatch: %s",ES("JSON","stringify",!1,i));var k=1;return h.replace(/%s/g,function(){return String(i[k++])})};e.exports=g},null),__d("ex",["eprintf"],function(a,b,c,d,e){var h=function(){for(var i=[],j=0,k=arguments.length;k>j;j++)i.push(arguments[j]);return i=ES(i,"map",!0,function(l){return String(l)}),i[0].split("%s").length!==i.length?h("ex args number mismatch: %s",ES("JSON","stringify",!1,i)):h._prefix+ES("JSON","stringify",!1,i)+h._suffix};h._prefix="<![EX[",h._suffix="]]>",e.exports=h},null),__d("invariant",["ex","sprintf"],function(a,b,c,d,e,f,g){"use strict";var i=g,j=function(k,l){if(!k){var m;if(void 0===l)m=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{for(var n=["Invariant Violation: "+l],o=2,p=arguments.length;p>o;o++)n.push(arguments[o]);m=new Error(i.apply(null,n)),m.messageWithParams=n}throw m.framesToPop=1,m}};e.exports=j},null),__d("sdk.feature",["JSSDKConfig","invariant"],function(a,b,c,d,e,f,g,h){function i(j,k){if(h(arguments.length>=2),g.features&&j in g.features){var l=g.features[j];return"object"==typeof l&&"number"==typeof l.rate?l.rate&&100*Math.random()<=l.rate?l.value||!0:l.value?null:!1:l}return k}e.exports=i},null),__d("sdk.getContextType",["sdk.Runtime","sdk.UA"],function(a,b,c,d,e,f,g,h){function i(){return h.nativeApp()?3:h.mobile()?2:g.isEnvironment(g.ENVIRONMENTS.CANVAS)?5:1}e.exports=i},null),__d("Log",["sprintf"],function(a,b,c,d,e,f,g){function i(k,l){var m=Array.prototype.slice.call(arguments,2),n=g.apply(null,m),o=window.console;o&&j.level>=l&&o[k in o?k:"log"](n)}var h={DEBUG:3,INFO:2,WARNING:1,ERROR:0},j={level:-1,Level:h,debug:ES(i,"bind",!0,null,"debug",h.DEBUG),info:ES(i,"bind",!0,null,"info",h.INFO),warn:ES(i,"bind",!0,null,"warn",h.WARNING),error:ES(i,"bind",!0,null,"error",h.ERROR)};e.exports=j},null),__d("sdk.domReady",[],function(a,b,c,d,e){function i(){if(g){for(var l;l=g.shift();)l();g=null}}function j(l){return g?void g.push(l):void l()}var g,h="readyState"in document?/loaded|complete/.test(document.readyState):!!document.body;if(!h&&(g=[],document.addEventListener?(document.addEventListener("DOMContentLoaded",i,!1),window.addEventListener("load",i,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",i),window.attachEvent("onload",i)),document.documentElement.doScroll&&window==window.top)){var k=function(){try{document.documentElement.doScroll("left")}catch(l){return void setTimeout(k,0)}i()};k()}e.exports=j},3),__d("sdk.Content",["Log","sdk.UA","sdk.domReady"],function(a,b,c,d,e,f,g,h,i){var j,l={append:function(m,n){if(n||(j?n=j:(j=n=document.getElementById("fb-root"),n||(g.warn('The "fb-root" div has not been created, auto-creating'),j=n=document.createElement("div"),n.id="fb-root",h.ie()||!document.body?i(function(){document.body.appendChild(n)}):document.body.appendChild(n)),n.className+=" fb_reset")),"string"==typeof m){var o=document.createElement("div");return n.appendChild(o).innerHTML=m,o}return n.appendChild(m)},appendHidden:function(m){if(!n){var n=document.createElement("div"),o=n.style;o.position="absolute",o.top="-10000px",o.width=o.height=0,n=l.append(n)}return l.append(m,n)},submitToTarget:function(m,n){var o=document.createElement("form");o.action=m.url,o.target=m.target,o.method=n?"GET":"POST",l.appendHidden(o);for(var p in m.params)if(m.params.hasOwnProperty(p)){var q=m.params[p];if(null!==q&&void 0!==q){var r=document.createElement("input");r.name=p,r.value=q,o.appendChild(r)}}o.submit(),o.parentNode.removeChild(o)}};e.exports=l},null),__d("Miny",[],function(a,b,c,d,e){function j(n){for(var o=h.encode.length;n>o;o++){var p=o.toString(32).split("");p[p.length-1]=i[parseInt(p[p.length-1],32)],p=p.join(""),h.encode[o]=p,h.decode[p]=o}return h}function k(n){if(/^$|[~\\]|__proto__/.test(n))return n;for(var o=n.match(/\w+|\W+/g),p={},q=0;q<o.length;q++)p[o[q]]=(p[o[q]]||0)+1;var r=ES("Object","keys",!1,p);r.sort(function(u,v){return p[u]<p[v]?1:p[v]<p[u]?-1:0});var s=j(r.length).encode;for(q=0;q<r.length;q++)p[r[q]]=s[q];var t=[];for(q=0;q<o.length;q++)t[q]=p[o[q]];return[g,r.length].concat(r).concat(t.join("")).join("~")}function l(n){var o=n.split("~");if(o.shift()!=g)return n;var p=parseInt(o.shift(),10),q=o.pop();q=q.match(/[0-9a-v]*[\-w-zA-Z_]/g);for(var r=o,s=j(p).decode,t=[],u=0;u<q.length;u++)t[u]=r[s[q[u]]];return t.join("")}var g="Miny1",h={encode:[],decode:{}},i="wxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_".split(""),m={encode:k,decode:l};e.exports=m},null),__d("UrlMap",["UrlMapConfig"],function(a,b,c,d,e,f,g){var h={resolve:function(i,j){var k="undefined"==typeof j?location.protocol.replace(":",""):j?"https":"http";return i in g?k+"://"+g[i]:"undefined"==typeof j&&i+"_"+k in g?k+"://"+g[i+"_"+k]:j!==!0&&i+"_http"in g?"http://"+g[i+"_http"]:j!==!1&&i+"_https"in g?"https://"+g[i+"_https"]:void 0}};e.exports=h},null),__d("dotAccess",[],function(a,b,c,d,e){function g(h,i,j){var k=i.split(".");do{var l=k.shift();h=h[l]||j&&(h[l]={})}while(k.length&&h);return h}e.exports=g},null),__d("GlobalCallback",["DOMWrapper","dotAccess","guid","wrapFunction"],function(a,b,c,d,e,f,g,h,i,j){var k,l,m={setPrefix:function(n){k=h(g.getWindow(),n,!0),l=n},create:function(n,o){k||this.setPrefix("__globalCallbacks");var p=i();return k[p]=j(n,"entry",o||"GlobalCallback"),l+"."+p},remove:function(n){var o=n.substring(l.length+1);delete k[o]}};e.exports=m},null),__d("insertIframe",["GlobalCallback","getBlankIframeSrc","guid"],function(a,b,c,d,e,f,g,h,i){function j(k){k.id=k.id||i(),k.name=k.name||i();var l=!1,m=!1,n=function(){l&&!m&&(m=!0,k.onload&&k.onload(k.root.firstChild))},o=g.create(n);if(document.attachEvent){var p='<iframe id="'+k.id+'" name="'+k.name+'"'+(k.title?' title="'+k.title+'"':"")+(k.className?' class="'+k.className+'"':"")+' style="border:none;'+(k.width?"width:"+k.width+"px;":"")+(k.height?"height:"+k.height+"px;":"")+'" src="'+h()+'" frameborder="0" scrolling="no" allowtransparency="true" onload="'+o+'()"></iframe>';k.root.innerHTML='<iframe src="'+h()+'" frameborder="0" scrolling="no" style="height:1px"></iframe>',l=!0,setTimeout(function(){k.root.innerHTML=p,k.root.firstChild.src=k.url,k.onInsert&&k.onInsert(k.root.firstChild)},0)}else{var q=document.createElement("iframe");q.id=k.id,q.name=k.name,q.onload=n,q.scrolling="no",q.style.border="none",q.style.overflow="hidden",k.title&&(q.title=k.title),k.className&&(q.className=k.className),void 0!==k.height&&(q.style.height=k.height+"px"),void 0!==k.width&&(q.style.width="100%"==k.width?k.width:k.width+"px"),k.root.appendChild(q),l=!0,q.src=k.url,k.onInsert&&k.onInsert(q)}}e.exports=j},null),__d("sdk.Impressions",["sdk.Content","Miny","QueryString","sdk.Runtime","UrlMap","getBlankIframeSrc","guid","insertIframe"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n){function o(q){var r=j.getClientID();!q.api_key&&r&&(q.api_key=r),q.kid_directed_site=j.getKidDirectedSite();var s=k.resolve("www",!0)+"/impression.php/"+m()+"/",t=i.appendToUrl(s,q);if(t.length>2e3&&q.payload&&"string"==typeof q.payload){var u=h.encode(q.payload);u&&u.length<q.payload.length&&(q.payload=u,t=i.appendToUrl(s,q))}if(t.length<=2e3){var v=new Image;v.src=t}else{var w=m(),x=g.appendHidden("");n({url:l(),root:x,name:w,className:"fb_hidden fb_invisible",onload:function(){x.parentNode.removeChild(x)}}),g.submitToTarget({url:s,target:w,params:q})}}var p={log:function(q,r){r.source||(r.source="jssdk"),o({lid:q,payload:ES("JSON","stringify",!1,r)})},impression:o};e.exports=p},null),__d("Base64",[],function(a,b,c,d,e){function h(l){return l=l.charCodeAt(0)<<16|l.charCodeAt(1)<<8|l.charCodeAt(2),String.fromCharCode(g.charCodeAt(l>>>18),g.charCodeAt(l>>>12&63),g.charCodeAt(l>>>6&63),g.charCodeAt(63&l))}function j(l){return l=i.charCodeAt(l.charCodeAt(0)-43)<<18|i.charCodeAt(l.charCodeAt(1)-43)<<12|i.charCodeAt(l.charCodeAt(2)-43)<<6|i.charCodeAt(l.charCodeAt(3)-43),String.fromCharCode(l>>>16,l>>>8&255,255&l)}var g="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=">___?456789:;<=_______\x00\b	\n\f\r______ !\"#$%&'()*+,-./0123",k={encode:function(l){l=unescape(encodeURI(l));var m=(l.length+2)%3;return l=(l+"\x00\x00".slice(m)).replace(/[\s\S]{3}/g,h),l.slice(0,l.length+m-2)+"==".slice(m)},decode:function(l){l=l.replace(/[^A-Za-z0-9+\/]/g,"");var m=l.length+3&3;l=(l+"AAA".slice(m)).replace(/..../g,j),l=l.slice(0,l.length+m-3);try{return decodeURIComponent(escape(l))}catch(n){throw new Error("Not valid UTF-8")}},encodeObject:function(l){return k.encode(ES("JSON","stringify",!1,l))},decodeObject:function(l){return ES("JSON","parse",!1,k.decode(l))},encodeNums:function(l){return String.fromCharCode.apply(String,ES(l,"map",!0,function(m){return g.charCodeAt((m|-(m>63))&-(m>0)&63)}))}};e.exports=k},null),__d("sdk.SignedRequest",["Base64"],function(a,b,c,d,e,f,g){function h(j){if(!j)return null;var k=j.split(".",2)[1].replace(/\-/g,"+").replace(/\_/g,"/");return g.decodeObject(k)}var i={parse:h};e.exports=i},null),__d("URIRFC3986",[],function(a,b,c,d,e){var g=new RegExp("^([^:/?#]+:)?(//([^\\\\/?#@]*@)?(\\[[A-Fa-f0-9:.]+\\]|[^\\/?#:]*)(:[0-9]*)?)?([^?#]*)(\\?[^#]*)?(#.*)?"),h={parse:function(i){if(""===ES(i,"trim",!0))return null;var j=i.match(g),k={};return k.uri=j[0]?j[0]:null,k.scheme=j[1]?j[1].substr(0,j[1].length-1):null,k.authority=j[2]?j[2].substr(2):null,k.userinfo=j[3]?j[3].substr(0,j[3].length-1):null,k.host=j[2]?j[4]:null,k.port=j[5]&&j[5].substr(1)?parseInt(j[5].substr(1),10):null,k.path=j[6]?j[6]:null,k.query=j[7]?j[7].substr(1):null,k.fragment=j[8]?j[8].substr(1):null,k.isGenericURI=null===k.authority&&!!k.scheme,k}};e.exports=h},null),__d("createObjectFrom",[],function(a,b,c,d,e){function g(h,i){var j={},k=ES("Array","isArray",!1,i);"undefined"==typeof i&&(i=!0);for(var l=h.length;l--;)j[h[l]]=k?i[l]:i;return j}e.exports=g},null),__d("URISchemes",["createObjectFrom"],function(a,b,c,d,e,f,g){var h=g(["fb","fb-ama","fb-messenger","fbcf","fbconnect","fbrpc","file","ftp","http","https","mailto","ms-app","itms","itms-apps","itms-services","market","svn+ssh","fbstaging","tel","sms","pebblejs"]),i={isAllowed:function(j){return j?h.hasOwnProperty(j.toLowerCase()):!0}};e.exports=i},null),__d("copyProperties",[],function(a,b,c,d,e){function g(h,i,j,k,l,m){h=h||{};for(var q,o=[i,j,k,l,m],p=0;o[p];){q=o[p++];for(var r in q)h[r]=q[r];q.hasOwnProperty&&q.hasOwnProperty("toString")&&"undefined"!=typeof q.toString&&h.toString!==q.toString&&(h.toString=q.toString)}return h}e.exports=g},null),__d("URIBase",["URIRFC3986","URISchemes","copyProperties","ex","invariant"],function(a,b,c,d,e,f,g,h,i,j,k){function n(q,r,s,t){if(!r)return!0;if(r instanceof p)return q.setProtocol(r.getProtocol()),q.setDomain(r.getDomain()),q.setPort(r.getPort()),q.setPath(r.getPath()),q.setQueryData(t.deserialize(t.serialize(r.getQueryData()))),q.setFragment(r.getFragment()),q.setForceFragmentSeparator(r.getForceFragmentSeparator()),!0;r=ES(r.toString(),"trim",!0);var u=g.parse(r)||{};if(!s&&!h.isAllowed(u.scheme))return!1;if(q.setProtocol(u.scheme||""),!s&&l.test(u.host))return!1;if(q.setDomain(u.host||""),q.setPort(u.port||""),q.setPath(u.path||""),s)q.setQueryData(t.deserialize(u.query)||{});else try{q.setQueryData(t.deserialize(u.query)||{})}catch(v){return!1}if(q.setFragment(u.fragment||""),""===u.fragment&&q.setForceFragmentSeparator(!0),null!==u.userinfo){if(s)throw new Error(j("URI.parse: invalid URI (userinfo is not allowed in a URI): %s",q.toString()));return!1}if(!q.getDomain()&&-1!==ES(q.getPath(),"indexOf",!0,"\\")){if(s)throw new Error(j("URI.parse: invalid URI (no domain but multiple back-slashes): %s",q.toString()));return!1}if(!q.getProtocol()&&m.test(r)){if(s)throw new Error(j("URI.parse: invalid URI (unsafe protocol-relative URLs): %s",q.toString()));return!1}return!0}function p(q,r){"use strict";k(r),this.$URIBase0=r,this.$URIBase1="",this.$URIBase2="",this.$URIBase3="",this.$URIBase4="",this.$URIBase5="",this.$URIBase6={},this.$URIBase7=!1,n(this,q,!0,r)}var l=new RegExp("[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]"),m=new RegExp("^(?:[^/]*:|[\\x00-\\x1f]*/[\\x00-\\x1f]*/)"),o=[];p.prototype.setProtocol=function(q){"use strict";return k(h.isAllowed(q)),this.$URIBase1=q,this},p.prototype.getProtocol=function(){"use strict";return this.$URIBase1},p.prototype.setSecure=function(q){"use strict";return this.setProtocol(q?"https":"http")},p.prototype.isSecure=function(){"use strict";return"https"===this.getProtocol()},p.prototype.setDomain=function(q){"use strict";if(l.test(q))throw new Error(j("URI.setDomain: unsafe domain specified: %s for url %s",q,this.toString()));return this.$URIBase2=q,this},p.prototype.getDomain=function(){"use strict";return this.$URIBase2},p.prototype.setPort=function(q){"use strict";return this.$URIBase3=q,this},p.prototype.getPort=function(){"use strict";return this.$URIBase3},p.prototype.setPath=function(q){"use strict";return this.$URIBase4=q,this},p.prototype.getPath=function(){"use strict";return this.$URIBase4},p.prototype.addQueryData=function(q,r){"use strict";return"[object Object]"===Object.prototype.toString.call(q)?i(this.$URIBase6,q):this.$URIBase6[q]=r,this},p.prototype.setQueryData=function(q){"use strict";return this.$URIBase6=q,this},p.prototype.getQueryData=function(){"use strict";return this.$URIBase6},p.prototype.removeQueryData=function(q){"use strict";ES("Array","isArray",!1,q)||(q=[q]);for(var r=0,s=q.length;s>r;++r)delete this.$URIBase6[q[r]];return this},p.prototype.setFragment=function(q){"use strict";return this.$URIBase5=q,this.setForceFragmentSeparator(!1),this},p.prototype.getFragment=function(){"use strict";return this.$URIBase5},p.prototype.setForceFragmentSeparator=function(q){"use strict";return this.$URIBase7=q,this},p.prototype.getForceFragmentSeparator=function(){"use strict";return this.$URIBase7},p.prototype.isEmpty=function(){"use strict";return!(this.getPath()||this.getProtocol()||this.getDomain()||this.getPort()||ES("Object","keys",!1,this.getQueryData()).length>0||this.getFragment())},p.prototype.toString=function(){"use strict";for(var q=this,r=0;r<o.length;r++)q=o[r](q);return q.$URIBase8()},p.prototype.$URIBase8=function(){"use strict";var q="",r=this.getProtocol();r&&(q+=r+"://");var s=this.getDomain();s&&(q+=s);var t=this.getPort();t&&(q+=":"+t);var u=this.getPath();u?q+=u:q&&(q+="/");var v=this.$URIBase0.serialize(this.getQueryData());v&&(q+="?"+v);var w=this.getFragment();return w?q+="#"+w:this.getForceFragmentSeparator()&&(q+="#"),q},p.registerFilter=function(q){"use strict";o.push(q)},p.prototype.getOrigin=function(){"use strict";var q=this.getPort();return this.getProtocol()+"://"+this.getDomain()+(q?":"+q:"")},p.isValidURI=function(q,r){return n(new p(null,r),q,!1,r)},e.exports=p},null),__d("sdk.URI",["Assert","QueryString","URIBase"],function(a,b,c,d,e,f,g,h,i){function n(o){"use strict";return g.isString(o,"The passed argument was of invalid type."),this instanceof n?void i.call(this,o,k):new n(o)}var j=/\.facebook\.com$/,k={serialize:function(o){return o?h.encode(o):""},deserialize:function(o){return o?h.decode(o):{}}};for(var l in i)i.hasOwnProperty(l)&&(n[l]=i[l]);var m=null===i?null:i.prototype;n.prototype=ES("Object","create",!1,m),n.prototype.constructor=n,n.__superConstructor__=i,n.prototype.isFacebookURI=function(){"use strict";return j.test(this.getDomain())},n.prototype.valueOf=function(){"use strict";return this.toString()},e.exports=n},null),__d("sdk.Event",[],function(a,b,c,d,e){var g={SUBSCRIBE:"event.subscribe",UNSUBSCRIBE:"event.unsubscribe",subscribers:function(){return this._subscribersMap||(this._subscribersMap={}),this._subscribersMap},subscribe:function(h,i){var j=this.subscribers();j[h]?-1==ES(j[h],"indexOf",!0,i)&&j[h].push(i):j[h]=[i],h!=this.SUBSCRIBE&&h!=this.UNSUBSCRIBE&&this.fire(this.SUBSCRIBE,h,j[h])},unsubscribe:function(h,i){var j=this.subscribers()[h];j&&ES(j,"forEach",!0,function(k,l){k==i&&j.splice(l,1)}),h!=this.SUBSCRIBE&&h!=this.UNSUBSCRIBE&&this.fire(this.UNSUBSCRIBE,h,j)},monitor:function(h,i){if(!i()){var j=this,k=function(){i.apply(i,arguments)&&j.unsubscribe(h,k)};this.subscribe(h,k)}},clear:function(h){delete this.subscribers()[h]},fire:function(h){var i=Array.prototype.slice.call(arguments,1),j=this.subscribers()[h];j&&ES(j,"forEach",!0,function(k){k&&k.apply(this,i)})}};e.exports=g},null),__d("Queue",["copyProperties"],function(a,b,c,d,e,f,g){function i(j){"use strict";this._opts=g({interval:0,processor:null},j),this._queue=[],this._stopped=!0}var h={};i.prototype._dispatch=function(){"use strict";if(!this._stopped&&0!==this._queue.length){if(!this._opts.processor)throw this._stopped=!0,new Error("No processor available");if(this._opts.interval)this._opts.processor.call(this,this._queue.shift()),this._timeout=setTimeout(ES(this._dispatch,"bind",!0,this),this._opts.interval);else for(;this._queue.length;)this._opts.processor.call(this,this._queue.shift())}},i.prototype.enqueue=function(j){"use strict";return this._opts.processor&&!this._stopped?this._opts.processor.call(this,j):this._queue.push(j),this},i.prototype.start=function(j){"use strict";return j&&(this._opts.processor=j),this._stopped=!1,this._dispatch(),this},i.prototype.isStarted=function(){"use strict";return!this._stopped},i.prototype.dispatch=function(){"use strict";this._dispatch(!0)},i.prototype.stop=function(j){"use strict";return this._stopped=!0,j&&clearTimeout(this._timeout),this},i.prototype.merge=function(j,k){"use strict";return this._queue[k?"unshift":"push"].apply(this._queue,j._queue),j._queue=[],this._dispatch(),this},i.prototype.getLength=function(){"use strict";return this._queue.length},i.get=function(j,k){"use strict";var l;return l=j in h?h[j]:h[j]=new i(k)},i.exists=function(j){"use strict";return j in h},i.remove=function(j){"use strict";return delete h[j]},e.exports=i},null),__d("JSONRPC",["Log"],function(a,b,c,d,e,f,g){function h(i){"use strict";this.$JSONRPC0=0,this.$JSONRPC1={},this.remote=ES(function(j){return this.$JSONRPC2=j,this.remote},"bind",!0,this),this.local={},this.$JSONRPC3=i}h.prototype.stub=function(i){"use strict";this.remote[i]=ES(function(){for(var j=[],k=0,l=arguments.length;l>k;k++)j.push(arguments[k]);var m={jsonrpc:"2.0",method:i};"function"==typeof j[j.length-1]&&(m.id=++this.$JSONRPC0,this.$JSONRPC1[m.id]=j.pop()),m.params=j,this.$JSONRPC3(ES("JSON","stringify",!1,m),this.$JSONRPC2||{method:i})},"bind",!0,this)},h.prototype.read=function(i,j){"use strict";var k=ES("JSON","parse",!1,i),l=k.id;if(!k.method){if(!this.$JSONRPC1[l])return void g.warn("Could not find callback %s",l);var m=this.$JSONRPC1[l];return delete this.$JSONRPC1[l],delete k.id,delete k.jsonrpc,void m(k)}var p,n=this,o=this.local[k.method];if(p=l?function(s,t){var u={jsonrpc:"2.0",id:l};u[s]=t,setTimeout(function(){n.$JSONRPC3(ES("JSON","stringify",!1,u),j)},0)}:function(){},!o)return g.error('Method "%s" has not been defined',k.method),void p("error",{code:-32601,message:"Method not found",data:k.method});k.params.push(ES(p,"bind",!0,null,"result")),k.params.push(ES(p,"bind",!0,null,"error"));try{var r=o.apply(j||null,k.params);"undefined"!=typeof r&&p("result",r)}catch(q){g.error("Invokation of RPC method %s resulted in the error: %s",k.method,q.message),p("error",{code:-32603,message:"Internal error",data:q.message})}},e.exports=h},null),__d("sdk.RPC",["Assert","JSONRPC","Queue"],function(a,b,c,d,e,f,g,h,i){var j=new i,k=new h(function(m){j.enqueue(m)}),l={local:k.local,remote:k.remote,stub:ES(k.stub,"bind",!0,k),setInQueue:function(m){g.isInstanceOf(i,m),m.start(function(n){k.read(n)})},getOutQueue:function(){return j}};e.exports=l},null),__d("sdk.Scribe",["QueryString","sdk.Runtime","UrlMap"],function(a,b,c,d,e,f,g,h,i){function j(l,m){"object"==typeof m.extra&&(m.extra.revision=h.getRevision()),(new Image).src=g.appendToUrl(i.resolve("www",!0)+"/common/scribe_endpoint.php",{c:l,m:ES("JSON","stringify",!1,m)})}var k={log:j};
e.exports=k},null),__d("emptyFunction",[],function(a,b,c,d,e){function g(i){return function(){return i}}function h(){}h.thatReturns=g,h.thatReturnsFalse=g(!1),h.thatReturnsTrue=g(!0),h.thatReturnsNull=g(null),h.thatReturnsThis=function(){return this},h.thatReturnsArgument=function(i){return i},e.exports=h},null),__d("htmlSpecialChars",[],function(a,b,c,d,e){function l(m){return"undefined"!=typeof m&&null!==m&&m.toString?m===!1?"0":m===!0?"1":m.toString().replace(g,"&amp;").replace(j,"&quot;").replace(k,"&#039;").replace(h,"&lt;").replace(i,"&gt;"):""}var g=/&/g,h=/</g,i=/>/g,j=/"/g,k=/'/g;e.exports=l},null),__d("Flash",["DOMEventListener","DOMWrapper","QueryString","UserAgent_DEPRECATED","copyProperties","guid","htmlSpecialChars"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){function q(v){var w=p.getElementById(v);w&&w.parentNode.removeChild(w),delete n[v]}function r(){for(var v in n)n.hasOwnProperty(v)&&q(v)}function s(v){return v.replace(/\d+/g,function(w){return"000".substring(w.length)+w})}function t(v){o||(j.ie()>=9&&g.add(window,"unload",r),o=!0),n[v]=v}var o,n={},p=h.getWindow().document,u={embed:function(v,w,x,y){var z=l();v=m(v).replace(/&amp;/g,"&"),x=k({allowscriptaccess:"always",flashvars:y,movie:v},x||{}),"object"==typeof x.flashvars&&(x.flashvars=i.encode(x.flashvars));var aa=[];for(var ba in x)x.hasOwnProperty(ba)&&x[ba]&&aa.push('<param name="'+m(ba)+'" value="'+m(x[ba])+'">');var ca=w.appendChild(p.createElement("span")),da="<object "+(j.ie()?'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ':'type="application/x-shockwave-flash"')+'data="'+v+'" '+(x.height?'height="'+x.height+'" ':"")+(x.width?'width="'+x.width+'" ':"")+'id="'+z+'">'+aa.join("")+"</object>";ca.innerHTML=da;var ea=ca.firstChild;return t(z),ea},remove:q,getVersion:function(){var y,v="Shockwave Flash",w="application/x-shockwave-flash",x="ShockwaveFlash.ShockwaveFlash";if(navigator.plugins&&"object"==typeof navigator.plugins[v]){var z=navigator.plugins[v].description;z&&navigator.mimeTypes&&navigator.mimeTypes[w]&&navigator.mimeTypes[w].enabledPlugin&&(y=z.match(/\d+/g))}if(!y)try{y=new ActiveXObject(x).GetVariable("$version").match(/(\d+),(\d+),(\d+),(\d+)/),y=Array.prototype.slice.call(y,1)}catch(aa){}return y},checkMinVersion:function(v){var w=u.getVersion();return w?s(w.join("."))>=s(v):!1},isAvailable:function(){return!!u.getVersion()}};e.exports=u},null),__d("XDM",["DOMEventListener","DOMWrapper","emptyFunction","Flash","GlobalCallback","guid","Log","UserAgent_DEPRECATED","wrapFunction"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o){function s(u){for(var v={},w=u.length,x=q.transports;w--;)v[u[w]]=1;for(w=x.length;w--;){var y=x[w],z=p[y];if(!v[y]&&z.isAvailable())return y}}var p={},q={transports:[]},r=h.getWindow(),t={register:function(u,v){m.debug("Registering %s as XDM provider",u),q.transports.push(u),p[u]=v},create:function(u){if(!u.whenReady&&!u.onMessage)throw m.error("An instance without whenReady or onMessage makes no sense"),new Error("An instance without whenReady or onMessage makes no sense");u.channel||(m.warn("Missing channel name, selecting at random"),u.channel=l()),u.whenReady||(u.whenReady=i),u.onMessage||(u.onMessage=i);var v=u.transport||s(u.blacklist||[]),w=p[v];return w&&w.isAvailable()?(m.debug("%s is available",v),w.init(u),v):void 0}};t.register("flash",function(){var v,y,u=!1,w=!1,x=15e3;return{isAvailable:function(){return j.checkMinVersion("8.0.24")},init:function(z){m.debug("init flash: "+z.channel);var aa={send:function(da,ea,fa,ga){m.debug("sending to: %s (%s)",ea,ga),v.postMessage(da,ea,ga)}};if(u)return void z.whenReady(aa);var ba=z.root.appendChild(r.document.createElement("div")),ca=k.create(function(){k.remove(ca),clearTimeout(y),m.info("xdm.swf called the callback");var da=k.create(function(ea,fa){ea=decodeURIComponent(ea),fa=decodeURIComponent(fa),m.debug("received message %s from %s",ea,fa),z.onMessage(ea,fa)},"xdm.swf:onMessage");v.init(z.channel,da),z.whenReady(aa)},"xdm.swf:load");v=j.embed(z.flashUrl,ba,null,{protocol:location.protocol.replace(":",""),host:location.host,callback:ca,log:w}),y=setTimeout(function(){m.warn("The Flash component did not load within %s ms - verify that the container is not set to hidden or invisible using CSS as this will cause some browsers to not load the components",x)},x),u=!0}}}()),t.register("postmessage",function(){var u=!1;return{isAvailable:function(){return!!r.postMessage},init:function(v){m.debug("init postMessage: "+v.channel);var w="_FB_"+v.channel,x={send:function(y,z,aa,ba){if(r===aa)throw m.error("Invalid windowref, equal to window (self)"),new Error;m.debug("sending to: %s (%s)",z,ba);var ca=function(){aa.postMessage("_FB_"+ba+y,z)};8==n.ie()||n.ieCompatibilityMode()?setTimeout(ca,0):ca()}};return u?void v.whenReady(x):(g.add(r,"message",o(function(event){var y=event.data,z=event.origin||"native";return/^(https?:\/\/|native$)/.test(z)?"string"!=typeof y?void m.warn("Received message of type %s from %s, expected a string",typeof y,z):(m.debug("received message %s from %s",y,z),y.substring(0,w.length)==w&&(y=y.substring(w.length)),void v.onMessage(y,z)):void m.debug("Received message from invalid origin type: %s",z)},"entry","onMessage")),v.whenReady(x),void(u=!0))}}}()),e.exports=t},null),__d("isFacebookURI",[],function(a,b,c,d,e){function i(j){return g||(g=new RegExp("(^|\\.)facebook\\.com$","i")),j.isEmpty()&&"#"!==j.toString()?!1:j.getDomain()||j.getProtocol()?-1!==ES(h,"indexOf",!0,j.getProtocol())&&g.test(j.getDomain()):!0}var g=null,h=["http","https"];i.setRegex=function(j){g=j},e.exports=i},null),__d("sdk.XD",["sdk.Content","sdk.Event","Log","QueryString","Queue","sdk.RPC","sdk.Runtime","sdk.Scribe","sdk.URI","UrlMap","JSSDKXDConfig","XDM","isFacebookURI","sdk.createIframe","sdk.feature","guid"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v){function na(ta){i.info("Remote XD can talk to facebook.com (%s)",ta),m.setEnvironment("canvas"===ta?m.ENVIRONMENTS.CANVAS:m.ENVIRONMENTS.PAGETAB)}function oa(ta,ua){if(!ua)throw i.error("No senderOrigin"),new Error;var va=/^https?/.exec(ua)[0];switch(ta.xd_action){case"proxy_ready":var wa,xa;"https"==va?(wa=y,xa=aa):(wa=x,xa=z),ta.registered&&(na(ta.registered),w=wa.merge(w)),i.info("Proxy ready, starting queue %s containing %s messages",va+"ProxyQueue",wa.getLength()),wa.start(function(za){ia.send("string"==typeof za?za:j.encode(za),ua,xa.contentWindow,ga+"_"+va)});break;case"plugin_ready":if(i.info("Plugin %s ready, protocol: %s",ta.name,va),la[ta.name]={protocol:va},k.exists(ta.name)){var ya=k.get(ta.name);i.debug("Enqueuing %s messages for %s in %s",ya.getLength(),ta.name,va+"ProxyQueue"),("https"==va?y:x).merge(ya)}}ta.data&&pa(ta.data,ua)}function pa(ta,ua){if(!ua||"native"===ua||s(o(ua))){if("string"==typeof ta){if(/^FB_RPC:/.test(ta))return void ma.enqueue(ta.substring(7));if("{"==ta.substring(0,1))try{ta=ES("JSON","parse",!1,ta)}catch(va){return void i.warn("Failed to decode %s as JSON",ta)}else ta=j.decode(ta)}if(ua||ta.xd_sig==ba&&(ua=ta.xd_origin),ta.xd_action)return void oa(ta,ua);if(ta.access_token&&m.setSecure(/^https/.test(ha)),ta.cb){var wa=sa._callbacks[ta.cb];sa._forever[ta.cb]||delete sa._callbacks[ta.cb],wa&&wa(ta)}}}function qa(ta,ua){if("facebook"==ta)ua.relation="parent.parent",w.enqueue(ua);else{ua.relation='parent.frames["'+ta+'"]';var va=la[ta];va?(i.debug("Enqueuing message for plugin %s in %s",ta,va.protocol+"ProxyQueue"),("https"==va.protocol?y:x).enqueue(ua)):(i.debug("Buffering message for plugin %s",ta),k.get(ta).enqueue(ua))}}function ra(ta){if(!ja){var ua=g.appendHidden(document.createElement("div")),va=r.create({blacklist:null,root:ua,channel:ga,flashUrl:q.Flash.path,whenReady:function(wa){ia=wa;var xa={channel:ga,origin:location.protocol+"//"+location.host,transport:va,xd_name:ta},ya="#"+j.encode(xa);m.getSecure()!==!0&&(z=t({url:ea+ya,name:"fb_xdm_frame_http",id:"fb_xdm_frame_http",root:ua,"aria-hidden":!0,title:ka,tabindex:-1})),aa=t({url:fa+ya,name:"fb_xdm_frame_https",id:"fb_xdm_frame_https",root:ua,"aria-hidden":!0,title:ka,tabindex:-1})},onMessage:pa});va||n.log("jssdk_error",{appId:m.getClientID(),error:"XD_TRANSPORT",extra:{message:"Failed to create a valid transport"}}),ja=!0}}var z,aa,ia,w=new k,x=new k,y=new k,ba=v(),ca=q.useCdn?"cdn":"www",da=u("use_bundle",!1)?q.XdBundleUrl:q.XdUrl,ea=p.resolve(ca,!1)+da,fa=p.resolve(ca,!0)+da,ga=v(),ha=location.protocol+"//"+location.host,ja=!1,ka="Facebook Cross Domain Communication Frame",la={},ma=new k;l.setInQueue(ma),l.getOutQueue().start(function(ta){qa("facebook","FB_RPC:"+ta)});var sa={rpc:l,_callbacks:{},_forever:{},_channel:ga,_origin:ha,onMessage:pa,recv:pa,init:ra,sendToFacebook:qa,inform:function(ta,ua,va,wa){qa("facebook",{method:ta,params:ES("JSON","stringify",!1,ua||{}),behavior:wa||"p",relation:va})},handler:function(ta,ua,va,wa){var xa="#"+j.encode({cb:this.registerCallback(ta,va,wa),origin:ha+"/"+ga,domain:location.hostname,relation:ua||"opener"});return("https:"==location.protocol?fa:ea)+xa},registerCallback:function(ta,ua,va){return va=va||v(),ua&&(sa._forever[va]=!0),sa._callbacks[va]=ta,va}};h.subscribe("init:post",function(ta){ra(ta.xdProxyName);var ua=u("xd_timeout",!1);ua&&setTimeout(function(){var va=aa&&!!z==x.isStarted()&&!!aa==y.isStarted();va||n.log("jssdk_error",{appId:m.getClientID(),error:"XD_INITIALIZATION",extra:{message:"Failed to initialize in "+ua+"ms"}})},ua)}),e.exports=sa},null),__d("sdk.Auth",["sdk.Cookie","sdk.createIframe","DOMWrapper","sdk.feature","sdk.getContextType","guid","sdk.Impressions","Log","ObservableMixin","sdk.Runtime","sdk.SignedRequest","UrlMap","sdk.URI","sdk.XD"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t){function x(da,ea){var fa=p.getUserID(),ga="";if(da)if(da.userID)ga=da.userID;else if(da.signedRequest){var ha=q.parse(da.signedRequest);ha&&ha.user_id&&(ga=ha.user_id)}var ia=p.getLoginStatus(),ja="unknown"===ia&&da||p.getUseCookie()&&p.getCookieUserID()!==ga,ka=fa&&!da,la=da&&fa&&fa!=ga,ma=da!=u,na=ea!=(ia||"unknown");p.setLoginStatus(ea),p.setAccessToken(da&&da.accessToken||null),p.setUserID(ga),u=da;var oa={authResponse:da,status:ea};return(ka||la)&&w.inform("logout",oa),(ja||la)&&w.inform("login",oa),ma&&w.inform("authresponse.change",oa),na&&w.inform("status.change",oa),oa}function y(){return u}function z(da,ea,fa){return function(ga){var ha;if(ga&&ga.access_token){var ia=q.parse(ga.signed_request);if(ea={accessToken:ga.access_token,userID:ia.user_id,expiresIn:parseInt(ga.expires_in,10),signedRequest:ga.signed_request},ga.granted_scopes&&(ea.grantedScopes=ga.granted_scopes),p.getUseCookie()){var ja=0===ea.expiresIn?0:ES("Date","now",!1)+1e3*ea.expiresIn,ka=g.getDomain();!ka&&ga.base_domain&&g.setDomain("."+ga.base_domain),g.setSignedRequestCookie(ga.signed_request,ja)}ha="connected",x(ea,ha)}else("logout"===fa||"login_status"===fa)&&(ha=ga.error&&"not_authorized"===ga.error?"not_authorized":"unknown",x(null,ha),p.getUseCookie()&&g.clearSignedRequestCookie());return ga&&1==ga.https&&p.setSecure(!0),da&&da({authResponse:ea,status:p.getLoginStatus()}),ea}}function aa(da){var ea,fa=ES("Date","now",!1);v&&(clearTimeout(v),v=null);var ga=z(da,u,"login_status"),ha=s(r.resolve("www",!0)+"/connect/ping").setQueryData({client_id:p.getClientID(),response_type:"token,signed_request,code",domain:location.hostname,origin:k(),redirect_uri:t.handler(function(ia){if(j("e2e_ping_tracking",!0)){var ja={init:fa,close:ES("Date","now",!1),method:"ping"};n.debug("e2e: %s",ES("JSON","stringify",!1,ja)),m.log(114,{payload:ja})}ea.parentNode.removeChild(ea),ga(ia)&&(v=setTimeout(function(){aa(function(){})},12e5))},"parent"),sdk:"joey",kid_directed_site:p.getKidDirectedSite()});ea=h({root:i.getRoot(),name:l(),url:ha.toString(),style:{display:"none"}})}function ca(da,ea){if(!p.getClientID())return void n.warn("FB.getLoginStatus() called before calling FB.init().");if(da){if(!ea&&"loaded"==ba)return void da({status:p.getLoginStatus(),authResponse:y()});w.subscribe("FB.loginStatus",da)}if(ea||"loading"!=ba){ba="loading";var fa=function(ga){ba="loaded",w.inform("FB.loginStatus",ga),w.clearSubscribers("FB.loginStatus")};aa(fa)}}var u,v,ba,w=new o;ES("Object","assign",!1,w,{getLoginStatus:ca,fetchLoginStatus:aa,setAuthResponse:x,getAuthResponse:y,parseSignedRequest:q.parse,xdResponseWrapper:z}),e.exports=w},null),__d("toArray",["invariant"],function(a,b,c,d,e,f,g){function h(i){var j=i.length;if(g(!ES("Array","isArray",!1,i)&&("object"==typeof i||"function"==typeof i)),g("number"==typeof j),g(0===j||j-1 in i),i.hasOwnProperty)try{return Array.prototype.slice.call(i)}catch(k){}for(var l=Array(j),m=0;j>m;m++)l[m]=i[m];return l}e.exports=h},null),__d("createArrayFromMixed",["toArray"],function(a,b,c,d,e,f,g){function h(j){return!!j&&("object"==typeof j||"function"==typeof j)&&"length"in j&&!("setInterval"in j)&&"number"!=typeof j.nodeType&&(ES("Array","isArray",!1,j)||"callee"in j||"item"in j)}function i(j){return h(j)?ES("Array","isArray",!1,j)?j.slice():g(j):[j]}e.exports=i},null),__d("sdk.DOM",["Assert","sdk.UA","createArrayFromMixed","sdk.domReady"],function(a,b,c,d,e,f,g,h,i,j){function l(z,aa){var ba=z.getAttribute(aa)||z.getAttribute(aa.replace(/_/g,"-"))||z.getAttribute(aa.replace(/-/g,"_"))||z.getAttribute(aa.replace(/-/g,""))||z.getAttribute(aa.replace(/_/g,""))||z.getAttribute("data-"+aa)||z.getAttribute("data-"+aa.replace(/_/g,"-"))||z.getAttribute("data-"+aa.replace(/-/g,"_"))||z.getAttribute("data-"+aa.replace(/-/g,""))||z.getAttribute("data-"+aa.replace(/_/g,""));return ba?String(ba):null}function m(z,aa){var ba=l(z,aa);return ba?/^(true|1|yes|on)$/.test(ba):null}function n(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa);try{return String(z[aa])}catch(ba){throw new Error("Could not read property "+aa+" : "+ba.message)}}function o(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa);try{z.innerHTML=aa}catch(ba){throw new Error("Could not set innerHTML : "+ba.message)}}function p(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa);var ba=" "+n(z,"className")+" ";return ES(ba,"indexOf",!0," "+aa+" ")>=0}function q(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa),p(z,aa)||(z.className=n(z,"className")+" "+aa)}function r(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa);var ba=new RegExp("\\s*"+aa,"g");z.className=ES(n(z,"className").replace(ba,""),"trim",!0)}function s(z,aa,ba){if(g.isString(z),aa=aa||document.body,ba=ba||"*",aa.querySelectorAll)return i(aa.querySelectorAll(ba+"."+z));for(var ca=aa.getElementsByTagName(ba),da=[],ea=0,fa=ca.length;fa>ea;ea++)p(ca[ea],z)&&(da[da.length]=ca[ea]);return da}function t(z,aa){g.isTruthy(z,"element not specified"),g.isString(aa),aa=aa.replace(/-(\w)/g,function(da,ea){return ea.toUpperCase()});var ba=z.currentStyle||document.defaultView.getComputedStyle(z,null),ca=ba[aa];return/backgroundPosition?/.test(aa)&&/top|left/.test(ca)&&(ca="0%"),ca}function u(z,aa,ba){g.isTruthy(z,"element not specified"),g.isString(aa),aa=aa.replace(/-(\w)/g,function(ca,da){return da.toUpperCase()}),z.style[aa]=ba}function v(z,aa){for(var da,ba=!0,ca=0;da=aa[ca++];)da in k||(ba=!1,k[da]=!0);if(!ba)if(h.ie()<11)try{document.createStyleSheet().cssText=z}catch(ea){document.styleSheets[0]&&(document.styleSheets[0].cssText+=z)}else{var fa=document.createElement("style");fa.type="text/css",fa.textContent=z,document.getElementsByTagName("head")[0].appendChild(fa)}}function w(){var z=document.documentElement&&"CSS1Compat"==document.compatMode?document.documentElement:document.body;return{scrollTop:z.scrollTop||document.body.scrollTop,scrollLeft:z.scrollLeft||document.body.scrollLeft,width:window.innerWidth?window.innerWidth:z.clientWidth,height:window.innerHeight?window.innerHeight:z.clientHeight}}function x(z){g.isTruthy(z,"element not specified");var aa=0,ba=0;do aa+=z.offsetLeft,ba+=z.offsetTop;while(z=z.offsetParent);return{x:aa,y:ba}}var k={},y={containsCss:p,addCss:q,removeCss:r,getByClass:s,getStyle:t,setStyle:u,getAttr:l,getBoolAttr:m,getProp:n,html:o,addCssRules:v,getViewportInfo:w,getPosition:x,ready:j};e.exports=y},null),__d("sdk.ErrorHandling",["ManagedError","sdk.Runtime","sdk.Scribe","sdk.UA","sdk.feature","wrapFunction"],function(a,b,c,d,e,f,g,h,i,j,k,l){function o(u){var v=u._originalError;throw delete u._originalError,i.log("jssdk_error",{appId:h.getClientID(),error:u.name||u.message,extra:u}),v}function p(u){var v={line:u.lineNumber||u.line,message:u.message,name:u.name,script:u.fileName||u.sourceURL||u.script,stack:u.stackTrace||u.stack};v._originalError=u,j.chrome()&&/([\w:\.\/]+\.js):(\d+)/.test(u.stack)&&(v.script=RegExp.$1,v.line=parseInt(RegExp.$2,10));for(var w in v)null==v[w]&&delete v[w];return v}function q(u,v){return function(){if(!m)return u.apply(this,arguments);try{return n=v,u.apply(this,arguments)}catch(w){if(w instanceof g)throw w;var x=p(w);x.entry=v;var y=ES(Array.prototype.slice.call(arguments),"map",!0,function(z){var aa=Object.prototype.toString.call(z);return/^\[object (String|Number|Boolean|Object|Date)\]$/.test(aa)?z:z.toString()});x.args=ES("JSON","stringify",!1,y).substring(0,200),o(x)}finally{n=""}}}function r(u){return u.__wrapper||(u.__wrapper=function(){try{return u.apply(this,arguments)}catch(v){return window.setTimeout(function(){throw v},0),!1}}),u.__wrapper}function s(u,v){return function(w,x){var y=v+":"+(n||"[global]")+":"+(w.name||"[anonymous]"+(arguments.callee.caller.name?"("+arguments.callee.caller.name+")":""));return u(l(w,"entry",y),x)}}var m=k("error_handling",!1),n="";m&&(setTimeout=s(setTimeout,"setTimeout"),setInterval=s(setInterval,"setInterval"),l.setWrapper(q,"entry"));var t={guard:q,unguard:r};e.exports=t},null),__d("sdk.Insights",["sdk.Impressions"],function(a,b,c,d,e,f,g){var h={TYPE:{NOTICE:"notice",WARNING:"warn",ERROR:"error"},CATEGORY:{DEPRECATED:"deprecated",APIERROR:"apierror"},log:function(i,j,k){var l={source:"jssdk",type:i,category:j,payload:k};g.log(113,l)},impression:g.impression};e.exports=h},null),__d("FB",["sdk.Auth","JSSDKCssConfig","dotAccess","sdk.domReady","sdk.DOM","sdk.ErrorHandling","sdk.Content","DOMWrapper","GlobalCallback","sdk.Insights","Log","sdk.Runtime","sdk.Scribe","JSSDKConfig"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t){function aa(ca,da,ea,fa){var ga;switch(/^_/.test(ea)?ga="hide":v&&!v[da]&&(ga=w),ga){case"hide":return;case"stub":return function(){q.warn("The method FB.%s has been removed from the JS SDK.",da)};default:return l.guard(function(){function ha(oa){return ES("Array","isArray",!1,oa)?ES(oa,"map",!0,ha):oa&&"object"==typeof oa&&oa.__wrapped?oa.__wrapped:"function"==typeof oa&&/^function/.test(oa.toString())?l.unguard(oa):oa}"warn"===ga&&(q.warn("The method FB.%s is not officially supported by Facebook and access to it will soon be removed.",da),x.hasOwnProperty(da)||(p.log(p.TYPE.WARNING,p.CATEGORY.DEPRECATED,"FB."+da),s.log("jssdk_error",{appId:r.getClientID(),error:"Private method used",extra:{args:da}}),x[da]=!0));var ka,ia=ES(Array.prototype.slice.call(arguments),"map",!0,ha),ja=ca.apply(fa,ia),la=!0;if(ja&&"object"==typeof ja){ka=ES("Object","create",!1,ja),ka.__wrapped=ja;for(var ma in ja){var na=ja[ma];"function"==typeof na&&"constructor"!==ma&&(la=!1,ka[ma]=aa(na,da+":"+ma,ma,ja))}}return la&&la?ja:ka},da)}}function ba(ca,da){var ea=ca?i(u,ca,!0):u;ES(ES("Object","keys",!1,da),"forEach",!0,function(fa){var ga=da[fa];if("function"==typeof ga){var ha=(ca?ca+".":"")+fa,ia=aa(ga,ha,fa,da);ia&&(ea[fa]=ia)}else"object"==typeof ga&&(ha=(ca?ca+".":"")+fa,v&&v[ha]&&(ea[fa]=ga))})}var u,v,w=i(t,"api.mode"),x={};u=window.FB={};var y={};q.level=1,o.setPrefix("FB.__globalCallbacks");var z=document.createElement("div");n.setRoot(z),j(function(){q.info("domReady"),m.appendHidden(z),h.rules&&k.addCssRules(h.rules,h.components)}),r.subscribe("AccessToken.change",function(ca){ca||"connected"!==r.getLoginStatus()||g.getLoginStatus(null,!0)}),i(t,"api.whitelist.length")&&(v={},ES(t.api.whitelist,"forEach",!0,function(ca){v[ca]=1})),r.setSecure(function(){var ca=/iframe_canvas|app_runner/.test(window.name),da=/dialog/.test(window.name);return"https:"!=location.protocol||window!=top&&(ca||da)?/_fb_https?/.test(window.name)?-1!=ES(window.name,"indexOf",!0,"_fb_https"):void 0:!0}()),ES("Object","assign",!1,y,{provide:ba}),e.exports=y},null),__d("ArgumentError",["ManagedError"],function(a,b,c,d,e,f,g){function h(){g.prototype.constructor.apply(this,arguments)}h.prototype=new g,h.prototype.constructor=h,e.exports=h},null),__d("CORSRequest",["wrapFunction","QueryString"],function(a,b,c,d,e,f,g,h){function i(l,m){if(!self.XMLHttpRequest)return null;var n=new XMLHttpRequest,o=function(){};if("withCredentials"in n)n.open(l,m,!0),n.setRequestHeader("Content-type","application/x-www-form-urlencoded");else{if(!self.XDomainRequest)return null;n=new XDomainRequest;try{n.open(l,m),n.onprogress=n.ontimeout=o}catch(p){return null}}var q={send:function(t){n.send(t)}},r=g(function(){r=o,"onload"in q&&q.onload(n)},"entry","XMLHttpRequest:load"),s=g(function(){s=o,"onerror"in q&&q.onerror(n)},"entry","XMLHttpRequest:error");return n.onload=function(){r()},n.onerror=function(){s()},n.onreadystatechange=function(){4==n.readyState&&(200==n.status?r():s())},q}function j(l,m,n,o){n.suppress_http_code=1;var p=h.encode(n);"post"!=m&&(l=h.appendToUrl(l,p),p="");var q=i(m,l);return q?(q.onload=function(r){o(ES("JSON","parse",!1,r.responseText))},q.onerror=function(r){o(r.responseText?ES("JSON","parse",!1,r.responseText):{error:{type:"http",message:"unknown error",status:r.status}})},q.send(p),!0):!1}var k={execute:j};e.exports=k},null),__d("FlashRequest",["DOMWrapper","Flash","GlobalCallback","QueryString","Queue"],function(a,b,c,d,e,f,g,h,i,j,k){function p(){if(!n)throw new Error("swfUrl has not been set");var s=i.create(function(){l.start(function(u){var v=o.execute(u.method,u.url,u.body);if(!v)throw new Error("Could create request");m[v]=u.callback})}),t=i.create(function(u,v,w){var x;try{x=ES("JSON","parse",!1,decodeURIComponent(w))}catch(y){x={error:{type:"SyntaxError",message:y.message,status:v,raw:w}}}m[u](x),delete m[u]});o=h.embed(n,g.getRoot(),null,{log:!1,initCallback:s,requestCallback:t})}function q(s,t,u,v){u.suppress_http_code=1,u.method||(u.method=t);var w=j.encode(u);if("get"===t&&s.length+w.length<2e3?(s=j.appendToUrl(s,w),w=""):t="post",!l){if(!h.isAvailable())return!1;l=new k,p()}return l.enqueue({method:t,url:s,body:w,callback:v}),!0}var l,n,o,m={},r={setSwfUrl:function(s){n=s},execute:q};e.exports=r},null),__d("flattenObject",[],function(a,b,c,d,e){function g(h){var i={};for(var j in h)if(h.hasOwnProperty(j)){var k=h[j];if(null===k||void 0===k)continue;i[j]="string"==typeof k?k:ES("JSON","stringify",!1,k)}return i}e.exports=g},null),__d("JSONPRequest",["DOMWrapper","GlobalCallback","QueryString"],function(a,b,c,d,e,f,g,h,i){function j(l,m,n,o){var p=document.createElement("script"),q=function(s){q=function(){},h.remove(n.callback),o(s),p.parentNode.removeChild(p)};if(n.callback=h.create(q),n.method||(n.method=m),l=i.appendToUrl(l,n),l.length>2e3)return h.remove(n.callback),!1;p.onerror=function(){q({error:{type:"http",message:"unknown error"}})};var r=function(){setTimeout(function(){q({error:{type:"http",message:"unknown error"}})},0)};return p.addEventListener?p.addEventListener("load",r,!1):p.onreadystatechange=function(){/loaded|complete/.test(this.readyState)&&r()},p.src=l,g.getRoot().appendChild(p),!0}var k={execute:j};e.exports=k},null),__d("ApiClient",["ArgumentError","Assert","CORSRequest","FlashRequest","flattenObject","JSONPRequest","Log","ObservableMixin","QueryString","sprintf","sdk.URI","UrlMap","ApiClientConfig","invariant"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t){function ea(ma,na,oa,pa){w&&(oa=ES("Object","assign",!1,{},w,oa)),oa.access_token=oa.access_token||u,oa.pretty=oa.pretty||0,oa=k(oa);var ra,qa={jsonp:l,cors:i,flash:j};oa.transport?(ra=[oa.transport],delete oa.transport):ra=["jsonp","cors","flash"];for(var sa=0;sa<ra.length;sa++){var ta=qa[ra[sa]],ua=ES("Object","assign",!1,{},oa);if(ta.execute(ma,na,ua,pa))return}pa({error:{type:"no-transport",message:"Could not find a usable transport for request"}})}function fa(ma,na,oa,pa,qa,ra){ra&&ra.error&&la.inform("request.error",na,oa,pa,ra,ES("Date","now",!1)-qa),la.inform("request.complete",na,oa,pa,ra,ES("Date","now",!1)-qa),ma&&ma(ra)}function ga(ma){var na=ma.shift();h.isString(na,"Invalid path"),/^https?/.test(na)||"/"===na.charAt(0)||(na="/"+na);var oa,pa={};try{oa=new q(na)}catch(qa){throw new g(qa.message,qa)}ES(ma,"forEach",!0,function(ua){return pa[typeof ua]=ua});var ra=(pa.string||"get").toLowerCase();h.isTrue(x.hasOwnProperty(ra),p("Invalid method passed to ApiClient: %s",ra));var sa=pa["function"];sa||m.warn("No callback passed to the ApiClient"),pa.object&&oa.addQueryData(k(pa.object));var ta=oa.getQueryData();return ta.method=ra,{uri:oa,callback:sa,params:ta}}function ha(){for(var ma=[],na=0,oa=arguments.length;oa>na;na++)ma.push(arguments[na]);var pa=ga(ma),qa=pa.uri,ra=pa.callback,sa=pa.params,ta=sa.method,ua=qa.getProtocol()&&qa.getDomain()?qa.setQueryData({}).toString():r.resolve("graph")+qa.getPath();la.inform("request.prepare",ua,sa),ea(ua,"get"==ta?"get":"post",sa,ES(fa,"bind",!0,null,ra,qa.getPath(),ta,sa,ES("Date","now",!1)))}function ia(){for(var ma=[],na=0,oa=arguments.length;oa>na;na++)ma.push(arguments[na]);var pa=ga(ma),qa=pa.uri,ra=pa.callback,sa=pa.params,ta=sa.method,ua={method:ta,relative_url:qa.removeQueryData("method").toString()};"post"==ta.toLowerCase()&&(ua.body=o.encode(qa.getQueryData()),ua.relative_url=qa.setQueryData({}).toString()),z.push(ua),aa.push(ra),z.length==ca?(ba&&clearTimeout(ba),ja()):ba||(ba=setTimeout(ja,0))}function ja(){t(z.length>0),t(z.length===aa.length);var ma=z,na=aa;if(z=[],aa=[],ba=null,1===ma.length){var oa=ma[0],pa=na[0],qa=oa.body?o.decode(oa.body):null;return void ha(oa.relative_url,oa.method,qa,pa)}ha("/","POST",{batch:ma,include_headers:!1,batch_app_id:v||da},function(ra){ES("Array","isArray",!1,ra)?ES(ra,"forEach",!0,function(sa,ta){na[ta](ES("JSON","parse",!1,sa.body))}):ES(na,"forEach",!0,function(sa){return sa({error:{message:"Fatal: batch call failed."}})})})}function ka(ma,na){h.isObject(ma),h.isString(ma.method,"method missing"),na||m.warn("No callback passed to the ApiClient");var oa=ma.method.toLowerCase().replace(".","_");ma.format="json-strings",ma.api_key=v;var pa=oa in y?"api_read":"api",qa=r.resolve(pa)+"/restserver.php",ra=ES(fa,"bind",!0,null,na,"/restserver.php","get",ma,ES("Date","now",!1));ea(qa,"get",ma,ra)}var u,v,w,x={get:!0,post:!0,"delete":!0,put:!0},y={fql_query:!0,fql_multiquery:!0,friends_get:!0,notifications_get:!0,stream_get:!0,users_getinfo:!0},z=[],aa=[],ba=null,ca=50,da=105440539523,la=ES("Object","assign",!1,new n,{setAccessToken:function(ma){u=ma},setClientID:function(ma){v=ma},setDefaultParams:function(ma){w=ma},rest:ka,graph:ha,scheduleBatchCall:ia});j.setSwfUrl(s.FlashRequest.swfUrl),e.exports=la},null),__d("sdk.PlatformVersioning",["sdk.Runtime","ManagedError"],function(a,b,c,d,e,f,g,h){var i=/^v\d+\.\d\d?$/,j={REGEX:i,assertVersionIsSet:function(){if(!g.getVersion())throw new h("init not called with valid version")},assertValidVersion:function(k){if(!i.test(k))throw new h("invalid version specified")}};e.exports=j},null),__d("sdk.api",["ApiClient","sdk.PlatformVersioning","sdk.Runtime","sdk.Scribe","sdk.URI","sdk.feature"],function(a,b,c,d,e,f,g,h,i,j,k,l){function o(p){if("string"==typeof p)if(i.getIsVersioned()){h.assertVersionIsSet(),/https?/.test(p)||"/"===p.charAt(0)||(p="/"+p),p=k(p).setDomain(null).setProtocol(null).toString(),h.REGEX.test(p.substring(1,ES(p,"indexOf",!0,"/",1)))||(p="/"+i.getVersion()+p);var q=[p].concat(Array.prototype.slice.call(arguments,1));g.graph.apply(g,q)}else g.graph.apply(g,arguments);else g.rest.apply(g,arguments)}var n,m=l("should_log_response_error",!1);i.subscribe("ClientID.change",function(p){return g.setClientID(p)}),i.subscribe("AccessToken.change",function(p){n=p,g.setAccessToken(p)}),g.setDefaultParams({sdk:"joey"}),g.subscribe("request.complete",function(p,q,r,s){var t=!1;s&&"object"==typeof s&&(s.error?("invalid_token"==s.error||"OAuthException"==s.error.type&&190==s.error.code)&&(t=!0):s.error_code&&"190"==s.error_code&&(t=!0)),t&&n===i.getAccessToken()&&i.setAccessToken(null)}),g.subscribe("request.complete",function(p,q,r,s){("/me/permissions"==p&&"delete"===q||"/restserver.php"==p&&"Auth.revokeAuthorization"==r.method)&&s===!0&&i.setAccessToken(null)}),g.subscribe("request.error",function(p,q,r,s){m&&"http"===s.error.type&&j.log("jssdk_error",{appId:i.getClientID(),error:"transport",extra:{name:"transport",message:ES("JSON","stringify",!1,s.error)}})}),e.exports=o},null),__d("legacy:fb.api",["FB","sdk.api"],function(a,b,c,d,e,f,g,h){g.provide("",{api:h})},3),__d("merge",[],function(a,b,c,d,e){"use strict";var g=function(h,i){return ES("Object","assign",!1,{},h,i)};e.exports=g},null),__d("sdk.AppEvents",["Assert","sdk.Impressions","merge","sdk.Runtime"],function(a,b,c,d,e,f,g,h,i,j){function p(t,u,v,w){g.isTrue(q(u),"Invalid event name: "+u+". It must be between 1 and "+n+" characters, and must be contain only alphanumerics, _, - or spaces, starting with alphanumeric or _.");var x={ae:1,ev:u,vts:v,canvas:j.isCanvasEnvironment()?1:0};w&&(x.cd=w),h.impression({api_key:t,payload:ES("JSON","stringify",!1,x)})}function q(t){return null===t||0===t.length||t.length>n||!new RegExp(o).test(t)?!1:!0}function r(t,u,v,w){var x={};x[m.CURRENCY]=v,p(t,l.PURCHASED,u,i(w,x))}function s(t){p(t,l.ACTIVATED_APP)}var k={COMPLETED_REGISTRATION:"fb_mobile_complete_registration",VIEWED_CONTENT:"fb_mobile_content_view",SEARCHED:"fb_mobile_search",RATED:"fb_mobile_rate",COMPLETED_TUTORIAL:"fb_mobile_tutorial_completion",ADDED_TO_CART:"fb_mobile_add_to_cart",ADDED_TO_WISHLIST:"fb_mobile_add_to_wishlist",INITIATED_CHECKOUT:"fb_mobile_initiated_checkout",ADDED_PAYMENT_INFO:"fb_mobile_add_payment_info",ACHIEVED_LEVEL:"fb_mobile_level_achieved",UNLOCKED_ACHIEVEMENT:"fb_mobile_achievement_unlocked",SPENT_CREDITS:"fb_mobile_spent_credits"},l={ACTIVATED_APP:"fb_mobile_activate_app",PURCHASED:"fb_mobile_purchase"},m={CURRENCY:"fb_currency",REGISTRATION_METHOD:"fb_registration_method",CONTENT_TYPE:"fb_content_type",CONTENT_ID:"fb_content_id",SEARCH_STRING:"fb_search_string",SUCCESS:"fb_success",MAX_RATING_VALUE:"fb_max_rating_value",PAYMENT_INFO_AVAILABLE:"fb_payment_info_available",NUM_ITEMS:"fb_num_items",LEVEL:"fb_level",DESCRIPTION:"fb_description"},n=40,o="^[0-9a-zA-Z_]+[0-9a-zA-Z _-]*$";e.exports={activateApp:s,logEvent:p,logPurchase:r,isValidEventName:q,EventNames:k,ParameterNames:m}},null),__d("legacy:fb.appevents",["Assert","sdk.AppEvents","FB","sdk.feature","sdk.Runtime"],function(a,b,c,d,e,f,g,h,i,j,k){i.provide("AppEvents",{logEvent:function(l,m,n){g.isTrue(j("allow_non_canvas_app_events",!1)||k.isCanvasEnvironment(),"You can only use this function in Facebook Canvas environment"),g.isString(l,"Invalid eventName"),g.maybeNumber(m,"Invalid valueToSum"),g.maybeObject(n,"Invalid params");var o=k.getClientID();g.isTrue(null!==o&&o.length>0,"You need to call FB.init() with App ID first."),h.logEvent(o,l,m,n)},logPurchase:function(l,m,n){g.isTrue(j("allow_non_canvas_app_events",!1)||k.isCanvasEnvironment(),"You can only use this function in Facebook Canvas environment"),g.isNumber(l,"Invalid purchaseAmount"),g.isString(m,"Invalid currency"),g.maybeObject(n,"Invalid params");var o=k.getClientID();g.isTrue(null!==o&&o.length>0,"You need to call FB.init() with App ID first."),h.logPurchase(o,l,m,n)},activateApp:function(){g.isTrue(j("allow_non_canvas_app_events",!1)||k.isCanvasEnvironment(),"You can only use this function in Facebook Canvas environment");var l=k.getClientID();g.isTrue(null!==l&&l.length>0,"You need to call FB.init() with App ID first."),h.activateApp(l)},EventNames:h.EventNames,ParameterNames:h.ParameterNames})},3),__d("sdk.Canvas.Environment",["sdk.RPC"],function(a,b,c,d,e,f,g){function h(k){g.remote.getPageInfo(function(l){k(l.result)})}function i(k,l){g.remote.scrollTo({x:k||0,y:l||0})
}g.stub("getPageInfo"),g.stub("scrollTo");var j={getPageInfo:h,scrollTo:i};e.exports=j},null),__d("sdk.fbt",[],function(a,b,c,d,e){var g={_:function(h){return"string"==typeof h?h:h[0]}};e.exports=g},null),__d("sdk.Dialog",["sdk.Canvas.Environment","sdk.Content","sdk.DOM","DOMEventListener","ObservableMixin","sdk.Runtime","Type","sdk.UA","sdk.fbt","sdk.feature"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){function v(){if(p("dialog_resize_refactor",!1)){var y=i.getViewportInfo();if(y.height&&y.width)return{width:Math.min(y.width,q),height:Math.min(y.height,r)}}return null}var q=590,r=500,s=240,t=575,u=function(){var y;if(p("dialog_resize_refactor",!1)){var z=v();y=z&&(z.height>=q||z.width>=r)}else y=!!n.ipad();return u=function(){return y},y},w=m.extend({constructor:function(z,aa){this.parent(),this.id=z,this.display=aa,this._e2e={},x._dialogs||(x._dialogs={},x._addOrientationHandler()),x._dialogs[z]=this,this.trackEvent("init")},trackEvent:function(y,z){return this._e2e[y]?this:(this._e2e[y]=z||ES("Date","now",!1),"close"==y&&this.inform("e2e:end",this._e2e),this)},trackEvents:function(y){"string"==typeof y&&(y=ES("JSON","parse",!1,y));for(var z in y)y.hasOwnProperty(z)&&this.trackEvent(z,y[z]);return this}},k),x={newInstance:function(y,z){return new w(y,z)},_dialogs:null,_lastYOffset:0,_loaderEl:null,_overlayEl:null,_stack:[],_active:null,get:function(y){return x._dialogs[y]},_findRoot:function(y){for(;y;){if(i.containsCss(y,"fb_dialog"))return y;y=y.parentNode}},_createWWWLoader:function(y){return y=y?y:460,x.create({content:'<div class="dialog_title">  <a id="fb_dialog_loader_close">    <div class="fb_dialog_close_icon"></div>  </a>  <span>Facebook</span>  <div style="clear:both;"></div></div><div class="dialog_content"></div><div class="dialog_footer"></div>',width:y})},_createMobileLoader:function(){var y=n.nativeApp()?"":'<table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="Cancel"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         Loading...        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table>';return x.create({classes:"loading"+(u()?" centered":""),content:'<div class="dialog_header">'+y+"</div>"})},_restoreBodyPosition:function(){if(!u()){var y=document.getElementsByTagName("body")[0];i.removeCss(y,"fb_hidden")}},_showTabletOverlay:function(){u()&&(x._overlayEl||(x._overlayEl=document.createElement("div"),x._overlayEl.setAttribute("id","fb_dialog_ipad_overlay"),h.append(x._overlayEl,null)),x._overlayEl.className="")},_hideTabletOverlay:function(){u()&&(x._overlayEl.className="hidden")},showLoader:function(y,z){x._showTabletOverlay(),x._loaderEl||(x._loaderEl=x._findRoot(n.mobile()?x._createMobileLoader():x._createWWWLoader(z))),y||(y=function(){});var aa=document.getElementById("fb_dialog_loader_close");i.removeCss(aa,"fb_hidden"),aa.onclick=function(){x._hideLoader(),x._restoreBodyPosition(),x._hideTabletOverlay(),y()};var ba=document.getElementById("fb_dialog_ipad_overlay");ba&&(ba.ontouchstart=aa.onclick),x._makeActive(x._loaderEl)},_hideLoader:function(){x._loaderEl&&x._loaderEl==x._active&&(x._loaderEl.style.top="-10000px")},_makeActive:function(y){x._setDialogSizes(),x._lowerActive(),x._active=y,l.isEnvironment(l.ENVIRONMENTS.CANVAS)&&g.getPageInfo(function(z){x._centerActive(z)}),x._centerActive()},_lowerActive:function(){x._active&&(x._active.style.top="-10000px",x._active=null)},_removeStacked:function(y){x._stack=ES(x._stack,"filter",!0,function(z){return z!=y})},_centerActive:function(y){var z=x._active;if(z){var aa=i.getViewportInfo(),ba=parseInt(z.offsetWidth,10),ca=parseInt(z.offsetHeight,10),da=aa.scrollLeft+(aa.width-ba)/2,ea=(aa.height-ca)/2.5;ea>da&&(ea=da);var fa=aa.height-ca-ea,ga=(aa.height-ca)/2;if(y&&(ga=y.scrollTop-y.offsetTop+(y.clientHeight-ca)/2),ea>ga?ga=ea:ga>fa&&(ga=fa),ga+=aa.scrollTop,n.mobile()){var ha=100;if(u())ha+=(aa.height-ca)/2;else{var ia=document.getElementsByTagName("body")[0];i.addCss(ia,"fb_hidden"),p("dialog_resize_refactor",!1)&&(ia.style.width="auto"),ga=1e4}var ja=i.getByClass("fb_dialog_padding",z);ja.length&&(ja[0].style.height=ha+"px")}z.style.left=(da>0?da:0)+"px",z.style.top=(ga>0?ga:0)+"px"}},_setDialogSizes:function(){if(n.mobile()&&!u())for(var y in x._dialogs)if(x._dialogs.hasOwnProperty(y)){var z=document.getElementById(y);z&&(z.style.width=x.getDefaultSize().width+"px",z.style.height=x.getDefaultSize().height+"px")}},getDefaultSize:function(){if(n.mobile()){var y=v();if(y)return y;if(n.ipad())return{width:r,height:q};if(n.android())return{width:screen.availWidth,height:screen.availHeight};var z=window.innerWidth,aa=window.innerHeight,ba=z/aa>1.2;return{width:z,height:Math.max(aa,ba?screen.width:screen.height)}}return{width:t,height:s}},_handleOrientationChange:function(){var z=p("dialog_resize_refactor",!1)?i.getViewportInfo().width:screen.availWidth;if(n.android()&&z==x._availScreenWidth)return void setTimeout(x._handleOrientationChange,50);if(x._availScreenWidth=z,u())x._centerActive();else{var aa=x.getDefaultSize().width;for(var ba in x._dialogs)if(x._dialogs.hasOwnProperty(ba)){var ca=document.getElementById(ba);ca&&(ca.style.width=aa+"px")}}},_addOrientationHandler:function(){if(n.mobile()){var y="onorientationchange"in window?"orientationchange":"resize";x._availScreenWidth=p("dialog_resize_refactor",!1)?i.getViewportInfo().width:screen.availWidth,j.add(window,y,x._handleOrientationChange)}},create:function(y){y=y||{};var z=document.createElement("div"),aa=document.createElement("div"),ba="fb_dialog";if(y.closeIcon&&y.onClose){var ca=document.createElement("a");ca.className="fb_dialog_close_icon",ca.onclick=y.onClose,z.appendChild(ca)}ba+=" "+(y.classes||""),n.ie()?(ba+=" fb_dialog_legacy",ES(["vert_left","vert_right","horiz_top","horiz_bottom","top_left","top_right","bottom_left","bottom_right"],"forEach",!0,function(fa){var ga=document.createElement("span");ga.className="fb_dialog_"+fa,z.appendChild(ga)})):ba+=n.mobile()?" fb_dialog_mobile":" fb_dialog_advanced",y.content&&h.append(y.content,aa),z.className=ba;var da=parseInt(y.width,10);if(isNaN(da)||(z.style.width=da+"px"),aa.className="fb_dialog_content",z.appendChild(aa),n.mobile()){var ea=document.createElement("div");ea.className="fb_dialog_padding",z.appendChild(ea)}return h.append(z),y.visible&&x.show(z),aa},show:function(y){var z=x._findRoot(y);z&&(x._removeStacked(z),x._hideLoader(),x._makeActive(z),x._stack.push(z),"fbCallID"in y&&x.get(y.fbCallID).inform("iframe_show").trackEvent("show"))},hide:function(y){var z=x._findRoot(y);x._hideLoader(),z==x._active&&(x._lowerActive(),x._restoreBodyPosition(),x._hideTabletOverlay(),"fbCallID"in y&&x.get(y.fbCallID).inform("iframe_hide").trackEvent("hide"))},remove:function(y){if(y=x._findRoot(y)){var z=x._active==y;x._removeStacked(y),z?(x._hideLoader(),x._stack.length>0?x.show(x._stack.pop()):(x._lowerActive(),x._restoreBodyPosition(),x._hideTabletOverlay())):null===x._active&&x._stack.length>0&&x.show(x._stack.pop()),setTimeout(function(){y.parentNode.removeChild(y)},3e3)}},isActive:function(y){var z=x._findRoot(y);return z&&z===x._active}};e.exports=x},null),__d("sdk.Frictionless",["sdk.Auth","sdk.api","sdk.Event","sdk.Dialog"],function(a,b,c,d,e,f,g,h,i,j){var k={_allowedRecipients:{},_useFrictionless:!1,_updateRecipients:function(){k._allowedRecipients={},h("/me/apprequestformerrecipients",function(l){l&&!l.error&&ES(l.data,"forEach",!0,function(m){k._allowedRecipients[m.recipient_id]=!0})})},init:function(){k._useFrictionless=!0,g.getLoginStatus(function(l){"connected"==l.status&&k._updateRecipients()}),i.subscribe("auth.login",function(l){l.authResponse&&k._updateRecipients()})},_processRequestResponse:function(l,m){return function(n){var o=n&&n.updated_frictionless;k._useFrictionless&&o&&k._updateRecipients(),n&&(!m&&n.frictionless&&(j._hideLoader(),j._restoreBodyPosition(),j._hideIPadOverlay()),delete n.frictionless,delete n.updated_frictionless),l&&l(n)}},isAllowed:function(l){if(!l)return!1;if("number"==typeof l)return l in k._allowedRecipients;"string"==typeof l&&(l=l.split(",")),l=ES(l,"map",!0,function(o){return ES(String(o),"trim",!0)});var m=!0,n=!1;return ES(l,"forEach",!0,function(o){m=m&&o in k._allowedRecipients,n=!0}),m&&n}};i.subscribe("init:post",function(l){l.frictionlessRequests&&k.init()}),e.exports=k},null),__d("sdk.Native",["Log","sdk.UA"],function(a,b,c,d,e,f,g,h){var i="fbNativeReady",j={onready:function(k){if(!h.nativeApp())return void g.error("FB.Native.onready only works when the page is rendered in a WebView of the native Facebook app. Test if this is the case calling FB.UA.nativeApp()");if(window.__fbNative&&!this.nativeReady&&ES("Object","assign",!1,this,window.__fbNative),this.nativeReady)k();else{var l=function(){window.removeEventListener(i,l),this.onready(k)};window.addEventListener(i,l,!1)}}};e.exports=j},null),__d("resolveURI",[],function(a,b,c,d,e){function g(h){if(!h)return window.location.href;h=h.replace(/&/g,"&amp;").replace(/"/g,"&quot;");var i=document.createElement("div");return i.innerHTML='<a href="'+h+'"></a>',i.firstChild.href}e.exports=g},null),__d("sdk.UIServer",["sdk.Auth","sdk.Content","sdk.DOM","sdk.Dialog","sdk.Event","sdk.Frictionless","Log","sdk.Native","QueryString","sdk.RPC","sdk.Runtime","JSSDKConfig","sdk.UA","UrlMap","sdk.XD","createObjectFrom","sdk.feature","flattenObject","sdk.getContextType","guid","insertIframe","resolveURI"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ba){function fa(ia,ja){return ea[ja]=!0,function(ka){delete ea[ja],ia(ka)}}function ga(ia){if(!w("should_force_single_dialog_instance",!0))return!1;var ja=ia.method.toLowerCase();return"pay"===ja&&"async"===ia.display?!0:!1}var ca={transform:function(ia){return"touch"===ia.params.display&&ia.params.access_token&&window.postMessage?(ia.params.channel=ha._xdChannelHandler(ia.id,"parent"),s.nativeApp()||(ia.params.in_iframe=1),ia):ha.genericTransform(ia)},getXdRelation:function(ia){var ja=ia.display;return"touch"===ja&&window.postMessage&&ia.in_iframe?"parent":ha.getXdRelation(ia)}},da={"stream.share":{size:{width:670,height:340},url:"sharer.php",transform:function(ia){return ia.params.u||(ia.params.u=window.location.toString()),ia.params.display="popup",ia}},apprequests:{transform:function(ia){return ia=ca.transform(ia),ia.params.frictionless=l&&l._useFrictionless,ia.params.frictionless&&(l.isAllowed(ia.params.to)&&(ia.params.display="iframe",ia.params.in_iframe=!0,ia.hideLoader=!0),ia.cb=l._processRequestResponse(ia.cb,ia.hideLoader)),ia.closeIcon=!1,ia},getXdRelation:ca.getXdRelation},feed:ca,"permissions.oauth":{url:"dialog/oauth",size:{width:s.mobile()?null:475,height:s.mobile()?null:183},transform:function(ia){if(!q.getClientID())return void m.error("FB.login() called before FB.init().");if(g.getAuthResponse()&&!ia.params.scope&&!ia.params.auth_type)return m.error("FB.login() called when user is already connected."),void(ia.cb&&ia.cb({status:q.getLoginStatus(),authResponse:g.getAuthResponse()}));var ja=ia.cb,ka=ia.id;delete ia.cb;var la=ES("Object","keys",!1,ES("Object","assign",!1,ia.params.response_type?v(ia.params.response_type.split(",")):{},{token:!0,signed_request:!0})).join(",");return"async"===ia.params.display?(ES("Object","assign",!1,ia.params,{client_id:q.getClientID(),origin:y(),response_type:la,domain:location.hostname}),ia.cb=g.xdResponseWrapper(ja,g.getAuthResponse(),"permissions.oauth")):ES("Object","assign",!1,ia.params,{client_id:q.getClientID(),redirect_uri:ba(ha.xdHandler(ja,ka,"opener",g.getAuthResponse(),"permissions.oauth")),origin:y(),response_type:la,domain:location.hostname}),ia}},"auth.logout":{url:"logout.php",transform:function(ia){if(q.getClientID()){if(g.getAuthResponse())return ia.params.next=ha.xdHandler(ia.cb,ia.id,"parent",g.getAuthResponse(),"logout"),ia;m.error("FB.logout() called without an access token.")}else m.error("FB.logout() called before calling FB.init().")}},"login.status":{url:"dialog/oauth",transform:function(ia){var ja=ia.cb,ka=ia.id;return delete ia.cb,ES("Object","assign",!1,ia.params,{client_id:q.getClientID(),redirect_uri:ha.xdHandler(ja,ka,"parent",g.getAuthResponse(),"login_status"),origin:y(),response_type:"token,signed_request,code",domain:location.hostname}),ia}},pay:{size:{width:555,height:120},connectDisplay:"popup"}},ea={},ha={Methods:da,_loadedNodes:{},_defaultCb:{},_resultToken:'"xxRESULTTOKENxx"',genericTransform:function(ia){return("dialog"==ia.params.display||"iframe"==ia.params.display)&&ES("Object","assign",!1,ia.params,{display:"iframe",channel:ha._xdChannelHandler(ia.id,"parent.parent")},!0),ia},checkOauthDisplay:function(ia){var ja=ia.scope||ia.perms||q.getScope();if(!ja)return ia.display;for(var ka=ja.split(/\s|,/g),la=0;la<ka.length;la++)if(!r.initSitevars.iframePermissions[ES(ka[la],"trim",!0)])return"popup";return ia.display},prepareCall:function(ia,ja){var ka=ia.method.toLowerCase(),la=ha.Methods.hasOwnProperty(ka)?ES("Object","assign",!1,{},ha.Methods[ka]):{},ma=z(),na=q.getSecure()||"auth.status"!==ka&&"login.status"!=ka;if(ES("Object","assign",!1,ia,{app_id:q.getClientID(),locale:q.getLocale(),sdk:"joey",access_token:na&&q.getAccessToken()||void 0}),ia.display=ha.getDisplayMode(la,ia),la.url||(la.url="dialog/"+ka),"dialog/oauth"!=la.url&&"dialog/permissions.request"!=la.url||!("iframe"==ia.display||"touch"==ia.display&&ia.in_iframe)||(ia.display=ha.checkOauthDisplay(ia)),"popup"==ia.display&&delete ia.access_token,q.getIsVersioned()&&"dialog/"===la.url.substring(0,7)&&(la.url=ia.version+"/"+la.url),ga(ia)){if(ea[ka]){var oa='Dialog "'+ka+'" is trying to run more than once.';return m.warn(oa),void ja({error_code:-100,error_message:oa})}ja=fa(ja,ka)}var pa={cb:ja,id:ma,size:la.size||ha.getDefaultSize(),url:t.resolve("touch"==ia.display?"m":"www",na)+"/"+la.url,params:ia,name:ka,dialog:j.newInstance(ma,ia.display)},qa=la.transform?la.transform:ha.genericTransform;if(!qa||(pa=qa(pa))){"touch"===ia.display&&ia.in_iframe&&(pa.params.parent_height=window.innerHeight);var ra=la.getXdRelation||ha.getXdRelation,sa=ra(pa.params);return pa.id in ha._defaultCb||"next"in pa.params||"redirect_uri"in pa.params||(pa.params.next=ha._xdResult(pa.cb,pa.id,sa,!0)),"parent"===sa&&ES("Object","assign",!1,pa.params,{channel_url:ha._xdChannelHandler(ma,"parent.parent")},!0),pa=ha.prepareParams(pa)}},prepareParams:function(ia){"async"!==ia.params.display&&delete ia.params.method,ia.params=x(ia.params);var ja=o.encode(ia.params);return!s.nativeApp()&&ha.urlTooLongForIE(ia.url+"?"+ja)?ia.post=!0:ja&&(ia.url+="?"+ja),ia},urlTooLongForIE:function(ia){return ia.length>2e3},getDisplayMode:function(ia,ja){if("hidden"===ja.display||"none"===ja.display)return ja.display;var ka=q.isEnvironment(q.ENVIRONMENTS.CANVAS)||q.isEnvironment(q.ENVIRONMENTS.PAGETAB);return ka&&!ja.display?"async":s.mobile()||"touch"===ja.display?"touch":q.getAccessToken()||"iframe"!=ja.display&&"dialog"!=ja.display||ia.loggedOutIframe?ia.connectDisplay&&!ka?ia.connectDisplay:ja.display||(q.getAccessToken()?"dialog":"popup"):(m.error('"dialog" mode can only be used when the user is connected.'),"popup")},getXdRelation:function(ia){var ja=ia.display;return"popup"===ja||"touch"===ja?"opener":"dialog"===ja||"iframe"===ja||"hidden"===ja||"none"===ja?"parent":"async"===ja?"parent.frames["+window.name+"]":void 0},popup:function(ia){var ja="undefined"!=typeof window.screenX?window.screenX:window.screenLeft,ka="undefined"!=typeof window.screenY?window.screenY:window.screenTop,la="undefined"!=typeof window.outerWidth?window.outerWidth:document.documentElement.clientWidth,ma="undefined"!=typeof window.outerHeight?window.outerHeight:document.documentElement.clientHeight-22,na=s.mobile()?null:ia.size.width,oa=s.mobile()?null:ia.size.height,pa=0>ja?window.screen.width+ja:ja,qa=parseInt(pa+(la-na)/2,10),ra=parseInt(ka+(ma-oa)/2.5,10),sa=[];null!==na&&sa.push("width="+na),null!==oa&&sa.push("height="+oa),sa.push("left="+qa),sa.push("top="+ra),sa.push("scrollbars=1"),("permissions.request"==ia.name||"permissions.oauth"==ia.name)&&sa.push("location=1,toolbar=0"),sa=sa.join(",");var ta;ia.post?(ta=window.open("about:blank",ia.id,sa),ta&&(ha.setLoadedNode(ia,ta,"popup"),h.submitToTarget({url:ia.url,target:ia.id,params:ia.params}))):(ta=window.open(ia.url,ia.id,sa),ta&&ha.setLoadedNode(ia,ta,"popup")),ta&&ia.id in ha._defaultCb&&ha._popupMonitor()},setLoadedNode:function(ia,ja,ka){ia.params&&"popup"!=ia.params.display&&(ja.fbCallID=ia.id),ja={node:ja,type:ka,fbCallID:ia.id},ha._loadedNodes[ia.id]=ja},getLoadedNode:function(ia){var ja="object"==typeof ia?ia.id:ia,ka=ha._loadedNodes[ja];return ka?ka.node:null},hidden:function(ia){ia.className="FB_UI_Hidden",ia.root=h.appendHidden(""),ha._insertIframe(ia)},iframe:function(ia){ia.className="FB_UI_Dialog";var ja=function(){ha._triggerDefault(ia.id)};ia.root=j.create({onClose:ja,closeIcon:void 0===ia.closeIcon?!0:ia.closeIcon,classes:s.ipad()?"centered":""}),ia.hideLoader||j.showLoader(ja,ia.size.width),i.addCss(ia.root,"fb_dialog_iframe"),ha._insertIframe(ia)},touch:function(ia){ia.params&&ia.params.in_iframe?ia.ui_created?j.showLoader(function(){ha._triggerDefault(ia.id)},0):ha.iframe(ia):s.nativeApp()&&!ia.ui_created?(ia.frame=ia.id,n.onready(function(){ha.setLoadedNode(ia,n.open(ia.url+"#cb="+ia.frameName),"native")}),ha._popupMonitor()):ia.ui_created||ha.popup(ia)},async:function(ia){ia.params.redirect_uri=location.protocol+"//"+location.host+location.pathname,delete ia.params.access_token,p.remote.showDialog(ia.params,function(ja){var ka=ja.result;if(ka&&ka.e2e){var la=j.get(ia.id);la.trackEvents(ka.e2e),la.trackEvent("close"),delete ka.e2e}ia.cb(ka)})},getDefaultSize:function(){return j.getDefaultSize()},_insertIframe:function(ia){ha._loadedNodes[ia.id]=!1;var ja=function(ka){ia.id in ha._loadedNodes&&ha.setLoadedNode(ia,ka,"iframe")};aa(ia.post?{url:"about:blank",root:ia.root,className:ia.className,width:ia.size.width,height:ia.size.height,id:ia.id,onInsert:ja,onload:function(ka){h.submitToTarget({url:ia.url,target:ka.name,params:ia.params})}}:{url:ia.url,root:ia.root,className:ia.className,width:ia.size.width,height:ia.size.height,id:ia.id,name:ia.frameName,onInsert:ja})},_handleResizeMessage:function(ia,ja){var ka=ha.getLoadedNode(ia);ka&&(ja.height&&(ka.style.height=ja.height+"px"),ja.width&&(ka.style.width=ja.width+"px"),u.inform("resize.ack",ja||{},"parent.frames["+ka.name+"]"),j.isActive(ka)||j.show(ka))},_triggerDefault:function(ia){ha._xdRecv({frame:ia},ha._defaultCb[ia]||function(){})},_popupMonitor:function(){var ia;for(var ja in ha._loadedNodes)if(ha._loadedNodes.hasOwnProperty(ja)&&ja in ha._defaultCb){var ka=ha._loadedNodes[ja];if("popup"!=ka.type&&"native"!=ka.type)continue;var la=ka.node;try{la.closed?ha._triggerDefault(ja):ia=!0}catch(ma){}}ia&&!ha._popupInterval?ha._popupInterval=setInterval(ha._popupMonitor,100):!ia&&ha._popupInterval&&(clearInterval(ha._popupInterval),ha._popupInterval=null)},_xdChannelHandler:function(ia,ja){return u.handler(function(ka){var la=ha.getLoadedNode(ia);if(la)if("resize"==ka.type)ha._handleResizeMessage(ia,ka);else if("hide"==ka.type)j.hide(la);else if("rendered"==ka.type){var ma=j._findRoot(la);j.show(ma)}else"fireevent"==ka.type&&k.fire(ka.event)},ja,!0,null)},_xdNextHandler:function(ia,ja,ka,la){return la&&(ha._defaultCb[ja]=ia),u.handler(function(ma){ha._xdRecv(ma,ia)},ka)+"&frame="+ja},_xdRecv:function(ia,ja){var ka=ha.getLoadedNode(ia.frame);if(ka)if(ka.close)try{ka.close(),/iPhone.*Version\/(5|6)/.test(navigator.userAgent)&&"5"!==RegExp.$1&&window.focus(),ha._popupCount--}catch(la){}else i.containsCss(ka,"FB_UI_Hidden")?setTimeout(function(){ka.parentNode.parentNode.removeChild(ka.parentNode)},3e3):i.containsCss(ka,"FB_UI_Dialog")&&j.remove(ka);if(delete ha._loadedNodes[ia.frame],delete ha._defaultCb[ia.frame],ia.e2e){var ma=j.get(ia.frame);ma.trackEvents(ia.e2e),ma.trackEvent("close"),delete ia.e2e}ja(ia)},_xdResult:function(ia,ja,ka,la){return ha._xdNextHandler(function(ma){ia&&ia(ma.result&&ma.result!=ha._resultToken&&ES("JSON","parse",!1,ma.result))},ja,ka,la)+"&result="+encodeURIComponent(ha._resultToken)},xdHandler:function(ia,ja,ka,la,ma){return ha._xdNextHandler(g.xdResponseWrapper(ia,la,ma),ja,ka,!0)}};p.stub("showDialog"),e.exports=ha},null),__d("sdk.ui",["Assert","sdk.Impressions","Log","sdk.PlatformVersioning","sdk.Runtime","sdk.UIServer","sdk.feature"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){function n(o,p){if(g.isObject(o),g.maybeFunction(p),k.getIsVersioned()&&(j.assertVersionIsSet(),o.version?j.assertValidVersion(o.version):o.version=k.getVersion()),o=ES("Object","assign",!1,{},o),!o.method)return i.error('"method" is a required parameter for FB.ui().'),null;"pay.prompt"==o.method&&(o.method="pay");var q=o.method;o.redirect_uri&&(i.warn("When using FB.ui, you should not specify a redirect_uri."),delete o.redirect_uri),"permissions.request"!=q&&"permissions.oauth"!=q||"iframe"!=o.display&&"dialog"!=o.display||(o.display=l.checkOauthDisplay(o));var r=m("e2e_tracking",!0);r&&(o.e2e={});var s=l.prepareCall(o,p||function(){});if(!s)return null;var t=s.params.display;"dialog"===t?t="iframe":"none"===t&&(t="hidden");var u=l[t];return u?(r&&s.dialog.subscribe("e2e:end",function(v){v.method=q,v.display=t,i.debug("e2e: %s",ES("JSON","stringify",!1,v)),h.log(114,{payload:v})}),u(s),s.dialog):(i.error('"display" must be one of "popup", "dialog", "iframe", "touch", "async", "hidden", or "none"'),null)}e.exports=n},null),__d("legacy:fb.auth",["sdk.Auth","sdk.Cookie","copyProperties","sdk.Event","FB","Log","sdk.Runtime","sdk.SignedRequest","sdk.ui"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o){k.provide("",{getLoginStatus:function(){return g.getLoginStatus.apply(g,arguments)},getAuthResponse:function(){return g.getAuthResponse()},getAccessToken:function(){return m.getAccessToken()||null},getUserID:function(){return m.getUserID()||m.getCookieUserID()},login:function(p,q){q&&q.perms&&!q.scope&&(q.scope=q.perms,delete q.perms,l.warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));var r=m.isEnvironment(m.ENVIRONMENTS.CANVAS)||m.isEnvironment(m.ENVIRONMENTS.PAGETAB);o(i({method:"permissions.oauth",display:r?"async":"popup",domain:location.hostname},q||{}),p)},logout:function(p){o({method:"auth.logout",display:"hidden"},p)}}),g.subscribe("logout",ES(j.fire,"bind",!0,j,"auth.logout")),g.subscribe("login",ES(j.fire,"bind",!0,j,"auth.login")),g.subscribe("authresponse.change",ES(j.fire,"bind",!0,j,"auth.authResponseChange")),g.subscribe("status.change",ES(j.fire,"bind",!0,j,"auth.statusChange")),j.subscribe("init:post",function(p){if(p.status&&g.getLoginStatus(),m.getClientID())if(p.authResponse)g.setAuthResponse(p.authResponse,"connected");else if(m.getUseCookie()){var r,q=h.loadSignedRequest();if(q){try{r=n.parse(q)}catch(s){h.clearSignedRequestCookie()}r&&r.user_id&&m.setCookieUserID(r.user_id)}h.loadMeta()}})},3),__d("sdk.Canvas.IframeHandling",["DOMWrapper","sdk.RPC"],function(a,b,c,d,e,f,g,h){function k(){var o=g.getWindow().document,p=o.body,q=o.documentElement,r=Math.max(p.offsetTop,0),s=Math.max(q.offsetTop,0),t=p.scrollHeight+r,u=p.offsetHeight+r,v=q.scrollHeight+s,w=q.offsetHeight+s;return Math.max(t,u,v,w)}function l(o){"object"!=typeof o&&(o={});var p=0,q=0;if(o.height||(o.height=k(),p=16,q=4),o.frame||(o.frame=window.name||"iframe_canvas"),j){var r=j.height,s=o.height-r;if(q>=s&&s>=-p)return!1}return j=o,h.remote.setSize(o),!0}function m(o,p){void 0===p&&"number"==typeof o&&(p=o,o=!0),o||void 0===o?(null===i&&(i=setInterval(function(){l()},p||100)),l()):null!==i&&(clearInterval(i),i=null)}var j,i=null;h.stub("setSize");var n={setSize:l,setAutoGrow:m};e.exports=n},null),__d("sdk.Canvas.Navigation",["sdk.RPC"],function(a,b,c,d,e,f,g){function h(j){g.local.navigate=function(k){j({path:k})},g.remote.setNavigationEnabled(!0)}g.stub("setNavigationEnabled");var i={setUrlHandler:h};e.exports=i},null),__d("sdk.Canvas.Plugin",["Log","sdk.RPC","sdk.Runtime","sdk.UA","sdk.api","createArrayFromMixed"],function(a,b,c,d,e,f,g,h,i,j,k,l){function r(ba){ba._hideunity_savedstyle={},ba._hideunity_savedstyle.left=ba.style.left,ba._hideunity_savedstyle.position=ba.style.position,ba._hideunity_savedstyle.width=ba.style.width,ba._hideunity_savedstyle.height=ba.style.height,ba.style.left="-10000px",ba.style.position="absolute",ba.style.width="1px",ba.style.height="1px"}function s(ba){ba._hideunity_savedstyle&&(ba.style.left=ba._hideunity_savedstyle.left,ba.style.position=ba._hideunity_savedstyle.position,ba.style.width=ba._hideunity_savedstyle.width,ba.style.height=ba._hideunity_savedstyle.height)}function t(ba){ba._old_visibility=ba.style.visibility,ba.style.visibility="hidden"}function u(ba){ba.style.visibility=ba._old_visibility||"",delete ba._old_visibility}function v(ba){var ca=ba.type?ba.type.toLowerCase():null,da="application/x-shockwave-flash"===ca||ba.classid&&ba.classid.toUpperCase()==m;if(!da)return!1;var ea=/opaque|transparent/i;if(ea.test(ba.getAttribute("wmode")))return!1;for(var fa=0;fa<ba.childNodes.length;fa++){var ga=ba.childNodes[fa];if(/param/i.test(ga.nodeName)&&/wmode/i.test(ga.name)&&ea.test(ga.value))return!1}return!0}function w(ba){var ca=ba.type?ba.type.toLowerCase():null;return"application/vnd.unity"===ca||ba.classid&&ba.classid.toUpperCase()==n}function x(ba){var ca=l(window.document.getElementsByTagName("object"));ca=ca.concat(l(window.document.getElementsByTagName("embed")));var da=!1,ea=!1;if(ES(ca,"forEach",!0,function(ga){var ha=v(ga),ia=q&&w(ga);if(ha||ia){da=da||ha,ea=ea||ia;var ja=function(){"opened"===ba.state?ha?t(ga):r(ga):ha?u(ga):s(ga)};if(o){g.info("Calling developer specified callback");var ka={state:ba.state,elem:ga};o(ka),setTimeout(ja,200)}else ja()}}),Math.random()<=.001){var fa={unity:ea,flash:da};k(i.getClientID()+"/occludespopups","post",fa)}}function y(){t(),r()}function z(){u(),s()}var m="CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000",n="CLSID:444785F1-DE89-4295-863A-D46C3A781394",o=null,p=j.osx()&&j.osx.getVersionParts(),q=!(p&&p[0]>10&&p[1]>10&&(j.chrome()>=31||j.webkit()>=537.71||j.firefox()>=25));h.local.hidePluginObjects=function(){g.info("hidePluginObjects called"),x({state:"opened"})},h.local.showPluginObjects=function(){g.info("showPluginObjects called"),x({state:"closed"})},h.local.showFlashObjects=h.local.showPluginObjects,h.local.hideFlashObjects=h.local.hidePluginObjects;var aa={_setHidePluginCallback:function(ba){o=ba},hidePluginElement:y,showPluginElement:z};e.exports=aa},null),__d("sdk.Canvas.Tti",["sdk.RPC","sdk.Runtime"],function(a,b,c,d,e,f,g,h){function i(n,o){var p={appId:h.getClientID(),time:ES("Date","now",!1),name:o},q=[p];n&&q.push(function(r){n(r.result)}),g.remote.logTtiMessage.apply(null,q)}function j(){i(null,"StartIframeAppTtiTimer")}function k(n){i(n,"StopIframeAppTtiTimer")}function l(n){i(n,"RecordIframeAppTti")}g.stub("logTtiMessage");var m={setDoneLoading:l,startTimer:j,stopTimer:k};e.exports=m},null),__d("legacy:fb.canvas",["Assert","sdk.Canvas.Environment","sdk.Event","FB","sdk.Canvas.IframeHandling","sdk.Canvas.Navigation","sdk.Canvas.Plugin","sdk.RPC","sdk.Runtime","sdk.Canvas.Tti"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){j.provide("Canvas",{setSize:function(q){return g.maybeObject(q,"Invalid argument"),k.setSize.apply(null,arguments)},setAutoGrow:function(){return k.setAutoGrow.apply(null,arguments)},getPageInfo:function(q){return g.isFunction(q,"Invalid argument"),h.getPageInfo.apply(null,arguments)},scrollTo:function(q,r){return g.maybeNumber(q,"Invalid argument"),g.maybeNumber(r,"Invalid argument"),h.scrollTo.apply(null,arguments)},setDoneLoading:function(q){return g.maybeFunction(q,"Invalid argument"),p.setDoneLoading.apply(null,arguments)},startTimer:function(){return p.startTimer.apply(null,arguments)},stopTimer:function(q){return g.maybeFunction(q,"Invalid argument"),p.stopTimer.apply(null,arguments)},getHash:function(q){return g.isFunction(q,"Invalid argument"),l.getHash.apply(null,arguments)},setHash:function(q){return g.isString(q,"Invalid argument"),l.setHash.apply(null,arguments)},setUrlHandler:function(q){return g.isFunction(q,"Invalid argument"),l.setUrlHandler.apply(null,arguments)}}),n.local.fireEvent=ES(i.fire,"bind",!0,i),i.subscribe("init:post",function(q){o.isEnvironment(o.ENVIRONMENTS.CANVAS)&&(g.isTrue(!q.hideFlashCallback||!q.hidePluginCallback,"cannot specify deprecated hideFlashCallback and new hidePluginCallback"),m._setHidePluginCallback(q.hidePluginCallback||q.hideFlashCallback))})},3),__d("legacy:fb.canvas.syncrequests",["sdk.RPC","sdk.Event"],function(a,b,c,d,e,f,g,h){function i(j){"canvas.syncRequestUpdated"==j&&(g.remote.initPendingSyncRequests(),h.unsubscribe(h.SUBSCRIBE,i))}g.stub("initPendingSyncRequests"),h.subscribe(h.SUBSCRIBE,i)},3),__d("sdk.Canvas.Prefetcher",["sdk.api","createArrayFromMixed","JSSDKCanvasPrefetcherConfig","sdk.Runtime"],function(a,b,c,d,e,f,g,h,i,j){function p(){var u={object:"data",link:"href",script:"src"};n==k.AUTOMATIC&&ES(ES("Object","keys",!1,u),"forEach",!0,function(v){var w=u[v];ES(h(document.getElementsByTagName(v)),"forEach",!0,function(x){x[w]&&o.push(x[w])})}),0!==o.length&&(g(j.getClientID()+"/staticresources","post",{urls:ES("JSON","stringify",!1,o),is_https:"https:"===location.protocol}),o=[])}function q(){j.isEnvironment(j.ENVIRONMENTS.CANVAS)&&j.getClientID()&&l&&(Math.random()>1/l||"*"==m||~ES(m,"indexOf",!0,j.getClientID())||setTimeout(p,3e4))}function r(u){n=u}function s(u){o.push(u)}var k={AUTOMATIC:0,MANUAL:1},l=i.sampleRate,m=i.blacklist,n=k.AUTOMATIC,o=[],t={COLLECT_AUTOMATIC:k.AUTOMATIC,COLLECT_MANUAL:k.MANUAL,addStaticResource:s,setCollectionMode:r,_maybeSample:q};e.exports=t},null),__d("legacy:fb.canvas.prefetcher",["FB","sdk.Canvas.Prefetcher","sdk.Event","sdk.Runtime"],function(a,b,c,d,e,f,g,h,i,j){g.provide("Canvas.Prefetcher",h),i.subscribe("init:post",function(){j.isEnvironment(j.ENVIRONMENTS.CANVAS)&&h._maybeSample()})},3),__d("legacy:fb.canvas.presence",["sdk.RPC","sdk.Event"],function(a,b,c,d,e,f,g,h){function i(k,l){"canvas.friendsOnlineUpdated"==k&&1===l.length&&g.remote.useFriendsOnline(!0)}function j(k,l){"canvas.friendsOnlineUpdated"==k&&0===l.length&&g.remote.useFriendsOnline(!1)}h.subscribe(h.SUBSCRIBE,i),h.subscribe(h.UNSUBSCRIBE,j),g.stub("useFriendsOnline")},3),__d("legacy:fb.event",["FB","sdk.Event","sdk.Runtime","sdk.Scribe","sdk.feature"],function(a,b,c,d,e,f,g,h,i,j,k){var l=[],m=null,n=k("event_subscriptions_log",!1);g.provide("Event",{subscribe:function(o,p){return n&&(l.push(o),m||(m=setTimeout(function(){j.log("jssdk_error",{appId:i.getClientID(),error:"EVENT_SUBSCRIPTIONS_LOG",extra:{line:0,name:"EVENT_SUBSCRIPTIONS_LOG",script:"N/A",stack:"N/A",message:l.sort().join(",")}}),l.length=0,m=null},n))),h.subscribe(o,p)},unsubscribe:ES(h.unsubscribe,"bind",!0,h)})},3),__d("legacy:fb.frictionless",["FB","sdk.Frictionless"],function(a,b,c,d,e,f,g,h){g.provide("Frictionless",h)},3),__d("sdk.init",["sdk.Cookie","sdk.ErrorHandling","sdk.Event","Log","ManagedError","sdk.PlatformVersioning","QueryString","sdk.Runtime","sdk.URI","createArrayFromMixed"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){function q(s){var t="number"==typeof s&&s>0||"string"==typeof s&&/^[0-9a-f]{21,}$|^[0-9]{1,21}$/.test(s);return t?s.toString():(j.warn("Invalid App Id: Must be a number or numeric string representing the application id."),null)}function r(s){if(n.getInitialized()&&j.warn("FB.init has already been called - this could indicate a problem"),n.getIsVersioned()){if("[object Object]"!==Object.prototype.toString.call(s))throw new k("Invalid argument");s.authResponse&&j.warn("Setting authResponse is not supported"),s.version||(s.version=o(location.href).getQueryData().sdk_version),l.assertValidVersion(s.version),n.setVersion(s.version)}else/number|string/.test(typeof s)&&(j.warn("FB.init called with invalid parameters"),s={apiKey:s}),s=ES("Object","assign",!1,{status:!0},s||{});
var t=q(s.appId||s.apiKey);null!==t&&n.setClientID(t),"scope"in s&&n.setScope(s.scope),s.cookie&&(n.setUseCookie(!0),"string"==typeof s.cookie&&g.setDomain(s.cookie)),s.kidDirectedSite&&n.setKidDirectedSite(!0),n.setInitialized(!0),i.fire("init:post",s)}setTimeout(function(){var s=/(connect\.facebook\.net|\.facebook\.com\/assets.php).*?#(.*)/;ES(p(document.getElementsByTagName("script")),"forEach",!0,function(t){if(t.src){var u=s.exec(t.src);if(u){var v=m.decode(u[2]);for(var w in v)if(v.hasOwnProperty(w)){var x=v[w];"0"==x&&(v[w]=0)}r(v)}}}),window.fbAsyncInit&&!window.fbAsyncInit.hasRun&&(window.fbAsyncInit.hasRun=!0,h.unguard(window.fbAsyncInit)())},0),e.exports=r},null),__d("legacy:fb.init",["FB","sdk.init"],function(a,b,c,d,e,f,g,h){g.provide("",{init:h})},3),__d("legacy:fb.ui",["FB","sdk.ui"],function(a,b,c,d,e,f,g,h){g.provide("",{ui:h})},3),__d("runOnce",[],function(a,b,c,d,e){function g(h){var i,j;return function(){return i||(i=!0,j=h()),j}}e.exports=g},null),__d("XFBML",["Assert","sdk.DOM","Log","ObservableMixin","sdk.UA","createArrayFromMixed","runOnce"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){function r(y,z){return y[z]+""}function s(y){return y.scopeName?y.scopeName+":"+y.nodeName:""}function t(y){return n[r(y,"nodeName").toLowerCase()]||n[s(y).toLowerCase()]}function u(y){var z=ES(ES(r(y,"className"),"trim",!0).split(/\s+/),"filter",!0,function(aa){return o.hasOwnProperty(aa)});return 0===z.length?void 0:y.getAttribute("fb-xfbml-state")||!y.childNodes||0===y.childNodes.length||1===y.childNodes.length&&3===y.childNodes[0].nodeType||1===y.children.length&&"fb-xfbml-parse-ignore"===r(y.children[0],"className")?o[z[0]]:void 0}function v(y){var z={};return ES(l(y.attributes),"forEach",!0,function(aa){z[r(aa,"name")]=r(aa,"value")}),z}function w(y,z,aa){var ba=document.createElement("div");return h.addCss(y,z+"-"+aa),ES(l(y.childNodes),"forEach",!0,function(ca){ba.appendChild(ca)}),ES(l(y.attributes),"forEach",!0,function(ca){ba.setAttribute(ca.name,ca.value)}),y.parentNode.replaceChild(ba,y),ba}function x(y,z,aa){g.isTrue(y&&y.nodeType&&1===y.nodeType&&!!y.getElementsByTagName,"Invalid DOM node passed to FB.XFBML.parse()"),g.isFunction(z,"Invalid callback passed to FB.XFBML.parse()");var ba=++p;i.info("XFBML Parsing Start %s",ba);var ca=1,da=0,ea=function(){ca--,0===ca&&(i.info("XFBML Parsing Finish %s, %s tags found",ba,da),z(),q.inform("render",ba,da)),g.isTrue(ca>=0,"onrender() has been called too many times")};ES(l(y.getElementsByTagName("*")),"forEach",!0,function(ga){if((aa||!ga.getAttribute("fb-xfbml-state"))&&1===ga.nodeType){var ha=t(ga)||u(ga);if(ha){k.ie()<9&&ga.scopeName&&(ga=w(ga,ha.xmlns,ha.localName)),ca++,da++;var ia=new ha.ctor(ga,ha.xmlns,ha.localName,v(ga));ia.subscribe("render",m(function(){ga.setAttribute("fb-xfbml-state","rendered"),ea()}));var ja=function(){"parsed"==ga.getAttribute("fb-xfbml-state")?q.subscribe("render.queue",ja):(ga.setAttribute("fb-xfbml-state","parsed"),ia.process())};ja()}}}),q.inform("parse",ba,da);var fa=3e4;setTimeout(function(){ca>0&&i.warn("%s tags failed to render in %s ms",ca,fa)},fa),ea()}var n={},o={},p=0,q=new j;q.subscribe("render",function(){var y=q.getSubscribers("render.queue");q.clearSubscribers("render.queue"),ES(y,"forEach",!0,function(z){z()})}),ES("Object","assign",!1,q,{registerTag:function(y){var z=y.xmlns+":"+y.localName;g.isUndefined(n[z],z+" already registered"),n[z]=y,o[y.xmlns+"-"+y.localName]=y},parse:function(y,z){x(y||document.body,z||function(){},!0)},parseNew:function(){x(document.body,function(){},!1)}}),e.exports=q},null),__d("PluginPipe",["sdk.Content","sdk.feature","guid","insertIframe","Miny","ObservableMixin","JSSDKPluginPipeConfig","sdk.Runtime","sdk.UA","UrlMap","XFBML"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q){function u(){return!(!h("plugin_pipe",!1)||void 0===n.getSecure()||!o.chrome()&&!o.firefox()||!m.enabledApps[n.getClientID()])}function v(){function z(){y--,0===y&&w(x)}var x=t;if(t=[],x.length<=s)return void ES(x,"forEach",!0,function(aa){j(aa.config)});var y=x.length+1;ES(x,"forEach",!0,function(aa){var ba={};for(var ca in aa.config)ba[ca]=aa.config[ca];ba.url=p.resolve("www",n.getSecure())+"/plugins/plugin_pipe_shell.php",ba.onload=z,j(ba)}),z()}function w(x){var y=document.createElement("span");g.appendHidden(y);var z={};ES(x,"forEach",!0,function(ea){z[ea.config.name]={plugin:ea.tag,params:ea.params}});var aa=ES("JSON","stringify",!1,z),ba=k.encode(aa);ES(x,"forEach",!0,function(ea){var fa=document.getElementsByName(ea.config.name)[0];fa.onload=ea.config.onload});var ca=p.resolve("www",n.getSecure())+"/plugins/pipe.php",da=i();j({url:"about:blank",root:y,name:da,className:"fb_hidden fb_invisible",onload:function(){g.submitToTarget({url:ca,target:da,params:{plugins:ba.length<aa.length?ba:aa}})}})}var r=new l,s=m.threshold,t=[];q.subscribe("parse",v),ES("Object","assign",!1,r,{add:function(x){var y=u();return y&&t.push({config:x._config,tag:x._tag,params:x._params}),y}}),e.exports=r},null),__d("IframePlugin",["sdk.Auth","sdk.DOM","sdk.Event","Log","ObservableMixin","sdk.PlatformVersioning","PluginPipe","QueryString","sdk.Runtime","Type","sdk.UA","sdk.URI","UrlMap","sdk.XD","sdk.createIframe","sdk.feature","guid","resolveURI"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x){function z(ha,ia,ja){(ia||0===ia)&&(ha.style.width=ia+"px"),(ja||0===ja)&&(ha.style.height=ja+"px")}function aa(ha){return function(ia){var ja={width:ia.width,height:ia.height,pluginID:ha};i.fire("xfbml.resize",ja)}}function ca(ha,ia){var ja=ha[ia]||ha[ia.replace(/_/g,"-")]||ha[ia.replace(/_/g,"")]||ha["data-"+ia]||ha["data-"+ia.replace(/_/g,"-")]||ha["data-"+ia.replace(/_/g,"")]||void 0;return ja}function da(ha,ia,ja,ka){ES(ES("Object","keys",!1,ha),"forEach",!0,function(la){"text"!=ha[la]||ja[la]||(ja[la]=ia.textContent||ia.innerText||"",ia.setAttribute(la,ja[la])),ka[la]=ba[ha[la]](ca(ja,la))})}function ea(ha){return ha||"0"===ha||0===ha?parseInt(ha,10):void 0}function fa(ha){ha&&z(ha,0,0)}var y={skin:"string",font:"string",width:"px",height:"px",ref:"string",color_scheme:"string"},ba={string:function(ha){return ha},bool:function(ha){return ha?/^(?:true|1|yes|on)$/i.test(ha):void 0},url:function(ha){return x(ha)},url_maybe:function(ha){return ha?x(ha):ha},hostname:function(ha){return ha||window.location.hostname},px:function(ha){return/^(\d+)(?:px)?$/.test(ha)?parseInt(RegExp.$1,10):void 0},text:function(ha){return ha}},ga=p.extend({constructor:function(ha,ia,ja,ka){this.parent(),ja=ja.replace(/-/g,"_");var la=ca(ka,"plugin_id");this.subscribe("xd.resize",aa(la)),this.subscribe("xd.resize.flow",aa(la)),this.subscribe("xd.resize.flow",ES(function(ra){ES("Object","assign",!1,this._iframeOptions.root.style,{verticalAlign:"bottom",overflow:""}),z(this._iframeOptions.root,ea(ra.width),ea(ra.height)),this.updateLift(),clearTimeout(this._timeoutID)},"bind",!0,this)),this.subscribe("xd.resize",ES(function(ra){ES("Object","assign",!1,this._iframeOptions.root.style,{verticalAlign:"bottom",overflow:""}),z(this._iframeOptions.root,ea(ra.width),ea(ra.height)),z(this._iframe,ea(ra.width),ea(ra.height)),this._isIframeResized=!0,this.updateLift(),clearTimeout(this._timeoutID)},"bind",!0,this)),this.subscribe("xd.resize.iframe",ES(function(ra){"true"===ra.reposition&&v("reposition_iframe",!1)&&this.reposition(ea(ra.width)),z(this._iframe,ea(ra.width),ea(ra.height)),this._isIframeResized=!0,this.updateLift(),clearTimeout(this._timeoutID)},"bind",!0,this)),this.subscribe("xd.sdk_event",function(ra){var sa=ES("JSON","parse",!1,ra.data);sa.pluginID=la,i.fire(ra.event,sa,ha)});var ma=o.getSecure()||"https:"==window.location.protocol,na=s.resolve("www",ma)+"/plugins/"+ja+".php?",oa={};da(this.getParams(),ha,ka,oa),da(y,ha,ka,oa),ES("Object","assign",!1,oa,{app_id:o.getClientID(),locale:o.getLocale(),sdk:"joey",kid_directed_site:o.getKidDirectedSite(),channel:t.handler(ES(function(ra){return this.inform("xd."+ra.type,ra)},"bind",!0,this),"parent.parent",!0)}),oa.container_width=ha.offsetWidth,h.addCss(ha,"fb_iframe_widget"),this.isFluid()&&h.addCss(ha,"fb_iframe_widget_fluid_desktop");var pa=w();this.subscribe("xd.verify",function(ra){t.sendToFacebook(pa,{method:"xd/verify",params:ES("JSON","stringify",!1,ra.token)})}),this.subscribe("xd.refreshLoginStatus",ES(g.getLoginStatus,"bind",!0,g,ES(this.inform,"bind",!0,this,"login.status"),!0));var qa=document.createElement("span");ES("Object","assign",!1,qa.style,{verticalAlign:"top",width:"0px",height:"0px",overflow:"hidden"}),this._element=ha,this._ns=ia,this._tag=ja,this._params=oa,this._config=this.getConfig(),this._iframeOptions={root:qa,url:na+n.encode(oa),name:pa,width:this._config.mobile_fullsize&&q.mobile()?void 0:oa.width||1e3,height:oa.height||1e3,style:{border:"none",visibility:"hidden"},title:this._ns+":"+this._tag+" Facebook Social Plugin",onload:ES(function(){return this.inform("render")},"bind",!0,this),onerror:ES(function(){return fa(this._iframe)},"bind",!0,this)},oa.allowfullscreen&&(this._iframeOptions.allowfullscreen=!0)},process:function(){if(o.getIsVersioned()){l.assertVersionIsSet();var ha=r(this._iframeOptions.url);this._iframeOptions.url=ha.setPath("/"+o.getVersion()+ha.getPath()).toString()}var ia=ES("Object","assign",!1,{},this._params);delete ia.channel;var ja=n.encode(ia);if(this._element.getAttribute("fb-iframe-plugin-query")==ja)return j.info("Skipping render: %s:%s %s",this._ns,this._tag,ja),void this.inform("render");for(this._element.setAttribute("fb-iframe-plugin-query",ja),this.subscribe("render",ES(function(){this._iframe.style.visibility="visible",this._isIframeResized||fa(this._iframe)},"bind",!0,this));this._element.firstChild;)this._element.removeChild(this._element.firstChild);this._element.appendChild(this._iframeOptions.root);var ka=q.mobile()?120:45;if(this._timeoutID=setTimeout(ES(function(){fa(this._iframe),j.warn("%s:%s failed to resize in %ss",this._ns,this._tag,ka)},"bind",!0,this),1e3*ka),m.add(this)||(this._iframe=u(this._iframeOptions)),q.mobile()&&(h.addCss(this._element,"fb_iframe_widget_fluid"),!this._iframeOptions.width)){ES("Object","assign",!1,this._element.style,{display:"block",width:"100%",height:"auto"}),ES("Object","assign",!1,this._iframeOptions.root.style,{width:"100%",height:"auto"});var la={height:"auto",position:"static",width:"100%"};(q.iphone()||q.ipad())&&ES("Object","assign",!1,la,{width:"220px","min-width":"100%"}),ES("Object","assign",!1,this._iframe.style,la)}},getConfig:function(){return{}},isFluid:function(){var ha=this.getConfig();return ha.fluid&&!q.mobile()},reposition:function(ha){var ia=h.getPosition(this._iframe).x,ja=h.getViewportInfo().width,ka=parseInt(h.getStyle(this._iframe,"width"),10),la={};if(ia+ha>ja&&ia>ha)this._iframe.style.left=parseInt(h.getStyle(this._iframe,"width"),10)-ha+"px",this._isRepositioned=!0,la.type="reposition";else{if(!this._isRepositioned||ka-ha===0)return;this._iframe.style.left="0px",this._isRepositioned=!1,la.type="restore"}t.sendToFacebook(this._iframe.name,{method:"xd/reposition",params:ES("JSON","stringify",!1,la)})},updateLift:function(){var ha=this._iframe.style.width===this._iframeOptions.root.style.width&&this._iframe.style.height===this._iframeOptions.root.style.height;h[ha?"removeCss":"addCss"](this._iframe,"fb_iframe_widget_lift")}},k);ga.getVal=ca,ga.withParams=function(ha,ia){return ga.extend({getParams:function(){return ha},getConfig:function(){return ia?ia:{}}})},e.exports=ga},null),__d("PluginConfig",["sdk.feature"],function(a,b,c,d,e,f,g){var h={post:{fluid:g("fluid_embed",!1),mobile_fullsize:!0}};e.exports=h},null),__d("PluginTags",[],function(a,b,c,d,e){var g={activity:{filter:"string",action:"string",max_age:"string",linktarget:"string",header:"bool",recommendations:"bool",site:"hostname"},composer:{action_type:"string",action_properties:"string"},create_event_button:{},degrees:{href:"url"},facepile:{href:"string",action:"string",size:"string",max_rows:"string",show_count:"bool"},follow:{href:"url",layout:"string",show_faces:"bool"},like:{href:"url",layout:"string",show_faces:"bool",share:"bool",action:"string",send:"bool"},like_box:{href:"string",show_faces:"bool",header:"bool",stream:"bool",force_wall:"bool",show_border:"bool",id:"string",connections:"string",profile_id:"string",name:"string"},open_graph:{href:"url",layout:"string",show_faces:"bool",action_type:"string",action_properties:"string"},open_graph_preview:{action_type:"string",action_properties:"string"},page_events:{href:"url"},post:{href:"url",show_border:"bool"},privacy_selector:{},profile_pic:{uid:"string",linked:"bool",href:"string",size:"string",facebook_logo:"bool"},recommendations:{filter:"string",action:"string",max_age:"string",linktarget:"string",header:"bool",site:"hostname"},share_button:{href:"url",layout:"string",type:"string"},shared_activity:{header:"bool"},send:{href:"url"},send_to_mobile:{max_rows:"string",show_faces:"bool",size:"string"},story:{href:"url",show_border:"bool"},topic:{topic_name:"string",topic_id:"string"},want:{href:"url",layout:"string",show_faces:"bool"}},h={subscribe:"follow",fan:"like_box",likebox:"like_box",friendpile:"facepile"};ES(ES("Object","keys",!1,h),"forEach",!0,function(i){g[i]=g[h[i]]}),e.exports=g},null),__d("sdk.Arbiter",[],function(a,b,c,d,e){var g={BEHAVIOR_EVENT:"e",BEHAVIOR_PERSISTENT:"p",BEHAVIOR_STATE:"s"};e.exports=g},null),__d("sdk.XFBML.Element",["sdk.DOM","Type","ObservableMixin"],function(a,b,c,d,e,f,g,h,i){var j=h.extend({constructor:function(k){this.parent(),this.dom=k},fire:function(){this.inform.apply(this,arguments)},getAttribute:function(k,l,m){var n=g.getAttr(this.dom,k);return n?m?m(n):n:l},_getBoolAttribute:function(k,l){var m=g.getBoolAttr(this.dom,k);return null===m?l:m},_getPxAttribute:function(k,l){return this.getAttribute(k,l,function(m){var n=parseInt(m,10);return isNaN(n)?l:n})},_getLengthAttribute:function(k,l){return this.getAttribute(k,l,function(m){if("100%"===m)return m;var n=parseInt(m,10);return isNaN(n)?l:n})},_getAttributeFromList:function(k,l,m){return this.getAttribute(k,l,function(n){return n=n.toLowerCase(),ES(m,"indexOf",!0,n)>-1?n:l})},isValid:function(){for(var k=this.dom;k;k=k.parentNode)if(k==document.body)return!0},clear:function(){g.html(this.dom,"")}},i);e.exports=j},null),__d("sdk.XFBML.IframeWidget",["sdk.Arbiter","sdk.Auth","sdk.Content","sdk.DOM","sdk.Event","sdk.XFBML.Element","guid","insertIframe","QueryString","sdk.Runtime","sdk.ui","UrlMap","sdk.XD"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){var t=l.extend({_iframeName:null,_showLoader:!0,_refreshOnAuthChange:!1,_allowReProcess:!1,_fetchPreCachedLoader:!1,_visibleAfter:"load",_widgetPipeEnabled:!1,_borderReset:!1,_repositioned:!1,getUrlBits:function(){throw new Error("Inheriting class needs to implement getUrlBits().")},setupAndValidate:function(){return!0},oneTimeSetup:function(){},getSize:function(){},getIframeName:function(){return this._iframeName},getIframeTitle:function(){return"Facebook Social Plugin"},getChannelUrl:function(){if(!this._channelUrl){var x=this;this._channelUrl=s.handler(function(y){x.fire("xd."+y.type,y)},"parent.parent",!0)}return this._channelUrl},getIframeNode:function(){return this.dom.getElementsByTagName("iframe")[0]},arbiterInform:function(event,x,y){s.sendToFacebook(this.getIframeName(),{method:event,params:ES("JSON","stringify",!1,x||{}),behavior:y||g.BEHAVIOR_PERSISTENT})},_arbiterInform:function(event,x,y){var z='parent.frames["'+this.getIframeNode().name+'"]';s.inform(event,x,z,y)},getDefaultWebDomain:function(){return r.resolve("www")},process:function(x){if(this._done){if(!this._allowReProcess&&!x)return;this.clear()}else this._oneTimeSetup();if(this._done=!0,this._iframeName=this.getIframeName()||this._iframeName||m(),!this.setupAndValidate())return void this.fire("render");this._showLoader&&this._addLoader(),j.addCss(this.dom,"fb_iframe_widget"),"immediate"!=this._visibleAfter?j.addCss(this.dom,"fb_hide_iframes"):this.subscribe("iframe.onload",ES(this.fire,"bind",!0,this,"render"));var y=this.getSize()||{},z=this.getFullyQualifiedURL();"100%"==y.width&&j.addCss(this.dom,"fb_iframe_widget_fluid"),this.clear(),n({url:z,root:this.dom.appendChild(document.createElement("span")),name:this._iframeName,title:this.getIframeTitle(),className:p.getRtl()?"fb_rtl":"fb_ltr",height:y.height,width:y.width,onload:ES(this.fire,"bind",!0,this,"iframe.onload")}),this._resizeFlow(y),this.loaded=!1,this.subscribe("iframe.onload",ES(function(){this.loaded=!0,this._isResizeHandled||j.addCss(this.dom,"fb_hide_iframes")},"bind",!0,this))},generateWidgetPipeIframeName:function(){return u++,"fb_iframe_"+u},getFullyQualifiedURL:function(){var x=this._getURL();if(x+="?"+o.encode(this._getQS()),x.length>2e3){x="about:blank";var y=ES(function(){this._postRequest(),this.unsubscribe("iframe.onload",y)},"bind",!0,this);this.subscribe("iframe.onload",y)}return x},_getWidgetPipeShell:function(){return r.resolve("www")+"/common/widget_pipe_shell.php"},_oneTimeSetup:function(){this.subscribe("xd.resize",ES(this._handleResizeMsg,"bind",!0,this)),this.subscribe("xd.resize",ES(this._bubbleResizeEvent,"bind",!0,this)),this.subscribe("xd.resize.iframe",ES(this._resizeIframe,"bind",!0,this)),this.subscribe("xd.resize.flow",ES(this._resizeFlow,"bind",!0,this)),this.subscribe("xd.resize.flow",ES(this._bubbleResizeEvent,"bind",!0,this)),this.subscribe("xd.refreshLoginStatus",function(){h.getLoginStatus(function(){},!0)}),this.subscribe("xd.logout",function(){q({method:"auth.logout",display:"hidden"},function(){})}),this._refreshOnAuthChange&&this._setupAuthRefresh(),"load"==this._visibleAfter&&this.subscribe("iframe.onload",ES(this._makeVisible,"bind",!0,this)),this.subscribe("xd.verify",ES(function(x){this.arbiterInform("xd/verify",x.token)},"bind",!0,this)),this.oneTimeSetup()},_makeVisible:function(){this._removeLoader(),j.removeCss(this.dom,"fb_hide_iframes"),this.fire("render")},_setupAuthRefresh:function(){h.getLoginStatus(ES(function(x){var y=x.status;k.subscribe("auth.statusChange",ES(function(z){this.isValid()&&(("unknown"==y||"unknown"==z.status)&&this.process(!0),y=z.status)},"bind",!0,this))},"bind",!0,this))},_handleResizeMsg:function(x){this.isValid()&&(this._resizeIframe(x),this._resizeFlow(x),this._borderReset||(this.getIframeNode().style.border="none",this._borderReset=!0),this._isResizeHandled=!0,this._makeVisible())},_bubbleResizeEvent:function(x){var y={height:x.height,width:x.width,pluginID:this.getAttribute("plugin-id")};k.fire("xfbml.resize",y)},_resizeIframe:function(x){var y=this.getIframeNode();"true"===x.reposition&&this._repositionIframe(x),x.height&&(y.style.height=x.height+"px"),x.width&&(y.style.width=x.width+"px"),this._updateIframeZIndex()},_resizeFlow:function(x){var y=this.dom.getElementsByTagName("span")[0];x.height&&(y.style.height=x.height+"px"),x.width&&(y.style.width=x.width+"px"),this._updateIframeZIndex()},_updateIframeZIndex:function(){var x=this.dom.getElementsByTagName("span")[0],y=this.getIframeNode(),z=y.style.height===x.style.height&&y.style.width===x.style.width,aa=z?"removeCss":"addCss";j[aa](y,"fb_iframe_widget_lift")},_repositionIframe:function(x){var y=this.getIframeNode(),z=parseInt(j.getStyle(y,"width"),10),aa=j.getPosition(y).x,ba=j.getViewportInfo().width,ca=parseInt(x.width,10);aa+ca>ba&&aa>ca?(y.style.left=z-ca+"px",this.arbiterInform("xd/reposition",{type:"horizontal"}),this._repositioned=!0):this._repositioned&&(y.style.left="0px",this.arbiterInform("xd/reposition",{type:"restore"}),this._repositioned=!1)},_addLoader:function(){this._loaderDiv||(j.addCss(this.dom,"fb_iframe_widget_loader"),this._loaderDiv=document.createElement("div"),this._loaderDiv.className="FB_Loader",this.dom.appendChild(this._loaderDiv))},_removeLoader:function(){this._loaderDiv&&(j.removeCss(this.dom,"fb_iframe_widget_loader"),this._loaderDiv.parentNode&&this._loaderDiv.parentNode.removeChild(this._loaderDiv),this._loaderDiv=null)},_getQS:function(){return ES("Object","assign",!1,{api_key:p.getClientID(),locale:p.getLocale(),sdk:"joey",kid_directed_site:p.getKidDirectedSite(),ref:this.getAttribute("ref")},this.getUrlBits().params)},_getURL:function(){var x=this.getDefaultWebDomain(),y="";return x+"/plugins/"+y+this.getUrlBits().name+".php"},_postRequest:function(){i.submitToTarget({url:this._getURL(),target:this.getIframeNode().name,params:this._getQS()})}}),u=0;e.exports=t},null),__d("sdk.XFBML.Comments",["sdk.Event","sdk.XFBML.IframeWidget","QueryString","sdk.Runtime","JSSDKConfig","sdk.UA","UrlMap"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){var n=h.extend({_visibleAfter:"immediate",_refreshOnAuthChange:!0,setupAndValidate:function(){var o={channel_url:this.getChannelUrl(),colorscheme:this.getAttribute("colorscheme"),skin:this.getAttribute("skin"),numposts:this.getAttribute("num-posts",10),width:this._getLengthAttribute("width"),href:this.getAttribute("href"),permalink:this.getAttribute("permalink"),publish_feed:this.getAttribute("publish_feed"),order_by:this.getAttribute("order_by"),mobile:this._getBoolAttribute("mobile")};if(o.width||o.permalink||(o.width=550),k.initSitevars.enableMobileComments&&l.mobile()&&o.mobile!==!1&&(o.mobile=!0,delete o.width),o.skin||(o.skin=o.colorscheme),o.href){var q=this.getAttribute("fb_comment_id");q||(q=i.decode(document.URL.substring(ES(document.URL,"indexOf",!0,"?")+1)).fb_comment_id,q&&ES(q,"indexOf",!0,"#")>0&&(q=q.substring(0,ES(q,"indexOf",!0,"#")))),q&&(o.fb_comment_id=q,this.subscribe("render",ES(function(){window.location.hash||(window.location.hash=this.getIframeNode().id)},"bind",!0,this)))}else{if(o.migrated=this.getAttribute("migrated"),o.xid=this.getAttribute("xid"),o.title=this.getAttribute("title",document.title),o.url=this.getAttribute("url",document.URL),o.quiet=this.getAttribute("quiet"),o.reverse=this.getAttribute("reverse"),o.simple=this.getAttribute("simple"),o.css=this.getAttribute("css"),o.notify=this.getAttribute("notify"),!o.xid){var p=ES(document.URL,"indexOf",!0,"#");o.xid=encodeURIComponent(p>0?document.URL.substring(0,p):document.URL)}o.migrated&&(o.href=m.resolve("www")+"/plugins/comments_v1.php?app_id="+j.getClientID()+"&xid="+encodeURIComponent(o.xid)+"&url="+encodeURIComponent(o.url))}return this._attr=o,!0},oneTimeSetup:function(){this.subscribe("xd.commentCreated",ES(this._handleCommentCreatedMsg,"bind",!0,this)),this.subscribe("xd.commentRemoved",ES(this._handleCommentRemovedMsg,"bind",!0,this))},getSize:function(){return this._attr.permalink?void 0:{width:this._attr.mobile?"100%":this._attr.width,height:100}},getUrlBits:function(){return{name:"comments",params:this._attr}},getDefaultWebDomain:function(){return m.resolve(this._attr.mobile?"m":"www",!0)},_handleCommentCreatedMsg:function(o){if(this.isValid()){var p={href:o.href,commentID:o.commentID,parentCommentID:o.parentCommentID,message:o.message};g.fire("comment.create",p)}},_handleCommentRemovedMsg:function(o){if(this.isValid()){var p={href:o.href,commentID:o.commentID};g.fire("comment.remove",p)}}});e.exports=n},null),__d("sdk.XFBML.CommentsCount",["ApiClient","sdk.DOM","sdk.XFBML.Element","sprintf"],function(a,b,c,d,e,f,g,h,i,j){var k=i.extend({process:function(){h.addCss(this.dom,"fb_comments_count_zero");var l=this.getAttribute("href",window.location.href);g.scheduleBatchCall("/v2.1/"+encodeURIComponent(l),{fields:"share"},ES(function(m){var n=m.share&&m.share.comment_count||0;h.html(this.dom,j('<span class="fb_comments_count">%s</span>',n)),n>0&&h.removeCss(this.dom,"fb_comments_count_zero"),this.fire("render")},"bind",!0,this))}});e.exports=k},null),__d("safeEval",[],function(a,b,c,d,e){function g(h,i){return null!==h&&"undefined"!=typeof h?"string"!=typeof h?h:/^\w+$/.test(h)&&"function"==typeof window[h]?window[h].apply(null,i||[]):Function('return eval("'+h.replace(/"/g,'\\"')+'");').apply(null,i||[]):void 0}e.exports=g},null),__d("sdk.Helper",["sdk.ErrorHandling","sdk.Event","UrlMap","safeEval","sprintf"],function(a,b,c,d,e,f,g,h,i,j,k){var l={isUser:function(m){return 22e8>m||m>=1e14&&0x5b0a58f100ef>=m||m>=89e12&&89999999999999>=m||m>=6000001e7&&60000019999999>=m},upperCaseFirstChar:function(m){return m.length>0?m.substr(0,1).toUpperCase()+m.substr(1):m},getProfileLink:function(m,n,o){return!o&&m&&(o=k("%s/profile.php?id=%s",i.resolve("www"),m.uid||m.id)),o&&(n=k('<a class="fb_link" href="%s">%s</a>',o,n)),n},invokeHandler:function(m,n,o){m&&("string"==typeof m?g.unguard(j)(m,o):m.apply&&g.unguard(m).apply(n,o||[]))},fireEvent:function(m,n){var o=n._attr.href;n.fire(m,o),h.fire(m,o,n)},executeFunctionByName:function(m){for(var n=Array.prototype.slice.call(arguments,1),o=m.split("."),p=o.pop(),q=window,r=0;r<o.length;r++)q=q[o[r]];return q[p].apply(this,n)}};e.exports=l},null),__d("sdk.XFBML.LoginButton",["sdk.Helper","IframePlugin"],function(a,b,c,d,e,f,g,h){var i=h.extend({constructor:function(j,k,l,m){this.parent(j,k,l,m);var n=h.getVal(m,"on_login");n&&this.subscribe("login.status",function(o){g.invokeHandler(n,null,[o])})},getParams:function(){return{scope:"string",perms:"string",size:"string",login_text:"text",show_faces:"bool",max_rows:"string",show_login_face:"bool",registration_url:"url_maybe",auto_logout_link:"bool",one_click:"bool",show_banner:"bool",auth_type:"string",default_audience:"string"}}});e.exports=i},null),__d("escapeHTML",[],function(a,b,c,d,e){function i(j){return j.replace(g,function(k){return h[k]})}var g=/[&<>"'\/]/g,h={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;","/":"&#x2F;"};e.exports=i},null),__d("sdk.XFBML.Name",["ApiClient","escapeHTML","sdk.Event","sdk.XFBML.Element","sdk.Helper","Log","sdk.Runtime"],function(a,b,c,d,e,f,g,h,i,j,k,l,m){var n={}.hasOwnProperty,o=j.extend({process:function(){if(ES("Object","assign",!1,this,{_uid:this.getAttribute("uid"),_firstnameonly:this._getBoolAttribute("first-name-only"),_lastnameonly:this._getBoolAttribute("last-name-only"),_possessive:this._getBoolAttribute("possessive"),_reflexive:this._getBoolAttribute("reflexive"),_objective:this._getBoolAttribute("objective"),_linked:this._getBoolAttribute("linked",!0),_subjectId:this.getAttribute("subject-id")}),!this._uid)return l.error('"uid" is a required attribute for <fb:name>'),void this.fire("render");var p=[];p.push(this._firstnameonly?"first_name":this._lastnameonly?"last_name":"name"),this._subjectId&&(p.push("gender"),this._subjectId==m.getUserID()&&(this._reflexive=!0)),i.monitor("auth.statusChange",ES(function(){return this.isValid()?(this._uid&&"loggedinuser"!=this._uid||(this._uid=m.getUserID()),void(this._uid&&g.scheduleBatchCall("/v1.0/"+this._uid,{fields:p.join(",")},ES(function(q){return n.call(q,"error")?void l.warn("The name is not found for ID: "+this._uid):(this._subjectId==this._uid?this._renderPronoun(q):this._renderOther(q),void this.fire("render"))},"bind",!0,this)))):(this.fire("render"),!0)},"bind",!0,this))},_renderPronoun:function(p){var q="",r=this._objective;if(this._subjectId&&(r=!0,this._subjectId===this._uid&&(this._reflexive=!0)),this._uid==m.getUserID()&&this._getBoolAttribute("use-you",!0))q=this._possessive?this._reflexive?"your own":"your":this._reflexive?"yourself":"you";else switch(p.gender){case"male":q=this._possessive?this._reflexive?"his own":"his":this._reflexive?"himself":r?"him":"he";break;case"female":q=this._possessive?this._reflexive?"her own":"her":this._reflexive?"herself":r?"her":"she";break;default:q=this._getBoolAttribute("use-they",!0)?this._possessive?this._reflexive?"their own":"their":this._reflexive?"themselves":r?"them":"they":this._possessive?this._reflexive?"his/her own":"his/her":this._reflexive?"himself/herself":r?"him/her":"he/she"}this._getBoolAttribute("capitalize",!1)&&(q=k.upperCaseFirstChar(q)),this.dom.innerHTML=q},_renderOther:function(p){var q="",r="";this._uid==m.getUserID()&&this._getBoolAttribute("use-you",!0)?q=this._reflexive?this._possessive?"your own":"yourself":this._possessive?"your":"you":p&&(null===p.first_name&&(p.first_name=""),null===p.last_name&&(p.last_name=""),this._firstnameonly&&void 0!==p.first_name?q=h(p.first_name):this._lastnameonly&&void 0!==p.last_name&&(q=h(p.last_name)),q||(q=h(p.name)),""!==q&&this._possessive&&(q+="'s")),q||(q=h(this.getAttribute("if-cant-see","Facebook User"))),q&&(this._getBoolAttribute("capitalize",!1)&&(q=k.upperCaseFirstChar(q)),r=p&&this._linked?k.getProfileLink(p,q,this.getAttribute("href",null)):q),this.dom.innerHTML=r}});e.exports=o},null),__d("sdk.XFBML.Registration",["sdk.Auth","sdk.Helper","sdk.XFBML.IframeWidget","sdk.Runtime","UrlMap"],function(a,b,c,d,e,f,g,h,i,j,k){var l=i.extend({_visibleAfter:"immediate",_baseHeight:167,_fieldHeight:28,_skinnyWidth:520,_skinnyBaseHeight:173,_skinnyFieldHeight:52,setupAndValidate:function(){return this._attr={action:this.getAttribute("action"),border_color:this.getAttribute("border-color"),channel_url:this.getChannelUrl(),client_id:j.getClientID(),fb_only:this._getBoolAttribute("fb-only",!1),fb_register:this._getBoolAttribute("fb-register",!1),fields:this.getAttribute("fields"),height:this._getPxAttribute("height"),redirect_uri:this.getAttribute("redirect-uri",window.location.href),no_footer:this._getBoolAttribute("no-footer"),no_header:this._getBoolAttribute("no-header"),onvalidate:this.getAttribute("onvalidate"),width:this._getPxAttribute("width",600),target:this.getAttribute("target")},this._attr.onvalidate&&this.subscribe("xd.validate",ES(function(m){var n=ES("JSON","parse",!1,m.value),o=ES(function(q){this.arbiterInform("Registration.Validation",{errors:q,id:m.id})},"bind",!0,this),p=h.executeFunctionByName(this._attr.onvalidate,n,o);p&&o(p)},"bind",!0,this)),this.subscribe("xd.authLogin",ES(this._onAuthLogin,"bind",!0,this)),this.subscribe("xd.authLogout",ES(this._onAuthLogout,"bind",!0,this)),!0},getSize:function(){return{width:this._attr.width,height:this._getHeight()}},_getHeight:function(){if(this._attr.height)return this._attr.height;var m;if(this._attr.fields)try{m=ES("JSON","parse",!1,this._attr.fields)}catch(n){m=this._attr.fields.split(/,/)}else m=["name"];return this._attr.width<this._skinnyWidth?this._skinnyBaseHeight+m.length*this._skinnyFieldHeight:this._baseHeight+m.length*this._fieldHeight},getUrlBits:function(){return{name:"registration",params:this._attr}},getDefaultWebDomain:function(){return k.resolve("www",!0)},_onAuthLogin:function(){g.getAuthResponse()||g.getLoginStatus(),h.fireEvent("auth.login",this)},_onAuthLogout:function(){g.getAuthResponse()||g.getLoginStatus(),h.fireEvent("auth.logout",this)}});e.exports=l},null),__d("legacy:fb.xfbml",["Assert","sdk.Event","FB","IframePlugin","PluginConfig","PluginTags","XFBML","sdk.domReady","sdk.feature","wrapFunction","sdk.XFBML.Comments","sdk.XFBML.CommentsCount","sdk.XFBML.LoginButton","sdk.XFBML.Name","sdk.XFBML.Registration"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){var q={comments:b("sdk.XFBML.Comments"),comments_count:b("sdk.XFBML.CommentsCount"),login_button:b("sdk.XFBML.LoginButton"),name:b("sdk.XFBML.Name"),registration:b("sdk.XFBML.Registration")},r=o("plugin_tags_blacklist",[]);ES(ES("Object","keys",!1,l),"forEach",!0,function(t){-1===ES(r,"indexOf",!0,t)&&m.registerTag({xmlns:"fb",localName:t.replace(/_/g,"-"),ctor:j.withParams(l[t],k[t])})}),ES(ES("Object","keys",!1,q),"forEach",!0,function(t){-1===ES(r,"indexOf",!0,t)&&m.registerTag({xmlns:"fb",localName:t.replace(/_/g,"-"),ctor:q[t]})}),i.provide("XFBML",{parse:function(t){return g.maybeXfbml(t,"Invalid argument"),t&&9===t.nodeType&&(t=t.body),m.parse.apply(null,arguments)}}),m.subscribe("parse",ES(h.fire,"bind",!0,h,"xfbml.parse")),m.subscribe("render",ES(h.fire,"bind",!0,h,"xfbml.render")),h.subscribe("init:post",function(t){t.xfbml&&setTimeout(p(ES(n,"bind",!0,null,m.parse),"entry","init:post:xfbml.parse"),0)}),g.define("Xfbml",function(t){return(1===t.nodeType||9===t.nodeType)&&"string"==typeof t.nodeName});try{document.namespaces&&!document.namespaces.item.fb&&document.namespaces.add("fb")}catch(s){}},3),__d("legacy:fb.versioned-sdk",["sdk.Runtime"],function(a,b,c,d,e,f,g){g.setIsVersioned(!0)},3)}.call({},window.inDapIF?parent.window:window)
}catch(e){(new Image).src="https://www.facebook.com/common/scribe_endpoint.php?c=jssdk_error&m="+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1594576","message":"'+e.message+'"}}')}!function(a){a.flexslider=function(b,c){var d=a(b);d.vars=a.extend({},a.flexslider.defaults,c);var j,e=d.vars.namespace,f=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,g=("ontouchstart"in window||f||window.DocumentTouch&&document instanceof DocumentTouch)&&d.vars.touch,h="click touchend MSPointerUp",i="",k="vertical"===d.vars.direction,l=d.vars.reverse,m=d.vars.itemWidth>0,n="fade"===d.vars.animation,o=""!==d.vars.asNavFor,p={},q=!0;a.data(b,"flexslider",d),p={init:function(){d.animating=!1,d.currentSlide=parseInt(d.vars.startAt?d.vars.startAt:0,10),isNaN(d.currentSlide)&&(d.currentSlide=0),d.animatingTo=d.currentSlide,d.atEnd=0===d.currentSlide||d.currentSlide===d.last,d.containerSelector=d.vars.selector.substr(0,d.vars.selector.search(" ")),d.slides=a(d.vars.selector,d),d.container=a(d.containerSelector,d),d.count=d.slides.length,d.syncExists=a(d.vars.sync).length>0,"slide"===d.vars.animation&&(d.vars.animation="swing"),d.prop=k?"top":"marginLeft",d.args={},d.manualPause=!1,d.stopped=!1,d.started=!1,d.startTimeout=null,d.transitions=!d.vars.video&&!n&&d.vars.useCSS&&function(){var a=document.createElement("div"),b=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var c in b)if(void 0!==a.style[b[c]])return d.pfx=b[c].replace("Perspective","").toLowerCase(),d.prop="-"+d.pfx+"-transform",!0;return!1}(),d.ensureAnimationEnd="",""!==d.vars.controlsContainer&&(d.controlsContainer=a(d.vars.controlsContainer).length>0&&a(d.vars.controlsContainer)),""!==d.vars.manualControls&&(d.manualControls=a(d.vars.manualControls).length>0&&a(d.vars.manualControls)),d.vars.randomize&&(d.slides.sort(function(){return Math.round(Math.random())-.5}),d.container.empty().append(d.slides)),d.doMath(),d.setup("init"),d.vars.controlNav&&p.controlNav.setup(),d.vars.directionNav&&p.directionNav.setup(),d.vars.keyboard&&(1===a(d.containerSelector).length||d.vars.multipleKeyboard)&&a(document).bind("keyup",function(a){var b=a.keyCode;if(!d.animating&&(39===b||37===b)){var c=39===b?d.getTarget("next"):37===b?d.getTarget("prev"):!1;d.flexAnimate(c,d.vars.pauseOnAction)}}),d.vars.mousewheel&&d.bind("mousewheel",function(a,b){a.preventDefault();var f=d.getTarget(0>b?"next":"prev");d.flexAnimate(f,d.vars.pauseOnAction)}),d.vars.pausePlay&&p.pausePlay.setup(),d.vars.slideshow&&d.vars.pauseInvisible&&p.pauseInvisible.init(),d.vars.slideshow&&(d.vars.pauseOnHover&&d.hover(function(){d.manualPlay||d.manualPause||d.pause()},function(){d.manualPause||d.manualPlay||d.stopped||d.play()}),d.vars.pauseInvisible&&p.pauseInvisible.isHidden()||(d.vars.initDelay>0?d.startTimeout=setTimeout(d.play,d.vars.initDelay):d.play())),o&&p.asNav.setup(),g&&d.vars.touch&&p.touch(),(!n||n&&d.vars.smoothHeight)&&a(window).bind("resize orientationchange focus",p.resize),d.find("img").attr("draggable","false"),setTimeout(function(){d.vars.start(d)},200)},asNav:{setup:function(){d.asNav=!0,d.animatingTo=Math.floor(d.currentSlide/d.move),d.currentItem=d.currentSlide,d.slides.removeClass(e+"active-slide").eq(d.currentItem).addClass(e+"active-slide"),f?(b._slider=d,d.slides.each(function(){var b=this;b._gesture=new MSGesture,b._gesture.target=b,b.addEventListener("MSPointerDown",function(a){a.preventDefault(),a.currentTarget._gesture&&a.currentTarget._gesture.addPointer(a.pointerId)},!1),b.addEventListener("MSGestureTap",function(b){b.preventDefault();var c=a(this),e=c.index();a(d.vars.asNavFor).data("flexslider").animating||c.hasClass("active")||(d.direction=d.currentItem<e?"next":"prev",d.flexAnimate(e,d.vars.pauseOnAction,!1,!0,!0))})})):d.slides.on(h,function(b){b.preventDefault();var c=a(this),f=c.index(),g=c.offset().left-a(d).scrollLeft();0>=g&&c.hasClass(e+"active-slide")?d.flexAnimate(d.getTarget("prev"),!0):a(d.vars.asNavFor).data("flexslider").animating||c.hasClass(e+"active-slide")||(d.direction=d.currentItem<f?"next":"prev",d.flexAnimate(f,d.vars.pauseOnAction,!1,!0,!0))})}},controlNav:{setup:function(){d.manualControls?p.controlNav.setupManual():p.controlNav.setupPaging()},setupPaging:function(){var f,g,b="thumbnails"===d.vars.controlNav?"control-thumbs":"control-paging",c=1;if(d.controlNavScaffold=a('<ol class="'+e+"control-nav "+e+b+'"></ol>'),d.pagingCount>1)for(var j=0;j<d.pagingCount;j++){if(g=d.slides.eq(j),f="thumbnails"===d.vars.controlNav?'<img src="'+g.attr("data-thumb")+'"/>':"<a>"+c+"</a>","thumbnails"===d.vars.controlNav&&!0===d.vars.thumbCaptions){var k=g.attr("data-thumbcaption");""!=k&&void 0!=k&&(f+='<span class="'+e+'caption">'+k+"</span>")}d.controlNavScaffold.append("<li>"+f+"</li>"),c++}d.controlsContainer?a(d.controlsContainer).append(d.controlNavScaffold):d.append(d.controlNavScaffold),p.controlNav.set(),p.controlNav.active(),d.controlNavScaffold.delegate("a, img",h,function(b){if(b.preventDefault(),""===i||i===b.type){var c=a(this),f=d.controlNav.index(c);c.hasClass(e+"active")||(d.direction=f>d.currentSlide?"next":"prev",d.flexAnimate(f,d.vars.pauseOnAction))}""===i&&(i=b.type),p.setToClearWatchedEvent()})},setupManual:function(){d.controlNav=d.manualControls,p.controlNav.active(),d.controlNav.bind(h,function(b){if(b.preventDefault(),""===i||i===b.type){var c=a(this),f=d.controlNav.index(c);c.hasClass(e+"active")||(d.direction=f>d.currentSlide?"next":"prev",d.flexAnimate(f,d.vars.pauseOnAction))}""===i&&(i=b.type),p.setToClearWatchedEvent()})},set:function(){var b="thumbnails"===d.vars.controlNav?"img":"a";d.controlNav=a("."+e+"control-nav li "+b,d.controlsContainer?d.controlsContainer:d)},active:function(){d.controlNav.removeClass(e+"active").eq(d.animatingTo).addClass(e+"active")},update:function(b,c){d.pagingCount>1&&"add"===b?d.controlNavScaffold.append(a("<li><a>"+d.count+"</a></li>")):1===d.pagingCount?d.controlNavScaffold.find("li").remove():d.controlNav.eq(c).closest("li").remove(),p.controlNav.set(),d.pagingCount>1&&d.pagingCount!==d.controlNav.length?d.update(c,b):p.controlNav.active()}},directionNav:{setup:function(){var b=a('<ul class="'+e+'direction-nav"><li><a class="'+e+'prev" href="#">'+d.vars.prevText+'</a></li><li><a class="'+e+'next" href="#">'+d.vars.nextText+"</a></li></ul>");d.controlsContainer?(a(d.controlsContainer).append(b),d.directionNav=a("."+e+"direction-nav li a",d.controlsContainer)):(d.append(b),d.directionNav=a("."+e+"direction-nav li a",d)),p.directionNav.update(),d.directionNav.bind(h,function(b){b.preventDefault();var c;(""===i||i===b.type)&&(c=d.getTarget(a(this).hasClass(e+"next")?"next":"prev"),d.flexAnimate(c,d.vars.pauseOnAction)),""===i&&(i=b.type),p.setToClearWatchedEvent()})},update:function(){var a=e+"disabled";1===d.pagingCount?d.directionNav.addClass(a).attr("tabindex","-1"):d.vars.animationLoop?d.directionNav.removeClass(a).removeAttr("tabindex"):0===d.animatingTo?d.directionNav.removeClass(a).filter("."+e+"prev").addClass(a).attr("tabindex","-1"):d.animatingTo===d.last?d.directionNav.removeClass(a).filter("."+e+"next").addClass(a).attr("tabindex","-1"):d.directionNav.removeClass(a).removeAttr("tabindex")}},pausePlay:{setup:function(){var b=a('<div class="'+e+'pauseplay"><a></a></div>');d.controlsContainer?(d.controlsContainer.append(b),d.pausePlay=a("."+e+"pauseplay a",d.controlsContainer)):(d.append(b),d.pausePlay=a("."+e+"pauseplay a",d)),p.pausePlay.update(d.vars.slideshow?e+"pause":e+"play"),d.pausePlay.bind(h,function(b){b.preventDefault(),(""===i||i===b.type)&&(a(this).hasClass(e+"pause")?(d.manualPause=!0,d.manualPlay=!1,d.pause()):(d.manualPause=!1,d.manualPlay=!0,d.play())),""===i&&(i=b.type),p.setToClearWatchedEvent()})},update:function(a){"play"===a?d.pausePlay.removeClass(e+"pause").addClass(e+"play").html(d.vars.playText):d.pausePlay.removeClass(e+"play").addClass(e+"pause").html(d.vars.pauseText)}},touch:function(){function r(f){d.animating?f.preventDefault():(window.navigator.msPointerEnabled||1===f.touches.length)&&(d.pause(),g=k?d.h:d.w,i=Number(new Date),o=f.touches[0].pageX,p=f.touches[0].pageY,e=m&&l&&d.animatingTo===d.last?0:m&&l?d.limit-(d.itemW+d.vars.itemMargin)*d.move*d.animatingTo:m&&d.currentSlide===d.last?d.limit:m?(d.itemW+d.vars.itemMargin)*d.move*d.currentSlide:l?(d.last-d.currentSlide+d.cloneOffset)*g:(d.currentSlide+d.cloneOffset)*g,a=k?p:o,c=k?o:p,b.addEventListener("touchmove",s,!1),b.addEventListener("touchend",t,!1))}function s(b){o=b.touches[0].pageX,p=b.touches[0].pageY,h=k?a-p:a-o,j=k?Math.abs(h)<Math.abs(o-c):Math.abs(h)<Math.abs(p-c);var f=500;(!j||Number(new Date)-i>f)&&(b.preventDefault(),!n&&d.transitions&&(d.vars.animationLoop||(h/=0===d.currentSlide&&0>h||d.currentSlide===d.last&&h>0?Math.abs(h)/g+2:1),d.setProps(e+h,"setTouch")))}function t(){if(b.removeEventListener("touchmove",s,!1),d.animatingTo===d.currentSlide&&!j&&null!==h){var k=l?-h:h,m=d.getTarget(k>0?"next":"prev");d.canAdvance(m)&&(Number(new Date)-i<550&&Math.abs(k)>50||Math.abs(k)>g/2)?d.flexAnimate(m,d.vars.pauseOnAction):n||d.flexAnimate(d.currentSlide,d.vars.pauseOnAction,!0)}b.removeEventListener("touchend",t,!1),a=null,c=null,h=null,e=null}function u(a){a.stopPropagation(),d.animating?a.preventDefault():(d.pause(),b._gesture.addPointer(a.pointerId),q=0,g=k?d.h:d.w,i=Number(new Date),e=m&&l&&d.animatingTo===d.last?0:m&&l?d.limit-(d.itemW+d.vars.itemMargin)*d.move*d.animatingTo:m&&d.currentSlide===d.last?d.limit:m?(d.itemW+d.vars.itemMargin)*d.move*d.currentSlide:l?(d.last-d.currentSlide+d.cloneOffset)*g:(d.currentSlide+d.cloneOffset)*g)}function v(a){a.stopPropagation();var c=a.target._slider;if(c){var d=-a.translationX,f=-a.translationY;return q+=k?f:d,h=q,j=k?Math.abs(q)<Math.abs(-d):Math.abs(q)<Math.abs(-f),a.detail===a.MSGESTURE_FLAG_INERTIA?void setImmediate(function(){b._gesture.stop()}):void((!j||Number(new Date)-i>500)&&(a.preventDefault(),!n&&c.transitions&&(c.vars.animationLoop||(h=q/(0===c.currentSlide&&0>q||c.currentSlide===c.last&&q>0?Math.abs(q)/g+2:1)),c.setProps(e+h,"setTouch"))))}}function w(b){b.stopPropagation();var d=b.target._slider;if(d){if(d.animatingTo===d.currentSlide&&!j&&null!==h){var f=l?-h:h,k=d.getTarget(f>0?"next":"prev");d.canAdvance(k)&&(Number(new Date)-i<550&&Math.abs(f)>50||Math.abs(f)>g/2)?d.flexAnimate(k,d.vars.pauseOnAction):n||d.flexAnimate(d.currentSlide,d.vars.pauseOnAction,!0)}a=null,c=null,h=null,e=null,q=0}}var a,c,e,g,h,i,j=!1,o=0,p=0,q=0;f?(b.style.msTouchAction="none",b._gesture=new MSGesture,b._gesture.target=b,b.addEventListener("MSPointerDown",u,!1),b._slider=d,b.addEventListener("MSGestureChange",v,!1),b.addEventListener("MSGestureEnd",w,!1)):b.addEventListener("touchstart",r,!1)},resize:function(){!d.animating&&d.is(":visible")&&(m||d.doMath(),n?p.smoothHeight():m?(d.slides.width(d.computedW),d.update(d.pagingCount),d.setProps()):k?(d.viewport.height(d.h),d.setProps(d.h,"setTotal")):(d.vars.smoothHeight&&p.smoothHeight(),d.newSlides.width(d.computedW),d.setProps(d.computedW,"setTotal")))},smoothHeight:function(a){if(!k||n){var b=n?d:d.viewport;a?b.animate({height:d.slides.eq(d.animatingTo).height()},a):b.height(d.slides.eq(d.animatingTo).height())}},sync:function(b){var c=a(d.vars.sync).data("flexslider"),e=d.animatingTo;switch(b){case"animate":c.flexAnimate(e,d.vars.pauseOnAction,!1,!0);break;case"play":c.playing||c.asNav||c.play();break;case"pause":c.pause()}},uniqueID:function(b){return b.find("[id]").each(function(){var b=a(this);b.attr("id",b.attr("id")+"_clone")}),b},pauseInvisible:{visProp:null,init:function(){var a=["webkit","moz","ms","o"];if("hidden"in document)return"hidden";for(var b=0;b<a.length;b++)a[b]+"Hidden"in document&&(p.pauseInvisible.visProp=a[b]+"Hidden");if(p.pauseInvisible.visProp){var c=p.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(c,function(){p.pauseInvisible.isHidden()?d.startTimeout?clearTimeout(d.startTimeout):d.pause():d.started?d.play():d.vars.initDelay>0?setTimeout(d.play,d.vars.initDelay):d.play()})}},isHidden:function(){return document[p.pauseInvisible.visProp]||!1}},setToClearWatchedEvent:function(){clearTimeout(j),j=setTimeout(function(){i=""},3e3)}},d.flexAnimate=function(b,c,f,h,i){if(d.vars.animationLoop||b===d.currentSlide||(d.direction=b>d.currentSlide?"next":"prev"),o&&1===d.pagingCount&&(d.direction=d.currentItem<b?"next":"prev"),!d.animating&&(d.canAdvance(b,i)||f)&&d.is(":visible")){if(o&&h){var j=a(d.vars.asNavFor).data("flexslider");if(d.atEnd=0===b||b===d.count-1,j.flexAnimate(b,!0,!1,!0,i),d.direction=d.currentItem<b?"next":"prev",j.direction=d.direction,Math.ceil((b+1)/d.visible)-1===d.currentSlide||0===b)return d.currentItem=b,d.slides.removeClass(e+"active-slide").eq(b).addClass(e+"active-slide"),!1;d.currentItem=b,d.slides.removeClass(e+"active-slide").eq(b).addClass(e+"active-slide"),b=Math.floor(b/d.visible)}if(d.animating=!0,d.animatingTo=b,c&&d.pause(),d.vars.before(d),d.syncExists&&!i&&p.sync("animate"),d.vars.controlNav&&p.controlNav.active(),m||d.slides.removeClass(e+"active-slide").eq(b).addClass(e+"active-slide"),d.atEnd=0===b||b===d.last,d.vars.directionNav&&p.directionNav.update(),b===d.last&&(d.vars.end(d),d.vars.animationLoop||d.pause()),n)g?(d.slides.eq(d.currentSlide).css({opacity:0,zIndex:1}),d.slides.eq(b).css({opacity:1,zIndex:2}),d.wrapup(q)):(d.slides.eq(d.currentSlide).css({zIndex:1}).animate({opacity:0},d.vars.animationSpeed,d.vars.easing),d.slides.eq(b).css({zIndex:2}).animate({opacity:1},d.vars.animationSpeed,d.vars.easing,d.wrapup));else{var r,s,t,q=k?d.slides.filter(":first").height():d.computedW;m?(r=d.vars.itemMargin,t=(d.itemW+r)*d.move*d.animatingTo,s=t>d.limit&&1!==d.visible?d.limit:t):s=0===d.currentSlide&&b===d.count-1&&d.vars.animationLoop&&"next"!==d.direction?l?(d.count+d.cloneOffset)*q:0:d.currentSlide===d.last&&0===b&&d.vars.animationLoop&&"prev"!==d.direction?l?0:(d.count+1)*q:l?(d.count-1-b+d.cloneOffset)*q:(b+d.cloneOffset)*q,d.setProps(s,"",d.vars.animationSpeed),d.transitions?(d.vars.animationLoop&&d.atEnd||(d.animating=!1,d.currentSlide=d.animatingTo),d.container.unbind("webkitTransitionEnd transitionend"),d.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(d.ensureAnimationEnd),d.wrapup(q)}),clearTimeout(d.ensureAnimationEnd),d.ensureAnimationEnd=setTimeout(function(){d.wrapup(q)},d.vars.animationSpeed+100)):d.container.animate(d.args,d.vars.animationSpeed,d.vars.easing,function(){d.wrapup(q)})}d.vars.smoothHeight&&p.smoothHeight(d.vars.animationSpeed)}},d.wrapup=function(a){n||m||(0===d.currentSlide&&d.animatingTo===d.last&&d.vars.animationLoop?d.setProps(a,"jumpEnd"):d.currentSlide===d.last&&0===d.animatingTo&&d.vars.animationLoop&&d.setProps(a,"jumpStart")),d.animating=!1,d.currentSlide=d.animatingTo,d.vars.after(d)},d.animateSlides=function(){!d.animating&&q&&d.flexAnimate(d.getTarget("next"))},d.pause=function(){clearInterval(d.animatedSlides),d.animatedSlides=null,d.playing=!1,d.vars.pausePlay&&p.pausePlay.update("play"),d.syncExists&&p.sync("pause")},d.play=function(){d.playing&&clearInterval(d.animatedSlides),d.animatedSlides=d.animatedSlides||setInterval(d.animateSlides,d.vars.slideshowSpeed),d.started=d.playing=!0,d.vars.pausePlay&&p.pausePlay.update("pause"),d.syncExists&&p.sync("play")},d.stop=function(){d.pause(),d.stopped=!0},d.canAdvance=function(a,b){var c=o?d.pagingCount-1:d.last;return b?!0:o&&d.currentItem===d.count-1&&0===a&&"prev"===d.direction?!0:o&&0===d.currentItem&&a===d.pagingCount-1&&"next"!==d.direction?!1:a!==d.currentSlide||o?d.vars.animationLoop?!0:d.atEnd&&0===d.currentSlide&&a===c&&"next"!==d.direction?!1:d.atEnd&&d.currentSlide===c&&0===a&&"next"===d.direction?!1:!0:!1},d.getTarget=function(a){return d.direction=a,"next"===a?d.currentSlide===d.last?0:d.currentSlide+1:0===d.currentSlide?d.last:d.currentSlide-1},d.setProps=function(a,b,c){var e=function(){var c=a?a:(d.itemW+d.vars.itemMargin)*d.move*d.animatingTo,e=function(){if(m)return"setTouch"===b?a:l&&d.animatingTo===d.last?0:l?d.limit-(d.itemW+d.vars.itemMargin)*d.move*d.animatingTo:d.animatingTo===d.last?d.limit:c;switch(b){case"setTotal":return l?(d.count-1-d.currentSlide+d.cloneOffset)*a:(d.currentSlide+d.cloneOffset)*a;case"setTouch":return l?a:a;case"jumpEnd":return l?a:d.count*a;case"jumpStart":return l?d.count*a:a;default:return a}}();return-1*e+"px"}();d.transitions&&(e=k?"translate3d(0,"+e+",0)":"translate3d("+e+",0,0)",c=void 0!==c?c/1e3+"s":"0s",d.container.css("-"+d.pfx+"-transition-duration",c),d.container.css("transition-duration",c)),d.args[d.prop]=e,(d.transitions||void 0===c)&&d.container.css(d.args),d.container.css("transform",e)},d.setup=function(b){if(n)d.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"}),"init"===b&&(g?d.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+d.vars.animationSpeed/1e3+"s ease",zIndex:1}).eq(d.currentSlide).css({opacity:1,zIndex:2}):d.slides.css({opacity:0,display:"block",zIndex:1}).eq(d.currentSlide).css({zIndex:2}).animate({opacity:1},d.vars.animationSpeed,d.vars.easing)),d.vars.smoothHeight&&p.smoothHeight();else{var c,f;"init"===b&&(d.viewport=a('<div class="'+e+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(d).append(d.container),d.cloneCount=0,d.cloneOffset=0,l&&(f=a.makeArray(d.slides).reverse(),d.slides=a(f),d.container.empty().append(d.slides))),d.vars.animationLoop&&!m&&(d.cloneCount=2,d.cloneOffset=1,"init"!==b&&d.container.find(".clone").remove(),p.uniqueID(d.slides.first().clone().addClass("clone").attr("aria-hidden","true")).appendTo(d.container),p.uniqueID(d.slides.last().clone().addClass("clone").attr("aria-hidden","true")).prependTo(d.container)),d.newSlides=a(d.vars.selector,d),c=l?d.count-1-d.currentSlide+d.cloneOffset:d.currentSlide+d.cloneOffset,k&&!m?(d.container.height(200*(d.count+d.cloneCount)+"%").css("position","absolute").width("100%"),setTimeout(function(){d.newSlides.css({display:"block"}),d.doMath(),d.viewport.height(d.h),d.setProps(c*d.h,"init")},"init"===b?100:0)):(d.container.width(200*(d.count+d.cloneCount)+"%"),d.setProps(c*d.computedW,"init"),setTimeout(function(){d.doMath(),d.newSlides.css({width:d.computedW,"float":"left",display:"block"}),d.vars.smoothHeight&&p.smoothHeight()},"init"===b?100:0))}m||d.slides.removeClass(e+"active-slide").eq(d.currentSlide).addClass(e+"active-slide"),d.vars.init(d)},d.doMath=function(){var a=d.slides.first(),b=d.vars.itemMargin,c=d.vars.minItems,e=d.vars.maxItems;d.w=void 0===d.viewport?d.width():d.viewport.width(),d.h=a.height(),d.boxPadding=a.outerWidth()-a.width(),m?(d.itemT=d.vars.itemWidth+b,d.minW=c?c*d.itemT:d.w,d.maxW=e?e*d.itemT-b:d.w,d.itemW=d.minW>d.w?(d.w-b*(c-1))/c:d.maxW<d.w?(d.w-b*(e-1))/e:d.vars.itemWidth>d.w?d.w:d.vars.itemWidth,d.visible=Math.floor(d.w/d.itemW),d.move=d.vars.move>0&&d.vars.move<d.visible?d.vars.move:d.visible,d.pagingCount=Math.ceil((d.count-d.visible)/d.move+1),d.last=d.pagingCount-1,d.limit=1===d.pagingCount?0:d.vars.itemWidth>d.w?d.itemW*(d.count-1)+b*(d.count-1):(d.itemW+b)*d.count-d.w-b):(d.itemW=d.w,d.pagingCount=d.count,d.last=d.count-1),d.computedW=d.itemW-d.boxPadding},d.update=function(a,b){d.doMath(),m||(a<d.currentSlide?d.currentSlide+=1:a<=d.currentSlide&&0!==a&&(d.currentSlide-=1),d.animatingTo=d.currentSlide),d.vars.controlNav&&!d.manualControls&&("add"===b&&!m||d.pagingCount>d.controlNav.length?p.controlNav.update("add"):("remove"===b&&!m||d.pagingCount<d.controlNav.length)&&(m&&d.currentSlide>d.last&&(d.currentSlide-=1,d.animatingTo-=1),p.controlNav.update("remove",d.last))),d.vars.directionNav&&p.directionNav.update()},d.addSlide=function(b,c){var e=a(b);d.count+=1,d.last=d.count-1,k&&l?void 0!==c?d.slides.eq(d.count-c).after(e):d.container.prepend(e):void 0!==c?d.slides.eq(c).before(e):d.container.append(e),d.update(c,"add"),d.slides=a(d.vars.selector+":not(.clone)",d),d.setup(),d.vars.added(d)},d.removeSlide=function(b){var c=isNaN(b)?d.slides.index(a(b)):b;d.count-=1,d.last=d.count-1,isNaN(b)?a(b,d.slides).remove():k&&l?d.slides.eq(d.last).remove():d.slides.eq(b).remove(),d.doMath(),d.update(c,"remove"),d.slides=a(d.vars.selector+":not(.clone)",d),d.setup(),d.vars.removed(d)},p.init()},a(window).blur(function(){focused=!1}).focus(function(){focused=!0}),a.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:!1,animationLoop:!0,smoothHeight:!1,startAt:0,slideshow:!0,slideshowSpeed:7e3,animationSpeed:600,initDelay:0,randomize:!1,thumbCaptions:!1,pauseOnAction:!0,pauseOnHover:!1,pauseInvisible:!0,useCSS:!0,touch:!0,video:!1,controlNav:!0,directionNav:!0,prevText:"Previous",nextText:"Next",keyboard:!0,multipleKeyboard:!1,mousewheel:!1,pausePlay:!1,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:!0,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}},a.fn.flexslider=function(b){if(void 0===b&&(b={}),"object"==typeof b)return this.each(function(){var c=a(this),d=b.selector?b.selector:".slides > li",e=c.find(d);1===e.length&&b.allowOneSlide===!0||0===e.length?(e.fadeIn(400),b.start&&b.start(c)):void 0===c.data("flexslider")&&new a.flexslider(this,b)});var c=a(this).data("flexslider");switch(b){case"play":c.play();break;case"pause":c.pause();break;case"stop":c.stop();break;case"next":c.flexAnimate(c.getTarget("next"),!0);break;case"prev":case"previous":c.flexAnimate(c.getTarget("prev"),!0);break;default:"number"==typeof b&&c.flexAnimate(b,!0)}}}(jQuery),function($){$.flexslider=function(el,options){var slider=$(el);slider.vars=$.extend({},$.flexslider.defaults,options);var watchedEventClearTimer,namespace=slider.vars.namespace,msGesture=window.navigator&&window.navigator.msPointerEnabled&&window.MSGesture,touch=("ontouchstart"in window||msGesture||window.DocumentTouch&&document instanceof DocumentTouch)&&slider.vars.touch,eventType="click touchend MSPointerUp keyup",watchedEvent="",vertical="vertical"===slider.vars.direction,reverse=slider.vars.reverse,carousel=slider.vars.itemWidth>0,fade="fade"===slider.vars.animation,asNav=""!==slider.vars.asNavFor,methods={},focused=!0;$.data(el,"flexslider",slider),methods={init:function(){slider.animating=!1,slider.currentSlide=parseInt(slider.vars.startAt?slider.vars.startAt:0,10),isNaN(slider.currentSlide)&&(slider.currentSlide=0),slider.animatingTo=slider.currentSlide,slider.atEnd=0===slider.currentSlide||slider.currentSlide===slider.last,slider.containerSelector=slider.vars.selector.substr(0,slider.vars.selector.search(" ")),slider.slides=$(slider.vars.selector,slider),slider.container=$(slider.containerSelector,slider),slider.count=slider.slides.length,slider.syncExists=$(slider.vars.sync).length>0,"slide"===slider.vars.animation&&(slider.vars.animation="swing"),slider.prop=vertical?"top":"marginLeft",slider.args={},slider.manualPause=!1,slider.stopped=!1,slider.started=!1,slider.startTimeout=null,slider.transitions=!slider.vars.video&&!fade&&slider.vars.useCSS&&function(){var obj=document.createElement("div"),props=["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"];for(var i in props)if(void 0!==obj.style[props[i]])return slider.pfx=props[i].replace("Perspective","").toLowerCase(),slider.prop="-"+slider.pfx+"-transform",!0;return!1}(),slider.ensureAnimationEnd="",""!==slider.vars.controlsContainer&&(slider.controlsContainer=$(slider.vars.controlsContainer).length>0&&$(slider.vars.controlsContainer)),""!==slider.vars.manualControls&&(slider.manualControls=$(slider.vars.manualControls).length>0&&$(slider.vars.manualControls)),slider.vars.randomize&&(slider.slides.sort(function(){return Math.round(Math.random())-.5}),slider.container.empty().append(slider.slides)),slider.doMath(),slider.setup("init"),slider.vars.controlNav&&methods.controlNav.setup(),slider.vars.directionNav&&methods.directionNav.setup(),slider.vars.keyboard&&(1===$(slider.containerSelector).length||slider.vars.multipleKeyboard)&&$(document).bind("keyup",function(event){var keycode=event.keyCode;if(!slider.animating&&(39===keycode||37===keycode)){var target=39===keycode?slider.getTarget("next"):37===keycode?slider.getTarget("prev"):!1;slider.flexAnimate(target,slider.vars.pauseOnAction)}}),slider.vars.mousewheel&&slider.bind("mousewheel",function(event,delta){event.preventDefault();var target=slider.getTarget(0>delta?"next":"prev");slider.flexAnimate(target,slider.vars.pauseOnAction)}),slider.vars.pausePlay&&methods.pausePlay.setup(),slider.vars.slideshow&&slider.vars.pauseInvisible&&methods.pauseInvisible.init(),slider.vars.slideshow&&(slider.vars.pauseOnHover&&slider.hover(function(){slider.manualPlay||slider.manualPause||slider.pause()},function(){slider.manualPause||slider.manualPlay||slider.stopped||slider.play()}),slider.vars.pauseInvisible&&methods.pauseInvisible.isHidden()||(slider.vars.initDelay>0?slider.startTimeout=setTimeout(slider.play,slider.vars.initDelay):slider.play())),asNav&&methods.asNav.setup(),touch&&slider.vars.touch&&methods.touch(),(!fade||fade&&slider.vars.smoothHeight)&&$(window).bind("resize orientationchange focus",methods.resize),slider.find("img").attr("draggable","false"),setTimeout(function(){slider.vars.start(slider)},200)},asNav:{setup:function(){slider.asNav=!0,slider.animatingTo=Math.floor(slider.currentSlide/slider.move),slider.currentItem=slider.currentSlide,slider.slides.removeClass(namespace+"active-slide").eq(slider.currentItem).addClass(namespace+"active-slide"),msGesture?(el._slider=slider,slider.slides.each(function(){var that=this;that._gesture=new MSGesture,that._gesture.target=that,that.addEventListener("MSPointerDown",function(e){e.preventDefault(),e.currentTarget._gesture&&e.currentTarget._gesture.addPointer(e.pointerId)},!1),that.addEventListener("MSGestureTap",function(e){e.preventDefault();var $slide=$(this),target=$slide.index();$(slider.vars.asNavFor).data("flexslider").animating||$slide.hasClass("active")||(slider.direction=slider.currentItem<target?"next":"prev",slider.flexAnimate(target,slider.vars.pauseOnAction,!1,!0,!0))})})):slider.slides.on(eventType,function(e){e.preventDefault();var $slide=$(this),target=$slide.index(),posFromLeft=$slide.offset().left-$(slider).scrollLeft();0>=posFromLeft&&$slide.hasClass(namespace+"active-slide")?slider.flexAnimate(slider.getTarget("prev"),!0):$(slider.vars.asNavFor).data("flexslider").animating||$slide.hasClass(namespace+"active-slide")||(slider.direction=slider.currentItem<target?"next":"prev",slider.flexAnimate(target,slider.vars.pauseOnAction,!1,!0,!0))})}},controlNav:{setup:function(){slider.manualControls?methods.controlNav.setupManual():methods.controlNav.setupPaging()},setupPaging:function(){var item,slide,type="thumbnails"===slider.vars.controlNav?"control-thumbs":"control-paging",j=1;if(slider.controlNavScaffold=$('<ol class="'+namespace+"control-nav "+namespace+type+'"></ol>'),slider.pagingCount>1)for(var i=0;i<slider.pagingCount;i++){if(slide=slider.slides.eq(i),item="thumbnails"===slider.vars.controlNav?'<img src="'+slide.attr("data-thumb")+'"/>':"<a>"+j+"</a>","thumbnails"===slider.vars.controlNav&&!0===slider.vars.thumbCaptions){var captn=slide.attr("data-thumbcaption");""!=captn&&void 0!=captn&&(item+='<span class="'+namespace+'caption">'+captn+"</span>")}slider.controlNavScaffold.append("<li>"+item+"</li>"),j++}slider.controlsContainer?$(slider.controlsContainer).append(slider.controlNavScaffold):slider.append(slider.controlNavScaffold),methods.controlNav.set(),methods.controlNav.active(),slider.controlNavScaffold.delegate("a, img",eventType,function(event){if(event.preventDefault(),""===watchedEvent||watchedEvent===event.type){var $this=$(this),target=slider.controlNav.index($this);$this.hasClass(namespace+"active")||(slider.direction=target>slider.currentSlide?"next":"prev",slider.flexAnimate(target,slider.vars.pauseOnAction))}""===watchedEvent&&(watchedEvent=event.type),methods.setToClearWatchedEvent()})},setupManual:function(){slider.controlNav=slider.manualControls,methods.controlNav.active(),slider.controlNav.bind(eventType,function(event){if(event.preventDefault(),""===watchedEvent||watchedEvent===event.type){var $this=$(this),target=slider.controlNav.index($this);$this.hasClass(namespace+"active")||(slider.direction=target>slider.currentSlide?"next":"prev",slider.flexAnimate(target,slider.vars.pauseOnAction))}""===watchedEvent&&(watchedEvent=event.type),methods.setToClearWatchedEvent()})},set:function(){var selector="thumbnails"===slider.vars.controlNav?"img":"a";slider.controlNav=$("."+namespace+"control-nav li "+selector,slider.controlsContainer?slider.controlsContainer:slider)},active:function(){slider.controlNav.removeClass(namespace+"active").eq(slider.animatingTo).addClass(namespace+"active")},update:function(action,pos){slider.pagingCount>1&&"add"===action?slider.controlNavScaffold.append($("<li><a>"+slider.count+"</a></li>")):1===slider.pagingCount?slider.controlNavScaffold.find("li").remove():slider.controlNav.eq(pos).closest("li").remove(),methods.controlNav.set(),slider.pagingCount>1&&slider.pagingCount!==slider.controlNav.length?slider.update(pos,action):methods.controlNav.active()}},directionNav:{setup:function(){var directionNavScaffold=$('<ul class="'+namespace+'direction-nav"><li><a class="'+namespace+'prev" href="#">'+slider.vars.prevText+'</a></li><li><a class="'+namespace+'next" href="#">'+slider.vars.nextText+"</a></li></ul>");slider.controlsContainer?($(slider.controlsContainer).append(directionNavScaffold),slider.directionNav=$("."+namespace+"direction-nav li a",slider.controlsContainer)):(slider.append(directionNavScaffold),slider.directionNav=$("."+namespace+"direction-nav li a",slider)),methods.directionNav.update(),slider.directionNav.bind(eventType,function(event){event.preventDefault();var target;(""===watchedEvent||watchedEvent===event.type)&&(target=slider.getTarget($(this).hasClass(namespace+"next")?"next":"prev"),slider.flexAnimate(target,slider.vars.pauseOnAction)),""===watchedEvent&&(watchedEvent=event.type),methods.setToClearWatchedEvent()})},update:function(){var disabledClass=namespace+"disabled";1===slider.pagingCount?slider.directionNav.addClass(disabledClass).attr("tabindex","-1"):slider.vars.animationLoop?slider.directionNav.removeClass(disabledClass).removeAttr("tabindex"):0===slider.animatingTo?slider.directionNav.removeClass(disabledClass).filter("."+namespace+"prev").addClass(disabledClass).attr("tabindex","-1"):slider.animatingTo===slider.last?slider.directionNav.removeClass(disabledClass).filter("."+namespace+"next").addClass(disabledClass).attr("tabindex","-1"):slider.directionNav.removeClass(disabledClass).removeAttr("tabindex")}},pausePlay:{setup:function(){var pausePlayScaffold=$('<div class="'+namespace+'pauseplay"><a></a></div>');slider.controlsContainer?(slider.controlsContainer.append(pausePlayScaffold),slider.pausePlay=$("."+namespace+"pauseplay a",slider.controlsContainer)):(slider.append(pausePlayScaffold),slider.pausePlay=$("."+namespace+"pauseplay a",slider)),methods.pausePlay.update(slider.vars.slideshow?namespace+"pause":namespace+"play"),slider.pausePlay.bind(eventType,function(event){event.preventDefault(),(""===watchedEvent||watchedEvent===event.type)&&($(this).hasClass(namespace+"pause")?(slider.manualPause=!0,slider.manualPlay=!1,slider.pause()):(slider.manualPause=!1,slider.manualPlay=!0,slider.play())),""===watchedEvent&&(watchedEvent=event.type),methods.setToClearWatchedEvent()})},update:function(state){"play"===state?slider.pausePlay.removeClass(namespace+"pause").addClass(namespace+"play").html(slider.vars.playText):slider.pausePlay.removeClass(namespace+"play").addClass(namespace+"pause").html(slider.vars.pauseText)
}},touch:function(){function onTouchStart(e){slider.animating?e.preventDefault():(window.navigator.msPointerEnabled||1===e.touches.length)&&(slider.pause(),cwidth=vertical?slider.h:slider.w,startT=Number(new Date),localX=e.touches[0].pageX,localY=e.touches[0].pageY,offset=carousel&&reverse&&slider.animatingTo===slider.last?0:carousel&&reverse?slider.limit-(slider.itemW+slider.vars.itemMargin)*slider.move*slider.animatingTo:carousel&&slider.currentSlide===slider.last?slider.limit:carousel?(slider.itemW+slider.vars.itemMargin)*slider.move*slider.currentSlide:reverse?(slider.last-slider.currentSlide+slider.cloneOffset)*cwidth:(slider.currentSlide+slider.cloneOffset)*cwidth,startX=vertical?localY:localX,startY=vertical?localX:localY,el.addEventListener("touchmove",onTouchMove,!1),el.addEventListener("touchend",onTouchEnd,!1))}function onTouchMove(e){localX=e.touches[0].pageX,localY=e.touches[0].pageY,dx=vertical?startX-localY:startX-localX,scrolling=vertical?Math.abs(dx)<Math.abs(localX-startY):Math.abs(dx)<Math.abs(localY-startY);var fxms=500;(!scrolling||Number(new Date)-startT>fxms)&&(e.preventDefault(),!fade&&slider.transitions&&(slider.vars.animationLoop||(dx/=0===slider.currentSlide&&0>dx||slider.currentSlide===slider.last&&dx>0?Math.abs(dx)/cwidth+2:1),slider.setProps(offset+dx,"setTouch")))}function onTouchEnd(){if(el.removeEventListener("touchmove",onTouchMove,!1),slider.animatingTo===slider.currentSlide&&!scrolling&&null!==dx){var updateDx=reverse?-dx:dx,target=slider.getTarget(updateDx>0?"next":"prev");slider.canAdvance(target)&&(Number(new Date)-startT<550&&Math.abs(updateDx)>50||Math.abs(updateDx)>cwidth/2)?slider.flexAnimate(target,slider.vars.pauseOnAction):fade||slider.flexAnimate(slider.currentSlide,slider.vars.pauseOnAction,!0)}el.removeEventListener("touchend",onTouchEnd,!1),startX=null,startY=null,dx=null,offset=null}function onMSPointerDown(e){e.stopPropagation(),slider.animating?e.preventDefault():(slider.pause(),el._gesture.addPointer(e.pointerId),accDx=0,cwidth=vertical?slider.h:slider.w,startT=Number(new Date),offset=carousel&&reverse&&slider.animatingTo===slider.last?0:carousel&&reverse?slider.limit-(slider.itemW+slider.vars.itemMargin)*slider.move*slider.animatingTo:carousel&&slider.currentSlide===slider.last?slider.limit:carousel?(slider.itemW+slider.vars.itemMargin)*slider.move*slider.currentSlide:reverse?(slider.last-slider.currentSlide+slider.cloneOffset)*cwidth:(slider.currentSlide+slider.cloneOffset)*cwidth)}function onMSGestureChange(e){e.stopPropagation();var slider=e.target._slider;if(slider){var transX=-e.translationX,transY=-e.translationY;return accDx+=vertical?transY:transX,dx=accDx,scrolling=vertical?Math.abs(accDx)<Math.abs(-transX):Math.abs(accDx)<Math.abs(-transY),e.detail===e.MSGESTURE_FLAG_INERTIA?void setImmediate(function(){el._gesture.stop()}):void((!scrolling||Number(new Date)-startT>500)&&(e.preventDefault(),!fade&&slider.transitions&&(slider.vars.animationLoop||(dx=accDx/(0===slider.currentSlide&&0>accDx||slider.currentSlide===slider.last&&accDx>0?Math.abs(accDx)/cwidth+2:1)),slider.setProps(offset+dx,"setTouch"))))}}function onMSGestureEnd(e){e.stopPropagation();var slider=e.target._slider;if(slider){if(slider.animatingTo===slider.currentSlide&&!scrolling&&null!==dx){var updateDx=reverse?-dx:dx,target=slider.getTarget(updateDx>0?"next":"prev");slider.canAdvance(target)&&(Number(new Date)-startT<550&&Math.abs(updateDx)>50||Math.abs(updateDx)>cwidth/2)?slider.flexAnimate(target,slider.vars.pauseOnAction):fade||slider.flexAnimate(slider.currentSlide,slider.vars.pauseOnAction,!0)}startX=null,startY=null,dx=null,offset=null,accDx=0}}var startX,startY,offset,cwidth,dx,startT,scrolling=!1,localX=0,localY=0,accDx=0;msGesture?(el.style.msTouchAction="none",el._gesture=new MSGesture,el._gesture.target=el,el.addEventListener("MSPointerDown",onMSPointerDown,!1),el._slider=slider,el.addEventListener("MSGestureChange",onMSGestureChange,!1),el.addEventListener("MSGestureEnd",onMSGestureEnd,!1)):el.addEventListener("touchstart",onTouchStart,!1)},resize:function(){!slider.animating&&slider.is(":visible")&&(carousel||slider.doMath(),fade?methods.smoothHeight():carousel?(slider.slides.width(slider.computedW),slider.update(slider.pagingCount),slider.setProps()):vertical?(slider.viewport.height(slider.h),slider.setProps(slider.h,"setTotal")):(slider.vars.smoothHeight&&methods.smoothHeight(),slider.newSlides.width(slider.computedW),slider.setProps(slider.computedW,"setTotal")))},smoothHeight:function(dur){if(!vertical||fade){var $obj=fade?slider:slider.viewport;dur?$obj.animate({height:slider.slides.eq(slider.animatingTo).height()},dur):$obj.height(slider.slides.eq(slider.animatingTo).height())}},sync:function(action){var $obj=$(slider.vars.sync).data("flexslider"),target=slider.animatingTo;switch(action){case"animate":$obj.flexAnimate(target,slider.vars.pauseOnAction,!1,!0);break;case"play":$obj.playing||$obj.asNav||$obj.play();break;case"pause":$obj.pause()}},uniqueID:function($clone){return $clone.filter("[id]").add($clone.find("[id]")).each(function(){var $this=$(this);$this.attr("id",$this.attr("id")+"_clone")}),$clone},pauseInvisible:{visProp:null,init:function(){var prefixes=["webkit","moz","ms","o"];if("hidden"in document)return"hidden";for(var i=0;i<prefixes.length;i++)prefixes[i]+"Hidden"in document&&(methods.pauseInvisible.visProp=prefixes[i]+"Hidden");if(methods.pauseInvisible.visProp){var evtname=methods.pauseInvisible.visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(evtname,function(){methods.pauseInvisible.isHidden()?slider.startTimeout?clearTimeout(slider.startTimeout):slider.pause():slider.started?slider.play():slider.vars.initDelay>0?setTimeout(slider.play,slider.vars.initDelay):slider.play()})}},isHidden:function(){return document[methods.pauseInvisible.visProp]||!1}},setToClearWatchedEvent:function(){clearTimeout(watchedEventClearTimer),watchedEventClearTimer=setTimeout(function(){watchedEvent=""},3e3)}},slider.flexAnimate=function(target,pause,override,withSync,fromNav){if(slider.vars.animationLoop||target===slider.currentSlide||(slider.direction=target>slider.currentSlide?"next":"prev"),asNav&&1===slider.pagingCount&&(slider.direction=slider.currentItem<target?"next":"prev"),!slider.animating&&(slider.canAdvance(target,fromNav)||override)&&slider.is(":visible")){if(asNav&&withSync){var master=$(slider.vars.asNavFor).data("flexslider");if(slider.atEnd=0===target||target===slider.count-1,master.flexAnimate(target,!0,!1,!0,fromNav),slider.direction=slider.currentItem<target?"next":"prev",master.direction=slider.direction,Math.ceil((target+1)/slider.visible)-1===slider.currentSlide||0===target)return slider.currentItem=target,slider.slides.removeClass(namespace+"active-slide").eq(target).addClass(namespace+"active-slide"),!1;slider.currentItem=target,slider.slides.removeClass(namespace+"active-slide").eq(target).addClass(namespace+"active-slide"),target=Math.floor(target/slider.visible)}if(slider.animating=!0,slider.animatingTo=target,pause&&slider.pause(),slider.vars.before(slider),slider.syncExists&&!fromNav&&methods.sync("animate"),slider.vars.controlNav&&methods.controlNav.active(),carousel||slider.slides.removeClass(namespace+"active-slide").eq(target).addClass(namespace+"active-slide"),slider.atEnd=0===target||target===slider.last,slider.vars.directionNav&&methods.directionNav.update(),target===slider.last&&(slider.vars.end(slider),slider.vars.animationLoop||slider.pause()),fade)touch?(slider.slides.eq(slider.currentSlide).css({opacity:0,zIndex:1}),slider.slides.eq(target).css({opacity:1,zIndex:2}),slider.wrapup(dimension)):(slider.slides.eq(slider.currentSlide).css({zIndex:1}).animate({opacity:0},slider.vars.animationSpeed,slider.vars.easing),slider.slides.eq(target).css({zIndex:2}).animate({opacity:1},slider.vars.animationSpeed,slider.vars.easing,slider.wrapup));else{var margin,slideString,calcNext,dimension=vertical?slider.slides.filter(":first").height():slider.computedW;carousel?(margin=slider.vars.itemMargin,calcNext=(slider.itemW+margin)*slider.move*slider.animatingTo,slideString=calcNext>slider.limit&&1!==slider.visible?slider.limit:calcNext):slideString=0===slider.currentSlide&&target===slider.count-1&&slider.vars.animationLoop&&"next"!==slider.direction?reverse?(slider.count+slider.cloneOffset)*dimension:0:slider.currentSlide===slider.last&&0===target&&slider.vars.animationLoop&&"prev"!==slider.direction?reverse?0:(slider.count+1)*dimension:reverse?(slider.count-1-target+slider.cloneOffset)*dimension:(target+slider.cloneOffset)*dimension,slider.setProps(slideString,"",slider.vars.animationSpeed),slider.transitions?(slider.vars.animationLoop&&slider.atEnd||(slider.animating=!1,slider.currentSlide=slider.animatingTo),slider.container.unbind("webkitTransitionEnd transitionend"),slider.container.bind("webkitTransitionEnd transitionend",function(){clearTimeout(slider.ensureAnimationEnd),slider.wrapup(dimension)}),clearTimeout(slider.ensureAnimationEnd),slider.ensureAnimationEnd=setTimeout(function(){slider.wrapup(dimension)},slider.vars.animationSpeed+100)):slider.container.animate(slider.args,slider.vars.animationSpeed,slider.vars.easing,function(){slider.wrapup(dimension)})}slider.vars.smoothHeight&&methods.smoothHeight(slider.vars.animationSpeed)}},slider.wrapup=function(dimension){fade||carousel||(0===slider.currentSlide&&slider.animatingTo===slider.last&&slider.vars.animationLoop?slider.setProps(dimension,"jumpEnd"):slider.currentSlide===slider.last&&0===slider.animatingTo&&slider.vars.animationLoop&&slider.setProps(dimension,"jumpStart")),slider.animating=!1,slider.currentSlide=slider.animatingTo,slider.vars.after(slider)},slider.animateSlides=function(){!slider.animating&&focused&&slider.flexAnimate(slider.getTarget("next"))},slider.pause=function(){clearInterval(slider.animatedSlides),slider.animatedSlides=null,slider.playing=!1,slider.vars.pausePlay&&methods.pausePlay.update("play"),slider.syncExists&&methods.sync("pause")},slider.play=function(){slider.playing&&clearInterval(slider.animatedSlides),slider.animatedSlides=slider.animatedSlides||setInterval(slider.animateSlides,slider.vars.slideshowSpeed),slider.started=slider.playing=!0,slider.vars.pausePlay&&methods.pausePlay.update("pause"),slider.syncExists&&methods.sync("play")},slider.stop=function(){slider.pause(),slider.stopped=!0},slider.canAdvance=function(target,fromNav){var last=asNav?slider.pagingCount-1:slider.last;return fromNav?!0:asNav&&slider.currentItem===slider.count-1&&0===target&&"prev"===slider.direction?!0:asNav&&0===slider.currentItem&&target===slider.pagingCount-1&&"next"!==slider.direction?!1:target!==slider.currentSlide||asNav?slider.vars.animationLoop?!0:slider.atEnd&&0===slider.currentSlide&&target===last&&"next"!==slider.direction?!1:slider.atEnd&&slider.currentSlide===last&&0===target&&"next"===slider.direction?!1:!0:!1},slider.getTarget=function(dir){return slider.direction=dir,"next"===dir?slider.currentSlide===slider.last?0:slider.currentSlide+1:0===slider.currentSlide?slider.last:slider.currentSlide-1},slider.setProps=function(pos,special,dur){var target=function(){var posCheck=pos?pos:(slider.itemW+slider.vars.itemMargin)*slider.move*slider.animatingTo,posCalc=function(){if(carousel)return"setTouch"===special?pos:reverse&&slider.animatingTo===slider.last?0:reverse?slider.limit-(slider.itemW+slider.vars.itemMargin)*slider.move*slider.animatingTo:slider.animatingTo===slider.last?slider.limit:posCheck;switch(special){case"setTotal":return reverse?(slider.count-1-slider.currentSlide+slider.cloneOffset)*pos:(slider.currentSlide+slider.cloneOffset)*pos;case"setTouch":return reverse?pos:pos;case"jumpEnd":return reverse?pos:slider.count*pos;case"jumpStart":return reverse?slider.count*pos:pos;default:return pos}}();return-1*posCalc+"px"}();slider.transitions&&(target=vertical?"translate3d(0,"+target+",0)":"translate3d("+target+",0,0)",dur=void 0!==dur?dur/1e3+"s":"0s",slider.container.css("-"+slider.pfx+"-transition-duration",dur),slider.container.css("transition-duration",dur)),slider.args[slider.prop]=target,(slider.transitions||void 0===dur)&&slider.container.css(slider.args),slider.container.css("transform",target)},slider.setup=function(type){if(fade)slider.slides.css({width:"100%","float":"left",marginRight:"-100%",position:"relative"}),"init"===type&&(touch?slider.slides.css({opacity:0,display:"block",webkitTransition:"opacity "+slider.vars.animationSpeed/1e3+"s ease",zIndex:1}).eq(slider.currentSlide).css({opacity:1,zIndex:2}):0==slider.vars.fadeFirstSlide?slider.slides.css({opacity:0,display:"block",zIndex:1}).eq(slider.currentSlide).css({zIndex:2}).css({opacity:1}):slider.slides.css({opacity:0,display:"block",zIndex:1}).eq(slider.currentSlide).css({zIndex:2}).animate({opacity:1},slider.vars.animationSpeed,slider.vars.easing)),slider.vars.smoothHeight&&methods.smoothHeight();else{var sliderOffset,arr;"init"===type&&(slider.viewport=$('<div class="'+namespace+'viewport"></div>').css({overflow:"hidden",position:"relative"}).appendTo(slider).append(slider.container),slider.cloneCount=0,slider.cloneOffset=0,reverse&&(arr=$.makeArray(slider.slides).reverse(),slider.slides=$(arr),slider.container.empty().append(slider.slides))),slider.vars.animationLoop&&!carousel&&(slider.cloneCount=2,slider.cloneOffset=1,"init"!==type&&slider.container.find(".clone").remove(),slider.container.append(methods.uniqueID(slider.slides.first().clone().addClass("clone")).attr("aria-hidden","true")).prepend(methods.uniqueID(slider.slides.last().clone().addClass("clone")).attr("aria-hidden","true"))),slider.newSlides=$(slider.vars.selector,slider),sliderOffset=reverse?slider.count-1-slider.currentSlide+slider.cloneOffset:slider.currentSlide+slider.cloneOffset,vertical&&!carousel?(slider.container.height(200*(slider.count+slider.cloneCount)+"%").css("position","absolute").width("100%"),setTimeout(function(){slider.newSlides.css({display:"block"}),slider.doMath(),slider.viewport.height(slider.h),slider.setProps(sliderOffset*slider.h,"init")},"init"===type?100:0)):(slider.container.width(200*(slider.count+slider.cloneCount)+"%"),slider.setProps(sliderOffset*slider.computedW,"init"),setTimeout(function(){slider.doMath(),slider.newSlides.css({width:slider.computedW,"float":"left",display:"block"}),slider.vars.smoothHeight&&methods.smoothHeight()},"init"===type?100:0))}carousel||slider.slides.removeClass(namespace+"active-slide").eq(slider.currentSlide).addClass(namespace+"active-slide"),slider.vars.init(slider)},slider.doMath=function(){var slide=slider.slides.first(),slideMargin=slider.vars.itemMargin,minItems=slider.vars.minItems,maxItems=slider.vars.maxItems;slider.w=void 0===slider.viewport?slider.width():slider.viewport.width(),slider.h=slide.height(),slider.boxPadding=slide.outerWidth()-slide.width(),carousel?(slider.itemT=slider.vars.itemWidth+slideMargin,slider.minW=minItems?minItems*slider.itemT:slider.w,slider.maxW=maxItems?maxItems*slider.itemT-slideMargin:slider.w,slider.itemW=slider.minW>slider.w?(slider.w-slideMargin*(minItems-1))/minItems:slider.maxW<slider.w?(slider.w-slideMargin*(maxItems-1))/maxItems:slider.vars.itemWidth>slider.w?slider.w:slider.vars.itemWidth,slider.visible=Math.floor(slider.w/slider.itemW),slider.move=slider.vars.move>0&&slider.vars.move<slider.visible?slider.vars.move:slider.visible,slider.pagingCount=Math.ceil((slider.count-slider.visible)/slider.move+1),slider.last=slider.pagingCount-1,slider.limit=1===slider.pagingCount?0:slider.vars.itemWidth>slider.w?slider.itemW*(slider.count-1)+slideMargin*(slider.count-1):(slider.itemW+slideMargin)*slider.count-slider.w-slideMargin):(slider.itemW=slider.w,slider.pagingCount=slider.count,slider.last=slider.count-1),slider.computedW=slider.itemW-slider.boxPadding},slider.update=function(pos,action){slider.doMath(),carousel||(pos<slider.currentSlide?slider.currentSlide+=1:pos<=slider.currentSlide&&0!==pos&&(slider.currentSlide-=1),slider.animatingTo=slider.currentSlide),slider.vars.controlNav&&!slider.manualControls&&("add"===action&&!carousel||slider.pagingCount>slider.controlNav.length?methods.controlNav.update("add"):("remove"===action&&!carousel||slider.pagingCount<slider.controlNav.length)&&(carousel&&slider.currentSlide>slider.last&&(slider.currentSlide-=1,slider.animatingTo-=1),methods.controlNav.update("remove",slider.last))),slider.vars.directionNav&&methods.directionNav.update()},slider.addSlide=function(obj,pos){var $obj=$(obj);slider.count+=1,slider.last=slider.count-1,vertical&&reverse?void 0!==pos?slider.slides.eq(slider.count-pos).after($obj):slider.container.prepend($obj):void 0!==pos?slider.slides.eq(pos).before($obj):slider.container.append($obj),slider.update(pos,"add"),slider.slides=$(slider.vars.selector+":not(.clone)",slider),slider.setup(),slider.vars.added(slider)},slider.removeSlide=function(obj){var pos=isNaN(obj)?slider.slides.index($(obj)):obj;slider.count-=1,slider.last=slider.count-1,isNaN(obj)?$(obj,slider.slides).remove():vertical&&reverse?slider.slides.eq(slider.last).remove():slider.slides.eq(obj).remove(),slider.doMath(),slider.update(pos,"remove"),slider.slides=$(slider.vars.selector+":not(.clone)",slider),slider.setup(),slider.vars.removed(slider)},methods.init()},$(window).blur(function(){focused=!1}).focus(function(){focused=!0}),$.flexslider.defaults={namespace:"flex-",selector:".slides > li",animation:"fade",easing:"swing",direction:"horizontal",reverse:!1,animationLoop:!0,smoothHeight:!1,startAt:0,slideshow:!0,slideshowSpeed:7e3,animationSpeed:600,initDelay:0,randomize:!1,fadeFirstSlide:!0,thumbCaptions:!1,pauseOnAction:!0,pauseOnHover:!1,pauseInvisible:!0,useCSS:!0,touch:!0,video:!1,controlNav:!0,directionNav:!0,prevText:"Previous",nextText:"Next",keyboard:!0,multipleKeyboard:!1,mousewheel:!1,pausePlay:!1,pauseText:"Pause",playText:"Play",controlsContainer:"",manualControls:"",sync:"",asNavFor:"",itemWidth:0,itemMargin:0,minItems:1,maxItems:0,move:0,allowOneSlide:!0,start:function(){},before:function(){},after:function(){},end:function(){},added:function(){},removed:function(){},init:function(){}},$.fn.flexslider=function(options){if(void 0===options&&(options={}),"object"==typeof options)return this.each(function(){var $this=$(this),selector=options.selector?options.selector:".slides > li",$slides=$this.find(selector);1===$slides.length&&options.allowOneSlide===!0||0===$slides.length?($slides.fadeIn(400),options.start&&options.start($this)):void 0===$this.data("flexslider")&&new $.flexslider(this,options)});var $slider=$(this).data("flexslider");switch(options){case"play":$slider.play();break;case"pause":$slider.pause();break;case"stop":$slider.stop();break;case"next":$slider.flexAnimate($slider.getTarget("next"),!0);break;case"prev":case"previous":$slider.flexAnimate($slider.getTarget("prev"),!0);break;default:"number"==typeof options&&$slider.flexAnimate(options,!0)}}}(jQuery),function(d){function x(f,a,b,c){var e,g,j;b*=t,a*=t;var h,k,o,i=[];b*=-1,h=c.x,k=c.y,o=(0===c.z?1e-4:c.z)*(c.vd||25),o=Math.max(500,o);var p,v,u,q=l(b),n=m(b),r=l(a),s=m(a);return d.each(f,function(a){p=a.x-h,v=a.y-k,u=a.z||0,e=n*p-q*u,g=-q*r*p-n*r*u+s*v,j=q*s*p+n*s*u+r*v,e=e*((o-j)/o)+h,g=g*((o-j)/o)+k,i.push({x:z(e),y:z(g),z:z(j)})}),i}function A(f){return void 0!==f&&null!==f}function w(f,a,b,c,e,g,d,i){var h=[];return g>e&&g-e>n/2+1e-4?(h=h.concat(w(f,a,b,c,e,e+n/2,d,i)),h=h.concat(w(f,a,b,c,e+n/2,g,d,i))):e>g&&e-g>n/2+1e-4?(h=h.concat(w(f,a,b,c,e,e-n/2,d,i)),h=h.concat(w(f,a,b,c,e-n/2,g,d,i))):(h=g-e,["C",f+b*m(e)-b*B*h*l(e)+d,a+c*l(e)+c*B*h*m(e)+i,f+b*m(g)+b*B*h*l(g)+d,a+c*l(g)-c*B*h*m(g)+i,f+b*m(g)+d,a+c*l(g)+i])}function D(f){if(this.chart.is3d()){var a=this.chart.options.plotOptions.column.grouping;void 0!==a&&!a&&void 0!==this.group.zIndex&&this.group.attr({zIndex:10*this.group.zIndex});var b=this.options,c=this.options.states;this.borderWidth=b.borderWidth=b.edgeWidth||1,d.each(this.data,function(a){null!==a.y&&(a=a.pointAttr,this.borderColor=d.pick(b.edgeColor,a[""].fill),a[""].stroke=this.borderColor,a.hover.stroke=d.pick(c.hover.edgeColor,this.borderColor),a.select.stroke=d.pick(c.select.edgeColor,this.borderColor))})}f.apply(this,[].slice.call(arguments,1))}var n=Math.PI,t=n/180,l=Math.sin,m=Math.cos,z=Math.round,B=4*(Math.sqrt(2)-1)/3/(n/2);d.SVGRenderer.prototype.toLinePath=function(f,a){var b=[];return d.each(f,function(a){b.push("L",a.x,a.y)}),b[0]="M",a&&b.push("Z"),b},d.SVGRenderer.prototype.cuboid=function(f){var a=this.g(),f=this.cuboidPath(f);return a.front=this.path(f[0]).attr({zIndex:f[3],"stroke-linejoin":"round"}).add(a),a.top=this.path(f[1]).attr({zIndex:f[4],"stroke-linejoin":"round"}).add(a),a.side=this.path(f[2]).attr({zIndex:f[5],"stroke-linejoin":"round"}).add(a),a.fillSetter=function(a){var c=d.Color(a).brighten(.1).get(),e=d.Color(a).brighten(-.1).get();return this.front.attr({fill:a}),this.top.attr({fill:c}),this.side.attr({fill:e}),this.color=a,this},a.opacitySetter=function(a){return this.front.attr({opacity:a}),this.top.attr({opacity:a}),this.side.attr({opacity:a}),this},a.attr=function(a){return a.shapeArgs||A(a.x)?(a=this.renderer.cuboidPath(a.shapeArgs||a),this.front.attr({d:a[0],zIndex:a[3]}),this.top.attr({d:a[1],zIndex:a[4]}),this.side.attr({d:a[2],zIndex:a[5]})):d.SVGElement.prototype.attr.call(this,a),this},a.animate=function(a,c,e){return A(a.x)&&A(a.y)?(a=this.renderer.cuboidPath(a),this.front.attr({zIndex:a[3]}).animate({d:a[0]},c,e),this.top.attr({zIndex:a[4]}).animate({d:a[1]},c,e),this.side.attr({zIndex:a[5]}).animate({d:a[2]},c,e)):a.opacity?(this.front.animate(a,c,e),this.top.animate(a,c,e),this.side.animate(a,c,e)):d.SVGElement.prototype.animate.call(this,a,c,e),this},a.destroy=function(){return this.front.destroy(),this.top.destroy(),this.side.destroy(),null},a.attr({zIndex:-f[3]}),a},d.SVGRenderer.prototype.cuboidPath=function(d){var a=d.x,b=d.y,c=d.z,e=d.height,g=d.width,j=d.depth,i=d.alpha,h=d.beta,a=[{x:a,y:b,z:c},{x:a+g,y:b,z:c},{x:a+g,y:b+e,z:c},{x:a,y:b+e,z:c},{x:a,y:b+e,z:c+j},{x:a+g,y:b+e,z:c+j},{x:a+g,y:b,z:c+j},{x:a,y:b,z:c+j}],a=x(a,i,h,d.origin),d=["M",a[0].x,a[0].y,"L",a[7].x,a[7].y,"L",a[6].x,a[6].y,"L",a[1].x,a[1].y,"Z"],b=["M",a[3].x,a[3].y,"L",a[2].x,a[2].y,"L",a[5].x,a[5].y,"L",a[4].x,a[4].y,"Z"],c=["M",a[1].x,a[1].y,"L",a[2].x,a[2].y,"L",a[5].x,a[5].y,"L",a[6].x,a[6].y,"Z"],e=["M",a[0].x,a[0].y,"L",a[7].x,a[7].y,"L",a[4].x,a[4].y,"L",a[3].x,a[3].y,"Z"];return[["M",a[0].x,a[0].y,"L",a[1].x,a[1].y,"L",a[2].x,a[2].y,"L",a[3].x,a[3].y,"Z"],a[7].y<a[1].y?d:a[4].y>a[2].y?b:[],a[6].x>a[1].x?c:a[7].x<a[0].x?e:[],(a[0].z+a[1].z+a[2].z+a[3].z)/4,h>0?(a[0].z+a[7].z+a[6].z+a[1].z)/4:(a[3].z+a[2].z+a[5].z+a[4].z)/4,i>0?(a[1].z+a[2].z+a[5].z+a[6].z)/4:(a[0].z+a[7].z+a[4].z+a[3].z)/4]},d.SVGRenderer.prototype.arc3d=function(f){f.alpha*=t,f.beta*=t;var a=this.g(),b=this.arc3dPath(f),c=a.renderer,e=100*b.zTop;return a.shapeArgs=f,a.top=c.path(b.top).attr({zIndex:b.zTop}).add(a),a.side1=c.path(b.side2).attr({zIndex:b.zSide2}),a.side2=c.path(b.side1).attr({zIndex:b.zSide1}),a.inn=c.path(b.inn).attr({zIndex:b.zInn}),a.out=c.path(b.out).attr({zIndex:b.zOut}),a.fillSetter=function(a){this.color=a;var b=d.Color(a).brighten(-.1).get();return this.side1.attr({fill:b}),this.side2.attr({fill:b}),this.inn.attr({fill:b}),this.out.attr({fill:b}),this.top.attr({fill:a}),this},a.translateXSetter=function(a){this.out.attr({translateX:a}),this.inn.attr({translateX:a}),this.side1.attr({translateX:a}),this.side2.attr({translateX:a}),this.top.attr({translateX:a})},a.translateYSetter=function(a){this.out.attr({translateY:a}),this.inn.attr({translateY:a}),this.side1.attr({translateY:a}),this.side2.attr({translateY:a}),this.top.attr({translateY:a})},a.animate=function(a,b,c){return A(a.end)||A(a.start)?(this._shapeArgs=this.shapeArgs,d.SVGElement.prototype.animate.call(this,{_args:a},{duration:b,step:function(){var a=arguments[1],b=a.elem,c=b._shapeArgs,e=a.end,a=a.pos,c=d.merge(c,{x:c.x+(e.x-c.x)*a,y:c.y+(e.y-c.y)*a,r:c.r+(e.r-c.r)*a,innerR:c.innerR+(e.innerR-c.innerR)*a,start:c.start+(e.start-c.start)*a,end:c.end+(e.end-c.end)*a}),e=b.renderer.arc3dPath(c);b.shapeArgs=c,b.top.attr({d:e.top,zIndex:e.zTop}),b.inn.attr({d:e.inn,zIndex:e.zInn}),b.out.attr({d:e.out,zIndex:e.zOut}),b.side1.attr({d:e.side1,zIndex:e.zSide1}),b.side2.attr({d:e.side2,zIndex:e.zSide2})}},c)):d.SVGElement.prototype.animate.call(this,a,b,c),this},a.destroy=function(){this.top.destroy(),this.out.destroy(),this.inn.destroy(),this.side1.destroy(),this.side2.destroy(),d.SVGElement.prototype.destroy.call(this)},a.hide=function(){this.top.hide(),this.out.hide(),this.inn.hide(),this.side1.hide(),this.side2.hide()},a.show=function(){this.top.show(),this.out.show(),this.inn.show(),this.side1.show(),this.side2.show()},a.zIndex=e,a.attr({zIndex:e}),a},d.SVGRenderer.prototype.arc3dPath=function(d){var a=d.x,b=d.y,c=d.start,e=d.end-1e-5,g=d.r,j=d.innerR,i=d.depth,h=d.alpha,k=d.beta,o=m(c),q=l(c),d=m(e),y=l(e),r=g*m(k),s=g*m(h),p=j*m(k);j*=m(h);var v=i*l(k),u=i*l(h),i=["M",a+r*o,b+s*q],i=i.concat(w(a,b,r,s,c,e,0,0)),i=i.concat(["L",a+p*d,b+j*y]),i=i.concat(w(a,b,p,j,e,c,0,0)),i=i.concat(["Z"]),k=k>0?n/2:0,h=h>0?0:n/2,k=c>-k?c:e>-k?-k:c,t=n-h>e?e:n-h>c?n-h:e,h=["M",a+r*m(k),b+s*l(k)],h=h.concat(w(a,b,r,s,k,t,0,0)),h=h.concat(["L",a+r*m(t)+v,b+s*l(t)+u]),h=h.concat(w(a,b,r,s,t,k,v,u)),h=h.concat(["Z"]),k=["M",a+p*o,b+j*q],k=k.concat(w(a,b,p,j,c,e,0,0)),k=k.concat(["L",a+p*m(e)+v,b+j*l(e)+u]),k=k.concat(w(a,b,p,j,e,c,v,u)),k=k.concat(["Z"]),o=["M",a+r*o,b+s*q,"L",a+r*o+v,b+s*q+u,"L",a+p*o+v,b+j*q+u,"L",a+p*o,b+j*q,"Z"],a=["M",a+r*d,b+s*y,"L",a+r*d+v,b+s*y+u,"L",a+p*d+v,b+j*y+u,"L",a+p*d,b+j*y,"Z"],b=l((c+e)/2),c=l(c),e=l(e);return{top:i,zTop:g,out:h,zOut:Math.max(b,c,e)*g,inn:k,zInn:Math.max(b,c,e)*g,side1:o,zSide1:c*g*.99,side2:a,zSide2:e*g*.99}},d.Chart.prototype.is3d=function(){return this.options.chart.options3d&&this.options.chart.options3d.enabled},d.wrap(d.Chart.prototype,"isInsidePlot",function(d){return this.is3d()?!0:d.apply(this,[].slice.call(arguments,1))}),d.getOptions().chart.options3d={enabled:!1,alpha:0,beta:0,depth:100,viewDistance:25,frame:{bottom:{size:1,color:"rgba(255,255,255,0)"},side:{size:1,color:"rgba(255,255,255,0)"},back:{size:1,color:"rgba(255,255,255,0)"}}},d.wrap(d.Chart.prototype,"init",function(f){var b,a=[].slice.call(arguments,1);a[0].chart.options3d&&a[0].chart.options3d.enabled&&(b=a[0].plotOptions||{},b=b.pie||{},b.borderColor=d.pick(b.borderColor,void 0)),f.apply(this,a)}),d.wrap(d.Chart.prototype,"setChartSize",function(d){if(d.apply(this,[].slice.call(arguments,1)),this.is3d()){var a=this.inverted,b=this.clipBox,c=this.margin;b[a?"y":"x"]=-(c[3]||0),b[a?"x":"y"]=-(c[0]||0),b[a?"height":"width"]=this.chartWidth+(c[3]||0)+(c[1]||0),b[a?"width":"height"]=this.chartHeight+(c[0]||0)+(c[2]||0)}}),d.wrap(d.Chart.prototype,"redraw",function(d){this.is3d()&&(this.isDirtyBox=!0),d.apply(this,[].slice.call(arguments,1))}),d.Chart.prototype.retrieveStacks=function(f,a){var b={},c=1;return f||!a?this.series:(d.each(this.series,function(a){b[a.options.stack||0]?b[a.options.stack||0].series.push(a):(b[a.options.stack||0]={series:[a],position:c},c++)}),b.totalStacks=c+1,b)},d.wrap(d.Axis.prototype,"init",function(f){var a=arguments;a[1].is3d()&&(a[2].tickWidth=d.pick(a[2].tickWidth,0),a[2].gridLineWidth=d.pick(a[2].gridLineWidth,1)),f.apply(this,[].slice.call(arguments,1))}),d.wrap(d.Axis.prototype,"render",function(d){if(d.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this.chart,b=a.renderer,c=a.options.chart.options3d,e=c.alpha,g=c.beta*(a.yAxis[0].opposite?-1:1),j=c.frame,i=j.bottom,h=j.back,j=j.side,k=c.depth,o=this.height,q=this.width,l=this.left,m=this.top,c={x:a.plotLeft+a.plotWidth/2,y:a.plotTop+a.plotHeight/2,z:k,vd:c.viewDistance};if(this.horiz)this.axisLine&&this.axisLine.hide(),g={x:l,y:m+(a.yAxis[0].reversed?-i.size:o),z:0,width:q,height:i.size,depth:k,alpha:e,beta:g,origin:c},this.bottomFrame?this.bottomFrame.animate(g):this.bottomFrame=b.cuboid(g).attr({fill:i.color,zIndex:a.yAxis[0].reversed&&e>0?4:-1}).css({stroke:i.color}).add();else{var n={x:l,y:m,z:k+1,width:q,height:o+i.size,depth:h.size,alpha:e,beta:g,origin:c};this.backFrame?this.backFrame.animate(n):this.backFrame=b.cuboid(n).attr({fill:h.color,zIndex:-3}).css({stroke:h.color}).add(),this.axisLine&&this.axisLine.hide(),a={x:(a.yAxis[0].opposite?q:0)+l-j.size,y:m,z:0,width:j.size,height:o+i.size,depth:k+h.size,alpha:e,beta:g,origin:c},this.sideFrame?this.sideFrame.animate(a):this.sideFrame=b.cuboid(a).attr({fill:j.color,zIndex:-2}).css({stroke:j.color}).add()}}}),d.wrap(d.Axis.prototype,"getPlotLinePath",function(d){var a=d.apply(this,[].slice.call(arguments,1));if(!this.chart.is3d())return a;if(null===a)return a;var b=this.chart,c=b.options.chart.options3d,e=c.depth;c.origin={x:b.plotLeft+b.plotWidth/2,y:b.plotTop+b.plotHeight/2,z:e,vd:c.viewDistance};var a=[{x:a[1],y:a[2],z:this.horiz||this.opposite?e:0},{x:a[1],y:a[2],z:e},{x:a[4],y:a[5],z:e},{x:a[4],y:a[5],z:this.horiz||this.opposite?0:e}],e=b.options.inverted?c.beta:c.alpha,g=b.options.inverted?c.alpha:c.beta;return g*=b.yAxis[0].opposite?-1:1,a=x(a,e,g,c.origin),a=this.chart.renderer.toLinePath(a,!1)}),d.wrap(d.Axis.prototype,"getPlotBandPath",function(d){if(this.chart.is3d()){var a=arguments,b=a[1],a=this.getPlotLinePath(a[2]);return(b=this.getPlotLinePath(b))&&a?b.push(a[7],a[8],a[4],a[5],a[1],a[2]):b=null,b}return d.apply(this,[].slice.call(arguments,1))}),d.wrap(d.Tick.prototype,"getMarkPath",function(d){var a=d.apply(this,[].slice.call(arguments,1));if(!this.axis.chart.is3d())return a;var b=this.axis.chart,c=b.options.chart.options3d,e={x:b.plotLeft+b.plotWidth/2,y:b.plotTop+b.plotHeight/2,z:c.depth,vd:c.viewDistance},a=[{x:a[1],y:a[2],z:0},{x:a[4],y:a[5],z:0}],g=b.inverted?c.beta:c.alpha,c=b.inverted?c.alpha:c.beta;return c*=b.yAxis[0].opposite?-1:1,a=x(a,g,c,e),a=["M",a[0].x,a[0].y,"L",a[1].x,a[1].y]}),d.wrap(d.Tick.prototype,"getLabelPosition",function(d){var a=d.apply(this,[].slice.call(arguments,1));if(!this.axis.chart.is3d())return a;var b=this.axis.chart,c=b.options.chart.options3d,e={x:b.plotLeft+b.plotWidth/2,y:b.plotTop+b.plotHeight/2,z:c.depth,vd:c.viewDistance},g=b.inverted?c.beta:c.alpha,c=b.inverted?c.alpha:c.beta;return c*=b.yAxis[0].opposite?-1:1,a=x([{x:a.x,y:a.y,z:0}],g,c,e)[0]}),d.wrap(d.Axis.prototype,"drawCrosshair",function(d){var a=arguments;this.chart.is3d()&&a[2]&&(a[2]={plotX:a[2].plotXold||a[2].plotX,plotY:a[2].plotYold||a[2].plotY}),d.apply(this,[].slice.call(a,1))}),d.wrap(d.seriesTypes.column.prototype,"translate",function(f){if(f.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this.chart,b=this.options,c=a.options.chart.options3d,e=b.depth||25,g={x:a.plotWidth/2,y:a.plotHeight/2,z:c.depth,vd:c.viewDistance},j=c.alpha,i=c.beta*(a.yAxis[0].opposite?-1:1),h=(b.stacking?b.stack||0:this._i)*(e+(b.groupZPadding||1));b.grouping!==!1&&(h=0),h+=b.groupZPadding||1,d.each(this.data,function(a){if(null!==a.y){var b=a.shapeArgs,c=a.tooltipPos;a.shapeType="cuboid",b.alpha=j,b.beta=i,b.z=h,b.origin=g,b.depth=e,c=x([{x:c[0],y:c[1],z:h}],j,i,g)[0],a.tooltipPos=[c.x,c.y]}})}}),d.wrap(d.seriesTypes.column.prototype,"animate",function(f){if(this.chart.is3d()){var a=arguments[1],b=this.yAxis,c=this,e=this.yAxis.reversed;d.svg&&(a?d.each(c.data,function(a){null===a.y||(a.height=a.shapeArgs.height,a.shapey=a.shapeArgs.y,a.shapeArgs.height=1,e)||(a.shapeArgs.y=a.stackY?a.plotY+b.translate(a.stackY):a.plotY+(a.negative?-a.height:a.height))}):(d.each(c.data,function(a){null!==a.y&&(a.shapeArgs.height=a.height,a.shapeArgs.y=a.shapey,a.graphic&&a.graphic.animate(a.shapeArgs,c.options.animation))}),this.drawDataLabels(),c.animate=null))}else f.apply(this,[].slice.call(arguments,1))}),d.wrap(d.seriesTypes.column.prototype,"init",function(d){if(d.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this.options,b=a.grouping,c=a.stacking,e=0;if((void 0===b||b)&&c){for(b=this.chart.retrieveStacks(b,c),c=a.stack||0,e=0;e<b[c].series.length&&b[c].series[e]!==this;e++);e=10*b.totalStacks-10*(b.totalStacks-b[c].position)-e
}a.zIndex=e}}),d.wrap(d.Series.prototype,"alignDataLabel",function(d){if(this.chart.is3d()&&("column"===this.type||"columnrange"===this.type)){var a=this.chart,b=a.options.chart.options3d,c=arguments[4],e={x:c.x,y:c.y,z:0},e=x([e],b.alpha,b.beta*(a.yAxis[0].opposite?-1:1),{x:a.plotWidth/2,y:a.plotHeight/2,z:b.depth,vd:b.viewDistance})[0];c.x=e.x,c.y=e.y}d.apply(this,[].slice.call(arguments,1))}),d.seriesTypes.columnrange&&d.wrap(d.seriesTypes.columnrange.prototype,"drawPoints",D),d.wrap(d.seriesTypes.column.prototype,"drawPoints",D);var C=d.getOptions();C.plotOptions.cylinder=d.merge(C.plotOptions.column),C=d.extendClass(d.seriesTypes.column,{type:"cylinder"}),d.seriesTypes.cylinder=C,d.wrap(d.seriesTypes.cylinder.prototype,"translate",function(f){if(f.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this.chart,b=a.options,c=b.plotOptions.cylinder,b=b.chart.options3d,e=c.depth||0,g={x:a.inverted?a.plotHeight/2:a.plotWidth/2,y:a.inverted?a.plotWidth/2:a.plotHeight/2,z:b.depth,vd:b.viewDistance},j=b.alpha,i=c.stacking?(this.options.stack||0)*e:this._i*e;i+=e/2,c.grouping!==!1&&(i=0),d.each(this.data,function(a){var b=a.shapeArgs;a.shapeType="arc3d",b.x+=e/2,b.z=i,b.start=0,b.end=2*n,b.r=.95*e,b.innerR=0,b.depth=b.height*(1/l((90-j)*t))-i,b.alpha=90-j,b.beta=0,b.origin=g})}}),d.wrap(d.seriesTypes.pie.prototype,"translate",function(f){if(f.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this,b=a.chart,c=a.options,e=c.depth||0,g=b.options.chart.options3d,j={x:b.plotWidth/2,y:b.plotHeight/2,z:g.depth},i=g.alpha,h=g.beta,k=c.stacking?(c.stack||0)*e:a._i*e;k+=e/2,c.grouping!==!1&&(k=0),d.each(a.data,function(b){b.shapeType="arc3d";var c=b.shapeArgs;b.y&&(c.z=k,c.depth=.75*e,c.origin=j,c.alpha=i,c.beta=h,c=(c.end+c.start)/2,b.slicedTranslation={translateX:z(m(c)*a.options.slicedOffset*m(i*t)),translateY:z(l(c)*a.options.slicedOffset*m(i*t))})})}}),d.wrap(d.seriesTypes.pie.prototype.pointClass.prototype,"haloPath",function(d){var a=arguments;return this.series.chart.is3d()?[]:d.call(this,a[1])}),d.wrap(d.seriesTypes.pie.prototype,"drawPoints",function(f){if(this.chart.is3d()){var a=this.options,b=this.options.states;this.borderWidth=a.borderWidth=a.edgeWidth||1,this.borderColor=a.edgeColor=d.pick(a.edgeColor,a.borderColor,void 0),b.hover.borderColor=d.pick(b.hover.edgeColor,this.borderColor),b.hover.borderWidth=d.pick(b.hover.edgeWidth,this.borderWidth),b.select.borderColor=d.pick(b.select.edgeColor,this.borderColor),b.select.borderWidth=d.pick(b.select.edgeWidth,this.borderWidth),d.each(this.data,function(a){var c=a.pointAttr;c[""].stroke=a.series.borderColor||a.color,c[""]["stroke-width"]=a.series.borderWidth,c.hover.stroke=b.hover.borderColor,c.hover["stroke-width"]=b.hover.borderWidth,c.select.stroke=b.select.borderColor,c.select["stroke-width"]=b.select.borderWidth})}if(f.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var c=this.group;d.each(this.points,function(a){a.graphic.out.add(c),a.graphic.inn.add(c),a.graphic.side1.add(c),a.graphic.side2.add(c)})}}),d.wrap(d.seriesTypes.pie.prototype,"drawDataLabels",function(f){this.chart.is3d()&&d.each(this.data,function(a){var b=a.shapeArgs,c=b.r,d=b.depth,f=b.alpha*t,b=(b.start+b.end)/2,a=a.labelPos;a[1]+=-c*(1-m(f))*l(b)+(l(b)>0?l(f)*d:0),a[3]+=-c*(1-m(f))*l(b)+(l(b)>0?l(f)*d:0),a[5]+=-c*(1-m(f))*l(b)+(l(b)>0?l(f)*d:0)}),f.apply(this,[].slice.call(arguments,1))}),d.wrap(d.seriesTypes.pie.prototype,"addPoint",function(d){d.apply(this,[].slice.call(arguments,1)),this.chart.is3d()&&this.update()}),d.wrap(d.seriesTypes.pie.prototype,"animate",function(f){if(this.chart.is3d()){var a=arguments[1],b=this.options.animation,c=this.center,e=this.group,g=this.markerGroup;d.svg&&(b===!0&&(b={}),a?(e.oldtranslateX=e.translateX,e.oldtranslateY=e.translateY,a={translateX:c[0],translateY:c[1],scaleX:.001,scaleY:.001},e.attr(a),g&&(g.attrSetters=e.attrSetters,g.attr(a))):(a={translateX:e.oldtranslateX,translateY:e.oldtranslateY,scaleX:1,scaleY:1},e.animate(a,b),g&&g.animate(a,b),this.animate=null))}else f.apply(this,[].slice.call(arguments,1))}),d.wrap(d.seriesTypes.scatter.prototype,"translate",function(f){if(f.apply(this,[].slice.call(arguments,1)),this.chart.is3d()){var a=this.chart,b=this.chart.options.chart.options3d,c=b.alpha,e=b.beta,g={x:a.inverted?a.plotHeight/2:a.plotWidth/2,y:a.inverted?a.plotWidth/2:a.plotHeight/2,z:b.depth,vd:b.viewDistance},b=b.depth,j=a.options.zAxis||{min:0,max:b},i=b/(j.max-j.min);d.each(this.data,function(a){var b={x:a.plotX,y:a.plotY,z:(a.z-j.min)*i},b=x([b],c,e,g)[0];a.plotXold=a.plotX,a.plotYold=a.plotY,a.plotX=b.x,a.plotY=b.y,a.plotZ=b.z})}}),d.wrap(d.seriesTypes.scatter.prototype,"init",function(d){var a=d.apply(this,[].slice.call(arguments,1));return this.chart.is3d()&&(this.pointArrayMap=["x","y","z"],this.tooltipOptions.pointFormat=this.userOptions.tooltip?this.userOptions.tooltip.pointFormat||"x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>":"x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>"),a}),d.VMLRenderer&&(d.setOptions({animate:!1}),d.VMLRenderer.prototype.cuboid=d.SVGRenderer.prototype.cuboid,d.VMLRenderer.prototype.cuboidPath=d.SVGRenderer.prototype.cuboidPath,d.VMLRenderer.prototype.toLinePath=d.SVGRenderer.prototype.toLinePath,d.VMLRenderer.prototype.createElement3D=d.SVGRenderer.prototype.createElement3D,d.VMLRenderer.prototype.arc3d=function(f){return f=d.SVGRenderer.prototype.arc3d.call(this,f),f.css({zIndex:f.zIndex}),f},d.VMLRenderer.prototype.arc3dPath=d.SVGRenderer.prototype.arc3dPath,d.Chart.prototype.renderSeries=function(){for(var d,a=this.series.length;a--;)d=this.series[a],d.translate(),d.setTooltipPoints&&d.setTooltipPoints(),d.render()},d.wrap(d.Axis.prototype,"render",function(d){d.apply(this,[].slice.call(arguments,1)),this.sideFrame&&(this.sideFrame.css({zIndex:0}),this.sideFrame.front.attr({fill:this.sideFrame.color})),this.bottomFrame&&(this.bottomFrame.css({zIndex:1}),this.bottomFrame.front.attr({fill:this.bottomFrame.color})),this.backFrame&&(this.backFrame.css({zIndex:0}),this.backFrame.front.attr({fill:this.backFrame.color}))}))}(Highcharts),function(l,C){function K(a,b,c){this.init.call(this,a,b,c)}var P=l.arrayMin,Q=l.arrayMax,s=l.each,F=l.extend,q=l.merge,R=l.map,o=l.pick,x=l.pInt,p=l.getOptions().plotOptions,g=l.seriesTypes,v=l.extendClass,L=l.splat,r=l.wrap,M=l.Axis,y=l.Tick,H=l.Point,S=l.Pointer,T=l.CenteredSeriesMixin,z=l.TrackerMixin,t=l.Series,w=Math,D=w.round,A=w.floor,N=w.max,U=l.Color,u=function(){};F(K.prototype,{init:function(a,b,c){var d=this,e=d.defaultOptions;d.chart=b,b.angular&&(e.background={}),d.options=a=q(e,a),(a=a.background)&&s([].concat(L(a)).reverse(),function(a){var b=a.backgroundColor,a=q(d.defaultBackgroundOptions,a);b&&(a.backgroundColor=b),a.color=a.backgroundColor,c.options.plotBands.unshift(a)})},defaultOptions:{center:["50%","50%"],size:"85%",startAngle:0},defaultBackgroundOptions:{shape:"circle",borderWidth:1,borderColor:"silver",backgroundColor:{linearGradient:{x1:0,y1:0,x2:0,y2:1},stops:[[0,"#FFF"],[1,"#DDD"]]},from:-Number.MAX_VALUE,innerRadius:0,to:Number.MAX_VALUE,outerRadius:"105%"}});var G=M.prototype,y=y.prototype,V={getOffset:u,redraw:function(){this.isDirty=!1},render:function(){this.isDirty=!1},setScale:u,setCategories:u,setTitle:u},O={isRadial:!0,defaultRadialGaugeOptions:{labels:{align:"center",x:0,y:null},minorGridLineWidth:0,minorTickInterval:"auto",minorTickLength:10,minorTickPosition:"inside",minorTickWidth:1,tickLength:10,tickPosition:"inside",tickWidth:2,title:{rotation:0},zIndex:2},defaultRadialXOptions:{gridLineWidth:1,labels:{align:null,distance:15,x:0,y:null},maxPadding:0,minPadding:0,showLastLabel:!1,tickLength:0},defaultRadialYOptions:{gridLineInterpolation:"circle",labels:{align:"right",x:-3,y:-2},showLastLabel:!1,title:{x:4,text:null,rotation:90}},setOptions:function(a){a=this.options=q(this.defaultOptions,this.defaultRadialOptions,a),a.plotBands||(a.plotBands=[])},getOffset:function(){G.getOffset.call(this),this.chart.axisOffset[this.side]=0,this.center=this.pane.center=T.getCenter.call(this.pane)},getLinePath:function(a,b){var c=this.center,b=o(b,c[2]/2-this.offset);return this.chart.renderer.symbols.arc(this.left+c[0],this.top+c[1],b,b,{start:this.startAngleRad,end:this.endAngleRad,open:!0,innerR:0})},setAxisTranslation:function(){G.setAxisTranslation.call(this),this.center&&(this.transA=this.isCircular?(this.endAngleRad-this.startAngleRad)/(this.max-this.min||1):this.center[2]/2/(this.max-this.min||1),this.minPixelPadding=this.isXAxis?this.transA*this.minPointOffset:0)},beforeSetTickPositions:function(){this.autoConnect&&(this.max+=this.categories&&1||this.pointRange||this.closestPointRange||0)},setAxisSize:function(){G.setAxisSize.call(this),this.isRadial&&(this.center=this.pane.center=l.CenteredSeriesMixin.getCenter.call(this.pane),this.isCircular&&(this.sector=this.endAngleRad-this.startAngleRad),this.len=this.width=this.height=this.center[2]*o(this.sector,1)/2)},getPosition:function(a,b){return this.postTranslate(this.isCircular?this.translate(a):0,o(this.isCircular?b:this.translate(a),this.center[2]/2)-this.offset)},postTranslate:function(a,b){var c=this.chart,d=this.center,a=this.startAngleRad+a;return{x:c.plotLeft+d[0]+Math.cos(a)*b,y:c.plotTop+d[1]+Math.sin(a)*b}},getPlotBandPath:function(a,b,c){var k,d=this.center,e=this.startAngleRad,f=d[2]/2,h=[o(c.outerRadius,"100%"),c.innerRadius,o(c.thickness,10)],j=/%$/,m=this.isCircular;return"polygon"===this.options.gridLineInterpolation?d=this.getPlotLinePath(a).concat(this.getPlotLinePath(b,!0)):(m||(h[0]=this.translate(a),h[1]=this.translate(b)),h=R(h,function(a){return j.test(a)&&(a=x(a,10)*f/100),a}),"circle"!==c.shape&&m?(a=e+this.translate(a),b=e+this.translate(b)):(a=-Math.PI/2,b=1.5*Math.PI,k=!0),d=this.chart.renderer.symbols.arc(this.left+d[0],this.top+d[1],h[0],h[0],{start:a,end:b,innerR:o(h[1],h[0]-h[2]),open:k})),d},getPlotLinePath:function(a,b){var h,j,k,c=this,d=c.center,e=c.chart,f=c.getPosition(a);return c.isCircular?k=["M",d[0]+e.plotLeft,d[1]+e.plotTop,"L",f.x,f.y]:"circle"===c.options.gridLineInterpolation?(a=c.translate(a))&&(k=c.getLinePath(0,a)):(s(e.xAxis,function(a){a.pane===c.pane&&(h=a)}),k=[],a=c.translate(a),d=h.tickPositions,h.autoConnect&&(d=d.concat([d[0]])),b&&(d=[].concat(d).reverse()),s(d,function(f,c){j=h.getPosition(f,a),k.push(c?"L":"M",j.x,j.y)})),k},getTitlePosition:function(){var a=this.center,b=this.chart,c=this.options.title;return{x:b.plotLeft+a[0]+(c.x||0),y:b.plotTop+a[1]-{high:.5,middle:.25,low:0}[c.align]*a[2]+(c.y||0)}}};r(G,"init",function(a,b,c){var i,j,k,d=b.angular,e=b.polar,f=c.isX,h=d&&f;k=b.options;var m=c.pane||0;d?(F(this,h?V:O),(j=!f)&&(this.defaultRadialOptions=this.defaultRadialGaugeOptions)):e&&(F(this,O),this.defaultRadialOptions=(j=f)?this.defaultRadialXOptions:q(this.defaultYAxisOptions,this.defaultRadialYOptions)),a.call(this,b,c),h||!d&&!e||(a=this.options,b.panes||(b.panes=[]),this.pane=(i=b.panes[m]=b.panes[m]||new K(L(k.pane)[m],b,this),m=i),m=m.options,b.inverted=!1,k.chart.zoomType=null,this.startAngleRad=b=(m.startAngle-90)*Math.PI/180,this.endAngleRad=k=(o(m.endAngle,m.startAngle+360)-90)*Math.PI/180,this.offset=a.offset||0,(this.isCircular=j)&&c.max===C&&k-b===2*Math.PI&&(this.autoConnect=!0))}),r(y,"getPosition",function(a,b,c,d,e){var f=this.axis;return f.getPosition?f.getPosition(c):a.call(this,b,c,d,e)}),r(y,"getLabelPosition",function(a,b,c,d,e,f,h,j,k){var m=this.axis,i=f.y,n=f.align,g=(m.translate(this.pos)+m.startAngleRad+Math.PI/2)/Math.PI*180%360;return m.isRadial?(a=m.getPosition(this.pos,m.center[2]/2+o(f.distance,-25)),"auto"===f.rotation?d.attr({rotation:g}):null===i&&(i=m.chart.renderer.fontMetrics(d.styles.fontSize).b-d.getBBox().height/2),null===n&&(n=m.isCircular?g>20&&160>g?"left":g>200&&340>g?"right":"center":"center",d.attr({align:n})),a.x+=f.x,a.y+=i):a=a.call(this,b,c,d,e,f,h,j,k),a}),r(y,"getMarkPath",function(a,b,c,d,e,f,h){var j=this.axis;return j.isRadial?(a=j.getPosition(this.pos,j.center[2]/2+d),b=["M",b,c,"L",a.x,a.y]):b=a.call(this,b,c,d,e,f,h),b}),p.arearange=q(p.area,{lineWidth:1,marker:null,threshold:null,tooltip:{pointFormat:'<span style="color:{series.color}">●</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>'},trackByArea:!0,dataLabels:{align:null,verticalAlign:null,xLow:0,xHigh:0,yLow:0,yHigh:0},states:{hover:{halo:!1}}}),g.arearange=v(g.area,{type:"arearange",pointArrayMap:["low","high"],toYData:function(a){return[a.low,a.high]},pointValKey:"low",getSegments:function(){var a=this;s(a.points,function(b){a.options.connectNulls||null!==b.low&&null!==b.high?null===b.low&&null!==b.high&&(b.y=b.high):b.y=null}),t.prototype.getSegments.call(this)},translate:function(){var a=this.yAxis;g.area.prototype.translate.apply(this),s(this.points,function(b){var c=b.low,d=b.high,e=b.plotY;null===d&&null===c?b.y=null:null===c?(b.plotLow=b.plotY=null,b.plotHigh=a.translate(d,0,1,0,1)):null===d?(b.plotLow=e,b.plotHigh=null):(b.plotLow=e,b.plotHigh=a.translate(d,0,1,0,1))})},getSegmentPath:function(a){var b,f,h,c=[],d=a.length,e=t.prototype.getSegmentPath;h=this.options;var j=h.step;for(b=HighchartsAdapter.grep(a,function(a){return null!==a.plotLow});d--;)f=a[d],null!==f.plotHigh&&c.push({plotX:f.plotX,plotY:f.plotHigh});return a=e.call(this,b),j&&(j===!0&&(j="left"),h.step={left:"right",center:"center",right:"left"}[j]),c=e.call(this,c),h.step=j,h=[].concat(a,c),c[0]="L",this.areaPath=this.areaPath.concat(a,c),h},drawDataLabels:function(){var c,j,a=this.data,b=a.length,d=[],e=t.prototype,f=this.options.dataLabels,h=f.align,k=this.chart.inverted;if(f.enabled||this._hasPointLabels){for(c=b;c--;)j=a[c],j.y=j.high,j._plotY=j.plotY,j.plotY=j.plotHigh,d[c]=j.dataLabel,j.dataLabel=j.dataLabelUpper,j.below=!1,k?(h||(f.align="left"),f.x=f.xHigh):f.y=f.yHigh;for(e.drawDataLabels&&e.drawDataLabels.apply(this,arguments),c=b;c--;)j=a[c],j.dataLabelUpper=j.dataLabel,j.dataLabel=d[c],j.y=j.low,j.plotY=j._plotY,j.below=!0,k?(h||(f.align="right"),f.x=f.xLow):f.y=f.yLow;e.drawDataLabels&&e.drawDataLabels.apply(this,arguments)}f.align=h},alignDataLabel:function(){g.column.prototype.alignDataLabel.apply(this,arguments)},getSymbol:u,drawPoints:u}),p.areasplinerange=q(p.arearange),g.areasplinerange=v(g.arearange,{type:"areasplinerange",getPointSpline:g.spline.prototype.getPointSpline}),function(){var a=g.column.prototype;p.columnrange=q(p.column,p.arearange,{lineWidth:1,pointRange:null}),g.columnrange=v(g.arearange,{type:"columnrange",translate:function(){var d,b=this,c=b.yAxis;a.translate.apply(b),s(b.points,function(a){var j,f=a.shapeArgs,h=b.options.minPointLength;a.tooltipPos=null,a.plotHigh=d=c.translate(a.high,0,1,0,1),a.plotLow=a.plotY,j=d,a=a.plotY-d,h>a&&(h-=a,a+=h,j-=h/2),f.height=a,f.y=j})},trackerGroups:["group","dataLabelsGroup"],drawGraph:u,pointAttrToOptions:a.pointAttrToOptions,drawPoints:a.drawPoints,drawTracker:a.drawTracker,animate:a.animate,getColumnMetrics:a.getColumnMetrics})}(),p.gauge=q(p.line,{dataLabels:{enabled:!0,defer:!1,y:15,borderWidth:1,borderColor:"silver",borderRadius:3,crop:!1,style:{fontWeight:"bold"},verticalAlign:"top",zIndex:2},dial:{},pivot:{},tooltip:{headerFormat:""},showInLegend:!1}),z={type:"gauge",pointClass:v(H,{setState:function(a){this.state=a}}),angular:!0,drawGraph:u,fixedBox:!0,forceDL:!0,trackerGroups:["group","dataLabelsGroup"],translate:function(){var a=this.yAxis,b=this.options,c=a.center;this.generatePoints(),s(this.points,function(d){var e=q(b.dial,d.dial),f=x(o(e.radius,80))*c[2]/200,h=x(o(e.baseLength,70))*f/100,j=x(o(e.rearLength,10))*f/100,k=e.baseWidth||3,m=e.topWidth||1,i=b.overshoot,n=a.startAngleRad+a.translate(d.y,null,null,null,!0);i&&"number"==typeof i?(i=i/180*Math.PI,n=Math.max(a.startAngleRad-i,Math.min(a.endAngleRad+i,n))):b.wrap===!1&&(n=Math.max(a.startAngleRad,Math.min(a.endAngleRad,n))),n=180*n/Math.PI,d.shapeType="path",d.shapeArgs={d:e.path||["M",-j,-k/2,"L",h,-k/2,f,-m/2,f,m/2,h,k/2,-j,k/2,"z"],translateX:c[0],translateY:c[1],rotation:n},d.plotX=c[0],d.plotY=c[1]})},drawPoints:function(){var a=this,b=a.yAxis.center,c=a.pivot,d=a.options,e=d.pivot,f=a.chart.renderer;s(a.points,function(c){var b=c.graphic,k=c.shapeArgs,e=k.d,i=q(d.dial,c.dial);b?(b.animate(k),k.d=e):c.graphic=f[c.shapeType](k).attr({stroke:i.borderColor||"none","stroke-width":i.borderWidth||0,fill:i.backgroundColor||"black",rotation:k.rotation}).add(a.group)}),c?c.animate({translateX:b[0],translateY:b[1]}):a.pivot=f.circle(0,0,o(e.radius,5)).attr({"stroke-width":e.borderWidth||0,stroke:e.borderColor||"silver",fill:e.backgroundColor||"black"}).translate(b[0],b[1]).add(a.group)},animate:function(a){var b=this;a||(s(b.points,function(a){var d=a.graphic;d&&(d.attr({rotation:180*b.yAxis.startAngleRad/Math.PI}),d.animate({rotation:a.shapeArgs.rotation},b.options.animation))}),b.animate=null)},render:function(){this.group=this.plotGroup("group","series",this.visible?"visible":"hidden",this.options.zIndex,this.chart.seriesGroup),t.prototype.render.call(this),this.group.clip(this.chart.clipRect)},setData:function(a,b){t.prototype.setData.call(this,a,!1),this.processData(),this.generatePoints(),o(b,!0)&&this.chart.redraw()},drawTracker:z&&z.drawTrackerPoint},g.gauge=v(g.line,z),p.boxplot=q(p.column,{fillColor:"#FFFFFF",lineWidth:1,medianWidth:2,states:{hover:{brightness:-.3}},threshold:null,tooltip:{pointFormat:'<span style="color:{series.color}">●</span> <b> {series.name}</b><br/>Maximum: {point.high}<br/>Upper quartile: {point.q3}<br/>Median: {point.median}<br/>Lower quartile: {point.q1}<br/>Minimum: {point.low}<br/>'},whiskerLength:"50%",whiskerWidth:2}),g.boxplot=v(g.column,{type:"boxplot",pointArrayMap:["low","q1","median","q3","high"],toYData:function(a){return[a.low,a.q1,a.median,a.q3,a.high]},pointValKey:"high",pointAttrToOptions:{fill:"fillColor",stroke:"color","stroke-width":"lineWidth"},drawDataLabels:u,translate:function(){var a=this.yAxis,b=this.pointArrayMap;g.column.prototype.translate.apply(this),s(this.points,function(c){s(b,function(b){null!==c[b]&&(c[b+"Plot"]=a.translate(c[b],0,1,0,1))})})},drawPoints:function(){var e,f,h,j,k,m,i,n,g,l,p,I,r,q,J,u,v,t,w,x,z,y,a=this,b=a.points,c=a.options,d=a.chart.renderer,E=a.doQuartiles!==!1,B=parseInt(a.options.whiskerLength,10)/100;s(b,function(b){g=b.graphic,z=b.shapeArgs,p={},q={},u={},y=b.color||a.color,b.plotY!==C&&(e=b.pointAttr[b.selected?"selected":""],v=z.width,t=A(z.x),w=t+v,x=D(v/2),f=A(E?b.q1Plot:b.lowPlot),h=A(E?b.q3Plot:b.lowPlot),j=A(b.highPlot),k=A(b.lowPlot),p.stroke=b.stemColor||c.stemColor||y,p["stroke-width"]=o(b.stemWidth,c.stemWidth,c.lineWidth),p.dashstyle=b.stemDashStyle||c.stemDashStyle,q.stroke=b.whiskerColor||c.whiskerColor||y,q["stroke-width"]=o(b.whiskerWidth,c.whiskerWidth,c.lineWidth),u.stroke=b.medianColor||c.medianColor||y,u["stroke-width"]=o(b.medianWidth,c.medianWidth,c.lineWidth),u["stroke-linecap"]="round",i=p["stroke-width"]%2/2,n=t+x+i,l=["M",n,h,"L",n,j,"M",n,f,"L",n,k],E&&(i=e["stroke-width"]%2/2,n=A(n)+i,f=A(f)+i,h=A(h)+i,t+=i,w+=i,I=["M",t,h,"L",t,f,"L",w,f,"L",w,h,"L",t,h,"z"]),B&&(i=q["stroke-width"]%2/2,j+=i,k+=i,r=["M",n-x*B,j,"L",n+x*B,j,"M",n-x*B,k,"L",n+x*B,k]),i=u["stroke-width"]%2/2,m=D(b.medianPlot)+i,J=["M",t,m,"L",w,m],g?(b.stem.animate({d:l}),B&&b.whiskers.animate({d:r}),E&&b.box.animate({d:I}),b.medianShape.animate({d:J})):(b.graphic=g=d.g().add(a.group),b.stem=d.path(l).attr(p).add(g),B&&(b.whiskers=d.path(r).attr(q).add(g)),E&&(b.box=d.path(I).attr(e).add(g)),b.medianShape=d.path(J).attr(u).add(g)))})}}),p.errorbar=q(p.boxplot,{color:"#000000",grouping:!1,linkedTo:":previous",tooltip:{pointFormat:'<span style="color:{series.color}">●</span> {series.name}: <b>{point.low}</b> - <b>{point.high}</b><br/>'},whiskerWidth:null}),g.errorbar=v(g.boxplot,{type:"errorbar",pointArrayMap:["low","high"],toYData:function(a){return[a.low,a.high]},pointValKey:"high",doQuartiles:!1,drawDataLabels:g.arearange?g.arearange.prototype.drawDataLabels:u,getColumnMetrics:function(){return this.linkedParent&&this.linkedParent.columnMetrics||g.column.prototype.getColumnMetrics.call(this)}}),p.waterfall=q(p.column,{lineWidth:1,lineColor:"#333",dashStyle:"dot",borderColor:"#333",states:{hover:{lineWidthPlus:0}}}),g.waterfall=v(g.column,{type:"waterfall",upColorProp:"fill",pointArrayMap:["low","y"],pointValKey:"y",init:function(a,b){b.stacking=!0,g.column.prototype.init.call(this,a,b)},translate:function(){var b,c,d,e,f,h,j,k,m,i,a=this.yAxis;for(b=this.options.threshold,g.column.prototype.translate.apply(this),k=m=b,d=this.points,c=0,b=d.length;b>c;c++)e=d[c],f=e.shapeArgs,h=this.getStack(c),i=h.points[this.index+","+c],isNaN(e.y)&&(e.y=this.yData[c]),j=N(k,k+e.y)+i[0],f.y=a.translate(j,0,1),e.isSum?(f.y=a.translate(i[1],0,1),f.height=a.translate(i[0],0,1)-f.y):e.isIntermediateSum?(f.y=a.translate(i[1],0,1),f.height=a.translate(m,0,1)-f.y,m=i[1]):k+=h.total,f.height<0&&(f.y+=f.height,f.height*=-1),e.plotY=f.y=D(f.y)-this.borderWidth%2/2,f.height=N(D(f.height),.001),e.yBottom=f.y+f.height,f=e.plotY+(e.negative?f.height:0),this.chart.inverted?e.tooltipPos[0]=a.len-f:e.tooltipPos[1]=f},processData:function(a){var d,f,h,j,k,m,i,b=this.yData,c=this.points,e=b.length;for(h=f=j=k=this.options.threshold||0,i=0;e>i;i++)m=b[i],d=c&&c[i]?c[i]:{},"sum"===m||d.isSum?b[i]=h:"intermediateSum"===m||d.isIntermediateSum?b[i]=f:(h+=m,f+=m),j=Math.min(h,j),k=Math.max(h,k);t.prototype.processData.call(this,a),this.dataMin=j,this.dataMax=k},toYData:function(a){return a.isSum?0===a.x?null:"sum":a.isIntermediateSum?0===a.x?null:"intermediateSum":a.y},getAttribs:function(){g.column.prototype.getAttribs.apply(this,arguments);var a=this.options,b=a.states,c=a.upColor||this.color,a=l.Color(c).brighten(.1).get(),d=q(this.pointAttr),e=this.upColorProp;d[""][e]=c,d.hover[e]=b.hover.upColor||a,d.select[e]=b.select.upColor||c,s(this.points,function(a){a.y>0&&!a.color&&(a.pointAttr=d,a.color=c)})},getGraphPath:function(){var e,f,h,a=this.data,b=a.length,c=D(this.options.lineWidth+this.borderWidth)%2/2,d=[];for(h=1;b>h;h++)f=a[h].shapeArgs,e=a[h-1].shapeArgs,f=["M",e.x+e.width,e.y+c,"L",f.x,e.y+c],a[h-1].y<0&&(f[2]+=e.height,f[5]+=e.height),d=d.concat(f);return d},getExtremes:u,getStack:function(a){var b=this.yAxis.stacks,c=this.stackKey;return this.processedYData[a]<this.options.threshold&&(c="-"+c),b[c][a]},drawGraph:t.prototype.drawGraph}),p.bubble=q(p.scatter,{dataLabels:{formatter:function(){return this.point.z},inside:!0,style:{color:"white",textShadow:"0px 0px 3px black"},verticalAlign:"middle"},marker:{lineColor:null,lineWidth:1},minSize:8,maxSize:"20%",states:{hover:{halo:{size:5}}},tooltip:{pointFormat:"({point.x}, {point.y}), Size: {point.z}"},turboThreshold:0,zThreshold:0}),z=v(H,{haloPath:function(){return H.prototype.haloPath.call(this,this.shapeArgs.r+this.series.options.states.hover.halo.size)}}),g.bubble=v(g.scatter,{type:"bubble",pointClass:z,pointArrayMap:["y","z"],parallelArrays:["x","y","z"],trackerGroups:["group","dataLabelsGroup"],bubblePadding:!0,pointAttrToOptions:{stroke:"lineColor","stroke-width":"lineWidth",fill:"fillColor"},applyOpacity:function(a){var b=this.options.marker,c=o(b.fillOpacity,.5),a=a||b.fillColor||this.color;return 1!==c&&(a=U(a).setOpacity(c).get("rgba")),a},convertAttribs:function(){var a=t.prototype.convertAttribs.apply(this,arguments);return a.fill=this.applyOpacity(a.fill),a},getRadii:function(a,b,c,d){var e,f,h,j=this.zData,k=[],m="width"!==this.options.sizeBy;for(f=0,e=j.length;e>f;f++)h=b-a,h=h>0?(j[f]-a)/(b-a):.5,m&&h>=0&&(h=Math.sqrt(h)),k.push(w.ceil(c+h*(d-c))/2);this.radii=k},animate:function(a){var b=this.options.animation;a||(s(this.points,function(a){var d=a.graphic,a=a.shapeArgs;d&&a&&(d.attr("r",1),d.animate({r:a.r},b))}),this.animate=null)},translate:function(){var a,c,d,b=this.data,e=this.radii;for(g.scatter.prototype.translate.call(this),a=b.length;a--;)c=b[a],d=e?e[a]:0,c.negative=c.z<(this.options.zThreshold||0),d>=this.minPxSize/2?(c.shapeType="circle",c.shapeArgs={x:c.plotX,y:c.plotY,r:d},c.dlBox={x:c.plotX-d,y:c.plotY-d,width:2*d,height:2*d}):c.shapeArgs=c.plotY=c.dlBox=C},drawLegendSymbol:function(a,b){var c=x(a.itemStyle.fontSize)/2;b.legendSymbol=this.chart.renderer.circle(c,a.baseline-c,c).attr({zIndex:3}).add(b.legendGroup),b.legendSymbol.isMarker=!0},drawPoints:g.column.prototype.drawPoints,alignDataLabel:g.column.prototype.alignDataLabel}),M.prototype.beforePadding=function(){var a=this,b=this.len,c=this.chart,d=0,e=b,f=this.isXAxis,h=f?"xData":"yData",j=this.min,k={},m=w.min(c.plotWidth,c.plotHeight),i=Number.MAX_VALUE,n=-Number.MAX_VALUE,g=this.max-j,l=b/g,p=[];this.tickPositions&&(s(this.series,function(b){var h=b.options;!b.bubblePadding||!b.visible&&c.options.chart.ignoreHiddenSeries||(a.allowZoomOutside=!0,p.push(b),f&&(s(["minSize","maxSize"],function(a){var b=h[a],f=/%$/.test(b),b=x(b);k[a]=f?m*b/100:b}),b.minPxSize=k.minSize,b=b.zData,b.length&&(i=o(h.zMin,w.min(i,w.max(P(b),h.displayNegative===!1?h.zThreshold:-Number.MAX_VALUE))),n=o(h.zMax,w.max(n,Q(b))))))}),s(p,function(a){var m,b=a[h],c=b.length;if(f&&a.getRadii(i,n,k.minSize,k.maxSize),g>0)for(;c--;)"number"==typeof b[c]&&(m=a.radii[c],d=Math.min((b[c]-j)*l-m,d),e=Math.max((b[c]-j)*l+m,e))}),p.length&&g>0&&o(this.options.min,this.userMin)===C&&o(this.options.max,this.userMax)===C&&(e-=b,l*=(b+d-e)/b,this.min+=d/l,this.max+=e/l))},function(){function a(a,b,c){a.call(this,b,c),this.chart.polar&&(this.closeSegment=function(a){var b=this.xAxis.center;a.push("L",b[0],b[1])},this.closedStacks=!0)}function b(a,b){var c=this.chart,d=this.options.animation,e=this.group,i=this.markerGroup,n=this.xAxis.center,g=c.plotLeft,l=c.plotTop;c.polar?c.renderer.isSVG&&(d===!0&&(d={}),b?(c={translateX:n[0]+g,translateY:n[1]+l,scaleX:.001,scaleY:.001},e.attr(c),i&&i.attr(c)):(c={translateX:g,translateY:l,scaleX:1,scaleY:1},e.animate(c,d),i&&i.animate(c,d),this.animate=null)):a.call(this,b)}var e,c=t.prototype,d=S.prototype;c.toXY=function(a){var b,c=this.chart,d=a.plotX;b=a.plotY,a.rectPlotX=d,a.rectPlotY=b,d=(d/Math.PI*180+this.xAxis.pane.options.startAngle)%360,0>d&&(d+=360),a.clientX=d,b=this.xAxis.postTranslate(a.plotX,this.yAxis.len-b),a.plotX=a.polarPlotX=b.x-c.plotLeft,a.plotY=a.polarPlotY=b.y-c.plotTop},c.orderTooltipPoints=function(a){this.chart.polar&&(a.sort(function(a,b){return a.clientX-b.clientX}),a[0])&&(a[0].wrappedClientX=a[0].clientX+360,a.push(a[0]))},g.area&&r(g.area.prototype,"init",a),g.areaspline&&r(g.areaspline.prototype,"init",a),g.spline&&r(g.spline.prototype,"getPointSpline",function(a,b,c,d){var e,i,n,g,l,p,o;return this.chart.polar?(e=c.plotX,i=c.plotY,a=b[d-1],n=b[d+1],this.connectEnds&&(a||(a=b[b.length-2]),n||(n=b[1])),a&&n&&(g=a.plotX,l=a.plotY,b=n.plotX,p=n.plotY,g=(1.5*e+g)/2.5,l=(1.5*i+l)/2.5,n=(1.5*e+b)/2.5,o=(1.5*i+p)/2.5,b=Math.sqrt(Math.pow(g-e,2)+Math.pow(l-i,2)),p=Math.sqrt(Math.pow(n-e,2)+Math.pow(o-i,2)),g=Math.atan2(l-i,g-e),l=Math.atan2(o-i,n-e),o=Math.PI/2+(g+l)/2,Math.abs(g-o)>Math.PI/2&&(o-=Math.PI),g=e+Math.cos(o)*b,l=i+Math.sin(o)*b,n=e+Math.cos(Math.PI+o)*p,o=i+Math.sin(Math.PI+o)*p,c.rightContX=n,c.rightContY=o),d?(c=["C",a.rightContX||a.plotX,a.rightContY||a.plotY,g||e,l||i,e,i],a.rightContX=a.rightContY=null):c=["M",e,i]):c=a.call(this,b,c,d),c}),r(c,"translate",function(a){if(a.call(this),this.chart.polar&&!this.preventPostTranslate)for(var a=this.points,b=a.length;b--;)this.toXY(a[b])}),r(c,"getSegmentPath",function(a,b){var c=this.points;return this.chart.polar&&this.options.connectEnds!==!1&&b[b.length-1]===c[c.length-1]&&null!==c[0].y&&(this.connectEnds=!0,b=[].concat(b,[c[0]])),a.call(this,b)}),r(c,"animate",b),r(c,"setTooltipPoints",function(a,b){return this.chart.polar&&F(this.xAxis,{tooltipLen:360}),a.call(this,b)}),g.column&&(e=g.column.prototype,r(e,"animate",b),r(e,"translate",function(a){var g,l,b=this.xAxis,c=this.yAxis.len,d=b.center,e=b.startAngleRad,i=this.chart.renderer;if(this.preventPostTranslate=!0,a.call(this),b.isRadial)for(b=this.points,l=b.length;l--;)g=b[l],a=g.barX+e,g.shapeType="path",g.shapeArgs={d:i.symbols.arc(d[0],d[1],c-g.plotY,null,{start:a,end:a+g.pointWidth,innerR:c-o(g.yBottom,c)})},this.toXY(g),g.tooltipPos=[g.plotX,g.plotY],g.ttBelow=g.plotY>d[1]}),r(e,"alignDataLabel",function(a,b,d,e,g,i){this.chart.polar?(a=b.rectPlotX/Math.PI*180,null===e.align&&(e.align=a>20&&160>a?"left":a>200&&340>a?"right":"center"),null===e.verticalAlign&&(e.verticalAlign=45>a||a>315?"bottom":a>135&&225>a?"top":"middle"),c.alignDataLabel.call(this,b,d,e,g,i)):a.call(this,b,d,e,g,i)})),r(d,"getIndex",function(a,b){var c,e,d=this.chart;return d.polar?(e=d.xAxis[0].center,c=b.chartX-e[0]-d.plotLeft,d=b.chartY-e[1]-d.plotTop,c=180-Math.round(Math.atan2(c,d)/Math.PI*180)):c=a.call(this,b),c}),r(d,"getCoordinates",function(a,b){var c=this.chart,d={xAxis:[],yAxis:[]};return c.polar?s(c.axes,function(a){var e=a.isXAxis,f=a.center,g=b.chartX-f[0]-c.plotLeft,f=b.chartY-f[1]-c.plotTop;d[e?"xAxis":"yAxis"].push({axis:a,value:a.translate(e?Math.PI-Math.atan2(g,f):Math.sqrt(Math.pow(g,2)+Math.pow(f,2)),!0)})}):d=a.call(this,b),d})}()}(Highcharts),function(){function r(a,b){var c;a||(a={});for(c in b)a[c]=b[c];return a}function w(){var a,c,b=arguments,d={},e=function(a,b){var c,d;"object"!=typeof a&&(a={});for(d in b)b.hasOwnProperty(d)&&(c=b[d],a[d]=c&&"object"==typeof c&&"[object Array]"!==Object.prototype.toString.call(c)&&"renderTo"!==d&&"number"!=typeof c.nodeType?e(a[d]||{},c):b[d]);return a};for(b[0]===!0&&(d=b[1],b=Array.prototype.slice.call(b,2)),c=b.length,a=0;c>a;a++)d=e(d,b[a]);return d}function y(a,b){return parseInt(a,b||10)}function Ga(a){return"string"==typeof a}function da(a){return a&&"object"==typeof a}function Ha(a){return"[object Array]"===Object.prototype.toString.call(a)}function ja(a){return"number"==typeof a}function za(a){return V.log(a)/V.LN10}function ka(a){return V.pow(10,a)}function la(a,b){for(var c=a.length;c--;)if(a[c]===b){a.splice(c,1);break}}function s(a){return a!==u&&null!==a}function F(a,b,c){var d,e;if(Ga(b))s(c)?a.setAttribute(b,c):a&&a.getAttribute&&(e=a.getAttribute(b));else if(s(b)&&da(b))for(d in b)a.setAttribute(d,b[d]);return e}function ra(a){return Ha(a)?a:[a]}function p(){var b,c,a=arguments,d=a.length;for(b=0;d>b;b++)if(c=a[b],c!==u&&null!==c)return c}function B(a,b){Aa&&!ba&&b&&b.opacity!==u&&(b.filter="alpha(opacity="+100*b.opacity+")"),r(a.style,b)}function $(a,b,c,d,e){return a=x.createElement(a),b&&r(a,b),e&&B(a,{padding:0,border:P,margin:0}),c&&B(a,c),d&&d.appendChild(a),a}function ma(a,b){var c=function(){return u};return c.prototype=new a,r(c.prototype,b),c}function Ba(a,b,c,d){var e=K.numberFormat,f=E.lang,g=+a||0,h=-1===b?(g.toString().split(".")[1]||"").length:isNaN(b=Q(b))?2:b,i=void 0===c?f.decimalPoint:c,f=void 0===d?f.thousandsSep:d,j=0>g?"-":"",k=String(y(g=Q(g).toFixed(h))),l=k.length>3?k.length%3:0;return e!==Ba?e(a,b,c,d):j+(l?k.substr(0,l)+f:"")+k.substr(l).replace(/(\d{3})(?=\d)/g,"$1"+f)+(h?i+Q(g-k).toFixed(h).slice(2):"")}function Ia(a,b){return Array((b||2)+1-String(a).length).join(0)+a}function Na(a,b,c){var d=a[b];a[b]=function(){var a=Array.prototype.slice.call(arguments);return a.unshift(d),c.apply(this,a)}}function Ja(a,b){for(var e,f,g,h,i,c="{",d=!1,j=[];-1!==(c=a.indexOf(c));){if(e=a.slice(0,c),d){for(f=e.split(":"),g=f.shift().split("."),i=g.length,e=b,h=0;i>h;h++)e=e[g[h]];f.length&&(f=f.join(":"),g=/\.([0-9])/,h=E.lang,i=void 0,/f$/.test(f)?(i=(i=f.match(g))?i[1]:-1,null!==e&&(e=Ba(e,i,h.decimalPoint,f.indexOf(",")>-1?h.thousandsSep:""))):e=cb(f,e))}j.push(e),a=a.slice(c+1),c=(d=!d)?"}":"{"}return j.push(a),j.join("")}function mb(a){return V.pow(10,U(V.log(a)/V.LN10))}function nb(a,b,c,d){var e,c=p(c,1);for(e=a/c,b||(b=[1,2,2.5,5,10],d===!1&&(1===c?b=[1,2,5,10]:.1>=c&&(b=[1/c]))),d=0;d<b.length&&(a=b[d],!(e<=(b[d]+(b[d+1]||b[d]))/2));d++);return a*=c}function ob(a,b){var d,e,c=a.length;for(e=0;c>e;e++)a[e].ss_i=e;for(a.sort(function(a,c){return d=b(a,c),0===d?a.ss_i-c.ss_i:d}),e=0;c>e;e++)delete a[e].ss_i}function Oa(a){for(var b=a.length,c=a[0];b--;)a[b]<c&&(c=a[b]);
return c}function Ca(a){for(var b=a.length,c=a[0];b--;)a[b]>c&&(c=a[b]);return c}function Pa(a,b){for(var c in a)a[c]&&a[c]!==b&&a[c].destroy&&a[c].destroy(),delete a[c]}function Qa(a){db||(db=$(Ka)),a&&db.appendChild(a),db.innerHTML=""}function ea(a){return parseFloat(a.toPrecision(14))}function Ra(a,b){va=p(a,b.animation)}function Bb(){var a=E.global.useUTC,b=a?"getUTC":"get",c=a?"setUTC":"set";Da=E.global.Date||window.Date,Sa=6e4*(a&&E.global.timezoneOffset||0),eb=a?Da.UTC:function(a,b,c,g,h,i){return new Da(a,b,p(c,1),p(g,0),p(h,0),p(i,0)).getTime()},pb=b+"Minutes",qb=b+"Hours",rb=b+"Day",Xa=b+"Date",fb=b+"Month",gb=b+"FullYear",Cb=c+"Minutes",Db=c+"Hours",sb=c+"Date",Eb=c+"Month",Fb=c+"FullYear"}function S(){}function Ta(a,b,c,d){this.axis=a,this.pos=b,this.type=c||"",this.isNew=!0,!c&&!d&&this.addLabel()}function na(){this.init.apply(this,arguments)}function Ya(){this.init.apply(this,arguments)}function Gb(a,b,c,d,e){var f=a.chart.inverted;this.axis=a,this.isNegative=c,this.options=b,this.x=d,this.total=null,this.points={},this.stack=e,this.alignOptions={align:b.align||(f?c?"left":"right":"center"),verticalAlign:b.verticalAlign||(f?"middle":c?"bottom":"top"),y:p(b.y,f?4:c?14:-6),x:p(b.x,f?c?-6:6:0)},this.textAlign=b.textAlign||(f?c?"right":"left":"center")}var u,Za,$a,db,E,cb,va,vb,A,ha,Da,eb,Sa,pb,qb,rb,Xa,fb,gb,Cb,Db,sb,Eb,Fb,K,x=document,G=window,V=Math,v=V.round,U=V.floor,La=V.ceil,t=V.max,L=V.min,Q=V.abs,aa=V.cos,fa=V.sin,oa=V.PI,Ea=2*oa/360,wa=navigator.userAgent,Hb=G.opera,Aa=/msie/i.test(wa)&&!Hb,hb=8===x.documentMode,tb=/AppleWebKit/.test(wa),Ua=/Firefox/.test(wa),Ib=/(Mobile|Android|Windows Phone)/.test(wa),xa="http://www.w3.org/2000/svg",ba=!!x.createElementNS&&!!x.createElementNS(xa,"svg").createSVGRect,Ob=Ua&&parseInt(wa.split("Firefox/")[1],10)<4,ga=!ba&&!Aa&&!!x.createElement("canvas").getContext,Jb={},ub=0,sa=function(){return u},W=[],ab=0,Ka="div",P="none",Pb=/^[0-9]+$/,Qb="stroke-width",H={};G.Highcharts?ha(16,!0):K=G.Highcharts={},cb=function(a,b,c){if(!s(b)||isNaN(b))return"Invalid date";var e,a=p(a,"%Y-%m-%d %H:%M:%S"),d=new Da(b-Sa),f=d[qb](),g=d[rb](),h=d[Xa](),i=d[fb](),j=d[gb](),k=E.lang,l=k.weekdays,d=r({a:l[g].substr(0,3),A:l[g],d:Ia(h),e:h,b:k.shortMonths[i],B:k.months[i],m:Ia(i+1),y:j.toString().substr(2,2),Y:j,H:Ia(f),I:Ia(f%12||12),l:f%12||12,M:Ia(d[pb]()),p:12>f?"AM":"PM",P:12>f?"am":"pm",S:Ia(d.getSeconds()),L:Ia(v(b%1e3),3)},K.dateFormats);for(e in d)for(;-1!==a.indexOf("%"+e);)a=a.replace("%"+e,"function"==typeof d[e]?d[e](b):d[e]);return c?a.substr(0,1).toUpperCase()+a.substr(1):a},ha=function(a,b){var c="Highcharts error #"+a+": www.highcharts.com/errors/"+a;if(b)throw c;G.console&&console.log(c)},A={millisecond:1,second:1e3,minute:6e4,hour:36e5,day:864e5,week:6048e5,month:26784e5,year:31556952e3},vb={init:function(a,b,c){var g,h,i,b=b||"",d=a.shift,e=b.indexOf("C")>-1,f=e?7:3,b=b.split(" "),c=[].concat(c),j=function(a){for(g=a.length;g--;)"M"===a[g]&&a.splice(g+1,0,a[g+1],a[g+2],a[g+1],a[g+2])};if(e&&(j(b),j(c)),a.isArea&&(h=b.splice(b.length-6,6),i=c.splice(c.length-6,6)),d<=c.length/f&&b.length===c.length)for(;d--;)c=[].concat(c).splice(0,f).concat(c);if(a.shift=0,b.length)for(a=c.length;b.length<a;)d=[].concat(b).splice(b.length-f,f),e&&(d[f-6]=d[f-2],d[f-5]=d[f-1]),b=b.concat(d);return h&&(b=b.concat(h),c=c.concat(i)),[b,c]},step:function(a,b,c,d){var e=[],f=a.length;if(1===c)e=d;else if(f===b.length&&1>c)for(;f--;)d=parseFloat(a[f]),e[f]=isNaN(d)?a[f]:c*parseFloat(b[f]-d)+d;else e=b;return e}},function(a){G.HighchartsAdapter=G.HighchartsAdapter||a&&{init:function(b){var c=a.fx;a.extend(a.easing,{easeOutQuad:function(a,b,c,g,h){return-g*(b/=h)*(b-2)+c}}),a.each(["cur","_default","width","height","opacity"],function(b,e){var g,f=c.step;"cur"===e?f=c.prototype:"_default"===e&&a.Tween&&(f=a.Tween.propHooks[e],e="set"),(g=f[e])&&(f[e]=function(a){var c,a=b?a:this;return"align"!==a.prop?(c=a.elem,c.attr?c.attr(a.prop,"cur"===e?u:a.now):g.apply(this,arguments)):void 0})}),Na(a.cssHooks.opacity,"get",function(a,b,c){return b.attr?b.opacity||0:a.call(this,b,c)}),this.addAnimSetter("d",function(a){var f,c=a.elem;a.started||(f=b.init(c,c.d,c.toD),a.start=f[0],a.end=f[1],a.started=!0),c.attr("d",b.step(a.start,a.end,a.pos,c.toD))}),this.each=Array.prototype.forEach?function(a,b){return Array.prototype.forEach.call(a,b)}:function(a,b){var c,g=a.length;for(c=0;g>c;c++)if(b.call(a[c],a[c],c,a)===!1)return c},a.fn.highcharts=function(){var c,g,a="Chart",b=arguments;return this[0]&&(Ga(b[0])&&(a=b[0],b=Array.prototype.slice.call(b,1)),c=b[0],c!==u&&(c.chart=c.chart||{},c.chart.renderTo=this[0],new K[a](c,b[1]),g=this),c===u&&(g=W[F(this[0],"data-highcharts-chart")])),g}},addAnimSetter:function(b,c){a.Tween?a.Tween.propHooks[b]={set:c}:a.fx.step[b]=c},getScript:a.getScript,inArray:a.inArray,adapterRun:function(b,c){return a(b)[c]()},grep:a.grep,map:function(a,c){for(var d=[],e=0,f=a.length;f>e;e++)d[e]=c.call(a[e],a[e],e,a);return d},offset:function(b){return a(b).offset()},addEvent:function(b,c,d){a(b).bind(c,d)},removeEvent:function(b,c,d){var e=x.removeEventListener?"removeEventListener":"detachEvent";x[e]&&b&&!b[e]&&(b[e]=function(){}),a(b).unbind(c,d)},fireEvent:function(b,c,d,e){var h,f=a.Event(c),g="detached"+c;!Aa&&d&&(delete d.layerX,delete d.layerY,delete d.returnValue),r(f,d),b[c]&&(b[g]=b[c],b[c]=null),a.each(["preventDefault","stopPropagation"],function(a,b){var c=f[b];f[b]=function(){try{c.call(f)}catch(a){"preventDefault"===b&&(h=!0)}}}),a(b).trigger(f),b[g]&&(b[c]=b[g],b[g]=null),e&&!f.isDefaultPrevented()&&!h&&e(f)},washMouseEvent:function(a){var c=a.originalEvent||a;return c.pageX===u&&(c.pageX=a.pageX,c.pageY=a.pageY),c},animate:function(b,c,d){var e=a(b);b.style||(b.style={}),c.d&&(b.toD=c.d,c.d=1),e.stop(),c.opacity!==u&&b.attr&&(c.opacity+="px"),b.hasAnim=1,e.animate(c,d)},stop:function(b){b.hasAnim&&a(b).stop()}}}(G.jQuery);var T=G.HighchartsAdapter,M=T||{};T&&T.init.call(T,vb);var ib=M.adapterRun,Rb=M.getScript,Ma=M.inArray,q=M.each,wb=M.grep,Sb=M.offset,Va=M.map,N=M.addEvent,X=M.removeEvent,I=M.fireEvent,Tb=M.washMouseEvent,jb=M.animate,bb=M.stop,M={enabled:!0,x:0,y:15,style:{color:"#606060",cursor:"default",fontSize:"11px"}};E={colors:"#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","),symbols:["circle","diamond","square","triangle","triangle-down"],lang:{loading:"Loading...",months:"January,February,March,April,May,June,July,August,September,October,November,December".split(","),shortMonths:"Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),weekdays:"Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),decimalPoint:".",numericSymbols:"k,M,G,T,P,E".split(","),resetZoom:"Reset zoom",resetZoomTitle:"Reset zoom level 1:1",thousandsSep:","},global:{useUTC:!0,canvasToolsURL:"http://code.highcharts.com/4.0.4/modules/canvas-tools.js",VMLRadialGradientURL:"http://code.highcharts.com/4.0.4/gfx/vml-radial-gradient.png"},chart:{borderColor:"#4572A7",borderRadius:0,defaultSeriesType:"line",ignoreHiddenSeries:!0,spacing:[10,10,15,10],backgroundColor:"#FFFFFF",plotBorderColor:"#C0C0C0",resetZoomButton:{theme:{zIndex:20},position:{align:"right",x:-10,y:10}}},title:{text:"Chart title",align:"center",margin:15,style:{color:"#333333",fontSize:"18px"}},subtitle:{text:"",align:"center",style:{color:"#555555"}},plotOptions:{line:{allowPointSelect:!1,showCheckbox:!1,animation:{duration:1e3},events:{},lineWidth:2,marker:{lineWidth:0,radius:4,lineColor:"#FFFFFF",states:{hover:{enabled:!0,lineWidthPlus:1,radiusPlus:2},select:{fillColor:"#FFFFFF",lineColor:"#000000",lineWidth:2}}},point:{events:{}},dataLabels:w(M,{align:"center",enabled:!1,formatter:function(){return null===this.y?"":Ba(this.y,-1)},verticalAlign:"bottom",y:0}),cropThreshold:300,pointRange:0,states:{hover:{lineWidthPlus:1,marker:{},halo:{size:10,opacity:.25}},select:{marker:{}}},stickyTracking:!0,turboThreshold:1e3}},labels:{style:{position:"absolute",color:"#3E576F"}},legend:{enabled:!0,align:"center",layout:"horizontal",labelFormatter:function(){return this.name},borderColor:"#909090",borderRadius:0,navigation:{activeColor:"#274b6d",inactiveColor:"#CCC"},shadow:!1,itemStyle:{color:"#333333",fontSize:"12px",fontWeight:"bold"},itemHoverStyle:{color:"#000"},itemHiddenStyle:{color:"#CCC"},itemCheckboxStyle:{position:"absolute",width:"13px",height:"13px"},symbolPadding:5,verticalAlign:"bottom",x:0,y:0,title:{style:{fontWeight:"bold"}}},loading:{labelStyle:{fontWeight:"bold",position:"relative",top:"45%"},style:{position:"absolute",backgroundColor:"white",opacity:.5,textAlign:"center"}},tooltip:{enabled:!0,animation:ba,backgroundColor:"rgba(249, 249, 249, .85)",borderWidth:1,borderRadius:3,dateTimeLabelFormats:{millisecond:"%A, %b %e, %H:%M:%S.%L",second:"%A, %b %e, %H:%M:%S",minute:"%A, %b %e, %H:%M",hour:"%A, %b %e, %H:%M",day:"%A, %b %e, %Y",week:"Week from %A, %b %e, %Y",month:"%B %Y",year:"%Y"},headerFormat:'<span style="font-size: 10px">{point.key}</span><br/>',pointFormat:'<span style="color:{series.color}">●</span> {series.name}: <b>{point.y}</b><br/>',shadow:!0,snap:Ib?25:10,style:{color:"#333333",cursor:"default",fontSize:"12px",padding:"8px",whiteSpace:"nowrap"}},credits:{enabled:!0,text:"Highcharts.com",href:"http://www.highcharts.com",position:{align:"right",x:-10,verticalAlign:"bottom",y:-5},style:{cursor:"pointer",color:"#909090",fontSize:"9px"}}};var ca=E.plotOptions,T=ca.line;Bb();var Ub=/rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,Vb=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,Wb=/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/,ya=function(a){var c,d,b=[];return function(a){a&&a.stops?d=Va(a.stops,function(a){return ya(a[1])}):(c=Ub.exec(a))?b=[y(c[1]),y(c[2]),y(c[3]),parseFloat(c[4],10)]:(c=Vb.exec(a))?b=[y(c[1],16),y(c[2],16),y(c[3],16),1]:(c=Wb.exec(a))&&(b=[y(c[1]),y(c[2]),y(c[3]),1])}(a),{get:function(c){var f;return d?(f=w(a),f.stops=[].concat(f.stops),q(d,function(a,b){f.stops[b]=[f.stops[b][0],a.get(c)]})):f=b&&!isNaN(b[0])?"rgb"===c?"rgb("+b[0]+","+b[1]+","+b[2]+")":"a"===c?b[3]:"rgba("+b.join(",")+")":a,f},brighten:function(a){if(d)q(d,function(b){b.brighten(a)});else if(ja(a)&&0!==a){var c;for(c=0;3>c;c++)b[c]+=y(255*a),b[c]<0&&(b[c]=0),b[c]>255&&(b[c]=255)}return this},rgba:b,setOpacity:function(a){return b[3]=a,this}}};S.prototype={opacity:1,textProps:"fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke".split(","),init:function(a,b){this.element="span"===b?$(b):x.createElementNS(xa,b),this.renderer=a},animate:function(a,b,c){return b=p(b,va,!0),bb(this),b?(b=w(b,{}),c&&(b.complete=c),jb(this,a,b)):(this.attr(a),c&&c()),this},colorGradient:function(a,b,c){var e,f,g,h,i,j,k,l,n,m,d=this.renderer,o=[];if(a.linearGradient?f="linearGradient":a.radialGradient&&(f="radialGradient"),f){g=a[f],h=d.gradients,j=a.stops,n=c.radialReference,Ha(g)&&(a[f]=g={x1:g[0],y1:g[1],x2:g[2],y2:g[3],gradientUnits:"userSpaceOnUse"}),"radialGradient"===f&&n&&!s(g.gradientUnits)&&(g=w(g,{cx:n[0]-n[2]/2+g.cx*n[2],cy:n[1]-n[2]/2+g.cy*n[2],r:g.r*n[2],gradientUnits:"userSpaceOnUse"}));for(m in g)"id"!==m&&o.push(m,g[m]);for(m in j)o.push(j[m]);o=o.join(","),h[o]?a=h[o].attr("id"):(g.id=a="highcharts-"+ub++,h[o]=i=d.createElement(f).attr(g).add(d.defs),i.stops=[],q(j,function(a){0===a[1].indexOf("rgba")?(e=ya(a[1]),k=e.get("rgb"),l=e.get("a")):(k=a[1],l=1),a=d.createElement("stop").attr({offset:a[0],"stop-color":k,"stop-opacity":l}).add(i),i.stops.push(a)})),c.setAttribute(b,"url("+d.url+"#"+a+")")}},attr:function(a,b){var c,d,f,h,e=this.element,g=this;if("string"==typeof a&&b!==u&&(c=a,a={},a[c]=b),"string"==typeof a)g=(this[a+"Getter"]||this._defaultGetter).call(this,a,e);else{for(c in a)d=a[c],h=!1,this.symbolName&&/^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c)&&(f||(this.symbolAttr(a),f=!0),h=!0),!this.rotation||"x"!==c&&"y"!==c||(this.doTransform=!0),h||(this[c+"Setter"]||this._defaultSetter).call(this,d,c,e),this.shadows&&/^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c)&&this.updateShadows(c,d);this.doTransform&&(this.updateTransform(),this.doTransform=!1)}return g},updateShadows:function(a,b){for(var c=this.shadows,d=c.length;d--;)c[d].setAttribute(a,"height"===a?t(b-(c[d].cutHeight||0),0):"d"===a?this.d:b)},addClass:function(a){var b=this.element,c=F(b,"class")||"";return-1===c.indexOf(a)&&F(b,"class",c+" "+a),this},symbolAttr:function(a){var b=this;q("x,y,r,start,end,width,height,innerR,anchorX,anchorY".split(","),function(c){b[c]=p(a[c],b[c])}),b.attr({d:b.renderer.symbols[b.symbolName](b.x,b.y,b.width,b.height,b)})},clip:function(a){return this.attr("clip-path",a?"url("+this.renderer.url+"#"+a.id+")":P)},crisp:function(a){var b,d,c={},e=a.strokeWidth||this.strokeWidth||0;d=v(e)%2/2,a.x=U(a.x||this.x||0)+d,a.y=U(a.y||this.y||0)+d,a.width=U((a.width||this.width||0)-2*d),a.height=U((a.height||this.height||0)-2*d),a.strokeWidth=e;for(b in a)this[b]!==a[b]&&(this[b]=c[b]=a[b]);return c},css:function(a){var e,f,b=this.styles,c={},d=this.element,g="";if(e=!b,a&&a.color&&(a.fill=a.color),b)for(f in a)a[f]!==b[f]&&(c[f]=a[f],e=!0);if(e){if(e=this.textWidth=a&&a.width&&"text"===d.nodeName.toLowerCase()&&y(a.width),b&&(a=r(b,c)),this.styles=a,e&&(ga||!ba&&this.renderer.forExport)&&delete a.width,Aa&&!ba)B(this.element,a);else{b=function(a,b){return"-"+b.toLowerCase()};for(f in a)g+=f.replace(/([A-Z])/g,b)+":"+a[f]+";";F(d,"style",g)}e&&this.added&&this.renderer.buildText(this)}return this},on:function(a,b){var c=this,d=c.element;return $a&&"click"===a?(d.ontouchstart=function(a){c.touchEventFired=Da.now(),a.preventDefault(),b.call(d,a)},d.onclick=function(a){(-1===wa.indexOf("Android")||Da.now()-(c.touchEventFired||0)>1100)&&b.call(d,a)}):d["on"+a]=b,this},setRadialReference:function(a){return this.element.radialReference=a,this},translate:function(a,b){return this.attr({translateX:a,translateY:b})},invert:function(){return this.inverted=!0,this.updateTransform(),this},updateTransform:function(){var a=this.translateX||0,b=this.translateY||0,c=this.scaleX,d=this.scaleY,e=this.inverted,f=this.rotation,g=this.element;e&&(a+=this.attr("width"),b+=this.attr("height")),a=["translate("+a+","+b+")"],e?a.push("rotate(90) scale(-1,1)"):f&&a.push("rotate("+f+" "+(g.getAttribute("x")||0)+" "+(g.getAttribute("y")||0)+")"),(s(c)||s(d))&&a.push("scale("+p(c,1)+" "+p(d,1)+")"),a.length&&g.setAttribute("transform",a.join(" "))},toFront:function(){var a=this.element;return a.parentNode.appendChild(a),this},align:function(a,b,c){var d,e,f,g,h={};return e=this.renderer,f=e.alignedObjects,a?(this.alignOptions=a,this.alignByTranslate=b,(!c||Ga(c))&&(this.alignTo=d=c||"renderer",la(f,this),f.push(this),c=null)):(a=this.alignOptions,b=this.alignByTranslate,d=this.alignTo),c=p(c,e[d],e),d=a.align,e=a.verticalAlign,f=(c.x||0)+(a.x||0),g=(c.y||0)+(a.y||0),("right"===d||"center"===d)&&(f+=(c.width-(a.width||0))/{right:1,center:2}[d]),h[b?"translateX":"x"]=v(f),("bottom"===e||"middle"===e)&&(g+=(c.height-(a.height||0))/({bottom:1,middle:2}[e]||1)),h[b?"translateY":"y"]=v(g),this[this.placed?"animate":"attr"](h),this.placed=!0,this.alignAttr=h,this},getBBox:function(){var c,d,a=this.bBox,b=this.renderer,e=this.rotation;c=this.element;var f=this.styles,g=e*Ea;d=this.textStr;var h;if((""===d||Pb.test(d))&&(h="num."+d.toString().length+(f?"|"+f.fontSize+"|"+f.fontFamily:"")),h&&(a=b.cache[h]),!a){if(c.namespaceURI===xa||b.forExport){try{a=c.getBBox?r({},c.getBBox()):{width:c.offsetWidth,height:c.offsetHeight}}catch(i){}(!a||a.width<0)&&(a={width:0,height:0})}else a=this.htmlGetBBox();b.isSVG&&(c=a.width,d=a.height,Aa&&f&&"11px"===f.fontSize&&"16.9"===d.toPrecision(3)&&(a.height=d=14),e&&(a.width=Q(d*fa(g))+Q(c*aa(g)),a.height=Q(d*aa(g))+Q(c*fa(g)))),this.bBox=a,h&&(b.cache[h]=a)}return a},show:function(a){return a&&this.element.namespaceURI===xa?this.element.removeAttribute("visibility"):this.attr({visibility:a?"inherit":"visible"}),this},hide:function(){return this.attr({visibility:"hidden"})},fadeOut:function(a){var b=this;b.animate({opacity:0},{duration:a||150,complete:function(){b.attr({y:-9999})}})},add:function(a){var g,h,b=this.renderer,c=a||b,d=c.element||b.box,e=this.element,f=this.zIndex;if(a&&(this.parentGroup=a),this.parentInverted=a&&a.inverted,void 0!==this.textStr&&b.buildText(this),f&&(c.handleZ=!0,f=y(f)),c.handleZ)for(a=d.childNodes,g=0;g<a.length;g++)if(b=a[g],c=F(b,"zIndex"),b!==e&&(y(c)>f||!s(f)&&s(c))){d.insertBefore(e,b),h=!0;break}return h||d.appendChild(e),this.added=!0,this.onAdd&&this.onAdd(),this},safeRemoveChild:function(a){var b=a.parentNode;b&&b.removeChild(a)},destroy:function(){var e,f,a=this,b=a.element||{},c=a.shadows,d=a.renderer.isSVG&&"SPAN"===b.nodeName&&a.parentGroup;if(b.onclick=b.onmouseout=b.onmouseover=b.onmousemove=b.point=null,bb(a),a.clipPath&&(a.clipPath=a.clipPath.destroy()),a.stops){for(f=0;f<a.stops.length;f++)a.stops[f]=a.stops[f].destroy();a.stops=null}for(a.safeRemoveChild(b),c&&q(c,function(b){a.safeRemoveChild(b)});d&&d.div&&0===d.div.childNodes.length;)b=d.parentGroup,a.safeRemoveChild(d.div),delete d.div,d=b;a.alignTo&&la(a.renderer.alignedObjects,a);for(e in a)delete a[e];return null},shadow:function(a,b,c){var e,f,h,i,j,k,d=[],g=this.element;if(a){for(i=p(a.width,3),j=(a.opacity||.15)/i,k=this.parentInverted?"(-1,-1)":"("+p(a.offsetX,1)+", "+p(a.offsetY,1)+")",e=1;i>=e;e++)f=g.cloneNode(0),h=2*i+1-2*e,F(f,{isShadow:"true",stroke:a.color||"black","stroke-opacity":j*e,"stroke-width":h,transform:"translate"+k,fill:P}),c&&(F(f,"height",t(F(f,"height")-h,0)),f.cutHeight=h),b?b.element.appendChild(f):g.parentNode.insertBefore(f,g),d.push(f);this.shadows=d}return this},xGetter:function(a){return"circle"===this.element.nodeName&&(a={x:"cx",y:"cy"}[a]||a),this._defaultGetter(a)},_defaultGetter:function(a){return a=p(this[a],this.element?this.element.getAttribute(a):null,0),/^[\-0-9\.]+$/.test(a)&&(a=parseFloat(a)),a},dSetter:function(a,b,c){a&&a.join&&(a=a.join(" ")),/(NaN| {2}|^$)/.test(a)&&(a="M 0 0"),c.setAttribute(b,a),this[b]=a},dashstyleSetter:function(a){var b;if(a=a&&a.toLowerCase()){for(a=a.replace("shortdashdotdot","3,1,1,1,1,1,").replace("shortdashdot","3,1,1,1").replace("shortdot","1,1,").replace("shortdash","3,1,").replace("longdash","8,3,").replace(/dot/g,"1,3,").replace("dash","4,3,").replace(/,$/,"").split(","),b=a.length;b--;)a[b]=y(a[b])*this["stroke-width"];a=a.join(",").replace("NaN","none"),this.element.setAttribute("stroke-dasharray",a)}},alignSetter:function(a){this.element.setAttribute("text-anchor",{left:"start",center:"middle",right:"end"}[a])},opacitySetter:function(a,b,c){this[b]=a,c.setAttribute(b,a)},titleSetter:function(a){var b=this.element.getElementsByTagName("title")[0];b||(b=x.createElementNS(xa,"title"),this.element.appendChild(b)),b.textContent=p(a,"").replace(/<[^>]*>/g,"")},textSetter:function(a){a!==this.textStr&&(delete this.bBox,this.textStr=a,this.added&&this.renderer.buildText(this))},fillSetter:function(a,b,c){"string"==typeof a?c.setAttribute(b,a):a&&this.colorGradient(a,b,c)},zIndexSetter:function(a,b,c){c.setAttribute(b,a),this[b]=a},_defaultSetter:function(a,b,c){c.setAttribute(b,a)}},S.prototype.yGetter=S.prototype.xGetter,S.prototype.translateXSetter=S.prototype.translateYSetter=S.prototype.rotationSetter=S.prototype.verticalAlignSetter=S.prototype.scaleXSetter=S.prototype.scaleYSetter=function(a,b){this[b]=a,this.doTransform=!0},S.prototype["stroke-widthSetter"]=S.prototype.strokeSetter=function(a,b,c){this[b]=a,this.stroke&&this["stroke-width"]?(this.strokeWidth=this["stroke-width"],S.prototype.fillSetter.call(this,this.stroke,"stroke",c),c.setAttribute("stroke-width",this["stroke-width"]),this.hasStroke=!0):"stroke-width"===b&&0===a&&this.hasStroke&&(c.removeAttribute("stroke"),this.hasStroke=!1)};var ta=function(){this.init.apply(this,arguments)};ta.prototype={Element:S,init:function(a,b,c,d,e){var g,f=location,d=this.createElement("svg").attr({version:"1.1"}).css(this.getStyle(d));g=d.element,a.appendChild(g),-1===a.innerHTML.indexOf("xmlns")&&F(g,"xmlns",xa),this.isSVG=!0,this.box=g,this.boxWrapper=d,this.alignedObjects=[],this.url=(Ua||tb)&&x.getElementsByTagName("base").length?f.href.replace(/#.*?$/,"").replace(/([\('\)])/g,"\\$1").replace(/ /g,"%20"):"",this.createElement("desc").add().element.appendChild(x.createTextNode("Created with Highcharts 4.0.4")),this.defs=this.createElement("defs").add(),this.forExport=e,this.gradients={},this.cache={},this.setSize(b,c,!1);var h;Ua&&a.getBoundingClientRect&&(this.subPixelFix=b=function(){B(a,{left:0,top:0}),h=a.getBoundingClientRect(),B(a,{left:La(h.left)-h.left+"px",top:La(h.top)-h.top+"px"})},b(),N(G,"resize",b))},getStyle:function(a){return this.style=r({fontFamily:'"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',fontSize:"12px"},a)},isHidden:function(){return!this.boxWrapper.getBBox().width},destroy:function(){var a=this.defs;return this.box=null,this.boxWrapper=this.boxWrapper.destroy(),Pa(this.gradients||{}),this.gradients=null,a&&(this.defs=a.destroy()),this.subPixelFix&&X(G,"resize",this.subPixelFix),this.alignedObjects=null},createElement:function(a){var b=new this.Element;return b.init(this,a),b},draw:function(){},buildText:function(a){for(var h,i,b=a.element,c=this,d=c.forExport,e=p(a.textStr,"").toString(),f=-1!==e.indexOf("<"),g=b.childNodes,j=F(b,"x"),k=a.styles,l=a.textWidth,n=k&&k.lineHeight,m=k&&k.HcTextStroke,o=g.length,Y=function(a){return n?y(n):c.fontMetrics(/(px|em)$/.test(a&&a.style.fontSize)?a.style.fontSize:k&&k.fontSize||c.style.fontSize||12,a).h};o--;)b.removeChild(g[o]);f||m||-1!==e.indexOf(" ")?(h=/<.*style="([^"]+)".*>/,i=/<.*href="(http[^"]+)".*>/,l&&!a.added&&this.box.appendChild(b),e=f?e.replace(/<(b|strong)>/g,'<span style="font-weight:bold">').replace(/<(i|em)>/g,'<span style="font-style:italic">').replace(/<a/g,"<span").replace(/<\/(b|strong|i|em|a)>/g,"</span>").split(/<br.*?>/g):[e],""===e[e.length-1]&&e.pop(),q(e,function(e,f){var g,n=0,e=e.replace(/<span/g,"|||<span").replace(/<\/span>/g,"</span>|||");g=e.split("|||"),q(g,function(e){if(""!==e||1===g.length){var p,m={},o=x.createElementNS(xa,"tspan");if(h.test(e)&&(p=e.match(h)[1].replace(/(;| |^)color([ :])/,"$1fill$2"),F(o,"style",p)),i.test(e)&&!d&&(F(o,"onclick",'location.href="'+e.match(i)[1]+'"'),B(o,{cursor:"pointer"})),e=(e.replace(/<(.|\n)*?>/g,"")||" ").replace(/&lt;/g,"<").replace(/&gt;/g,">")," "!==e){if(o.appendChild(x.createTextNode(e)),n?m.dx=0:f&&null!==j&&(m.x=j),F(o,m),b.appendChild(o),!n&&f&&(!ba&&d&&B(o,{display:"block"}),F(o,"dy",Y(o))),l)for(var q,D,e=e.replace(/([^\^])-/g,"$1- ").split(" "),m=g.length>1||e.length>1&&"nowrap"!==k.whiteSpace,s=k.HcHeight,t=[],u=Y(o),Lb=1;m&&(e.length||t.length);)delete a.bBox,q=a.getBBox(),D=q.width,!ba&&c.forExport&&(D=c.measureSpanWidth(o.firstChild.data,a.styles)),q=D>l,q&&1!==e.length?(o.removeChild(o.firstChild),t.unshift(e.pop())):(e=t,t=[],e.length&&(Lb++,s&&Lb*u>s?(e=["..."],a.attr("title",a.textStr)):(o=x.createElementNS(xa,"tspan"),F(o,{dy:u,x:j}),p&&F(o,"style",p),b.appendChild(o))),D>l&&(l=D)),e.length&&o.appendChild(x.createTextNode(e.join(" ").replace(/- /g,"-")));n++}}})})):b.appendChild(x.createTextNode(e))},button:function(a,b,c,d,e,f,g,h,i){var l,n,m,o,p,q,j=this.label(a,b,c,i,null,null,null,null,"button"),k=0,a={x1:0,y1:0,x2:0,y2:1},e=w({"stroke-width":1,stroke:"#CCCCCC",fill:{linearGradient:a,stops:[[0,"#FEFEFE"],[1,"#F6F6F6"]]},r:2,padding:5,style:{color:"black"}},e);return m=e.style,delete e.style,f=w(e,{stroke:"#68A",fill:{linearGradient:a,stops:[[0,"#FFF"],[1,"#ACF"]]}},f),o=f.style,delete f.style,g=w(e,{stroke:"#68A",fill:{linearGradient:a,stops:[[0,"#9BD"],[1,"#CDF"]]}},g),p=g.style,delete g.style,h=w(e,{style:{color:"#CCC"}},h),q=h.style,delete h.style,N(j.element,Aa?"mouseover":"mouseenter",function(){3!==k&&j.attr(f).css(o)}),N(j.element,Aa?"mouseout":"mouseleave",function(){3!==k&&(l=[e,f,g][k],n=[m,o,p][k],j.attr(l).css(n))}),j.setState=function(a){(j.state=k=a)?2===a?j.attr(g).css(p):3===a&&j.attr(h).css(q):j.attr(e).css(m)},j.on("click",function(){3!==k&&d.call(j)}).attr(e).css(r({cursor:"default"},m))},crispLine:function(a,b){return a[1]===a[4]&&(a[1]=a[4]=v(a[1])-b%2/2),a[2]===a[5]&&(a[2]=a[5]=v(a[2])+b%2/2),a},path:function(a){var b={fill:P};return Ha(a)?b.d=a:da(a)&&r(b,a),this.createElement("path").attr(b)},circle:function(a,b,c){return a=da(a)?a:{x:a,y:b,r:c},b=this.createElement("circle"),b.xSetter=function(a){this.element.setAttribute("cx",a)},b.ySetter=function(a){this.element.setAttribute("cy",a)},b.attr(a)},arc:function(a,b,c,d,e,f){return da(a)&&(b=a.y,c=a.r,d=a.innerR,e=a.start,f=a.end,a=a.x),a=this.symbol("arc",a||0,b||0,c||0,c||0,{innerR:d||0,start:e||0,end:f||0}),a.r=c,a},rect:function(a,b,c,d,e,f){var e=da(a)?a.r:e,g=this.createElement("rect"),a=da(a)?a:a===u?{}:{x:a,y:b,width:t(c,0),height:t(d,0)};return f!==u&&(a.strokeWidth=f,a=g.crisp(a)),e&&(a.r=e),g.rSetter=function(a){F(this.element,{rx:a,ry:a})},g.attr(a)},setSize:function(a,b,c){var d=this.alignedObjects,e=d.length;for(this.width=a,this.height=b,this.boxWrapper[p(c,!0)?"animate":"attr"]({width:a,height:b});e--;)d[e].align()},g:function(a){var b=this.createElement("g");return s(a)?b.attr({"class":"highcharts-"+a}):b},image:function(a,b,c,d,e){var f={preserveAspectRatio:P};return arguments.length>1&&r(f,{x:b,y:c,width:d,height:e}),f=this.createElement("image").attr(f),f.element.setAttributeNS?f.element.setAttributeNS("http://www.w3.org/1999/xlink","href",a):f.element.setAttribute("hc-svg-href",a),f},symbol:function(a,b,c,d,e,f){var g,j,k,h=this.symbols[a],h=h&&h(v(b),v(c),d,e,f),i=/^url\((.*?)\)$/;return h?(g=this.path(h),r(g,{symbolName:a,x:b,y:c,width:d,height:e}),f&&r(g,f)):i.test(a)&&(k=function(a,b){a.element&&(a.attr({width:b[0],height:b[1]}),a.alignByTranslate||a.translate(v((d-b[0])/2),v((e-b[1])/2)))},j=a.match(i)[1],a=Jb[j]||f&&f.width&&f.height&&[f.width,f.height],g=this.image(j).attr({x:b,y:c}),g.isImg=!0,a?k(g,a):(g.attr({width:0,height:0}),$("img",{onload:function(){k(g,Jb[j]=[this.width,this.height])},src:j}))),g},symbols:{circle:function(a,b,c,d){var e=.166*c;return["M",a+c/2,b,"C",a+c+e,b,a+c+e,b+d,a+c/2,b+d,"C",a-e,b+d,a-e,b,a+c/2,b,"Z"]},square:function(a,b,c,d){return["M",a,b,"L",a+c,b,a+c,b+d,a,b+d,"Z"]},triangle:function(a,b,c,d){return["M",a+c/2,b,"L",a+c,b+d,a,b+d,"Z"]},"triangle-down":function(a,b,c,d){return["M",a,b,"L",a+c,b,a+c/2,b+d,"Z"]},diamond:function(a,b,c,d){return["M",a+c/2,b,"L",a+c,b+d/2,a+c/2,b+d,a,b+d/2,"Z"]},arc:function(a,b,c,d,e){var f=e.start,c=e.r||c||d,g=e.end-.001,d=e.innerR,h=e.open,i=aa(f),j=fa(f),k=aa(g),g=fa(g),e=e.end-f<oa?0:1;return["M",a+c*i,b+c*j,"A",c,c,0,e,1,a+c*k,b+c*g,h?"M":"L",a+d*k,b+d*g,"A",d,d,0,e,0,a+d*i,b+d*j,h?"":"Z"]},callout:function(a,b,c,d,e){var f=L(e&&e.r||0,c,d),g=f+6,h=e&&e.anchorX,i=e&&e.anchorY,e=v(e.strokeWidth||0)%2/2;return a+=e,b+=e,e=["M",a+f,b,"L",a+c-f,b,"C",a+c,b,a+c,b,a+c,b+f,"L",a+c,b+d-f,"C",a+c,b+d,a+c,b+d,a+c-f,b+d,"L",a+f,b+d,"C",a,b+d,a,b+d,a,b+d-f,"L",a,b+f,"C",a,b,a,b,a+f,b],h&&h>c&&i>b+g&&b+d-g>i?e.splice(13,3,"L",a+c,i-6,a+c+6,i,a+c,i+6,a+c,b+d-f):h&&0>h&&i>b+g&&b+d-g>i?e.splice(33,3,"L",a,i+6,a-6,i,a,i-6,a,b+f):i&&i>d&&h>a+g&&a+c-g>h?e.splice(23,3,"L",h+6,b+d,h,b+d+6,h-6,b+d,a+f,b+d):i&&0>i&&h>a+g&&a+c-g>h&&e.splice(3,3,"L",h-6,b,h,b-6,h+6,b,c-f,b),e}},clipRect:function(a,b,c,d){var e="highcharts-"+ub++,f=this.createElement("clipPath").attr({id:e}).add(this.defs),a=this.rect(a,b,c,d,0).add(f);return a.id=e,a.clipPath=f,a},text:function(a,b,c,d){var e=ga||!ba&&this.forExport,f={};return d&&!this.forExport?this.html(a,b,c):(f.x=Math.round(b||0),c&&(f.y=Math.round(c)),(a||0===a)&&(f.text=a),a=this.createElement("text").attr(f),e&&a.css({position:"absolute"}),d||(a.xSetter=function(a,b,c){var e,n,d=c.getElementsByTagName("tspan"),f=c.getAttribute(b);for(n=0;n<d.length;n++)e=d[n],e.getAttribute(b)===f&&e.setAttribute(b,a);c.setAttribute(b,a)}),a)},fontMetrics:function(a,b){a=a||this.style.fontSize,b&&G.getComputedStyle&&(b=b.element||b,a=G.getComputedStyle(b,"").fontSize);var a=/px/.test(a)?y(a):/em/.test(a)?12*parseFloat(a):12,c=24>a?a+4:v(1.2*a),d=v(.8*c);return{h:c,b:d,f:a}},label:function(a,b,c,d,e,f,g,h,i){function j(){var a,b;a=o.element.style,D=(void 0===t||void 0===xb||m.styles.textAlign)&&o.textStr&&o.getBBox(),m.width=(t||D.width||0)+2*C+kb,m.height=(xb||D.height||0)+2*C,R=C+n.fontMetrics(a&&a.fontSize,o).b,y&&(p||(a=v(-J*C),b=h?-R:0,m.box=p=d?n.symbol(d,a,b,m.width,m.height,z):n.rect(a,b,m.width,m.height,0,z[Qb]),p.attr("fill",P).add(m)),p.isImg||p.attr(r({width:v(m.width),height:v(m.height)},z)),z=null)}function k(){var c,a=m.styles,a=a&&a.textAlign,b=kb+C*(1-J);c=h?0:R,s(t)&&D&&("center"===a||"right"===a)&&(b+={center:.5,right:1}[a]*(t-D.width)),(b!==o.x||c!==o.y)&&(o.attr("x",b),c!==u&&o.attr("y",c)),o.x=b,o.y=c}function l(a,b){p?p.attr(a,b):z[a]=b}var p,D,t,xb,yb,x,R,y,n=this,m=n.g(i),o=n.text("",0,0,g).attr({zIndex:1}),J=0,C=3,kb=0,Kb=0,z={};m.onAdd=function(){o.add(m),m.attr({text:a||0===a?a:"",x:b,y:c}),p&&s(e)&&m.attr({anchorX:e,anchorY:f})},m.widthSetter=function(a){t=a},m.heightSetter=function(a){xb=a},m.paddingSetter=function(a){s(a)&&a!==C&&(C=a,k())},m.paddingLeftSetter=function(a){s(a)&&a!==kb&&(kb=a,k())},m.alignSetter=function(a){J={left:0,center:.5,right:1}[a]},m.textSetter=function(a){a!==u&&o.textSetter(a),j(),k()},m["stroke-widthSetter"]=function(a,b){a&&(y=!0),Kb=a%2/2,l(b,a)},m.strokeSetter=m.fillSetter=m.rSetter=function(a,b){"fill"===b&&a&&(y=!0),l(b,a)},m.anchorXSetter=function(a,b){e=a,l(b,a+Kb-yb)},m.anchorYSetter=function(a,b){f=a,l(b,a-x)},m.xSetter=function(a){m.x=a,J&&(a-=J*((t||D.width)+C)),yb=v(a),m.attr("translateX",yb)},m.ySetter=function(a){x=m.y=v(a),m.attr("translateY",x)};var A=m.css;return r(m,{css:function(a){if(a){var b={},a=w(a);q(m.textProps,function(c){a[c]!==u&&(b[c]=a[c],delete a[c])}),o.css(b)}return A.call(m,a)},getBBox:function(){return{width:D.width+2*C,height:D.height+2*C,x:D.x-C,y:D.y-C}},shadow:function(a){return p&&p.shadow(a),m},destroy:function(){X(m.element,"mouseenter"),X(m.element,"mouseleave"),o&&(o=o.destroy()),p&&(p=p.destroy()),S.prototype.destroy.call(m),m=n=j=k=l=null}})}},Za=ta,r(S.prototype,{htmlCss:function(a){var b=this.element;return(b=a&&"SPAN"===b.tagName&&a.width)&&(delete a.width,this.textWidth=b,this.updateTransform()),this.styles=r(this.styles,a),B(this.element,a),this},htmlGetBBox:function(){var a=this.element,b=this.bBox;return b||("text"===a.nodeName&&(a.style.position="absolute"),b=this.bBox={x:a.offsetLeft,y:a.offsetTop,width:a.offsetWidth,height:a.offsetHeight}),b},htmlUpdateTransform:function(){if(this.added){var a=this.renderer,b=this.element,c=this.translateX||0,d=this.translateY||0,e=this.x||0,f=this.y||0,g=this.textAlign||"left",h={left:0,center:.5,right:1}[g],i=this.shadows;if(B(b,{marginLeft:c,marginTop:d}),i&&q(i,function(a){B(a,{marginLeft:c+1,marginTop:d+1})}),this.inverted&&q(b.childNodes,function(c){a.invertChild(c,b)}),"SPAN"===b.tagName){var k,j=this.rotation,l=y(this.textWidth),n=[j,g,b.innerHTML,this.textWidth].join(",");n!==this.cTT&&(k=a.fontMetrics(b.style.fontSize).b,s(j)&&this.setSpanRotation(j,h,k),i=p(this.elemWidth,b.offsetWidth),i>l&&/[ \-]/.test(b.textContent||b.innerText)&&(B(b,{width:l+"px",display:"block",whiteSpace:"normal"}),i=l),this.getSpanCorrection(i,k,h,j,g)),B(b,{left:e+(this.xCorr||0)+"px",top:f+(this.yCorr||0)+"px"}),tb&&(k=b.offsetHeight),this.cTT=n}}else this.alignOnAdd=!0},setSpanRotation:function(a,b,c){var d={},e=Aa?"-ms-transform":tb?"-webkit-transform":Ua?"MozTransform":Hb?"-o-transform":"";d[e]=d.transform="rotate("+a+"deg)",d[e+(Ua?"Origin":"-origin")]=d.transformOrigin=100*b+"% "+c+"px",B(this.element,d)},getSpanCorrection:function(a,b,c){this.xCorr=-a*c,this.yCorr=-b}}),r(ta.prototype,{html:function(a,b,c){var d=this.createElement("span"),e=d.element,f=d.renderer;return d.textSetter=function(a){a!==e.innerHTML&&delete this.bBox,e.innerHTML=this.textStr=a},d.xSetter=d.ySetter=d.alignSetter=d.rotationSetter=function(a,b){"align"===b&&(b="textAlign"),d[b]=a,d.htmlUpdateTransform()
},d.attr({text:a,x:v(b),y:v(c)}).css({position:"absolute",whiteSpace:"nowrap",fontFamily:this.style.fontFamily,fontSize:this.style.fontSize}),d.css=d.htmlCss,f.isSVG&&(d.add=function(a){var b,c=f.box.parentNode,j=[];if(this.parentGroup=a){if(b=a.div,!b){for(;a;)j.push(a),a=a.parentGroup;q(j.reverse(),function(a){var d;b=a.div=a.div||$(Ka,{className:F(a.element,"class")},{position:"absolute",left:(a.translateX||0)+"px",top:(a.translateY||0)+"px"},b||c),d=b.style,r(a,{translateXSetter:function(b,c){d.left=b+"px",a[c]=b,a.doTransform=!0},translateYSetter:function(b,c){d.top=b+"px",a[c]=b,a.doTransform=!0},visibilitySetter:function(a,b){d[b]=a}})})}}else b=c;return b.appendChild(e),d.added=!0,d.alignOnAdd&&d.htmlUpdateTransform(),d}),d}});var Z;if(!ba&&!ga){Z={init:function(a,b){var c=["<",b,' filled="f" stroked="f"'],d=["position: ","absolute",";"],e=b===Ka;("shape"===b||e)&&d.push("left:0;top:0;width:1px;height:1px;"),d.push("visibility: ",e?"hidden":"visible"),c.push(' style="',d.join(""),'"/>'),b&&(c=e||"span"===b||"img"===b?c.join(""):a.prepVML(c),this.element=$(c)),this.renderer=a},add:function(a){var b=this.renderer,c=this.element,d=b.box,d=a?a.element||a:d;return a&&a.inverted&&b.invertChild(c,d),d.appendChild(c),this.added=!0,this.alignOnAdd&&!this.deferUpdateTransform&&this.updateTransform(),this.onAdd&&this.onAdd(),this},updateTransform:S.prototype.htmlUpdateTransform,setSpanRotation:function(){var a=this.rotation,b=aa(a*Ea),c=fa(a*Ea);B(this.element,{filter:a?["progid:DXImageTransform.Microsoft.Matrix(M11=",b,", M12=",-c,", M21=",c,", M22=",b,", sizingMethod='auto expand')"].join(""):P})},getSpanCorrection:function(a,b,c,d,e){var i,f=d?aa(d*Ea):1,g=d?fa(d*Ea):0,h=p(this.elemHeight,this.element.offsetHeight);this.xCorr=0>f&&-a,this.yCorr=0>g&&-h,i=0>f*g,this.xCorr+=g*b*(i?1-c:c),this.yCorr-=f*b*(d?i?c:1-c:1),e&&"left"!==e&&(this.xCorr-=a*c*(0>f?-1:1),d&&(this.yCorr-=h*c*(0>g?-1:1)),B(this.element,{textAlign:e}))},pathToVML:function(a){for(var b=a.length,c=[];b--;)ja(a[b])?c[b]=v(10*a[b])-5:"Z"===a[b]?c[b]="x":(c[b]=a[b],!a.isArc||"wa"!==a[b]&&"at"!==a[b]||(c[b+5]===c[b+7]&&(c[b+7]+=a[b+7]>a[b+5]?1:-1),c[b+6]===c[b+8]&&(c[b+8]+=a[b+8]>a[b+6]?1:-1)));return c.join(" ")||"x"},clip:function(a){var c,b=this;return a?(c=a.members,la(c,b),c.push(b),b.destroyClip=function(){la(c,b)},a=a.getCSS(b)):(b.destroyClip&&b.destroyClip(),a={clip:hb?"inherit":"rect(auto)"}),b.css(a)},css:S.prototype.htmlCss,safeRemoveChild:function(a){a.parentNode&&Qa(a)},destroy:function(){return this.destroyClip&&this.destroyClip(),S.prototype.destroy.apply(this)},on:function(a,b){return this.element["on"+a]=function(){var a=G.event;a.target=a.srcElement,b(a)},this},cutOffPath:function(a,b){var c,a=a.split(/[ ,]/);return c=a.length,(9===c||11===c)&&(a[c-4]=a[c-2]=y(a[c-2])-10*b),a.join(" ")},shadow:function(a,b,c){var e,h,j,l,n,m,o,d=[],f=this.element,g=this.renderer,i=f.style,k=f.path;if(k&&"string"!=typeof k.value&&(k="x"),n=k,a){for(m=p(a.width,3),o=(a.opacity||.15)/m,e=1;3>=e;e++)l=2*m+1-2*e,c&&(n=this.cutOffPath(k.value,l+.5)),j=['<shape isShadow="true" strokeweight="',l,'" filled="false" path="',n,'" coordsize="10 10" style="',f.style.cssText,'" />'],h=$(g.prepVML(j),null,{left:y(i.left)+p(a.offsetX,1),top:y(i.top)+p(a.offsetY,1)}),c&&(h.cutOff=l+1),j=['<stroke color="',a.color||"black",'" opacity="',o*e,'"/>'],$(g.prepVML(j),null,null,h),b?b.element.appendChild(h):f.parentNode.insertBefore(h,f),d.push(h);this.shadows=d}return this},updateShadows:sa,setAttr:function(a,b){hb?this.element[a]=b:this.element.setAttribute(a,b)},classSetter:function(a){this.element.className=a},dashstyleSetter:function(a,b,c){(c.getElementsByTagName("stroke")[0]||$(this.renderer.prepVML(["<stroke/>"]),null,null,c))[b]=a||"solid",this[b]=a},dSetter:function(a,b,c){var d=this.shadows,a=a||[];if(this.d=a.join&&a.join(" "),c.path=a=this.pathToVML(a),d)for(c=d.length;c--;)d[c].path=d[c].cutOff?this.cutOffPath(a,d[c].cutOff):a;this.setAttr(b,a)},fillSetter:function(a,b,c){var d=c.nodeName;"SPAN"===d?c.style.color=a:"IMG"!==d&&(c.filled=a!==P,this.setAttr("fillcolor",this.renderer.color(a,c,b,this)))},opacitySetter:sa,rotationSetter:function(a,b,c){c=c.style,this[b]=c[b]=a,c.left=-v(fa(a*Ea)+1)+"px",c.top=v(aa(a*Ea))+"px"},strokeSetter:function(a,b,c){this.setAttr("strokecolor",this.renderer.color(a,c,b))},"stroke-widthSetter":function(a,b,c){c.stroked=!!a,this[b]=a,ja(a)&&(a+="px"),this.setAttr("strokeweight",a)},titleSetter:function(a,b){this.setAttr(b,a)},visibilitySetter:function(a,b,c){"inherit"===a&&(a="visible"),this.shadows&&q(this.shadows,function(c){c.style[b]=a}),"DIV"===c.nodeName&&(a="hidden"===a?"-999em":0,hb||(c.style[b]=a?"visible":"hidden"),b="top"),c.style[b]=a},xSetter:function(a,b,c){this[b]=a,"x"===b?b="left":"y"===b&&(b="top"),this.updateClipping?(this[b]=a,this.updateClipping()):c.style[b]=a},zIndexSetter:function(a,b,c){c.style[b]=a}},K.VMLElement=Z=ma(S,Z),Z.prototype.ySetter=Z.prototype.widthSetter=Z.prototype.heightSetter=Z.prototype.xSetter;var ia={Element:Z,isIE8:wa.indexOf("MSIE 8.0")>-1,init:function(a,b,c,d){var e;if(this.alignedObjects=[],d=this.createElement(Ka).css(r(this.getStyle(d),{position:"relative"})),e=d.element,a.appendChild(d.element),this.isVML=!0,this.box=e,this.boxWrapper=d,this.cache={},this.setSize(b,c,!1),!x.namespaces.hcv){x.namespaces.add("hcv","urn:schemas-microsoft-com:vml");try{x.createStyleSheet().cssText="hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "}catch(f){x.styleSheets[0].cssText+="hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "}}},isHidden:function(){return!this.box.offsetWidth},clipRect:function(a,b,c,d){var e=this.createElement(),f=da(a);return r(e,{members:[],left:(f?a.x:a)+1,top:(f?a.y:b)+1,width:(f?a.width:c)-1,height:(f?a.height:d)-1,getCSS:function(a){var b=a.element,c=b.nodeName,a=a.inverted,d=this.top-("shape"===c?b.offsetTop:0),e=this.left,b=e+this.width,f=d+this.height,d={clip:"rect("+v(a?e:d)+"px,"+v(a?f:b)+"px,"+v(a?b:f)+"px,"+v(a?d:e)+"px)"};return!a&&hb&&"DIV"===c&&r(d,{width:b+"px",height:f+"px"}),d},updateClipping:function(){q(e.members,function(a){a.element&&a.css(e.getCSS(a))})}})},color:function(a,b,c,d){var f,h,i,e=this,g=/^rgba/,j=P;if(a&&a.linearGradient?i="gradient":a&&a.radialGradient&&(i="pattern"),i){var k,l,m,o,p,D,J,t,n=a.linearGradient||a.radialGradient,C="",a=a.stops,s=[],u=function(){h=['<fill colors="'+s.join(",")+'" opacity="',p,'" o:opacity2="',o,'" type="',i,'" ',C,'focus="100%" method="any" />'],$(e.prepVML(h),null,null,b)};if(m=a[0],t=a[a.length-1],m[0]>0&&a.unshift([0,m[1]]),t[0]<1&&a.push([1,t[1]]),q(a,function(a,b){g.test(a[1])?(f=ya(a[1]),k=f.get("rgb"),l=f.get("a")):(k=a[1],l=1),s.push(100*a[0]+"% "+k),b?(p=l,D=k):(o=l,J=k)}),"fill"===c)if("gradient"===i)c=n.x1||n[0]||0,a=n.y1||n[1]||0,m=n.x2||n[2]||0,n=n.y2||n[3]||0,C='angle="'+(90-180*V.atan((n-a)/(m-c))/oa)+'"',u();else{var w,j=n.r,r=2*j,v=2*j,x=n.cx,z=n.cy,R=b.radialReference,j=function(){R&&(w=d.getBBox(),x+=(R[0]-w.x)/w.width-.5,z+=(R[1]-w.y)/w.height-.5,r*=R[2]/w.width,v*=R[2]/w.height),C='src="'+E.global.VMLRadialGradientURL+'" size="'+r+","+v+'" origin="0.5,0.5" position="'+x+","+z+'" color2="'+J+'" ',u()};d.added?j():d.onAdd=j,j=D}else j=k}else g.test(a)&&"IMG"!==b.tagName?(f=ya(a),h=["<",c,' opacity="',f.get("a"),'"/>'],$(this.prepVML(h),null,null,b),j=f.get("rgb")):(j=b.getElementsByTagName(c),j.length&&(j[0].opacity=1,j[0].type="solid"),j=a);return j},prepVML:function(a){var b=this.isIE8,a=a.join("");return b?(a=a.replace("/>",' xmlns="urn:schemas-microsoft-com:vml" />'),a=-1===a.indexOf('style="')?a.replace("/>",' style="display:inline-block;behavior:url(#default#VML);" />'):a.replace('style="','style="display:inline-block;behavior:url(#default#VML);')):a=a.replace("<","<hcv:"),a},text:ta.prototype.html,path:function(a){var b={coordsize:"10 10"};return Ha(a)?b.d=a:da(a)&&r(b,a),this.createElement("shape").attr(b)},circle:function(a,b,c){var d=this.symbol("circle");return da(a)&&(c=a.r,b=a.y,a=a.x),d.isCircle=!0,d.r=c,d.attr({x:a,y:b})},g:function(a){var b;return a&&(b={className:"highcharts-"+a,"class":"highcharts-"+a}),this.createElement(Ka).attr(b)},image:function(a,b,c,d,e){var f=this.createElement("img").attr({src:a});return arguments.length>1&&f.attr({x:b,y:c,width:d,height:e}),f},createElement:function(a){return"rect"===a?this.symbol(a):ta.prototype.createElement.call(this,a)},invertChild:function(a,b){var c=this,d=b.style,e="IMG"===a.tagName&&a.style;B(a,{flip:"x",left:y(d.width)-(e?y(e.top):1),top:y(d.height)-(e?y(e.left):1),rotation:-90}),q(a.childNodes,function(b){c.invertChild(b,a)})},symbols:{arc:function(a,b,c,d,e){var f=e.start,g=e.end,h=e.r||c||d,c=e.innerR,d=aa(f),i=fa(f),j=aa(g),k=fa(g);return g-f===0?["x"]:(f=["wa",a-h,b-h,a+h,b+h,a+h*d,b+h*i,a+h*j,b+h*k],e.open&&!c&&f.push("e","M",a,b),f.push("at",a-c,b-c,a+c,b+c,a+c*j,b+c*k,a+c*d,b+c*i,"x","e"),f.isArc=!0,f)},circle:function(a,b,c,d,e){return e&&(c=d=2*e.r),e&&e.isCircle&&(a-=c/2,b-=d/2),["wa",a,b,a+c,b+d,a+c,b+d/2,a+c,b+d/2,"e"]},rect:function(a,b,c,d,e){return ta.prototype.symbols[s(e)&&e.r?"callout":"square"].call(0,a,b,c,d,e)}}};K.VMLRenderer=Z=function(){this.init.apply(this,arguments)},Z.prototype=w(ta.prototype,ia),Za=Z}ta.prototype.measureSpanWidth=function(a,b){var d,c=x.createElement("span");return d=x.createTextNode(a),c.appendChild(d),B(c,b),this.box.appendChild(c),d=c.offsetWidth,Qa(c),d};var Mb;ga&&(K.CanVGRenderer=Z=function(){xa="http://www.w3.org/1999/xhtml"},Z.prototype.symbols={},Mb=function(){function a(){var d,a=b.length;for(d=0;a>d;d++)b[d]();b=[]}var b=[];return{push:function(c,d){0===b.length&&Rb(d,a),b.push(c)}}}(),Za=Z),Ta.prototype={addLabel:function(){var n,a=this.axis,b=a.options,c=a.chart,d=a.horiz,e=a.categories,f=a.names,g=this.pos,h=b.labels,i=h.rotation,j=a.tickPositions,d=d&&e&&!h.step&&!h.staggerLines&&!h.rotation&&c.plotWidth/j.length||!d&&(c.margin[3]||.33*c.chartWidth),k=g===j[0],l=g===j[j.length-1],f=e?p(e[g],f[g],g):g,e=this.label,m=j.info;a.isDatetimeAxis&&m&&(n=b.dateTimeLabelFormats[m.higherRanks[g]||m.unitName]),this.isFirst=k,this.isLast=l,b=a.labelFormatter.call({axis:a,chart:c,isFirst:k,isLast:l,dateTimeLabelFormat:n,value:a.isLog?ea(ka(f)):f}),g=d&&{width:t(1,v(d-2*(h.padding||10)))+"px"},s(e)?e&&e.attr({text:b}).css(g):(n={align:a.labelAlign},ja(i)&&(n.rotation=i),d&&h.ellipsis&&(g.HcHeight=a.len/j.length),this.label=e=s(b)&&h.enabled?c.renderer.text(b,0,0,h.useHTML).attr(n).css(r(g,h.style)).add(a.labelGroup):null,a.tickBaseline=c.renderer.fontMetrics(h.style.fontSize,e).b,i&&2===a.side&&(a.tickBaseline*=aa(i*Ea))),this.yOffset=e?p(h.y,a.tickBaseline+(2===a.side?8:-(e.getBBox().height/2))):0},getLabelSize:function(){var a=this.label,b=this.axis;return a?a.getBBox()[b.horiz?"height":"width"]:0},getLabelSides:function(){var a=this.label.getBBox(),b=this.axis,c=b.horiz,d=b.options.labels,a=c?a.width:a.height,b=c?d.x-a*{left:0,center:.5,right:1}[b.labelAlign]:0;return[b,c?a+b:a]},handleOverflow:function(a,b){var l,n,m,c=!0,d=this.axis,e=this.isFirst,f=this.isLast,g=d.horiz?b.x:b.y,h=d.reversed,i=d.tickPositions,j=this.getLabelSides(),k=j[0],j=j[1],o=this.label.line;if(l=o||0,n=d.labelEdge,m=d.justifyLabels&&(e||f),n[l]===u||g+k>n[l]?n[l]=g+j:m||(c=!1),m){l=(n=d.justifyToPlot)?d.pos:0,n=n?l+d.len:d.chart.chartWidth;do a+=e?1:-1,m=d.ticks[i[a]];while(i[a]&&(!m||!m.label||m.label.line!==o));d=m&&m.label.xy&&m.label.xy.x+m.getLabelSides()[e?0:1],e&&!h||f&&h?l>g+k&&(g=l-k,m&&g+j>d&&(c=!1)):g+j>n&&(g=n-j,m&&d>g+k&&(c=!1)),b.x=g}return c},getPosition:function(a,b,c,d){var e=this.axis,f=e.chart,g=d&&f.oldChartHeight||f.chartHeight;return{x:a?e.translate(b+c,null,null,d)+e.transB:e.left+e.offset+(e.opposite?(d&&f.oldChartWidth||f.chartWidth)-e.right-e.left:0),y:a?g-e.bottom+e.offset-(e.opposite?e.height:0):g-e.translate(b+c,null,null,d)-e.transB}},getLabelPosition:function(a,b,c,d,e,f,g,h){var i=this.axis,j=i.transA,k=i.reversed,l=i.staggerLines,a=a+e.x-(f&&d?f*j*(k?-1:1):0),b=b+this.yOffset-(f&&!d?f*j*(k?1:-1):0);return l&&(c.line=g/(h||1)%l,b+=c.line*(i.labelOffset/l)),{x:a,y:b}},getMarkPath:function(a,b,c,d,e,f){return f.crispLine(["M",a,b,"L",a+(e?0:-c),b+(e?c:0)],d)},render:function(a,b,c){var d=this.axis,e=d.options,f=d.chart.renderer,g=d.horiz,h=this.type,i=this.label,j=this.pos,k=e.labels,l=this.gridLine,n=h?h+"Grid":"grid",m=h?h+"Tick":"tick",o=e[n+"LineWidth"],q=e[n+"LineColor"],D=e[n+"LineDashStyle"],J=e[m+"Length"],n=e[m+"Width"]||0,C=e[m+"Color"],t=e[m+"Position"],m=this.mark,s=k.step,r=!0,v=d.tickmarkOffset,w=this.getPosition(g,j,v,b),x=w.x,w=w.y,z=g&&x===d.pos+d.len||!g&&w===d.pos?-1:1,c=p(c,1);this.isActive=!0,o&&(j=d.getPlotLinePath(j+v,o*z,b,!0),l===u&&(l={stroke:q,"stroke-width":o},D&&(l.dashstyle=D),h||(l.zIndex=1),b&&(l.opacity=0),this.gridLine=l=o?f.path(j).attr(l).add(d.gridGroup):null),!b&&l&&j&&l[this.isNew?"attr":"animate"]({d:j,opacity:c})),n&&J&&("inside"===t&&(J=-J),d.opposite&&(J=-J),h=this.getMarkPath(x,w,J,n*z,g,f),m?m.animate({d:h,opacity:c}):this.mark=f.path(h).attr({stroke:C,"stroke-width":n,opacity:c}).add(d.axisGroup)),i&&!isNaN(x)&&(i.xy=w=this.getLabelPosition(x,w,i,g,k,v,a,s),this.isFirst&&!this.isLast&&!p(e.showFirstLabel,1)||this.isLast&&!this.isFirst&&!p(e.showLastLabel,1)?r=!1:!d.isRadial&&!k.step&&!k.rotation&&!b&&0!==c&&(r=this.handleOverflow(a,w)),s&&a%s&&(r=!1),r&&!isNaN(w.y)?(w.opacity=c,i[this.isNew?"attr":"animate"](w),this.isNew=!1):i.attr("y",-9999))},destroy:function(){Pa(this,this.axis)}},K.PlotLineOrBand=function(a,b){this.axis=a,b&&(this.options=b,this.id=b.id)},K.PlotLineOrBand.prototype={render:function(){var p,a=this,b=a.axis,c=b.horiz,d=(b.pointRange||0)/2,e=a.options,f=e.label,g=a.label,h=e.width,i=e.to,j=e.from,k=s(j)&&s(i),l=e.value,n=e.dashStyle,m=a.svgElem,o=[],q=e.color,J=e.zIndex,C=e.events,r={},u=b.chart.renderer;if(b.isLog&&(j=za(j),i=za(i),l=za(l)),h)o=b.getPlotLinePath(l,h),r={stroke:q,"stroke-width":h},n&&(r.dashstyle=n);else{if(!k)return;j=t(j,b.min-d),i=L(i,b.max+d),o=b.getPlotBandPath(j,i,e),q&&(r.fill=q),e.borderWidth&&(r.stroke=e.borderColor,r["stroke-width"]=e.borderWidth)}if(s(J)&&(r.zIndex=J),m)o?m.animate({d:o},null,m.onGetPath):(m.hide(),m.onGetPath=function(){m.show()},g&&(a.label=g=g.destroy()));else if(o&&o.length&&(a.svgElem=m=u.path(o).attr(r).add(),C))for(p in d=function(b){m.on(b,function(c){C[b].apply(a,[c])})},C)d(p);return f&&s(f.text)&&o&&o.length&&b.width>0&&b.height>0?(f=w({align:c&&k&&"center",x:c?!k&&4:10,verticalAlign:!c&&k&&"middle",y:c?k?16:10:k?6:-4,rotation:c&&!k&&90},f),g||(r={align:f.textAlign||f.align,rotation:f.rotation},s(J)&&(r.zIndex=J),a.label=g=u.text(f.text,0,0,f.useHTML).attr(r).css(f.style).add()),b=[o[1],o[4],k?o[6]:o[1]],k=[o[2],o[5],k?o[7]:o[2]],o=Oa(b),c=Oa(k),g.align(f,!1,{x:o,y:c,width:Ca(b)-o,height:Ca(k)-c}),g.show()):g&&g.hide(),a},destroy:function(){la(this.axis.plotLinesAndBands,this),delete this.axis,Pa(this)}},na.prototype={defaultOptions:{dateTimeLabelFormats:{millisecond:"%H:%M:%S.%L",second:"%H:%M:%S",minute:"%H:%M",hour:"%H:%M",day:"%e. %b",week:"%e. %b",month:"%b '%y",year:"%Y"},endOnTick:!1,gridLineColor:"#C0C0C0",labels:M,lineColor:"#C0D0E0",lineWidth:1,minPadding:.01,maxPadding:.01,minorGridLineColor:"#E0E0E0",minorGridLineWidth:1,minorTickColor:"#A0A0A0",minorTickLength:2,minorTickPosition:"outside",startOfWeek:1,startOnTick:!1,tickColor:"#C0D0E0",tickLength:10,tickmarkPlacement:"between",tickPixelInterval:100,tickPosition:"outside",tickWidth:1,title:{align:"middle",style:{color:"#707070"}},type:"linear"},defaultYAxisOptions:{endOnTick:!0,gridLineWidth:1,tickPixelInterval:72,showLastLabel:!0,labels:{x:-8,y:3},lineWidth:0,maxPadding:.05,minPadding:.05,startOnTick:!0,tickWidth:0,title:{rotation:270,text:"Values"},stackLabels:{enabled:!1,formatter:function(){return Ba(this.total,-1)},style:M.style}},defaultLeftAxisOptions:{labels:{x:-15,y:null},title:{rotation:270}},defaultRightAxisOptions:{labels:{x:15,y:null},title:{rotation:90}},defaultBottomAxisOptions:{labels:{x:0,y:null},title:{rotation:0}},defaultTopAxisOptions:{labels:{x:0,y:-15},title:{rotation:0}},init:function(a,b){var c=b.isX;this.horiz=a.inverted?!c:c,this.coll=(this.isXAxis=c)?"xAxis":"yAxis",this.opposite=b.opposite,this.side=b.side||(this.horiz?this.opposite?0:2:this.opposite?1:3),this.setOptions(b);var d=this.options,e=d.type;this.labelFormatter=d.labels.formatter||this.defaultLabelFormatter,this.userOptions=b,this.minPixelPadding=0,this.chart=a,this.reversed=d.reversed,this.zoomEnabled=d.zoomEnabled!==!1,this.categories=d.categories||"category"===e,this.names=[],this.isLog="logarithmic"===e,this.isDatetimeAxis="datetime"===e,this.isLinked=s(d.linkedTo),this.tickmarkOffset=this.categories&&"between"===d.tickmarkPlacement&&1===p(d.tickInterval,1)?.5:0,this.ticks={},this.labelEdge=[],this.minorTicks={},this.plotLinesAndBands=[],this.alternateBands={},this.len=0,this.minRange=this.userMinRange=d.minRange||d.maxZoom,this.range=d.range,this.offset=d.offset||0,this.stacks={},this.oldStacks={},this.min=this.max=null,this.crosshair=p(d.crosshair,ra(a.options.tooltip.crosshairs)[c?0:1],!1);var f,d=this.options.events;-1===Ma(this,a.axes)&&(c&&!this.isColorAxis?a.axes.splice(a.xAxis.length,0,this):a.axes.push(this),a[this.coll].push(this)),this.series=this.series||[],a.inverted&&c&&this.reversed===u&&(this.reversed=!0),this.removePlotLine=this.removePlotBand=this.removePlotBandOrLine;for(f in d)N(this,f,d[f]);this.isLog&&(this.val2lin=za,this.lin2val=ka)},setOptions:function(a){this.options=w(this.defaultOptions,this.isXAxis?{}:this.defaultYAxisOptions,[this.defaultTopAxisOptions,this.defaultRightAxisOptions,this.defaultBottomAxisOptions,this.defaultLeftAxisOptions][this.side],w(E[this.coll],a))},defaultLabelFormatter:function(){var g,a=this.axis,b=this.value,c=a.categories,d=this.dateTimeLabelFormat,e=E.lang.numericSymbols,f=e&&e.length,h=a.options.labels.format,a=a.isLog?b:a.tickInterval;if(h)g=Ja(h,this);else if(c)g=b;else if(d)g=cb(d,b);else if(f&&a>=1e3)for(;f--&&g===u;)c=Math.pow(1e3,f+1),a>=c&&null!==e[f]&&(g=Ba(b/c,-1)+e[f]);return g===u&&(g=Q(b)>=1e4?Ba(b,0):Ba(b,-1,u,"")),g},getSeriesExtremes:function(){var a=this,b=a.chart;a.hasVisibleSeries=!1,a.dataMin=a.dataMax=a.ignoreMinPadding=a.ignoreMaxPadding=null,a.buildStacks&&a.buildStacks(),q(a.series,function(c){if(c.visible||!b.options.chart.ignoreHiddenSeries){var d;d=c.options.threshold;var e;a.hasVisibleSeries=!0,a.isLog&&0>=d&&(d=null),a.isXAxis?(d=c.xData,d.length&&(a.dataMin=L(p(a.dataMin,d[0]),Oa(d)),a.dataMax=t(p(a.dataMax,d[0]),Ca(d)))):(c.getExtremes(),e=c.dataMax,c=c.dataMin,s(c)&&s(e)&&(a.dataMin=L(p(a.dataMin,c),c),a.dataMax=t(p(a.dataMax,e),e)),s(d)&&(a.dataMin>=d?(a.dataMin=d,a.ignoreMinPadding=!0):a.dataMax<d&&(a.dataMax=d,a.ignoreMaxPadding=!0)))}})},translate:function(a,b,c,d,e,f){var g=1,h=0,i=d?this.oldTransA:this.transA,d=d?this.oldMin:this.min,j=this.minPixelPadding,e=(this.options.ordinal||this.isLog&&e)&&this.lin2val;return i||(i=this.transA),c&&(g*=-1,h=this.len),this.reversed&&(g*=-1,h-=g*(this.sector||this.len)),b?(a=a*g+h,a-=j,a=a/i+d,e&&(a=this.lin2val(a))):(e&&(a=this.val2lin(a)),"between"===f&&(f=.5),a=g*(a-d)*i+h+g*j+(ja(f)?i*f*this.pointRange:0)),a},toPixels:function(a,b){return this.translate(a,!1,!this.horiz,null,!0)+(b?0:this.pos)},toValue:function(a,b){return this.translate(a-(b?0:this.pos),!0,!this.horiz,null,!0)},getPlotLinePath:function(a,b,c,d,e){var i,j,n,f=this.chart,g=this.left,h=this.top,k=c&&f.oldChartHeight||f.chartHeight,l=c&&f.oldChartWidth||f.chartWidth;return i=this.transB,e=p(e,this.translate(a,null,null,c)),a=c=v(e+i),i=j=v(k-e-i),isNaN(e)?n=!0:this.horiz?(i=h,j=k-this.bottom,(g>a||a>g+this.width)&&(n=!0)):(a=g,c=l-this.right,(h>i||i>h+this.height)&&(n=!0)),n&&!d?null:f.renderer.crispLine(["M",a,i,"L",c,j],b||1)},getLinearTickPositions:function(a,b,c){var d,e=ea(U(b/a)*a),f=ea(La(c/a)*a),g=[];if(b===c&&ja(b))return[b];for(b=e;f>=b&&(g.push(b),b=ea(b+a),b!==d);)d=b;return g},getMinorTickPositions:function(){var e,a=this.options,b=this.tickPositions,c=this.minorTickInterval,d=[];if(this.isLog)for(e=b.length,a=1;e>a;a++)d=d.concat(this.getLogTickPositions(c,b[a-1],b[a],!0));else if(this.isDatetimeAxis&&"auto"===a.minorTickInterval)d=d.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c),this.min,this.max,a.startOfWeek)),d[0]<this.min&&d.shift();else for(b=this.min+(b[0]-this.min)%c;b<=this.max;b+=c)d.push(b);return d},adjustForMinRange:function(){var d,f,g,h,i,j,a=this.options,b=this.min,c=this.max,e=this.dataMax-this.dataMin>=this.minRange;if(this.isXAxis&&this.minRange===u&&!this.isLog&&(s(a.min)||s(a.max)?this.minRange=null:(q(this.series,function(a){for(i=a.xData,g=j=a.xIncrement?1:i.length-1;g>0;g--)h=i[g]-i[g-1],(f===u||f>h)&&(f=h)}),this.minRange=L(5*f,this.dataMax-this.dataMin))),c-b<this.minRange){var k=this.minRange;d=(k-c+b)/2,d=[b-d,p(a.min,b-d)],e&&(d[2]=this.dataMin),b=Ca(d),c=[b+k,p(a.max,b+k)],e&&(c[2]=this.dataMax),c=Oa(c),k>c-b&&(d[0]=c-k,d[1]=p(a.min,c-k),b=Ca(d))}this.min=b,this.max=c},setAxisTranslation:function(a){var e,b=this,c=b.max-b.min,d=b.axisPointRange||0,f=0,g=0,h=b.linkedParent,i=!!b.categories,j=b.transA;(b.isXAxis||i||d)&&(h?(f=h.minPointOffset,g=h.pointRangePadding):q(b.series,function(a){var h=i?1:b.isXAxis?a.pointRange:b.axisPointRange||0,j=a.options.pointPlacement,m=a.closestPointRange;h>c&&(h=0),d=t(d,h),f=t(f,Ga(j)?0:h/2),g=t(g,"on"===j?0:h),!a.noSharedTooltip&&s(m)&&(e=s(e)?L(e,m):m)}),h=b.ordinalSlope&&e?b.ordinalSlope/e:1,b.minPointOffset=f*=h,b.pointRangePadding=g*=h,b.pointRange=L(d,c),b.closestPointRange=e),a&&(b.oldTransA=j),b.translationSlope=b.transA=j=b.len/(c+g||1),b.transB=b.horiz?b.left:b.bottom,b.minPixelPadding=j*f},setTickPositions:function(a){var D,b=this,c=b.chart,d=b.options,e=d.startOnTick,f=d.endOnTick,g=b.isLog,h=b.isDatetimeAxis,i=b.isXAxis,j=b.isLinked,k=b.options.tickPositioner,l=d.maxPadding,n=d.minPadding,m=d.tickInterval,o=d.minTickInterval,Y=d.tickPixelInterval,J=b.categories;j?(b.linkedParent=c[b.coll][d.linkedTo],c=b.linkedParent.getExtremes(),b.min=p(c.min,c.dataMin),b.max=p(c.max,c.dataMax),d.type!==b.linkedParent.options.type&&ha(11,1)):(b.min=p(b.userMin,d.min,b.dataMin),b.max=p(b.userMax,d.max,b.dataMax)),g&&(!a&&L(b.min,p(b.dataMin,b.min))<=0&&ha(10,1),b.min=ea(za(b.min)),b.max=ea(za(b.max))),b.range&&s(b.max)&&(b.userMin=b.min=t(b.min,b.max-b.range),b.userMax=b.max,b.range=null),b.beforePadding&&b.beforePadding(),b.adjustForMinRange(),J||b.axisPointRange||b.usePercentage||j||!s(b.min)||!s(b.max)||!(c=b.max-b.min)||(s(d.min)||s(b.userMin)||!n||!(b.dataMin<0)&&b.ignoreMinPadding||(b.min-=c*n),s(d.max)||s(b.userMax)||!l||!(b.dataMax>0)&&b.ignoreMaxPadding||(b.max+=c*l)),ja(d.floor)&&(b.min=t(b.min,d.floor)),ja(d.ceiling)&&(b.max=L(b.max,d.ceiling)),b.min===b.max||void 0===b.min||void 0===b.max?b.tickInterval=1:j&&!m&&Y===b.linkedParent.options.tickPixelInterval?b.tickInterval=b.linkedParent.tickInterval:(b.tickInterval=p(m,J?1:(b.max-b.min)*Y/t(b.len,Y)),!s(m)&&b.len<Y&&!this.isRadial&&!this.isLog&&!J&&e&&f&&(D=!0,b.tickInterval/=4)),i&&!a&&q(b.series,function(a){a.processData(b.min!==b.oldMin||b.max!==b.oldMax)}),b.setAxisTranslation(!0),b.beforeSetTickPositions&&b.beforeSetTickPositions(),b.postProcessTickInterval&&(b.tickInterval=b.postProcessTickInterval(b.tickInterval)),b.pointRange&&(b.tickInterval=t(b.pointRange,b.tickInterval)),!m&&b.tickInterval<o&&(b.tickInterval=o),h||g||m||(b.tickInterval=nb(b.tickInterval,null,mb(b.tickInterval),p(d.allowDecimals,!(b.tickInterval>1&&b.tickInterval<5&&b.max>1e3&&b.max<9999)))),b.minorTickInterval="auto"===d.minorTickInterval&&b.tickInterval?b.tickInterval/5:d.minorTickInterval,b.tickPositions=a=d.tickPositions?[].concat(d.tickPositions):k&&k.apply(b,[b.min,b.max]),a||(!b.ordinalPositions&&(b.max-b.min)/b.tickInterval>t(2*b.len,200)&&ha(19,!0),a=h?b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval,d.units),b.min,b.max,d.startOfWeek,b.ordinalPositions,b.closestPointRange,!0):g?b.getLogTickPositions(b.tickInterval,b.min,b.max):b.getLinearTickPositions(b.tickInterval,b.min,b.max),D&&a.splice(1,a.length-2),b.tickPositions=a),j||(d=a[0],g=a[a.length-1],h=b.minPointOffset||0,e?b.min=d:b.min-h>d&&a.shift(),f?b.max=g:b.max+h<g&&a.pop(),0===a.length&&s(d)&&a.push((g+d)/2),1===a.length&&(e=Q(b.max)>1e13?1:.001,b.min-=e,b.max+=e))},setMaxTicks:function(){var a=this.chart,b=a.maxTicks||{},c=this.tickPositions,d=this._maxTicksKey=[this.coll,this.pos,this.len].join("-");!this.isLinked&&!this.isDatetimeAxis&&c&&c.length>(b[d]||0)&&this.options.alignTicks!==!1&&(b[d]=c.length),a.maxTicks=b},adjustTickAmount:function(){var a=this._maxTicksKey,b=this.tickPositions,c=this.chart.maxTicks;if(c&&c[a]&&!this.isDatetimeAxis&&!this.categories&&!this.isLinked&&this.options.alignTicks!==!1&&this.min!==u){var d=this.tickAmount,e=b.length;if(this.tickAmount=a=c[a],a>e){for(;b.length<a;)b.push(ea(b[b.length-1]+this.tickInterval));this.transA*=(e-1)/(a-1),this.max=b[b.length-1]}s(d)&&a!==d&&(this.isDirty=!0)}},setScale:function(){var b,c,d,e,a=this.stacks;if(this.oldMin=this.min,this.oldMax=this.max,this.oldAxisLength=this.len,this.setAxisSize(),e=this.len!==this.oldAxisLength,q(this.series,function(a){(a.isDirtyData||a.isDirty||a.xAxis.isDirty)&&(d=!0)}),e||d||this.isLinked||this.forceRedraw||this.userMin!==this.oldUserMin||this.userMax!==this.oldUserMax){if(!this.isXAxis)for(b in a)for(c in a[b])a[b][c].total=null,a[b][c].cum=0;this.forceRedraw=!1,this.getSeriesExtremes(),this.setTickPositions(),this.oldUserMin=this.userMin,this.oldUserMax=this.userMax,this.isDirty||(this.isDirty=e||this.min!==this.oldMin||this.max!==this.oldMax)}else if(!this.isXAxis){this.oldStacks&&(a=this.stacks=this.oldStacks);for(b in a)for(c in a[b])a[b][c].cum=a[b][c].total}this.setMaxTicks()},setExtremes:function(a,b,c,d,e){var f=this,g=f.chart,c=p(c,!0),e=r(e,{min:a,max:b});I(f,"setExtremes",e,function(){f.userMin=a,f.userMax=b,f.eventArgs=e,f.isDirtyExtremes=!0,c&&g.redraw(d)})},zoom:function(a,b){var c=this.dataMin,d=this.dataMax,e=this.options;return this.allowZoomOutside||(s(c)&&a<=L(c,p(e.min,c))&&(a=u),s(d)&&b>=t(d,p(e.max,d))&&(b=u)),this.displayBtn=a!==u||b!==u,this.setExtremes(a,b,!1,u,{trigger:"zoom"}),!0},setAxisSize:function(){var a=this.chart,b=this.options,c=b.offsetLeft||0,d=this.horiz,e=p(b.width,a.plotWidth-c+(b.offsetRight||0)),f=p(b.height,a.plotHeight),g=p(b.top,a.plotTop),b=p(b.left,a.plotLeft+c),c=/%$/;c.test(f)&&(f=parseInt(f,10)/100*a.plotHeight),c.test(g)&&(g=parseInt(g,10)/100*a.plotHeight+a.plotTop),this.left=b,this.top=g,this.width=e,this.height=f,this.bottom=a.chartHeight-f-g,this.right=a.chartWidth-e-b,this.len=t(d?e:f,0),this.pos=d?b:g},getExtremes:function(){var a=this.isLog;return{min:a?ea(ka(this.min)):this.min,max:a?ea(ka(this.max)):this.max,dataMin:this.dataMin,dataMax:this.dataMax,userMin:this.userMin,userMax:this.userMax}},getThreshold:function(a){var b=this.isLog,c=b?ka(this.min):this.min,b=b?ka(this.max):this.max;return c>a||null===a?a=c:a>b&&(a=b),this.translate(a,0,1,0,1)},autoLabelAlign:function(a){return a=(p(a,0)-90*this.side+720)%360,a>15&&165>a?"right":a>195&&345>a?"left":"center"},getOffset:function(){var j,k,n,r,x,y,A,z,R,a=this,b=a.chart,c=b.renderer,d=a.options,e=a.tickPositions,f=a.ticks,g=a.horiz,h=a.side,i=b.inverted?[1,0,3,2][h]:h,l=0,m=0,o=d.title,Y=d.labels,D=0,J=b.axisOffset,b=b.clipOffset,C=[-1,1,1,-1][h],v=1,w=p(Y.maxStaggerLines,5);if(a.hasData=j=a.hasVisibleSeries||s(a.min)&&s(a.max)&&!!e,a.showAxis=k=j||p(d.showEmpty,!0),a.staggerLines=a.horiz&&Y.staggerLines,a.axisGroup||(a.gridGroup=c.g("grid").attr({zIndex:d.gridZIndex||1}).add(),a.axisGroup=c.g("axis").attr({zIndex:d.zIndex||2}).add(),a.labelGroup=c.g("axis-labels").attr({zIndex:Y.zIndex||7}).addClass("highcharts-"+a.coll.toLowerCase()+"-labels").add()),j||a.isLinked){if(a.labelAlign=p(Y.align||a.autoLabelAlign(Y.rotation)),q(e,function(b){f[b]?f[b].addLabel():f[b]=new Ta(a,b)}),a.horiz&&!a.staggerLines&&w&&!Y.rotation){for(j=a.reversed?[].concat(e).reverse():e;w>v;){for(x=[],y=!1,r=0;r<j.length;r++)A=j[r],z=(z=f[A].label&&f[A].label.getBBox())?z.width:0,R=r%v,z&&(A=a.translate(A),x[R]!==u&&A<x[R]&&(y=!0),x[R]=A+z);if(!y)break;v++}v>1&&(a.staggerLines=v)}q(e,function(b){(0===h||2===h||{1:"left",3:"right"}[h]===a.labelAlign)&&(D=t(f[b].getLabelSize(),D))}),a.staggerLines&&(D*=a.staggerLines,a.labelOffset=D)}else for(r in f)f[r].destroy(),delete f[r];o&&o.text&&o.enabled!==!1&&(a.axisTitle||(a.axisTitle=c.text(o.text,0,0,o.useHTML).attr({zIndex:7,rotation:o.rotation||0,align:o.textAlign||{low:"left",middle:"center",high:"right"}[o.align]}).addClass("highcharts-"+this.coll.toLowerCase()+"-title").css(o.style).add(a.axisGroup),a.axisTitle.isNew=!0),k&&(l=a.axisTitle.getBBox()[g?"height":"width"],n=o.offset,m=s(n)?0:p(o.margin,g?5:10)),a.axisTitle[k?"show":"hide"]()),a.offset=C*p(d.offset,J[h]),c=2===h?a.tickBaseline:0,g=D+m+(D&&C*(g?p(Y.y,a.tickBaseline+8):Y.x)-c),a.axisTitleMargin=p(n,g),J[h]=t(J[h],a.axisTitleMargin+l+C*a.offset,g),b[i]=t(b[i],2*U(d.lineWidth/2))},getLinePath:function(a){var b=this.chart,c=this.opposite,d=this.offset,e=this.horiz,f=this.left+(c?this.width:0)+d,d=b.chartHeight-this.bottom-(c?this.height:0)+d;return c&&(a*=-1),b.renderer.crispLine(["M",e?this.left:f,e?d:this.top,"L",e?b.chartWidth-this.right:f,e?d:b.chartHeight-this.bottom],a)},getTitlePosition:function(){var a=this.horiz,b=this.left,c=this.top,d=this.len,e=this.options.title,f=a?b:c,g=this.opposite,h=this.offset,i=y(e.style.fontSize||12),d={low:f+(a?0:d),middle:f+d/2,high:f+(a?d:0)}[e.align],b=(a?c+this.height:b)+(a?1:-1)*(g?-1:1)*this.axisTitleMargin+(2===this.side?i:0);return{x:a?d:b+(g?this.width:0)+h+(e.x||0),y:a?b-(g?this.height:0)+h:d+(e.y||0)}},render:function(){var j,v,A,a=this,b=a.horiz,c=a.reversed,d=a.chart,e=d.renderer,f=a.options,g=a.isLog,h=a.isLinked,i=a.tickPositions,k=a.axisTitle,l=a.ticks,n=a.minorTicks,m=a.alternateBands,o=f.stackLabels,p=f.alternateGridColor,D=a.tickmarkOffset,J=f.lineWidth,C=d.hasRendered&&s(a.oldMin)&&!isNaN(a.oldMin),r=a.hasData,t=a.showAxis,w=f.labels.overflow,x=a.justifyLabels=b&&w!==!1;a.labelEdge.length=0,a.justifyToPlot="justify"===w,q([l,n,m],function(a){for(var b in a)a[b].isActive=!1}),(r||h)&&(a.minorTickInterval&&!a.categories&&q(a.getMinorTickPositions(),function(b){n[b]||(n[b]=new Ta(a,b,"minor")),C&&n[b].isNew&&n[b].render(null,!0),n[b].render(null,!1,1)}),i.length&&(j=i.slice(),(b&&c||!b&&!c)&&j.reverse(),x&&(j=j.slice(1).concat([j[0]])),q(j,function(b,c){x&&(c=c===j.length-1?0:c+1),(!h||b>=a.min&&b<=a.max)&&(l[b]||(l[b]=new Ta(a,b)),C&&l[b].isNew&&l[b].render(c,!0,.1),l[b].render(c))}),D&&0===a.min&&(l[-1]||(l[-1]=new Ta(a,-1,null,!0)),l[-1].render(-1))),p&&q(i,function(b,c){c%2===0&&b<a.max&&(m[b]||(m[b]=new K.PlotLineOrBand(a)),v=b+D,A=i[c+1]!==u?i[c+1]+D:a.max,m[b].options={from:g?ka(v):v,to:g?ka(A):A,color:p},m[b].render(),m[b].isActive=!0)}),a._addedPlotLB||(q((f.plotLines||[]).concat(f.plotBands||[]),function(b){a.addPlotBandOrLine(b)}),a._addedPlotLB=!0)),q([l,n,m],function(a){var b,c,e=[],f=va?va.duration||500:0,g=function(){for(c=e.length;c--;)a[e[c]]&&!a[e[c]].isActive&&(a[e[c]].destroy(),delete a[e[c]])};for(b in a)a[b].isActive||(a[b].render(b,!1,0),a[b].isActive=!1,e.push(b));a!==m&&d.hasRendered&&f?f&&setTimeout(g,f):g()}),J&&(b=a.getLinePath(J),a.axisLine?a.axisLine.animate({d:b}):a.axisLine=e.path(b).attr({stroke:f.lineColor,"stroke-width":J,zIndex:7}).add(a.axisGroup),a.axisLine[t?"show":"hide"]()),k&&t&&(k[k.isNew?"attr":"animate"](a.getTitlePosition()),k.isNew=!1),o&&o.enabled&&a.renderStackTotals(),a.isDirty=!1},redraw:function(){this.render(),q(this.plotLinesAndBands,function(a){a.render()}),q(this.series,function(a){a.isDirty=!0})},destroy:function(a){var d,b=this,c=b.stacks,e=b.plotLinesAndBands;a||X(b);for(d in c)Pa(c[d]),c[d]=null;for(q([b.ticks,b.minorTicks,b.alternateBands],function(a){Pa(a)}),a=e.length;a--;)e[a].destroy();q("stackTotalGroup,axisLine,axisTitle,axisGroup,cross,gridGroup,labelGroup".split(","),function(a){b[a]&&(b[a]=b[a].destroy())
}),this.cross&&this.cross.destroy()},drawCrosshair:function(a,b){if(this.crosshair)if((s(b)||!p(this.crosshair.snap,!0))===!1)this.hideCrosshair();else{var c,d=this.crosshair,e=d.animation;p(d.snap,!0)?s(b)&&(c=this.chart.inverted!=this.horiz?b.plotX:this.len-b.plotY):c=this.horiz?a.chartX-this.pos:this.len-a.chartY+this.pos,c=this.isRadial?this.getPlotLinePath(this.isXAxis?b.x:p(b.stackY,b.y)):this.getPlotLinePath(null,null,null,null,c),null===c?this.hideCrosshair():this.cross?this.cross.attr({visibility:"visible"})[e?"animate":"attr"]({d:c},e):(e={"stroke-width":d.width||1,stroke:d.color||"#C0C0C0",zIndex:d.zIndex||2},d.dashStyle&&(e.dashstyle=d.dashStyle),this.cross=this.chart.renderer.path(c).attr(e).add())}},hideCrosshair:function(){this.cross&&this.cross.hide()}},r(na.prototype,{getPlotBandPath:function(a,b){var c=this.getPlotLinePath(b),d=this.getPlotLinePath(a);return d&&c?d.push(c[4],c[5],c[1],c[2]):d=null,d},addPlotBand:function(a){return this.addPlotBandOrLine(a,"plotBands")},addPlotLine:function(a){return this.addPlotBandOrLine(a,"plotLines")},addPlotBandOrLine:function(a,b){var c=new K.PlotLineOrBand(this,a).render(),d=this.userOptions;return c&&(b&&(d[b]=d[b]||[],d[b].push(a)),this.plotLinesAndBands.push(c)),c},removePlotBandOrLine:function(a){for(var b=this.plotLinesAndBands,c=this.options,d=this.userOptions,e=b.length;e--;)b[e].id===a&&b[e].destroy();q([c.plotLines||[],d.plotLines||[],c.plotBands||[],d.plotBands||[]],function(b){for(e=b.length;e--;)b[e].id===a&&la(b,b[e])})}}),na.prototype.getTimeTicks=function(a,b,c,d){var h,e=[],f={},g=E.global.useUTC,i=new Da(b-Sa),j=a.unitRange,k=a.count;if(s(b)){j>=A.second&&(i.setMilliseconds(0),i.setSeconds(j>=A.minute?0:k*U(i.getSeconds()/k))),j>=A.minute&&i[Cb](j>=A.hour?0:k*U(i[pb]()/k)),j>=A.hour&&i[Db](j>=A.day?0:k*U(i[qb]()/k)),j>=A.day&&i[sb](j>=A.month?1:k*U(i[Xa]()/k)),j>=A.month&&(i[Eb](j>=A.year?0:k*U(i[fb]()/k)),h=i[gb]()),j>=A.year&&(h-=h%k,i[Fb](h)),j===A.week&&i[sb](i[Xa]()-i[rb]()+p(d,1)),b=1,Sa&&(i=new Da(i.getTime()+Sa)),h=i[gb]();for(var d=i.getTime(),l=i[fb](),n=i[Xa](),m=(A.day+(g?Sa:6e4*i.getTimezoneOffset()))%A.day;c>d;)e.push(d),j===A.year?d=eb(h+b*k,0):j===A.month?d=eb(h,l+b*k):g||j!==A.day&&j!==A.week?d+=j*k:d=eb(h,l,n+b*k*(j===A.day?1:7)),b++;e.push(d),q(wb(e,function(a){return j<=A.hour&&a%A.day===m}),function(a){f[a]="day"})}return e.info=r(a,{higherRanks:f,totalRange:j*k}),e},na.prototype.normalizeTimeTickInterval=function(a,b){var g,c=b||[["millisecond",[1,2,5,10,20,25,50,100,200,500]],["second",[1,2,5,10,15,30]],["minute",[1,2,5,10,15,30]],["hour",[1,2,3,4,6,8,12]],["day",[1,2]],["week",[1,2]],["month",[1,2,3,4,6]],["year",null]],d=c[c.length-1],e=A[d[0]],f=d[1];for(g=0;g<c.length&&(d=c[g],e=A[d[0]],f=d[1],!(c[g+1]&&a<=(e*f[f.length-1]+A[c[g+1][0]])/2));g++);return e===A.year&&5*e>a&&(f=[1,2,5]),c=nb(a/e,f,"year"===d[0]?t(mb(a/e),1):1),{unitRange:e,count:c,unitName:d[0]}},na.prototype.getLogTickPositions=function(a,b,c,d){var e=this.options,f=this.len,g=[];if(d||(this._minorAutoInterval=null),a>=.5)a=v(a),g=this.getLinearTickPositions(a,b,c);else if(a>=.08)for(var h,i,j,k,l,f=U(b),e=a>.3?[1,2,4]:a>.15?[1,2,4,6,8]:[1,2,3,4,5,6,7,8,9];c+1>f&&!l;f++)for(i=e.length,h=0;i>h&&!l;h++)j=za(ka(f)*e[h]),j>b&&(!d||c>=k)&&k!==u&&g.push(k),k>c&&(l=!0),k=j;else b=ka(b),c=ka(c),a=e[d?"minorTickInterval":"tickInterval"],a=p("auto"===a?null:a,this._minorAutoInterval,(c-b)*(e.tickPixelInterval/(d?5:1))/((d?f/this.tickPositions.length:f)||1)),a=nb(a,null,mb(a)),g=Va(this.getLinearTickPositions(a,b,c),za),d||(this._minorAutoInterval=a/5);return d||(this.tickInterval=a),g};var Nb=K.Tooltip=function(){this.init.apply(this,arguments)};Nb.prototype={init:function(a,b){var c=b.borderWidth,d=b.style,e=y(d.padding);this.chart=a,this.options=b,this.crosshairs=[],this.now={x:0,y:0},this.isHidden=!0,this.label=a.renderer.label("",0,0,b.shape||"callout",null,null,b.useHTML,null,"tooltip").attr({padding:e,fill:b.backgroundColor,"stroke-width":c,r:b.borderRadius,zIndex:8}).css(d).css({padding:0}).add().attr({y:-9999}),ga||this.label.shadow(b.shadow),this.shared=b.shared},destroy:function(){this.label&&(this.label=this.label.destroy()),clearTimeout(this.hideTimer),clearTimeout(this.tooltipTimeout)},move:function(a,b,c,d){var e=this,f=e.now,g=e.options.animation!==!1&&!e.isHidden&&(Q(a-f.x)>1||Q(b-f.y)>1),h=e.followPointer||e.len>1;r(f,{x:g?(2*f.x+a)/3:a,y:g?(f.y+b)/2:b,anchorX:h?u:g?(2*f.anchorX+c)/3:c,anchorY:h?u:g?(f.anchorY+d)/2:d}),e.label.attr(f),g&&(clearTimeout(this.tooltipTimeout),this.tooltipTimeout=setTimeout(function(){e&&e.move(a,b,c,d)},32))},hide:function(a){var c,b=this;clearTimeout(this.hideTimer),this.isHidden||(c=this.chart.hoverPoints,this.hideTimer=setTimeout(function(){b.label.fadeOut(),b.isHidden=!0},p(a,this.options.hideDelay,500)),c&&q(c,function(a){a.setState()}),this.chart.hoverPoints=null)},getAnchor:function(a,b){var c,i,d=this.chart,e=d.inverted,f=d.plotTop,g=0,h=0,a=ra(a);return c=a[0].tooltipPos,this.followPointer&&b&&(b.chartX===u&&(b=d.pointer.normalize(b)),c=[b.chartX-d.plotLeft,b.chartY-f]),c||(q(a,function(a){i=a.series.yAxis,g+=a.plotX,h+=(a.plotLow?(a.plotLow+a.plotHigh)/2:a.plotY)+(!e&&i?i.top-f:0)}),g/=a.length,h/=a.length,c=[e?d.plotWidth-h:g,this.shared&&!e&&a.length>1&&b?b.chartY-f:e?d.plotHeight-g:h]),Va(c,v)},getPosition:function(a,b,c){var g,d=this.chart,e=this.distance,f={},h=["y",d.chartHeight,b,c.plotY+d.plotTop],i=["x",d.chartWidth,a,c.plotX+d.plotLeft],j=c.ttBelow||d.inverted&&!c.negative||!d.inverted&&c.negative,k=function(a,b,c,d){var g=d-e>c,b=b>d+e+c,c=d-e-c;if(d+=e,j&&b)f[a]=d;else if(!j&&g)f[a]=c;else if(g)f[a]=c;else{if(!b)return!1;f[a]=d}},l=function(a,b,c,d){return e>d||d>b-e?!1:void(f[a]=c/2>d?1:d>b-c/2?b-c-2:d-c/2)},n=function(a){var b=h;h=i,i=b,g=a},m=function(){k.apply(0,h)!==!1?l.apply(0,i)===!1&&!g&&(n(!0),m()):g?f.x=f.y=0:(n(!0),m())};return(d.inverted||this.len>1)&&n(),m(),f},defaultFormatter:function(a){var d,b=this.points||ra(this),c=b[0].series;return d=[a.tooltipHeaderFormatter(b[0])],q(b,function(a){c=a.series,d.push(c.tooltipFormatter&&c.tooltipFormatter(a)||a.point.tooltipFormatter(c.tooltipOptions.pointFormat))}),d.push(a.options.footerFormat||""),d.join("")},refresh:function(a,b){var f,g,i,c=this.chart,d=this.label,e=this.options,h={},j=[];i=e.formatter||this.defaultFormatter;var k,h=c.hoverPoints,l=this.shared;clearTimeout(this.hideTimer),this.followPointer=ra(a)[0].series.tooltipOptions.followPointer,g=this.getAnchor(a,b),f=g[0],g=g[1],!l||a.series&&a.series.noSharedTooltip?h=a.getLabelConfig():(c.hoverPoints=a,h&&q(h,function(a){a.setState()}),q(a,function(a){a.setState("hover"),j.push(a.getLabelConfig())}),h={x:a[0].category,y:a[0].y},h.points=j,this.len=j.length,a=a[0]),i=i.call(h,this),h=a.series,this.distance=p(h.tooltipOptions.distance,16),i===!1?this.hide():(this.isHidden&&(bb(d),d.attr("opacity",1).show()),d.attr({text:i}),k=e.borderColor||a.color||h.color||"#606060",d.attr({stroke:k}),this.updatePosition({plotX:f,plotY:g,negative:a.negative,ttBelow:a.ttBelow}),this.isHidden=!1),I(c,"tooltipRefresh",{text:i,x:f+c.plotLeft,y:g+c.plotTop,borderColor:k})},updatePosition:function(a){var b=this.chart,c=this.label,c=(this.options.positioner||this.getPosition).call(this,c.width,c.height,a);this.move(v(c.x),v(c.y),a.plotX+b.plotLeft,a.plotY+b.plotTop)},tooltipHeaderFormatter:function(a){var h,b=a.series,c=b.tooltipOptions,d=c.dateTimeLabelFormats,e=c.xDateFormat,f=b.xAxis,g=f&&"datetime"===f.options.type&&ja(a.key),c=c.headerFormat,f=f&&f.closestPointRange;if(g&&!e){if(f){for(h in A)if(A[h]>=f||A[h]<=A.day&&a.key%A[h]>0){e=d[h];break}}else e=d.day;e=e||d.year}return g&&e&&(c=c.replace("{point.key}","{point.key:"+e+"}")),Ja(c,{point:a,series:b})}};var pa;$a=x.documentElement.ontouchstart!==u;var Wa=K.Pointer=function(a,b){this.init(a,b)};if(Wa.prototype={init:function(a,b){var f,c=b.chart,d=c.events,e=ga?"":c.zoomType,c=a.inverted;this.options=b,this.chart=a,this.zoomX=f=/x/.test(e),this.zoomY=e=/y/.test(e),this.zoomHor=f&&!c||e&&c,this.zoomVert=e&&!c||f&&c,this.hasZoom=f||e,this.runChartClick=d&&!!d.click,this.pinchDown=[],this.lastValidTouch={},K.Tooltip&&b.tooltip.enabled&&(a.tooltip=new Nb(a,b.tooltip),this.followTouchMove=b.tooltip.followTouchMove),this.setDOMEvents()},normalize:function(a,b){var c,d,a=a||window.event,a=Tb(a);return a.target||(a.target=a.srcElement),d=a.touches?a.touches.length?a.touches.item(0):a.changedTouches[0]:a,b||(this.chartPosition=b=Sb(this.chart.container)),d.pageX===u?(c=t(a.x,a.clientX-b.left),d=a.y):(c=d.pageX-b.left,d=d.pageY-b.top),r(a,{chartX:v(c),chartY:v(d)})},getCoordinates:function(a){var b={xAxis:[],yAxis:[]};return q(this.chart.axes,function(c){b[c.isXAxis?"xAxis":"yAxis"].push({axis:c,value:c.toValue(a[c.horiz?"chartX":"chartY"])})}),b},getIndex:function(a){var b=this.chart;return b.inverted?b.plotHeight+b.plotTop-a.chartY:a.chartX-b.plotLeft},runPointActions:function(a){var e,f,i,j,b=this.chart,c=b.series,d=b.tooltip,g=b.hoverPoint,h=b.hoverSeries,k=b.chartWidth,l=this.getIndex(a);if(d&&this.options.tooltip.shared&&(!h||!h.noSharedTooltip)){for(f=[],i=c.length,j=0;i>j;j++)c[j].visible&&c[j].options.enableMouseTracking!==!1&&!c[j].noSharedTooltip&&c[j].singularTooltips!==!0&&c[j].tooltipPoints.length&&(e=c[j].tooltipPoints[l])&&e.series&&(e._dist=Q(l-e.clientX),k=L(k,e._dist),f.push(e));for(i=f.length;i--;)f[i]._dist>k&&f.splice(i,1);f.length&&f[0].clientX!==this.hoverX&&(d.refresh(f,a),this.hoverX=f[0].clientX)}c=h&&h.tooltipOptions.followPointer,h&&h.tracker&&!c?(e=h.tooltipPoints[l])&&e!==g&&e.onMouseOver(a):d&&c&&!d.isHidden&&(h=d.getAnchor([{}],a),d.updatePosition({plotX:h[0],plotY:h[1]})),d&&!this._onDocumentMouseMove&&(this._onDocumentMouseMove=function(a){W[pa]&&W[pa].pointer.onDocumentMouseMove(a)},N(x,"mousemove",this._onDocumentMouseMove)),q(b.axes,function(b){b.drawCrosshair(a,p(e,g))})},reset:function(a,b){var c=this.chart,d=c.hoverSeries,e=c.hoverPoint,f=c.tooltip,g=f&&f.shared?c.hoverPoints:e;(a=a&&f&&g)&&ra(g)[0].plotX===u&&(a=!1),a?(f.refresh(g),e&&e.setState(e.state,!0)):(e&&e.onMouseOut(),d&&d.onMouseOut(),f&&f.hide(b),this._onDocumentMouseMove&&(X(x,"mousemove",this._onDocumentMouseMove),this._onDocumentMouseMove=null),q(c.axes,function(a){a.hideCrosshair()}),this.hoverX=null)},scaleGroups:function(a,b){var d,c=this.chart;q(c.series,function(e){d=a||e.getPlotBox(),e.xAxis&&e.xAxis.zoomEnabled&&(e.group.attr(d),e.markerGroup&&(e.markerGroup.attr(d),e.markerGroup.clip(b?c.clipRect:null)),e.dataLabelsGroup&&e.dataLabelsGroup.attr(d))}),c.clipRect.attr(b||c.clipBox)},dragStart:function(a){var b=this.chart;b.mouseIsDown=a.type,b.cancelClick=!1,b.mouseDownX=this.mouseDownX=a.chartX,b.mouseDownY=this.mouseDownY=a.chartY},drag:function(a){var l,b=this.chart,c=b.options.chart,d=a.chartX,e=a.chartY,f=this.zoomHor,g=this.zoomVert,h=b.plotLeft,i=b.plotTop,j=b.plotWidth,k=b.plotHeight,n=this.mouseDownX,m=this.mouseDownY,o=c.panKey&&a[c.panKey+"Key"];h>d?d=h:d>h+j&&(d=h+j),i>e?e=i:e>i+k&&(e=i+k),this.hasDragged=Math.sqrt(Math.pow(n-d,2)+Math.pow(m-e,2)),this.hasDragged>10&&(l=b.isInsidePlot(n-h,m-i),b.hasCartesianSeries&&(this.zoomX||this.zoomY)&&l&&!o&&!this.selectionMarker&&(this.selectionMarker=b.renderer.rect(h,i,f?1:j,g?1:k,0).attr({fill:c.selectionMarkerFill||"rgba(69,114,167,0.25)",zIndex:7}).add()),this.selectionMarker&&f&&(d-=n,this.selectionMarker.attr({width:Q(d),x:(d>0?0:d)+n})),this.selectionMarker&&g&&(d=e-m,this.selectionMarker.attr({height:Q(d),y:(d>0?0:d)+m})),l&&!this.selectionMarker&&c.panning&&b.pan(a,c.panning))},drop:function(a){var b=this.chart,c=this.hasPinched;if(this.selectionMarker){var j,d={xAxis:[],yAxis:[],originalEvent:a.originalEvent||a},e=this.selectionMarker,f=e.attr?e.attr("x"):e.x,g=e.attr?e.attr("y"):e.y,h=e.attr?e.attr("width"):e.width,i=e.attr?e.attr("height"):e.height;(this.hasDragged||c)&&(q(b.axes,function(b){if(b.zoomEnabled){var c=b.horiz,e="touchend"===a.type?b.minPixelPadding:0,m=b.toValue((c?f:g)+e),c=b.toValue((c?f+h:g+i)-e);!isNaN(m)&&!isNaN(c)&&(d[b.coll].push({axis:b,min:L(m,c),max:t(m,c)}),j=!0)}}),j&&I(b,"selection",d,function(a){b.zoom(r(a,c?{animation:!1}:null))})),this.selectionMarker=this.selectionMarker.destroy(),c&&this.scaleGroups()}b&&(B(b.container,{cursor:b._cursor}),b.cancelClick=this.hasDragged>10,b.mouseIsDown=this.hasDragged=this.hasPinched=!1,this.pinchDown=[])},onContainerMouseDown:function(a){a=this.normalize(a),a.preventDefault&&a.preventDefault(),this.dragStart(a)},onDocumentMouseUp:function(a){W[pa]&&W[pa].pointer.drop(a)},onDocumentMouseMove:function(a){var b=this.chart,c=this.chartPosition,d=b.hoverSeries,a=this.normalize(a,c);c&&d&&!this.inClass(a.target,"highcharts-tracker")&&!b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop)&&this.reset()},onContainerMouseLeave:function(){var a=W[pa];a&&(a.pointer.reset(),a.pointer.chartPosition=null)},onContainerMouseMove:function(a){var b=this.chart;pa=b.index,a=this.normalize(a),a.returnValue=!1,"mousedown"===b.mouseIsDown&&this.drag(a),(this.inClass(a.target,"highcharts-tracker")||b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop))&&!b.openMenu&&this.runPointActions(a)},inClass:function(a,b){for(var c;a;){if(c=F(a,"class")){if(-1!==c.indexOf(b))return!0;if(-1!==c.indexOf("highcharts-container"))return!1}a=a.parentNode}},onTrackerMouseOut:function(a){var b=this.chart.hoverSeries,c=(a=a.relatedTarget||a.toElement)&&a.point&&a.point.series;!b||b.options.stickyTracking||this.inClass(a,"highcharts-tooltip")||c===b||b.onMouseOut()},onContainerClick:function(a){var b=this.chart,c=b.hoverPoint,d=b.plotLeft,e=b.plotTop,a=this.normalize(a);a.cancelBubble=!0,b.cancelClick||(c&&this.inClass(a.target,"highcharts-tracker")?(I(c.series,"click",r(a,{point:c})),b.hoverPoint&&c.firePointEvent("click",a)):(r(a,this.getCoordinates(a)),b.isInsidePlot(a.chartX-d,a.chartY-e)&&I(b,"click",a)))},setDOMEvents:function(){var a=this,b=a.chart.container;b.onmousedown=function(b){a.onContainerMouseDown(b)},b.onmousemove=function(b){a.onContainerMouseMove(b)},b.onclick=function(b){a.onContainerClick(b)},N(b,"mouseleave",a.onContainerMouseLeave),1===ab&&N(x,"mouseup",a.onDocumentMouseUp),$a&&(b.ontouchstart=function(b){a.onContainerTouchStart(b)},b.ontouchmove=function(b){a.onContainerTouchMove(b)},1===ab&&N(x,"touchend",a.onDocumentTouchEnd))},destroy:function(){var a;X(this.chart.container,"mouseleave",this.onContainerMouseLeave),ab||(X(x,"mouseup",this.onDocumentMouseUp),X(x,"touchend",this.onDocumentTouchEnd)),clearInterval(this.tooltipTimeout);for(a in this)this[a]=null}},r(K.Pointer.prototype,{pinchTranslate:function(a,b,c,d,e,f){(this.zoomHor||this.pinchHor)&&this.pinchTranslateDirection(!0,a,b,c,d,e,f),(this.zoomVert||this.pinchVert)&&this.pinchTranslateDirection(!1,a,b,c,d,e,f)},pinchTranslateDirection:function(a,b,c,d,e,f,g,h){var o,p,x,i=this.chart,j=a?"x":"y",k=a?"X":"Y",l="chart"+k,n=a?"width":"height",m=i["plot"+(a?"Left":"Top")],q=h||1,r=i.inverted,C=i.bounds[a?"h":"v"],t=1===b.length,s=b[0][l],v=c[0][l],u=!t&&b[1][l],w=!t&&c[1][l],c=function(){!t&&Q(s-u)>20&&(q=h||Q(v-w)/Q(s-u)),p=(m-v)/q+s,o=i["plot"+(a?"Width":"Height")]/q};c(),b=p,b<C.min?(b=C.min,x=!0):b+o>C.max&&(b=C.max-o,x=!0),x?(v-=.8*(v-g[j][0]),t||(w-=.8*(w-g[j][1])),c()):g[j]=[v,w],r||(f[j]=p-m,f[n]=o),f=r?1/q:q,e[n]=o,e[j]=b,d[r?a?"scaleY":"scaleX":"scale"+k]=q,d["translate"+k]=f*m+(v-f*s)},pinch:function(a){var b=this,c=b.chart,d=b.pinchDown,e=b.followTouchMove,f=a.touches,g=f.length,h=b.lastValidTouch,i=b.hasZoom,j=b.selectionMarker,k={},l=1===g&&(b.inClass(a.target,"highcharts-tracker")&&c.runTrackerClick||b.runChartClick),n={};(i||e)&&!l&&a.preventDefault(),Va(f,function(a){return b.normalize(a)}),"touchstart"===a.type?(q(f,function(a,b){d[b]={chartX:a.chartX,chartY:a.chartY}}),h.x=[d[0].chartX,d[1]&&d[1].chartX],h.y=[d[0].chartY,d[1]&&d[1].chartY],q(c.axes,function(a){if(a.zoomEnabled){var b=c.bounds[a.horiz?"h":"v"],d=a.minPixelPadding,e=a.toPixels(p(a.options.min,a.dataMin)),f=a.toPixels(p(a.options.max,a.dataMax)),g=L(e,f),e=t(e,f);b.min=L(a.pos,g-d),b.max=t(a.pos+a.len,e+d)}}),b.res=!0):d.length&&(j||(b.selectionMarker=j=r({destroy:sa},c.plotBox)),b.pinchTranslate(d,f,k,j,n,h),b.hasPinched=i,b.scaleGroups(k,n),!i&&e&&1===g?this.runPointActions(b.normalize(a)):b.res&&(b.res=!1,this.reset(!1,0)))},onContainerTouchStart:function(a){var b=this.chart;pa=b.index,1===a.touches.length?(a=this.normalize(a),b.isInsidePlot(a.chartX-b.plotLeft,a.chartY-b.plotTop)?(this.runPointActions(a),this.pinch(a)):this.reset()):2===a.touches.length&&this.pinch(a)},onContainerTouchMove:function(a){(1===a.touches.length||2===a.touches.length)&&this.pinch(a)},onDocumentTouchEnd:function(a){W[pa]&&W[pa].pointer.drop(a)}}),G.PointerEvent||G.MSPointerEvent){var ua={},zb=!!G.PointerEvent,Xb=function(){var a,b=[];b.item=function(a){return this[a]};for(a in ua)ua.hasOwnProperty(a)&&b.push({pageX:ua[a].pageX,pageY:ua[a].pageY,target:ua[a].target});return b},Ab=function(a,b,c,d){a=a.originalEvent||a,"touch"!==a.pointerType&&a.pointerType!==a.MSPOINTER_TYPE_TOUCH||!W[pa]||(d(a),d=W[pa].pointer,d[b]({type:c,target:a.currentTarget,preventDefault:sa,touches:Xb()}))};r(Wa.prototype,{onContainerPointerDown:function(a){Ab(a,"onContainerTouchStart","touchstart",function(a){ua[a.pointerId]={pageX:a.pageX,pageY:a.pageY,target:a.currentTarget}})},onContainerPointerMove:function(a){Ab(a,"onContainerTouchMove","touchmove",function(a){ua[a.pointerId]={pageX:a.pageX,pageY:a.pageY},ua[a.pointerId].target||(ua[a.pointerId].target=a.currentTarget)})},onDocumentPointerUp:function(a){Ab(a,"onContainerTouchEnd","touchend",function(a){delete ua[a.pointerId]})},batchMSEvents:function(a){a(this.chart.container,zb?"pointerdown":"MSPointerDown",this.onContainerPointerDown),a(this.chart.container,zb?"pointermove":"MSPointerMove",this.onContainerPointerMove),a(x,zb?"pointerup":"MSPointerUp",this.onDocumentPointerUp)}}),Na(Wa.prototype,"init",function(a,b,c){a.call(this,b,c),(this.hasZoom||this.followTouchMove)&&B(b.container,{"-ms-touch-action":P,"touch-action":P})}),Na(Wa.prototype,"setDOMEvents",function(a){a.apply(this),(this.hasZoom||this.followTouchMove)&&this.batchMSEvents(N)}),Na(Wa.prototype,"destroy",function(a){this.batchMSEvents(X),a.call(this)})}var lb=K.Legend=function(a,b){this.init(a,b)};lb.prototype={init:function(a,b){var c=this,d=b.itemStyle,e=p(b.padding,8),f=b.itemMarginTop||0;this.options=b,b.enabled&&(c.itemStyle=d,c.itemHiddenStyle=w(d,b.itemHiddenStyle),c.itemMarginTop=f,c.padding=e,c.initialItemX=e,c.initialItemY=e-5,c.maxItemWidth=0,c.chart=a,c.itemHeight=0,c.lastLineHeight=0,c.symbolWidth=p(b.symbolWidth,16),c.pages=[],c.render(),N(c.chart,"endResize",function(){c.positionCheckboxes()}))},colorizeItem:function(a,b){var j,c=this.options,d=a.legendItem,e=a.legendLine,f=a.legendSymbol,g=this.itemHiddenStyle.color,c=b?c.itemStyle.color:g,h=b?a.legendColor||a.color||"#CCC":g,g=a.options&&a.options.marker,i={fill:h};if(d&&d.css({fill:c,color:c}),e&&e.attr({stroke:h}),f){if(g&&f.isMarker)for(j in i.stroke=h,g=a.convertAttribs(g))d=g[j],d!==u&&(i[j]=d);f.attr(i)}},positionItem:function(a){var b=this.options,c=b.symbolPadding,b=!b.rtl,d=a._legendItemPos,e=d[0],d=d[1],f=a.checkbox;a.legendGroup&&a.legendGroup.translate(b?e:this.legendWidth-e-2*c-4,d),f&&(f.x=e,f.y=d)},destroyItem:function(a){var b=a.checkbox;q(["legendItem","legendLine","legendSymbol","legendGroup"],function(b){a[b]&&(a[b]=a[b].destroy())}),b&&Qa(a.checkbox)},destroy:function(){var a=this.group,b=this.box;b&&(this.box=b.destroy()),a&&(this.group=a.destroy())},positionCheckboxes:function(a){var c,b=this.group.alignAttr,d=this.clipHeight||this.legendHeight;b&&(c=b.translateY,q(this.allItems,function(e){var g,f=e.checkbox;f&&(g=c+f.y+(a||0)+3,B(f,{left:b.translateX+e.checkboxOffset+f.x-20+"px",top:g+"px",display:g>c-6&&c+d-6>g?"":P}))}))},renderTitle:function(){var a=this.padding,b=this.options.title,c=0;b.text&&(this.title||(this.title=this.chart.renderer.label(b.text,a-3,a-4,null,null,null,null,null,"legend-title").attr({zIndex:1}).css(b.style).add(this.group)),a=this.title.getBBox(),c=a.height,this.offsetWidth=a.width,this.contentGroup.attr({translateY:c})),this.titleHeight=c},renderItem:function(a){var b=this.chart,c=b.renderer,d=this.options,e="horizontal"===d.layout,f=this.symbolWidth,g=d.symbolPadding,h=this.itemStyle,i=this.itemHiddenStyle,j=this.padding,k=e?p(d.itemDistance,20):0,l=!d.rtl,n=d.width,m=d.itemMarginBottom||0,o=this.itemMarginTop,q=this.initialItemX,r=a.legendItem,s=a.series&&a.series.drawLegendSymbol?a.series:a,C=s.options,C=this.createCheckboxForItem&&C&&C.showCheckbox,u=d.useHTML;r||(a.legendGroup=c.g("legend-item").attr({zIndex:1}).add(this.scrollGroup),a.legendItem=r=c.text(d.labelFormat?Ja(d.labelFormat,a):d.labelFormatter.call(a),l?f+g:-g,this.baseline||0,u).css(w(a.visible?h:i)).attr({align:l?"left":"right",zIndex:2}).add(a.legendGroup),this.baseline||(this.baseline=c.fontMetrics(h.fontSize,r).f+3+o,r.attr("y",this.baseline)),s.drawLegendSymbol(this,a),this.setItemEvents&&this.setItemEvents(a,r,u,h,i),this.colorizeItem(a,a.visible),C&&this.createCheckboxForItem(a)),c=r.getBBox(),f=a.checkboxOffset=d.itemWidth||a.legendItemWidth||f+g+c.width+k+(C?20:0),this.itemHeight=g=v(a.legendItemHeight||c.height),e&&this.itemX-q+f>(n||b.chartWidth-2*j-q-d.x)&&(this.itemX=q,this.itemY+=o+this.lastLineHeight+m,this.lastLineHeight=0),this.maxItemWidth=t(this.maxItemWidth,f),this.lastItemY=o+this.itemY+m,this.lastLineHeight=t(g,this.lastLineHeight),a._legendItemPos=[this.itemX,this.itemY],e?this.itemX+=f:(this.itemY+=o+g+m,this.lastLineHeight=g),this.offsetWidth=n||t((e?this.itemX-q-k:f)+j,this.offsetWidth)},getAllItems:function(){var a=[];return q(this.chart.series,function(b){var c=b.options;p(c.showInLegend,s(c.linkedTo)?!1:u,!0)&&(a=a.concat(b.legendItems||("point"===c.legendType?b.data:b)))}),a},render:function(){var e,f,g,h,a=this,b=a.chart,c=b.renderer,d=a.group,i=a.box,j=a.options,k=a.padding,l=j.borderWidth,n=j.backgroundColor;a.itemX=a.initialItemX,a.itemY=a.initialItemY,a.offsetWidth=0,a.lastItemY=0,d||(a.group=d=c.g("legend").attr({zIndex:7}).add(),a.contentGroup=c.g().attr({zIndex:1}).add(d),a.scrollGroup=c.g().add(a.contentGroup)),a.renderTitle(),e=a.getAllItems(),ob(e,function(a,b){return(a.options&&a.options.legendIndex||0)-(b.options&&b.options.legendIndex||0)}),j.reversed&&e.reverse(),a.allItems=e,a.display=f=!!e.length,q(e,function(b){a.renderItem(b)}),g=j.width||a.offsetWidth,h=a.lastItemY+a.lastLineHeight+a.titleHeight,h=a.handleOverflow(h),(l||n)&&(g+=k,h+=k,i?g>0&&h>0&&(i[i.isNew?"attr":"animate"](i.crisp({width:g,height:h})),i.isNew=!1):(a.box=i=c.rect(0,0,g,h,j.borderRadius,l||0).attr({stroke:j.borderColor,"stroke-width":l||0,fill:n||P}).add(d).shadow(j.shadow),i.isNew=!0),i[f?"show":"hide"]()),a.legendWidth=g,a.legendHeight=h,q(e,function(b){a.positionItem(b)}),f&&d.align(r({width:g,height:h},j),!0,"spacingBox"),b.isResizing||this.positionCheckboxes()},handleOverflow:function(a){var h,o,b=this,c=this.chart,d=c.renderer,e=this.options,f=e.y,f=c.spacingBox.height+("top"===e.verticalAlign?-f:f)-this.padding,g=e.maxHeight,i=this.clipRect,j=e.navigation,k=p(j.animation,!0),l=j.arrowSize||12,n=this.nav,m=this.pages,r=this.allItems;return"horizontal"===e.layout&&(f/=2),g&&(f=L(f,g)),m.length=0,a>f&&!e.useHTML?(this.clipHeight=h=t(f-20-this.titleHeight-this.padding,0),this.currentPage=p(this.currentPage,1),this.fullHeight=a,q(r,function(a,b){var c=a._legendItemPos[1],d=v(a.legendItem.getBBox().height),e=m.length;(!e||c-m[e-1]>h&&(o||c)!==m[e-1])&&(m.push(o||c),e++),b===r.length-1&&c+d-m[e-1]>h&&m.push(c),c!==o&&(o=c)}),i||(i=b.clipRect=d.clipRect(0,this.padding,9999,0),b.contentGroup.clip(i)),i.attr({height:h}),n||(this.nav=n=d.g().attr({zIndex:1}).add(this.group),this.up=d.symbol("triangle",0,0,l,l).on("click",function(){b.scroll(-1,k)}).add(n),this.pager=d.text("",15,10).css(j.style).add(n),this.down=d.symbol("triangle-down",0,0,l,l).on("click",function(){b.scroll(1,k)}).add(n)),b.scroll(0),a=f):n&&(i.attr({height:c.chartHeight}),n.hide(),this.scrollGroup.attr({translateY:1}),this.clipHeight=0),a},scroll:function(a,b){var c=this.pages,d=c.length,e=this.currentPage+a,f=this.clipHeight,g=this.options.navigation,h=g.activeColor,g=g.inactiveColor,i=this.pager,j=this.padding;e>d&&(e=d),e>0&&(b!==u&&Ra(b,this.chart),this.nav.attr({translateX:j,translateY:f+this.padding+7+this.titleHeight,visibility:"visible"}),this.up.attr({fill:1===e?g:h}).css({cursor:1===e?"default":"pointer"}),i.attr({text:e+"/"+d}),this.down.attr({x:18+this.pager.getBBox().width,fill:e===d?g:h}).css({cursor:e===d?"default":"pointer"}),c=-c[e-1]+this.initialItemY,this.scrollGroup.animate({translateY:c}),this.currentPage=e,this.positionCheckboxes(c))}},M=K.LegendSymbolMixin={drawRectangle:function(a,b){var c=a.options.symbolHeight||12;b.legendSymbol=this.chart.renderer.rect(0,a.baseline-5-c/2,a.symbolWidth,c,a.options.symbolRadius||0).attr({zIndex:3}).add(b.legendGroup)},drawLineMarker:function(a){var d,b=this.options,c=b.marker;d=a.symbolWidth;var g,e=this.chart.renderer,f=this.legendGroup,a=a.baseline-v(.3*e.fontMetrics(a.options.itemStyle.fontSize,this.legendItem).b);b.lineWidth&&(g={"stroke-width":b.lineWidth},b.dashStyle&&(g.dashstyle=b.dashStyle),this.legendLine=e.path(["M",0,a,"L",d,a]).attr(g).add(f)),c&&c.enabled!==!1&&(b=c.radius,this.legendSymbol=d=e.symbol(this.symbol,d/2-b,a-b,2*b,2*b).add(f),d.isMarker=!0)}},(/Trident\/7\.0/.test(wa)||Ua)&&Na(lb.prototype,"positionItem",function(a,b){var c=this,d=function(){b._legendItemPos&&a.call(c,b)};d(),setTimeout(d)}),Ya.prototype={init:function(a,b){var c,d=a.series;a.series=null,c=w(E,a),c.series=a.series=d,this.userOptions=a,d=c.chart,this.margin=this.splashArray("margin",d),this.spacing=this.splashArray("spacing",d);var e=d.events;this.bounds={h:{},v:{}},this.callback=b,this.isResizing=0,this.options=c,this.axes=[],this.series=[],this.hasCartesianSeries=d.showAxes;var g,f=this;if(f.index=W.length,W.push(f),ab++,d.reflow!==!1&&N(f,"load",function(){f.initReflow()}),e)for(g in e)N(f,g,e[g]);f.xAxis=[],f.yAxis=[],f.animation=ga?!1:p(d.animation,!0),f.pointCount=f.colorCounter=f.symbolCounter=0,f.firstRender()},initSeries:function(a){var b=this.options.chart;return(b=H[a.type||b.type||b.defaultSeriesType])||ha(17,!0),b=new b,b.init(this,a),b},isInsidePlot:function(a,b,c){var d=c?b:a,a=c?a:b;return d>=0&&d<=this.plotWidth&&a>=0&&a<=this.plotHeight},adjustTickAmounts:function(){this.options.chart.alignTicks!==!1&&q(this.axes,function(a){a.adjustTickAmount()}),this.maxTicks=null},redraw:function(a){var g,h,b=this.axes,c=this.series,d=this.pointer,e=this.legend,f=this.isDirtyLegend,i=this.hasCartesianSeries,j=this.isDirtyBox,k=c.length,l=k,n=this.renderer,m=n.isHidden(),o=[];for(Ra(a,this),m&&this.cloneRenderTo(),this.layOutTitles();l--;)if(a=c[l],a.options.stacking&&(g=!0,a.isDirty)){h=!0;break}if(h)for(l=k;l--;)a=c[l],a.options.stacking&&(a.isDirty=!0);q(c,function(a){a.isDirty&&"point"===a.options.legendType&&(f=!0)}),f&&e.options.enabled&&(e.render(),this.isDirtyLegend=!1),g&&this.getStacks(),i&&(this.isResizing||(this.maxTicks=null,q(b,function(a){a.setScale()})),this.adjustTickAmounts()),this.getMargins(),i&&(q(b,function(a){a.isDirty&&(j=!0)}),q(b,function(a){a.isDirtyExtremes&&(a.isDirtyExtremes=!1,o.push(function(){I(a,"afterSetExtremes",r(a.eventArgs,a.getExtremes())),delete a.eventArgs})),(j||g)&&a.redraw()})),j&&this.drawChartBox(),q(c,function(a){a.isDirty&&a.visible&&(!a.isCartesian||a.xAxis)&&a.redraw()}),d&&d.reset(!0),n.draw(),I(this,"redraw"),m&&this.cloneRenderTo(!0),q(o,function(a){a.call()})},get:function(a){var d,e,b=this.axes,c=this.series;for(d=0;d<b.length;d++)if(b[d].options.id===a)return b[d];for(d=0;d<c.length;d++)if(c[d].options.id===a)return c[d];for(d=0;d<c.length;d++)for(e=c[d].points||[],b=0;b<e.length;b++)if(e[b].id===a)return e[b];return null},getAxes:function(){var a=this,b=this.options,c=b.xAxis=ra(b.xAxis||{}),b=b.yAxis=ra(b.yAxis||{});q(c,function(a,b){a.index=b,a.isX=!0}),q(b,function(a,b){a.index=b}),c=c.concat(b),q(c,function(b){new na(a,b)}),a.adjustTickAmounts()},getSelectedPoints:function(){var a=[];return q(this.series,function(b){a=a.concat(wb(b.points||[],function(a){return a.selected}))}),a},getSelectedSeries:function(){return wb(this.series,function(a){return a.selected})},getStacks:function(){var a=this;q(a.yAxis,function(a){a.stacks&&a.hasVisibleSeries&&(a.oldStacks=a.stacks)}),q(a.series,function(b){!b.options.stacking||b.visible!==!0&&a.options.chart.ignoreHiddenSeries!==!1||(b.stackKey=b.type+p(b.options.stack,""))})},setTitle:function(a,b,c){var g,f,d=this,e=d.options;f=e.title=w(e.title,a),g=e.subtitle=w(e.subtitle,b),e=g,q([["title",a,f],["subtitle",b,e]],function(a){var b=a[0],c=d[b],e=a[1],a=a[2];c&&e&&(d[b]=c=c.destroy()),a&&a.text&&!c&&(d[b]=d.renderer.text(a.text,0,0,a.useHTML).attr({align:a.align,"class":"highcharts-"+b,zIndex:a.zIndex||4}).css(a.style).add())}),d.layOutTitles(c)},layOutTitles:function(a){var b=0,c=this.title,d=this.subtitle,e=this.options,f=e.title,e=e.subtitle,g=this.renderer,h=this.spacingBox.width-44;!c||(c.css({width:(f.width||h)+"px"}).align(r({y:g.fontMetrics(f.style.fontSize,c).b-3},f),!1,"spacingBox"),f.floating||f.verticalAlign)||(b=c.getBBox().height),d&&(d.css({width:(e.width||h)+"px"}).align(r({y:b+(f.margin-13)+g.fontMetrics(f.style.fontSize,d).b},e),!1,"spacingBox"),!e.floating&&!e.verticalAlign&&(b=La(b+d.getBBox().height))),c=this.titleOffset!==b,this.titleOffset=b,!this.isDirtyBox&&c&&(this.isDirtyBox=c,this.hasRendered&&p(a,!0)&&this.isDirtyBox&&this.redraw())},getChartSize:function(){var a=this.options.chart,b=a.width,a=a.height,c=this.renderToClone||this.renderTo;s(b)||(this.containerWidth=ib(c,"width")),s(a)||(this.containerHeight=ib(c,"height")),this.chartWidth=t(0,b||this.containerWidth||600),this.chartHeight=t(0,p(a,this.containerHeight>19?this.containerHeight:400))},cloneRenderTo:function(a){var b=this.renderToClone,c=this.container;a?b&&(this.renderTo.appendChild(c),Qa(b),delete this.renderToClone):(c&&c.parentNode===this.renderTo&&this.renderTo.removeChild(c),this.renderToClone=b=this.renderTo.cloneNode(0),B(b,{position:"absolute",top:"-9999px",display:"block"}),b.style.setProperty&&b.style.setProperty("display","block","important"),x.body.appendChild(b),c&&b.appendChild(c))},getContainer:function(){var a,c,d,e,b=this.options.chart;this.renderTo=a=b.renderTo,e="highcharts-"+ub++,Ga(a)&&(this.renderTo=a=x.getElementById(a)),a||ha(13,!0),c=y(F(a,"data-highcharts-chart")),!isNaN(c)&&W[c]&&W[c].hasRendered&&W[c].destroy(),F(a,"data-highcharts-chart",this.index),a.innerHTML="",!b.skipClone&&!a.offsetWidth&&this.cloneRenderTo(),this.getChartSize(),c=this.chartWidth,d=this.chartHeight,this.container=a=$(Ka,{className:"highcharts-container"+(b.className?" "+b.className:""),id:e},r({position:"relative",overflow:"hidden",width:c+"px",height:d+"px",textAlign:"left",lineHeight:"normal",zIndex:0,"-webkit-tap-highlight-color":"rgba(0,0,0,0)"},b.style),this.renderToClone||a),this._cursor=a.style.cursor,this.renderer=b.forExport?new ta(a,c,d,b.style,!0):new Za(a,c,d,b.style),ga&&this.renderer.create(this,a,c,d)},getMargins:function(){var b,a=this.spacing,c=this.legend,d=this.margin,e=this.options.legend,f=p(e.margin,20),g=e.x,h=e.y,i=e.align,j=e.verticalAlign,k=this.titleOffset;this.resetMargins(),b=this.axisOffset,k&&!s(d[0])&&(this.plotTop=t(this.plotTop,k+this.options.title.margin+a[0])),c.display&&!e.floating&&("right"===i?s(d[1])||(this.marginRight=t(this.marginRight,c.legendWidth-g+f+a[1])):"left"===i?s(d[3])||(this.plotLeft=t(this.plotLeft,c.legendWidth+g+f+a[3])):"top"===j?s(d[0])||(this.plotTop=t(this.plotTop,c.legendHeight+h+f+a[0])):"bottom"!==j||s(d[2])||(this.marginBottom=t(this.marginBottom,c.legendHeight-h+f+a[2]))),this.extraBottomMargin&&(this.marginBottom+=this.extraBottomMargin),this.extraTopMargin&&(this.plotTop+=this.extraTopMargin),this.hasCartesianSeries&&q(this.axes,function(a){a.getOffset()}),s(d[3])||(this.plotLeft+=b[3]),s(d[0])||(this.plotTop+=b[0]),s(d[2])||(this.marginBottom+=b[2]),s(d[1])||(this.marginRight+=b[1]),this.setChartSize()
},reflow:function(a){var b=this,c=b.options.chart,d=b.renderTo,e=c.width||ib(d,"width"),f=c.height||ib(d,"height"),c=a?a.target:G,d=function(){b.container&&(b.setSize(e,f,!1),b.hasUserSize=null)};b.hasUserSize||!e||!f||c!==G&&c!==x||((e!==b.containerWidth||f!==b.containerHeight)&&(clearTimeout(b.reflowTimeout),a?b.reflowTimeout=setTimeout(d,100):d()),b.containerWidth=e,b.containerHeight=f)},initReflow:function(){var a=this,b=function(b){a.reflow(b)};N(G,"resize",b),N(a,"destroy",function(){X(G,"resize",b)})},setSize:function(a,b,c){var e,f,g,d=this;d.isResizing+=1,g=function(){d&&I(d,"endResize",null,function(){d.isResizing-=1})},Ra(c,d),d.oldChartHeight=d.chartHeight,d.oldChartWidth=d.chartWidth,s(a)&&(d.chartWidth=e=t(0,v(a)),d.hasUserSize=!!e),s(b)&&(d.chartHeight=f=t(0,v(b))),(va?jb:B)(d.container,{width:e+"px",height:f+"px"},va),d.setChartSize(!0),d.renderer.setSize(e,f,c),d.maxTicks=null,q(d.axes,function(a){a.isDirty=!0,a.setScale()}),q(d.series,function(a){a.isDirty=!0}),d.isDirtyLegend=!0,d.isDirtyBox=!0,d.layOutTitles(),d.getMargins(),d.redraw(c),d.oldChartHeight=null,I(d,"resize"),va===!1?g():setTimeout(g,va&&va.duration||500)},setChartSize:function(a){var i,j,k,l,b=this.inverted,c=this.renderer,d=this.chartWidth,e=this.chartHeight,f=this.options.chart,g=this.spacing,h=this.clipOffset;this.plotLeft=i=v(this.plotLeft),this.plotTop=j=v(this.plotTop),this.plotWidth=k=t(0,v(d-i-this.marginRight)),this.plotHeight=l=t(0,v(e-j-this.marginBottom)),this.plotSizeX=b?l:k,this.plotSizeY=b?k:l,this.plotBorderWidth=f.plotBorderWidth||0,this.spacingBox=c.spacingBox={x:g[3],y:g[0],width:d-g[3]-g[1],height:e-g[0]-g[2]},this.plotBox=c.plotBox={x:i,y:j,width:k,height:l},d=2*U(this.plotBorderWidth/2),b=La(t(d,h[3])/2),c=La(t(d,h[0])/2),this.clipBox={x:b,y:c,width:U(this.plotSizeX-t(d,h[1])/2-b),height:t(0,U(this.plotSizeY-t(d,h[2])/2-c))},a||q(this.axes,function(a){a.setAxisSize(),a.setAxisTranslation()})},resetMargins:function(){var a=this.spacing,b=this.margin;this.plotTop=p(b[0],a[0]),this.marginRight=p(b[1],a[1]),this.marginBottom=p(b[2],a[2]),this.plotLeft=p(b[3],a[3]),this.axisOffset=[0,0,0,0],this.clipOffset=[0,0,0,0]},drawChartBox:function(){var m,a=this.options.chart,b=this.renderer,c=this.chartWidth,d=this.chartHeight,e=this.chartBackground,f=this.plotBackground,g=this.plotBorder,h=this.plotBGImage,i=a.borderWidth||0,j=a.backgroundColor,k=a.plotBackgroundColor,l=a.plotBackgroundImage,n=a.plotBorderWidth||0,o=this.plotLeft,p=this.plotTop,q=this.plotWidth,r=this.plotHeight,t=this.plotBox,s=this.clipRect,v=this.clipBox;m=i+(a.shadow?8:0),(i||j)&&(e?e.animate(e.crisp({width:c-m,height:d-m})):(e={fill:j||P},i&&(e.stroke=a.borderColor,e["stroke-width"]=i),this.chartBackground=b.rect(m/2,m/2,c-m,d-m,a.borderRadius,i).attr(e).addClass("highcharts-background").add().shadow(a.shadow))),k&&(f?f.animate(t):this.plotBackground=b.rect(o,p,q,r,0).attr({fill:k}).add().shadow(a.plotShadow)),l&&(h?h.animate(t):this.plotBGImage=b.image(l,o,p,q,r).add()),s?s.animate({width:v.width,height:v.height}):this.clipRect=b.clipRect(v),n&&(g?g.animate(g.crisp({x:o,y:p,width:q,height:r,strokeWidth:-n})):this.plotBorder=b.rect(o,p,q,r,0,-n).attr({stroke:a.plotBorderColor,"stroke-width":n,fill:P,zIndex:1}).add()),this.isDirtyBox=!1},propFromSeries:function(){var c,e,f,a=this,b=a.options.chart,d=a.options.series;q(["inverted","angular","polar"],function(g){for(c=H[b.type||b.defaultSeriesType],f=a[g]||b[g]||c&&c.prototype[g],e=d&&d.length;!f&&e--;)(c=H[d[e].type])&&c.prototype[g]&&(f=!0);a[g]=f})},linkSeries:function(){var a=this,b=a.series;q(b,function(a){a.linkedSeries.length=0}),q(b,function(b){var d=b.options.linkedTo;Ga(d)&&(d=":previous"===d?a.series[b.index-1]:a.get(d))&&(d.linkedSeries.push(b),b.linkedParent=d)})},renderSeries:function(){q(this.series,function(a){a.translate(),a.setTooltipPoints&&a.setTooltipPoints(),a.render()})},renderLabels:function(){var a=this,b=a.options.labels;b.items&&q(b.items,function(c){var d=r(b.style,c.style),e=y(d.left)+a.plotLeft,f=y(d.top)+a.plotTop+12;delete d.left,delete d.top,a.renderer.text(c.html,e,f).attr({zIndex:2}).css(d).add()})},render:function(){var a=this.axes,b=this.renderer,c=this.options;this.setTitle(),this.legend=new lb(this,c.legend),this.getStacks(),q(a,function(a){a.setScale()}),this.getMargins(),this.maxTicks=null,q(a,function(a){a.setTickPositions(!0),a.setMaxTicks()}),this.adjustTickAmounts(),this.getMargins(),this.drawChartBox(),this.hasCartesianSeries&&q(a,function(a){a.render()}),this.seriesGroup||(this.seriesGroup=b.g("series-group").attr({zIndex:3}).add()),this.renderSeries(),this.renderLabels(),this.showCredits(c.credits),this.hasRendered=!0},showCredits:function(a){a.enabled&&!this.credits&&(this.credits=this.renderer.text(a.text,0,0).on("click",function(){a.href&&(location.href=a.href)}).attr({align:a.position.align,zIndex:8}).css(a.style).add().align(a.position))},destroy:function(){var e,a=this,b=a.axes,c=a.series,d=a.container,f=d&&d.parentNode;for(I(a,"destroy"),W[a.index]=u,ab--,a.renderTo.removeAttribute("data-highcharts-chart"),X(a),e=b.length;e--;)b[e]=b[e].destroy();for(e=c.length;e--;)c[e]=c[e].destroy();q("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","),function(b){var c=a[b];c&&c.destroy&&(a[b]=c.destroy())}),d&&(d.innerHTML="",X(d),f&&Qa(d));for(e in a)delete a[e]},isReadyToRender:function(){var a=this;return!ba&&G==G.top&&"complete"!==x.readyState||ga&&!G.canvg?(ga?Mb.push(function(){a.firstRender()},a.options.global.canvasToolsURL):x.attachEvent("onreadystatechange",function(){x.detachEvent("onreadystatechange",a.firstRender),"complete"===x.readyState&&a.firstRender()}),!1):!0},firstRender:function(){var a=this,b=a.options,c=a.callback;a.isReadyToRender()&&(a.getContainer(),I(a,"init"),a.resetMargins(),a.setChartSize(),a.propFromSeries(),a.getAxes(),q(b.series||[],function(b){a.initSeries(b)}),a.linkSeries(),I(a,"beforeRender"),K.Pointer&&(a.pointer=new Wa(a,b)),a.render(),a.renderer.draw(),c&&c.apply(a,[a]),q(a.callbacks,function(b){b.apply(a,[a])}),a.cloneRenderTo(!0),I(a,"load"))},splashArray:function(a,b){var c=b[a],c=da(c)?c:[c,c,c,c];return[p(b[a+"Top"],c[0]),p(b[a+"Right"],c[1]),p(b[a+"Bottom"],c[2]),p(b[a+"Left"],c[3])]}},Ya.prototype.callbacks=[],Z=K.CenteredSeriesMixin={getCenter:function(){var d,h,a=this.options,b=this.chart,c=2*(a.slicedOffset||0),e=b.plotWidth-2*c,f=b.plotHeight-2*c,b=a.center,a=[p(b[0],"50%"),p(b[1],"50%"),a.size||"100%",a.innerSize||0],g=L(e,f);return Va(a,function(a,b){return h=/%$/.test(a),d=2>b||2===b&&h,(h?[e,f,g,g][b]*y(a)/100:a)+(d?c:0)})}};var Fa=function(){};Fa.prototype={init:function(a,b,c){return this.series=a,this.applyOptions(b,c),this.pointAttr={},a.options.colorByPoint&&(b=a.options.colors||a.chart.options.colors,this.color=this.color||b[a.colorCounter++],a.colorCounter===b.length)&&(a.colorCounter=0),a.chart.pointCount++,this},applyOptions:function(a,b){var c=this.series,d=c.options.pointValKey||c.pointValKey,a=Fa.prototype.optionsToObject.call(this,a);return r(this,a),this.options=this.options?r(this.options,a):a,d&&(this.y=this[d]),this.x===u&&c&&(this.x=b===u?c.autoIncrement():b),this},optionsToObject:function(a){var b={},c=this.series,d=c.pointArrayMap||["y"],e=d.length,f=0,g=0;if("number"==typeof a||null===a)b[d[0]]=a;else if(Ha(a))for(a.length>e&&(c=typeof a[0],"string"===c?b.name=a[0]:"number"===c&&(b.x=a[0]),f++);e>g;)b[d[g++]]=a[f++];else"object"==typeof a&&(b=a,a.dataLabels&&(c._hasPointLabels=!0),a.marker&&(c._hasPointMarkers=!0));return b},destroy:function(){var c,a=this.series.chart,b=a.hoverPoints;a.pointCount--,b&&(this.setState(),la(b,this),!b.length)&&(a.hoverPoints=null),this===a.hoverPoint&&this.onMouseOut(),(this.graphic||this.dataLabel)&&(X(this),this.destroyElements()),this.legendItem&&a.legend.destroyItem(this);for(c in this)this[c]=null},destroyElements:function(){for(var b,a="graphic,dataLabel,dataLabelUpper,group,connector,shadowGroup".split(","),c=6;c--;)b=a[c],this[b]&&(this[b]=this[b].destroy())},getLabelConfig:function(){return{x:this.category,y:this.y,key:this.name||this.category,series:this.series,point:this,percentage:this.percentage,total:this.total||this.stackTotal}},tooltipFormatter:function(a){var b=this.series,c=b.tooltipOptions,d=p(c.valueDecimals,""),e=c.valuePrefix||"",f=c.valueSuffix||"";return q(b.pointArrayMap||["y"],function(b){b="{point."+b,(e||f)&&(a=a.replace(b+"}",e+b+"}"+f)),a=a.replace(b+"}",b+":,."+d+"f}")}),Ja(a,{point:this,series:this.series})},firePointEvent:function(a,b,c){var d=this,e=this.series.options;(e.point.events[a]||d.options&&d.options.events&&d.options.events[a])&&this.importEvents(),"click"===a&&e.allowPointSelect&&(c=function(a){d.select(null,a.ctrlKey||a.metaKey||a.shiftKey)}),I(this,a,b,c)}};var O=function(){};O.prototype={isCartesian:!0,type:"line",pointClass:Fa,sorted:!0,requireSorting:!0,pointAttrToOptions:{stroke:"lineColor","stroke-width":"lineWidth",fill:"fillColor",r:"radius"},axisTypes:["xAxis","yAxis"],colorCounter:0,parallelArrays:["x","y"],init:function(a,b){var d,e,c=this,f=a.series,g=function(a,b){return p(a.options.index,a._i)-p(b.options.index,b._i)};c.chart=a,c.options=b=c.setOptions(b),c.linkedSeries=[],c.bindAxes(),r(c,{name:b.name,state:"",pointAttr:{},visible:b.visible!==!1,selected:b.selected===!0}),ga&&(b.animation=!1),e=b.events;for(d in e)N(c,d,e[d]);(e&&e.click||b.point&&b.point.events&&b.point.events.click||b.allowPointSelect)&&(a.runTrackerClick=!0),c.getColor(),c.getSymbol(),q(c.parallelArrays,function(a){c[a+"Data"]=[]}),c.setData(b.data,!1),c.isCartesian&&(a.hasCartesianSeries=!0),f.push(c),c._i=f.length-1,ob(f,g),this.yAxis&&ob(this.yAxis.series,g),q(f,function(a,b){a.index=b,a.name=a.name||"Series "+(b+1)})},bindAxes:function(){var d,a=this,b=a.options,c=a.chart;q(a.axisTypes||[],function(e){q(c[e],function(c){d=c.options,(b[e]===d.index||b[e]!==u&&b[e]===d.id||b[e]===u&&0===d.index)&&(c.series.push(a),a[e]=c,c.isDirty=!0)}),!a[e]&&a.optionalAxis!==e&&ha(18,!0)})},updateParallelArrays:function(a,b){var c=a.series,d=arguments;q(c.parallelArrays,"number"==typeof b?function(d){var f="y"===d&&c.toYData?c.toYData(a):a[d];c[d+"Data"][b]=f}:function(a){Array.prototype[b].apply(c[a+"Data"],Array.prototype.slice.call(d,2))})},autoIncrement:function(){var a=this.options,b=this.xIncrement,b=p(b,a.pointStart,0);return this.pointInterval=p(this.pointInterval,a.pointInterval,1),this.xIncrement=b+this.pointInterval,b},getSegments:function(){var c,a=-1,b=[],d=this.points,e=d.length;if(e)if(this.options.connectNulls){for(c=e;c--;)null===d[c].y&&d.splice(c,1);d.length&&(b=[d])}else q(d,function(c,g){null===c.y?(g>a+1&&b.push(d.slice(a+1,g)),a=g):g===e-1&&b.push(d.slice(a+1,g+1))});this.segments=b},setOptions:function(a){var b=this.chart,c=b.options.plotOptions,b=b.userOptions||{},d=b.plotOptions||{},e=c[this.type];return this.userOptions=a,c=w(e,c.series,a),this.tooltipOptions=w(E.tooltip,E.plotOptions[this.type].tooltip,b.tooltip,d.series&&d.series.tooltip,d[this.type]&&d[this.type].tooltip,a.tooltip),null===e.marker&&delete c.marker,c},getCyclic:function(a,b,c){var d=this.userOptions,e="_"+a+"Index",f=a+"Counter";b||(s(d[e])?b=d[e]:(d[e]=b=this.chart[f]%c.length,this.chart[f]+=1),b=c[b]),this[a]=b},getColor:function(){this.options.colorByPoint||this.getCyclic("color",this.options.color||ca[this.type].color,this.chart.options.colors)},getSymbol:function(){var a=this.options.marker;this.getCyclic("symbol",a.symbol,this.chart.options.symbols),/^url/.test(this.symbol)&&(a.radius=0)},drawLegendSymbol:M.drawLineMarker,setData:function(a,b,c,d){var h,e=this,f=e.points,g=f&&f.length||0,i=e.options,j=e.chart,k=null,l=e.xAxis,n=l&&!!l.categories,m=e.tooltipPoints,o=i.turboThreshold,r=this.xData,t=this.yData,s=(h=e.pointArrayMap)&&h.length,a=a||[];if(h=a.length,b=p(b,!0),d===!1||!h||g!==h||e.cropped||e.hasGroupedData){if(e.xIncrement=null,e.pointRange=n?1:i.pointRange,e.colorCounter=0,q(this.parallelArrays,function(a){e[a+"Data"].length=0}),o&&h>o){for(c=0;null===k&&h>c;)k=a[c],c++;if(ja(k)){for(n=p(i.pointStart,0),i=p(i.pointInterval,1),c=0;h>c;c++)r[c]=n,t[c]=a[c],n+=i;e.xIncrement=n}else if(Ha(k))if(s)for(c=0;h>c;c++)i=a[c],r[c]=i[0],t[c]=i.slice(1,s+1);else for(c=0;h>c;c++)i=a[c],r[c]=i[0],t[c]=i[1];else ha(12)}else for(c=0;h>c;c++)a[c]!==u&&(i={series:e},e.pointClass.prototype.applyOptions.apply(i,[a[c]]),e.updateParallelArrays(i,c),n&&i.name)&&(l.names[i.x]=i.name);for(Ga(t[0])&&ha(14,!0),e.data=[],e.options.data=a,c=g;c--;)f[c]&&f[c].destroy&&f[c].destroy();m&&(m.length=0),l&&(l.minRange=l.userMinRange),e.isDirty=e.isDirtyData=j.isDirtyBox=!0,c=!1}else q(a,function(a,b){f[b].update(a,!1,null,!1)});b&&j.redraw(c)},processData:function(a){var e,b=this.xData,c=this.yData,d=b.length;e=0;var f,g,i,h=this.xAxis,j=this.options;i=j.cropThreshold;var n,m,k=0,l=this.isCartesian;if(l&&!this.isDirty&&!h.isDirty&&!this.yAxis.isDirty&&!a)return!1;for(h&&(n=h.getExtremes(),m=n.min,n=n.max),l&&this.sorted&&(!i||d>i||this.forceCrop)&&(b[d-1]<m||b[0]>n?(b=[],c=[]):(b[0]<m||b[d-1]>n)&&(e=this.cropData(this.xData,this.yData,m,n),b=e.xData,c=e.yData,e=e.start,f=!0,k=b.length)),i=b.length-1;i>=0;i--)d=b[i]-b[i-1],!f&&b[i]>m&&b[i]<n&&k++,d>0&&(g===u||g>d)?g=d:0>d&&this.requireSorting&&ha(15);this.cropped=f,this.cropStart=e,this.processedXData=b,this.processedYData=c,this.activePointCount=k,null===j.pointRange&&(this.pointRange=g||1),this.closestPointRange=g},cropData:function(a,b,c,d){var i,e=a.length,f=0,g=e,h=p(this.cropShoulder,1);for(i=0;e>i;i++)if(a[i]>=c){f=t(0,i-h);break}for(;e>i;i++)if(a[i]>d){g=i+h;break}return{xData:a.slice(f,g),yData:b.slice(f,g),start:f,end:g}},generatePoints:function(){var c,i,k,n,a=this.options.data,b=this.data,d=this.processedXData,e=this.processedYData,f=this.pointClass,g=d.length,h=this.cropStart||0,j=this.hasGroupedData,l=[];for(b||j||(b=[],b.length=a.length,b=this.data=b),n=0;g>n;n++)i=h+n,j?l[n]=(new f).init(this,[d[n]].concat(ra(e[n]))):(b[i]?k=b[i]:a[i]!==u&&(b[i]=k=(new f).init(this,a[i],d[n])),l[n]=k),l[n].index=i;if(b&&(g!==(c=b.length)||j))for(n=0;c>n;n++)n===h&&!j&&(n+=g),b[n]&&(b[n].destroyElements(),b[n].plotX=u);this.data=b,this.points=l},getExtremes:function(a){var d,b=this.yAxis,c=this.processedXData,e=[],f=0;d=this.xAxis.getExtremes();var i,j,k,l,g=d.min,h=d.max,a=a||this.stackedYData||this.processedYData;for(d=a.length,l=0;d>l;l++)if(j=c[l],k=a[l],i=null!==k&&k!==u&&(!b.isLog||k.length||k>0),j=this.getExtremesFromAll||this.cropped||(c[l+1]||j)>=g&&(c[l-1]||j)<=h,i&&j)if(i=k.length)for(;i--;)null!==k[i]&&(e[f++]=k[i]);else e[f++]=k;this.dataMin=p(void 0,Oa(e)),this.dataMax=p(void 0,Ca(e))},translate:function(){this.processedXData||this.processData(),this.generatePoints();for(var a=this.options,b=a.stacking,c=this.xAxis,d=c.categories,e=this.yAxis,f=this.points,g=f.length,h=!!this.modifyValue,i=a.pointPlacement,j="between"===i||ja(i),k=a.threshold,a=0;g>a;a++){var l=f[a],n=l.x,m=l.y,o=l.low,q=b&&e.stacks[(this.negStacks&&k>m?"-":"")+this.stackKey];e.isLog&&0>=m&&(l.y=m=null,ha(10)),l.plotX=c.translate(n,0,0,0,1,i,"flags"===this.type),b&&this.visible&&q&&q[n]&&(q=q[n],m=q.points[this.index+","+a],o=m[0],m=m[1],0===o&&(o=p(k,e.min)),e.isLog&&0>=o&&(o=null),l.total=l.stackTotal=q.total,l.percentage=q.total&&l.y/q.total*100,l.stackY=m,q.setOffset(this.pointXOffset||0,this.barW||0)),l.yBottom=s(o)?e.translate(o,0,1,0,1):null,h&&(m=this.modifyValue(m,l)),l.plotY="number"==typeof m&&1/0!==m?e.translate(m,0,1,0,1):u,l.clientX=j?c.translate(n,0,0,0,1):l.plotX,l.negative=l.y<(k||0),l.category=d&&d[l.x]!==u?d[l.x]:l.x}this.getSegments()},animate:function(a){var d,b=this.chart,c=b.renderer;d=this.options.animation;var g,e=this.clipBox||b.clipBox,f=b.inverted;d&&!da(d)&&(d=ca[this.type].animation),g=["_sharedClip",d.duration,d.easing,e.height].join(","),a?(a=b[g],d=b[g+"m"],a||(b[g]=a=c.clipRect(r(e,{width:0})),b[g+"m"]=d=c.clipRect(-99,f?-b.plotLeft:-b.plotTop,99,f?b.chartWidth:b.chartHeight)),this.group.clip(a),this.markerGroup.clip(d),this.sharedClipKey=g):((a=b[g])&&a.animate({width:b.plotSizeX},d),b[g+"m"]&&b[g+"m"].animate({width:b.plotSizeX+99},d),this.animate=null)},afterAnimate:function(){var a=this.chart,b=this.sharedClipKey,c=this.group,d=this.clipBox;c&&this.options.clip!==!1&&(b&&d||c.clip(d?a.renderer.clipRect(d):a.clipRect),this.markerGroup.clip()),I(this,"afterAnimate"),setTimeout(function(){b&&a[b]&&(d||(a[b]=a[b].destroy()),a[b+"m"]&&(a[b+"m"]=a[b+"m"].destroy()))},100)},drawPoints:function(){var a,d,e,f,g,h,i,j,k,m,o,q,b=this.points,c=this.chart,l=this.options.marker,n=this.pointAttr[""],t=this.markerGroup,s=p(l.enabled,!this.requireSorting||this.activePointCount<.5*this.xAxis.len/l.radius);if(l.enabled!==!1||this._hasPointMarkers)for(f=b.length;f--;)g=b[f],d=U(g.plotX),e=g.plotY,k=g.graphic,m=g.marker||{},o=!!g.marker,a=s&&m.enabled===u||m.enabled,q=c.isInsidePlot(v(d),e,c.inverted),a&&e!==u&&!isNaN(e)&&null!==g.y?(a=g.pointAttr[g.selected?"select":""]||n,h=a.r,i=p(m.symbol,this.symbol),j=0===i.indexOf("url"),k?k[q?"show":"hide"](!0).animate(r({x:d-h,y:e-h},k.symbolName?{width:2*h,height:2*h}:{})):q&&(h>0||j)&&(g.graphic=c.renderer.symbol(i,d-h,e-h,2*h,2*h,o?m:l).attr(a).add(t))):k&&(g.graphic=k.destroy())},convertAttribs:function(a,b,c,d){var f,g,e=this.pointAttrToOptions,h={},a=a||{},b=b||{},c=c||{},d=d||{};for(f in e)g=e[f],h[f]=p(a[g],b[f],c[f],d[f]);return h},getAttribs:function(){var f,a=this,b=a.options,c=ca[a.type].marker?b.marker:b,d=c.states,e=d.hover,g=a.color;f={stroke:g,fill:g};var i,k,h=a.points||[],j=[],l=a.pointAttrToOptions;k=a.hasPointSpecificOptions;var n=b.negativeColor,m=c.lineColor,o=c.fillColor;i=b.turboThreshold;var p;if(b.marker?(e.radius=e.radius||c.radius+e.radiusPlus,e.lineWidth=e.lineWidth||c.lineWidth+e.lineWidthPlus):e.color=e.color||ya(e.color||g).brighten(e.brightness).get(),j[""]=a.convertAttribs(c,f),q(["hover","select"],function(b){j[b]=a.convertAttribs(d[b],j[""])}),a.pointAttr=j,g=h.length,!i||i>g||k)for(;g--;){if(i=h[g],(c=i.options&&i.options.marker||i.options)&&c.enabled===!1&&(c.radius=0),i.negative&&n&&(i.color=i.fillColor=n),k=b.colorByPoint||i.color,i.options)for(p in l)s(c[l[p]])&&(k=!0);k?(c=c||{},k=[],d=c.states||{},f=d.hover=d.hover||{},b.marker||(f.color=f.color||!i.options.color&&e.color||ya(i.color).brighten(f.brightness||e.brightness).get()),f={color:i.color},o||(f.fillColor=i.color),m||(f.lineColor=i.color),k[""]=a.convertAttribs(r(f,c),j[""]),k.hover=a.convertAttribs(d.hover,j.hover,k[""]),k.select=a.convertAttribs(d.select,j.select,k[""])):k=j,i.pointAttr=k}},destroy:function(){var d,e,g,h,i,a=this,b=a.chart,c=/AppleWebKit\/533/.test(wa),f=a.data||[];for(I(a,"destroy"),X(a),q(a.axisTypes||[],function(b){(i=a[b])&&(la(i.series,a),i.isDirty=i.forceRedraw=!0)}),a.legendItem&&a.chart.legend.destroyItem(a),e=f.length;e--;)(g=f[e])&&g.destroy&&g.destroy();a.points=null,clearTimeout(a.animationTimeout),q("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","),function(b){a[b]&&(d=c&&"group"===b?"hide":"destroy",a[b][d]())}),b.hoverSeries===a&&(b.hoverSeries=null),la(b.series,a);for(h in a)delete a[h]},getSegmentPath:function(a){var b=this,c=[],d=b.options.step;return q(a,function(e,f){var i,g=e.plotX,h=e.plotY;b.getPointSpline?c.push.apply(c,b.getPointSpline(a,e,f)):(c.push(f?"L":"M"),d&&f&&(i=a[f-1],"right"===d?c.push(i.plotX,h):"center"===d?c.push((i.plotX+g)/2,i.plotY,(i.plotX+g)/2,h):c.push(g,i.plotY)),c.push(e.plotX,e.plotY))}),c},getGraphPath:function(){var c,a=this,b=[],d=[];return q(a.segments,function(e){c=a.getSegmentPath(e),e.length>1?b=b.concat(c):d.push(e[0])}),a.singlePoints=d,a.graphPath=b},drawGraph:function(){var a=this,b=this.options,c=[["graph",b.lineColor||this.color]],d=b.lineWidth,e=b.dashStyle,f="square"!==b.linecap,g=this.getGraphPath(),h=b.negativeColor;h&&c.push(["graphNeg",h]),q(c,function(c,h){var k=c[0],l=a[k];l?(bb(l),l.animate({d:g})):d&&g.length&&(l={stroke:c[1],"stroke-width":d,fill:P,zIndex:1},e?l.dashstyle=e:f&&(l["stroke-linecap"]=l["stroke-linejoin"]="round"),a[k]=a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h&&b.shadow))})},clipNeg:function(){var e,a=this.options,b=this.chart,c=b.renderer,d=a.negativeColor||a.negativeFillColor,f=this.graph,g=this.area,h=this.posClip,i=this.negClip;e=b.chartWidth;var j=b.chartHeight,k=t(e,j),l=this.yAxis;d&&(f||g)&&(d=v(l.toPixels(a.threshold||0,!0)),0>d&&(k-=d),a={x:0,y:0,width:k,height:d},k={x:0,y:d,width:k,height:k},b.inverted&&(a.height=k.y=b.plotWidth-d,c.isVML&&(a={x:b.plotWidth-d-b.plotLeft,y:0,width:e,height:j},k={x:d+b.plotLeft-e,y:0,width:b.plotLeft+d,height:e})),l.reversed?(b=k,e=a):(b=a,e=k),h?(h.animate(b),i.animate(e)):(this.posClip=h=c.clipRect(b),this.negClip=i=c.clipRect(e),f&&this.graphNeg&&(f.clip(h),this.graphNeg.clip(i)),g&&(g.clip(h),this.areaNeg.clip(i))))},invertGroups:function(){function a(){var a={width:b.yAxis.len,height:b.xAxis.len};q(["group","markerGroup"],function(c){b[c]&&b[c].attr(a).invert()})}var b=this,c=b.chart;b.xAxis&&(N(c,"resize",a),N(b,"destroy",function(){X(c,"resize",a)}),a(),b.invertGroups=a)},plotGroup:function(a,b,c,d,e){var f=this[a],g=!f;return g&&(this[a]=f=this.chart.renderer.g(b).attr({visibility:c,zIndex:d||.1}).add(e)),f[g?"attr":"animate"](this.getPlotBox()),f},getPlotBox:function(){var a=this.chart,b=this.xAxis,c=this.yAxis;return a.inverted&&(b=c,c=this.xAxis),{translateX:b?b.left:a.plotLeft,translateY:c?c.top:a.plotTop,scaleX:1,scaleY:1}},render:function(){var c,a=this,b=a.chart,d=a.options,e=(c=d.animation)&&!!a.animate&&b.renderer.isSVG&&p(c.duration,500)||0,f=a.visible?"visible":"hidden",g=d.zIndex,h=a.hasRendered,i=b.seriesGroup;c=a.plotGroup("group","series",f,g,i),a.markerGroup=a.plotGroup("markerGroup","markers",f,g,i),e&&a.animate(!0),a.getAttribs(),c.inverted=a.isCartesian?b.inverted:!1,a.drawGraph&&(a.drawGraph(),a.clipNeg()),q(a.points,function(a){a.redraw&&a.redraw()}),a.drawDataLabels&&a.drawDataLabels(),a.visible&&a.drawPoints(),a.drawTracker&&a.options.enableMouseTracking!==!1&&a.drawTracker(),b.inverted&&a.invertGroups(),d.clip!==!1&&!a.sharedClipKey&&!h&&c.clip(b.clipRect),e&&a.animate(),h||(e?a.animationTimeout=setTimeout(function(){a.afterAnimate()},e):a.afterAnimate()),a.isDirty=a.isDirtyData=!1,a.hasRendered=!0},redraw:function(){var a=this.chart,b=this.isDirtyData,c=this.group,d=this.xAxis,e=this.yAxis;c&&(a.inverted&&c.attr({width:a.plotWidth,height:a.plotHeight}),c.animate({translateX:p(d&&d.left,a.plotLeft),translateY:p(e&&e.top,a.plotTop)})),this.translate(),this.setTooltipPoints&&this.setTooltipPoints(!0),this.render(),b&&I(this,"updatedData")}},Gb.prototype={destroy:function(){Pa(this,this.axis)},render:function(a){var b=this.options,c=b.format,c=c?Ja(c,this):b.formatter.call(this);this.label?this.label.attr({text:c,visibility:"hidden"}):this.label=this.axis.chart.renderer.text(c,null,null,b.useHTML).css(b.style).attr({align:this.textAlign,rotation:b.rotation,visibility:"hidden"}).add(a)},setOffset:function(a,b){var c=this.axis,d=c.chart,e=d.inverted,f=this.isNegative,g=c.translate(c.usePercentage?100:this.total,0,0,0,1),c=c.translate(0),c=Q(g-c),h=d.xAxis[0].translate(this.x)+a,i=d.plotHeight,f={x:e?f?g:g-c:h,y:e?i-h-b:f?i-g-c:i-g,width:e?c:b,height:e?b:c};(e=this.label)&&(e.align(this.alignOptions,null,f),f=e.alignAttr,e[this.options.crop===!1||d.isInsidePlot(f.x,f.y)?"show":"hide"](!0))}},na.prototype.buildStacks=function(){var a=this.series,b=p(this.options.reversedStacks,!0),c=a.length;if(!this.isXAxis){for(this.usePercentage=!1;c--;)a[b?c:a.length-c-1].setStackedPoints();if(this.usePercentage)for(c=0;c<a.length;c++)a[c].setPercentStacks()}},na.prototype.renderStackTotals=function(){var d,e,a=this.chart,b=a.renderer,c=this.stacks,f=this.stackTotalGroup;f||(this.stackTotalGroup=f=b.g("stack-labels").attr({visibility:"visible",zIndex:6}).add()),f.translate(a.plotLeft,a.plotTop);for(d in c)for(e in a=c[d])a[e].render(f)},O.prototype.setStackedPoints=function(){if(this.options.stacking&&(this.visible===!0||this.chart.options.chart.ignoreHiddenSeries===!1)){var m,o,p,q,r,s,a=this.processedXData,b=this.processedYData,c=[],d=b.length,e=this.options,f=e.threshold,g=e.stack,e=e.stacking,h=this.stackKey,i="-"+h,j=this.negStacks,k=this.yAxis,l=k.stacks,n=k.oldStacks;for(q=0;d>q;q++)r=a[q],s=b[q],p=this.index+","+q,o=(m=j&&f>s)?i:h,l[o]||(l[o]={}),l[o][r]||(n[o]&&n[o][r]?(l[o][r]=n[o][r],l[o][r].total=null):l[o][r]=new Gb(k,k.options.stackLabels,m,r,g)),o=l[o][r],o.points[p]=[o.cum||0],"percent"===e?(m=m?h:i,j&&l[m]&&l[m][r]?(m=l[m][r],o.total=m.total=t(m.total,o.total)+Q(s)||0):o.total=ea(o.total+(Q(s)||0))):o.total=ea(o.total+(s||0)),o.cum=(o.cum||0)+(s||0),o.points[p].push(o.cum),c[q]=o.cum;"percent"===e&&(k.usePercentage=!0),this.stackedYData=c,k.oldStacks={}}},O.prototype.setPercentStacks=function(){var a=this,b=a.stackKey,c=a.yAxis.stacks,d=a.processedXData;q([b,"-"+b],function(b){for(var e,g,h,f=d.length;f--;)g=d[f],e=(h=c[b]&&c[b][g])&&h.points[a.index+","+f],(g=e)&&(h=h.total?100/h.total:0,g[0]=ea(g[0]*h),g[1]=ea(g[1]*h),a.stackedYData[f]=g[1])})},r(Ya.prototype,{addSeries:function(a,b,c){var d,e=this;return a&&(b=p(b,!0),I(e,"addSeries",{options:a},function(){d=e.initSeries(a),e.isDirtyLegend=!0,e.linkSeries(),b&&e.redraw(c)})),d},addAxis:function(a,b,c,d){var e=b?"xAxis":"yAxis",f=this.options;new na(this,w(a,{index:this[e].length,isX:b})),f[e]=ra(f[e]||{}),f[e].push(a),p(c,!0)&&this.redraw(d)},showLoading:function(a){var b=this,c=b.options,d=b.loadingDiv,e=c.loading,f=function(){d&&B(d,{left:b.plotLeft+"px",top:b.plotTop+"px",width:b.plotWidth+"px",height:b.plotHeight+"px"})};d||(b.loadingDiv=d=$(Ka,{className:"highcharts-loading"},r(e.style,{zIndex:10,display:P}),b.container),b.loadingSpan=$("span",null,e.labelStyle,d),N(b,"redraw",f)),b.loadingSpan.innerHTML=a||c.lang.loading,b.loadingShown||(B(d,{opacity:0,display:""}),jb(d,{opacity:e.style.opacity},{duration:e.showDuration||0}),b.loadingShown=!0),f()},hideLoading:function(){var a=this.options,b=this.loadingDiv;b&&jb(b,{opacity:0},{duration:a.loading.hideDuration||100,complete:function(){B(b,{display:P})}}),this.loadingShown=!1}}),r(Fa.prototype,{update:function(a,b,c,d){function e(){f.applyOptions(a),da(a)&&!Ha(a)&&(f.redraw=function(){h&&(a&&a.marker&&a.marker.symbol?f.graphic=h.destroy():h.attr(f.pointAttr[f.state||""])),a&&a.dataLabels&&f.dataLabel&&(f.dataLabel=f.dataLabel.destroy()),f.redraw=null}),i=f.index,g.updateParallelArrays(f,i),k.data[i]=f.options,g.isDirty=g.isDirtyData=!0,!g.fixedBox&&g.hasCartesianSeries&&(j.isDirtyBox=!0),"point"===k.legendType&&j.legend.destroyItem(f),b&&j.redraw(c)}var i,f=this,g=f.series,h=f.graphic,j=g.chart,k=g.options,b=p(b,!0);d===!1?e():f.firePointEvent("update",{options:a},e)},remove:function(a,b){var g,c=this,d=c.series,e=d.points,f=d.chart,h=d.data;Ra(b,f),a=p(a,!0),c.firePointEvent("remove",null,function(){g=Ma(c,h),h.length===e.length&&e.splice(g,1),h.splice(g,1),d.options.data.splice(g,1),d.updateParallelArrays(c,"splice",g,1),c.destroy(),d.isDirty=!0,d.isDirtyData=!0,a&&f.redraw()})}}),r(O.prototype,{addPoint:function(a,b,c,d){var n,e=this.options,f=this.data,g=this.graph,h=this.area,i=this.chart,j=this.xAxis&&this.xAxis.names,k=g&&g.shift||0,l=e.data,m=this.xData;if(Ra(d,i),c&&q([g,h,this.graphNeg,this.areaNeg],function(a){a&&(a.shift=k+1)}),h&&(h.isArea=!0),b=p(b,!0),d={series:this},this.pointClass.prototype.applyOptions.apply(d,[a]),g=d.x,h=m.length,this.requireSorting&&g<m[h-1])for(n=!0;h&&m[h-1]>g;)h--;this.updateParallelArrays(d,"splice",h,0,0),this.updateParallelArrays(d,h),j&&d.name&&(j[g]=d.name),l.splice(h,0,a),n&&(this.data.splice(h,0,null),this.processData()),"point"===e.legendType&&this.generatePoints(),c&&(f[0]&&f[0].remove?f[0].remove(!1):(f.shift(),this.updateParallelArrays(d,"shift"),l.shift())),this.isDirtyData=this.isDirty=!0,b&&(this.getAttribs(),i.redraw())},remove:function(a,b){var c=this,d=c.chart,a=p(a,!0);c.isRemoving||(c.isRemoving=!0,I(c,"remove",null,function(){c.destroy(),d.isDirtyLegend=d.isDirtyBox=!0,d.linkSeries(),a&&d.redraw(b)})),c.isRemoving=!1},update:function(a,b){var i,c=this,d=this.chart,e=this.userOptions,f=this.type,g=H[f].prototype,h=["group","markerGroup","dataLabelsGroup"];q(h,function(a){h[a]=c[a],delete c[a]}),a=w(e,{animation:!1,index:this.index,pointStart:this.xData[0]},{data:this.options.data},a),this.remove(!1);for(i in g)g.hasOwnProperty(i)&&(this[i]=u);r(this,H[a.type||f].prototype),q(h,function(a){c[a]=h[a]}),this.init(d,a),d.linkSeries(),p(b,!0)&&d.redraw(!1)}}),r(na.prototype,{update:function(a,b){var c=this.chart,a=c.options[this.coll][this.options.index]=w(this.userOptions,a);this.destroy(!0),this._addedPlotLB=u,this.init(c,r(a,{events:u})),c.isDirtyBox=!0,p(b,!0)&&c.redraw()},remove:function(a){for(var b=this.chart,c=this.coll,d=this.series,e=d.length;e--;)d[e]&&d[e].remove(!1);la(b.axes,this),la(b[c],this),b.options[c].splice(this.options.index,1),q(b[c],function(a,b){a.options.index=b}),this.destroy(),b.isDirtyBox=!0,p(a,!0)&&b.redraw()},setTitle:function(a,b){this.update({title:a},b)},setCategories:function(a,b){this.update({categories:a},b)}}),ia=ma(O),H.line=ia,ca.area=w(T,{threshold:0});var qa=ma(O,{type:"area",getSegments:function(){var i,j,n,m,a=this,b=[],c=[],d=[],e=this.xAxis,f=this.yAxis,g=f.stacks[this.stackKey],h={},k=this.points,l=this.options.connectNulls;if(this.options.stacking&&!this.cropped){for(n=0;n<k.length;n++)h[k[n].x]=k[n];for(m in g)null!==g[m].total&&d.push(+m);d.sort(function(a,b){return a-b}),q(d,function(b){var k,d=0;if(!l||h[b]&&null!==h[b].y)if(h[b])c.push(h[b]);else{for(n=a.index;n<=f.series.length;n++)if(k=g[b].points[n+","+b]){d=k[1];break}i=e.translate(b),j=f.toPixels(d,!0),c.push({y:null,plotX:i,clientX:i,plotY:j,yBottom:j,onMouseOver:sa})}}),c.length&&b.push(c)}else O.prototype.getSegments.call(this),b=this.segments;this.segments=b},getSegmentPath:function(a){var d,b=O.prototype.getSegmentPath.call(this,a),c=[].concat(b),e=this.options;d=b.length;var g,f=this.yAxis.getThreshold(e.threshold);if(3===d&&c.push("L",b[1],b[2]),e.stacking&&!this.closedStacks)for(d=a.length-1;d>=0;d--)g=p(a[d].yBottom,f),d<a.length-1&&e.step&&c.push(a[d+1].plotX,g),c.push(a[d].plotX,g);else this.closeSegment(c,a,f);return this.areaPath=this.areaPath.concat(c),b},closeSegment:function(a,b,c){a.push("L",b[b.length-1].plotX,c,"L",b[0].plotX,c)},drawGraph:function(){this.areaPath=[],O.prototype.drawGraph.apply(this);var a=this,b=this.areaPath,c=this.options,d=c.negativeColor,e=c.negativeFillColor,f=[["area",this.color,c.fillColor]];(d||e)&&f.push(["areaNeg",d,e]),q(f,function(d){var e=d[0],f=a[e];f?f.animate({d:b}):a[e]=a.chart.renderer.path(b).attr({fill:p(d[2],ya(d[1]).setOpacity(p(c.fillOpacity,.75)).get()),zIndex:0}).add(a.group)})},drawLegendSymbol:M.drawRectangle});H.area=qa,ca.spline=w(T),ia=ma(O,{type:"spline",getPointSpline:function(a,b,c){var h,i,j,k,d=b.plotX,e=b.plotY,f=a[c-1],g=a[c+1];if(f&&g){a=f.plotY,j=g.plotX;var l,g=g.plotY;h=(1.5*d+f.plotX)/2.5,i=(1.5*e+a)/2.5,j=(1.5*d+j)/2.5,k=(1.5*e+g)/2.5,l=(k-i)*(j-d)/(j-h)+e-k,i+=l,k+=l,i>a&&i>e?(i=t(a,e),k=2*e-i):a>i&&e>i&&(i=L(a,e),k=2*e-i),k>g&&k>e?(k=t(g,e),i=2*e-k):g>k&&e>k&&(k=L(g,e),i=2*e-k),b.rightContX=j,b.rightContY=k}return c?(b=["C",f.rightContX||f.plotX,f.rightContY||f.plotY,h||d,i||e,d,e],f.rightContX=f.rightContY=null):b=["M",d,e],b}}),H.spline=ia,ca.areaspline=w(ca.area),qa=qa.prototype,ia=ma(ia,{type:"areaspline",closedStacks:!0,getSegmentPath:qa.getSegmentPath,closeSegment:qa.closeSegment,drawGraph:qa.drawGraph,drawLegendSymbol:M.drawRectangle}),H.areaspline=ia,ca.column=w(T,{borderColor:"#FFFFFF",borderRadius:0,groupPadding:.2,marker:null,pointPadding:.1,minPointLength:0,cropThreshold:50,pointRange:null,states:{hover:{brightness:.1,shadow:!1,halo:!1},select:{color:"#C0C0C0",borderColor:"#000000",shadow:!1}},dataLabels:{align:null,verticalAlign:null,y:null},stickyTracking:!1,tooltip:{distance:6},threshold:0}),ia=ma(O,{type:"column",pointAttrToOptions:{stroke:"borderColor",fill:"color",r:"borderRadius"},cropShoulder:0,trackerGroups:["group","dataLabelsGroup"],negStacks:!0,init:function(){O.prototype.init.apply(this,arguments);
var a=this,b=a.chart;b.hasRendered&&q(b.series,function(b){b.type===a.type&&(b.isDirty=!0)})},getColumnMetrics:function(){var f,h,a=this,b=a.options,c=a.xAxis,d=a.yAxis,e=c.reversed,g={},i=0;b.grouping===!1?i=1:q(a.chart.series,function(b){var c=b.options,e=b.yAxis;b.type===a.type&&b.visible&&d.len===e.len&&d.pos===e.pos&&(c.stacking?(f=b.stackKey,g[f]===u&&(g[f]=i++),h=g[f]):c.grouping!==!1&&(h=i++),b.columnIndex=h)});var c=L(Q(c.transA)*(c.ordinalSlope||b.pointRange||c.closestPointRange||c.tickInterval||1),c.len),j=c*b.groupPadding,k=(c-2*j)/i,l=b.pointWidth,b=s(l)?(k-l)/2:k*b.pointPadding,l=p(l,k-2*b);return a.columnMetrics={width:l,offset:b+(j+((e?i-(a.columnIndex||0):a.columnIndex)||0)*k-c/2)*(e?-1:1)}},translate:function(){var a=this,b=a.chart,c=a.options,d=a.borderWidth=p(c.borderWidth,a.activePointCount>.5*a.xAxis.len?0:1),e=a.yAxis,f=a.translatedThreshold=e.getThreshold(c.threshold),g=p(c.minPointLength,5),h=a.getColumnMetrics(),i=h.width,j=a.barW=t(i,1+2*d),k=a.pointXOffset=h.offset,l=-(d%2?.5:0),n=d%2?.5:1;b.renderer.isVML&&b.inverted&&(n+=1),c.pointPadding&&(j=La(j)),O.prototype.translate.apply(a),q(a.points,function(c){var u,d=p(c.yBottom,f),h=L(t(-999-d,c.plotY),e.len+999+d),q=c.plotX+k,r=j,s=L(h,d);u=t(h,d)-s,Q(u)<g&&g&&(u=g,s=v(Q(s-f)>g?d-g:f-(e.translate(c.y,0,1,0,1)<=f?g:0))),c.barX=q,c.pointWidth=i,c.tooltipPos=b.inverted?[e.len-h,a.xAxis.len-q-r/2]:[q+r/2,h+e.pos-b.plotTop],r=v(q+r)+l,q=v(q)+l,r-=q,d=Q(s)<.5,u=v(s+u)+n,s=v(s)+n,u-=s,d&&(s-=1,u+=1),c.shapeType="rect",c.shapeArgs={x:q,y:s,width:r,height:u}})},getSymbol:sa,drawLegendSymbol:M.drawRectangle,drawGraph:sa,drawPoints:function(){var f,g,a=this,b=this.chart,c=a.options,d=b.renderer,e=c.animationLimit||250;q(a.points,function(h){var i=h.plotY,j=h.graphic;i===u||isNaN(i)||null===h.y?j&&(h.graphic=j.destroy()):(f=h.shapeArgs,i=s(a.borderWidth)?{"stroke-width":a.borderWidth}:{},g=h.pointAttr[h.selected?"select":""]||a.pointAttr[""],j?(bb(j),j.attr(i)[b.pointCount<e?"animate":"attr"](w(f))):h.graphic=d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow,null,c.stacking&&!c.borderRadius))})},animate:function(a){var b=this.yAxis,c=this.options,d=this.chart.inverted,e={};ba&&(a?(e.scaleY=.001,a=L(b.pos+b.len,t(b.pos,b.toPixels(c.threshold))),d?e.translateX=a-b.len:e.translateY=a,this.group.attr(e)):(e.scaleY=1,e[d?"translateX":"translateY"]=b.pos,this.group.animate(e,this.options.animation),this.animate=null))},remove:function(){var a=this,b=a.chart;b.hasRendered&&q(b.series,function(b){b.type===a.type&&(b.isDirty=!0)}),O.prototype.remove.apply(a,arguments)}}),H.column=ia,ca.bar=w(ca.column),qa=ma(ia,{type:"bar",inverted:!0}),H.bar=qa,ca.scatter=w(T,{lineWidth:0,tooltip:{headerFormat:'<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>',pointFormat:"x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>"},stickyTracking:!1}),qa=ma(O,{type:"scatter",sorted:!1,requireSorting:!1,noSharedTooltip:!0,trackerGroups:["markerGroup","dataLabelsGroup"],takeOrdinalPosition:!1,singularTooltips:!0,drawGraph:function(){this.options.lineWidth&&O.prototype.drawGraph.call(this)}}),H.scatter=qa,ca.pie=w(T,{borderColor:"#FFFFFF",borderWidth:1,center:[null,null],clip:!1,colorByPoint:!0,dataLabels:{distance:30,enabled:!0,formatter:function(){return this.point.name}},ignoreHiddenPoint:!0,legendType:"point",marker:null,size:null,showInLegend:!1,slicedOffset:10,states:{hover:{brightness:.1,shadow:!1}},stickyTracking:!1,tooltip:{followPointer:!0}}),T={type:"pie",isCartesian:!1,pointClass:ma(Fa,{init:function(){Fa.prototype.init.apply(this,arguments);var b,a=this;return a.y<0&&(a.y=null),r(a,{visible:a.visible!==!1,name:p(a.name,"Slice")}),b=function(b){a.slice("select"===b.type)},N(a,"select",b),N(a,"unselect",b),a},setVisible:function(a){var b=this,c=b.series,d=c.chart;b.visible=b.options.visible=a=a===u?!b.visible:a,c.options.data[Ma(b,c.data)]=b.options,q(["graphic","dataLabel","connector","shadowGroup"],function(c){b[c]&&b[c][a?"show":"hide"](!0)}),b.legendItem&&d.legend.colorizeItem(b,a),!c.isDirty&&c.options.ignoreHiddenPoint&&(c.isDirty=!0,d.redraw())},slice:function(a,b,c){var d=this.series;Ra(c,d.chart),p(b,!0),this.sliced=this.options.sliced=a=s(a)?a:!this.sliced,d.options.data[Ma(this,d.data)]=this.options,a=a?this.slicedTranslation:{translateX:0,translateY:0},this.graphic.animate(a),this.shadowGroup&&this.shadowGroup.animate(a)},haloPath:function(a){var b=this.shapeArgs,c=this.series.chart;return this.sliced||!this.visible?[]:this.series.chart.renderer.symbols.arc(c.plotLeft+b.x,c.plotTop+b.y,b.r+a,b.r+a,{innerR:this.shapeArgs.r,start:b.start,end:b.end})}}),requireSorting:!1,noSharedTooltip:!0,trackerGroups:["group","dataLabelsGroup"],axisTypes:[],pointAttrToOptions:{stroke:"borderColor","stroke-width":"borderWidth",fill:"color"},singularTooltips:!0,getColor:sa,animate:function(a){var b=this,c=b.points,d=b.startAngleRad;a||(q(c,function(a){var c=a.graphic,a=a.shapeArgs;c&&(c.attr({r:b.center[3]/2,start:d,end:d}),c.animate({r:a.r,start:a.start,end:a.end},b.options.animation))}),b.animate=null)},setData:function(a,b,c,d){O.prototype.setData.call(this,a,!1,c,d),this.processData(),this.generatePoints(),p(b,!0)&&this.chart.redraw(c)},generatePoints:function(){var a,c,d,e,b=0,f=this.options.ignoreHiddenPoint;for(O.prototype.generatePoints.call(this),c=this.points,d=c.length,a=0;d>a;a++)e=c[a],b+=f&&!e.visible?0:e.y;for(this.total=b,a=0;d>a;a++)e=c[a],e.percentage=b>0?e.y/b*100:0,e.total=b},translate:function(a){this.generatePoints();var f,g,h,n,o,b=0,c=this.options,d=c.slicedOffset,e=d+c.borderWidth,i=c.startAngle||0,j=this.startAngleRad=oa/180*(i-90),i=(this.endAngleRad=oa/180*(p(c.endAngle,i+360)-90))-j,k=this.points,l=c.dataLabels.distance,c=c.ignoreHiddenPoint,m=k.length;for(a||(this.center=a=this.getCenter()),this.getX=function(b,c){return h=V.asin(L((b-a[1])/(a[2]/2+l),1)),a[0]+(c?-1:1)*aa(h)*(a[2]/2+l)},n=0;m>n;n++)o=k[n],f=j+b*i,(!c||o.visible)&&(b+=o.percentage/100),g=j+b*i,o.shapeType="arc",o.shapeArgs={x:a[0],y:a[1],r:a[2]/2,innerR:a[3]/2,start:v(1e3*f)/1e3,end:v(1e3*g)/1e3},h=(g+f)/2,h>1.5*oa?h-=2*oa:-oa/2>h&&(h+=2*oa),o.slicedTranslation={translateX:v(aa(h)*d),translateY:v(fa(h)*d)},f=aa(h)*a[2]/2,g=fa(h)*a[2]/2,o.tooltipPos=[a[0]+.7*f,a[1]+.7*g],o.half=-oa/2>h||h>oa/2?1:0,o.angle=h,e=L(e,l/2),o.labelPos=[a[0]+f+aa(h)*l,a[1]+g+fa(h)*l,a[0]+f+aa(h)*e,a[1]+g+fa(h)*e,a[0]+f,a[1]+g,0>l?"center":o.half?"right":"left",h]},drawGraph:null,drawPoints:function(){var c,d,f,g,a=this,b=a.chart.renderer,e=a.options.shadow;e&&!a.shadowGroup&&(a.shadowGroup=b.g("shadow").add(a.group)),q(a.points,function(h){d=h.graphic,g=h.shapeArgs,f=h.shadowGroup,e&&!f&&(f=h.shadowGroup=b.g("shadow").add(a.shadowGroup)),c=h.sliced?h.slicedTranslation:{translateX:0,translateY:0},f&&f.attr(c),d?d.animate(r(g,c)):h.graphic=d=b[h.shapeType](g).setRadialReference(a.center).attr(h.pointAttr[h.selected?"select":""]).attr({"stroke-linejoin":"round"}).attr(c).add(a.group).shadow(e,f),void 0!==h.visible&&h.setVisible(h.visible)})},sortByAngle:function(a,b){a.sort(function(a,d){return void 0!==a.angle&&(d.angle-a.angle)*b})},drawLegendSymbol:M.drawRectangle,getCenter:Z.getCenter,getSymbol:sa},T=ma(O,T),H.pie=T,O.prototype.drawDataLabels=function(){var f,g,i,j,a=this,b=a.options,c=b.cursor,d=b.dataLabels,e=a.points,h=a.hasRendered||0;(d.enabled||a._hasPointLabels)&&(a.dlProcessOptions&&a.dlProcessOptions(d),j=a.plotGroup("dataLabelsGroup","data-labels",d.defer?"hidden":"visible",d.zIndex||6),p(d.defer,!0)&&(j.attr({opacity:+h}),h||N(a,"afterAnimate",function(){a.visible&&j.show(),j[b.animation?"animate":"attr"]({opacity:1},{duration:200})})),g=d,q(e,function(b){var e,m,o,h=b.dataLabel,q=b.connector,t=!0;if(f=b.options&&b.options.dataLabels,e=p(f&&f.enabled,g.enabled),h&&!e)b.dataLabel=h.destroy();else if(e){if(d=w(g,f),e=d.rotation,m=b.getLabelConfig(),i=d.format?Ja(d.format,m):d.formatter.call(m,d),d.style.color=p(d.color,d.style.color,a.color,"black"),h)s(i)?(h.attr({text:i}),t=!1):(b.dataLabel=h=h.destroy(),q&&(b.connector=q.destroy()));else if(s(i)){h={fill:d.backgroundColor,stroke:d.borderColor,"stroke-width":d.borderWidth,r:d.borderRadius||0,rotation:e,padding:d.padding,zIndex:1};for(o in h)h[o]===u&&delete h[o];h=b.dataLabel=a.chart.renderer[e?"text":"label"](i,0,-999,null,null,null,d.useHTML).attr(h).css(r(d.style,c&&{cursor:c})).add(j).shadow(d.shadow)}h&&a.alignDataLabel(b,h,d,null,t)}}))},O.prototype.alignDataLabel=function(a,b,c,d,e){var f=this.chart,g=f.inverted,h=p(a.plotX,-999),i=p(a.plotY,-999),j=b.getBBox();(a=this.visible&&(a.series.forceDL||f.isInsidePlot(h,v(i),g)||d&&f.isInsidePlot(h,g?d.x+1:d.y+d.height-1,g)))&&(d=r({x:g?f.plotWidth-i:h,y:v(g?f.plotHeight-h:i),width:0,height:0},d),r(c,{width:j.width,height:j.height}),c.rotation?b[e?"attr":"animate"]({x:d.x+c.x+d.width/2,y:d.y+c.y+d.height/2}).attr({align:c.align}):(b.align(c,null,d),g=b.alignAttr,"justify"===p(c.overflow,"justify")?this.justifyDataLabel(b,c,g,j,d,e):p(c.crop,!0)&&(a=f.isInsidePlot(g.x,g.y)&&f.isInsidePlot(g.x+j.width,g.y+j.height)))),a||(b.attr({y:-999}),b.placed=!1)},O.prototype.justifyDataLabel=function(a,b,c,d,e,f){var j,k,g=this.chart,h=b.align,i=b.verticalAlign;j=c.x,0>j&&("right"===h?b.align="left":b.x=-j,k=!0),j=c.x+d.width,j>g.plotWidth&&("left"===h?b.align="right":b.x=g.plotWidth-j,k=!0),j=c.y,0>j&&("bottom"===i?b.verticalAlign="top":b.y=-j,k=!0),j=c.y+d.height,j>g.plotHeight&&("top"===i?b.verticalAlign="bottom":b.y=g.plotHeight-j,k=!0),k&&(a.placed=!f,a.align(b,null,e))},H.pie&&(H.pie.prototype.drawDataLabels=function(){var c,j,k,u,w,x,y,B,I,H,z,a=this,b=a.data,d=a.chart,e=a.options.dataLabels,f=p(e.connectorPadding,10),g=p(e.connectorWidth,1),h=d.plotWidth,i=d.plotHeight,l=p(e.softConnector,!0),n=e.distance,m=a.center,o=m[2]/2,r=m[1],s=n>0,A=[[],[]],R=[0,0,0,0],N=function(a,b){return b.y-a.y};if(a.visible&&(e.enabled||a._hasPointLabels)){for(O.prototype.drawDataLabels.apply(a),q(b,function(a){a.dataLabel&&a.visible&&A[a.half].push(a)}),H=2;H--;){var E,G=[],M=[],F=A[H],K=F.length;if(K){for(a.sortByAngle(F,H-.5),z=b=0;!b&&F[z];)b=F[z]&&F[z].dataLabel&&(F[z].dataLabel.getBBox().height||21),z++;if(n>0){for(w=L(r+o+n,d.plotHeight),z=t(0,r-o-n);w>=z;z+=b)G.push(z);if(w=G.length,K>w){for(c=[].concat(F),c.sort(N),z=K;z--;)c[z].rank=z;for(z=K;z--;)F[z].rank>=w&&F.splice(z,1);K=F.length}for(z=0;K>z;z++){c=F[z],x=c.labelPos,c=9999;var S,P;for(P=0;w>P;P++)S=Q(G[P]-x[1]),c>S&&(c=S,E=P);if(z>E&&null!==G[z])E=z;else for(K-z+E>w&&null!==G[z]&&(E=w-K+z);null===G[E];)E++;M.push({i:E,y:G[E]}),G[E]=null}M.sort(N)}for(z=0;K>z;z++)c=F[z],x=c.labelPos,u=c.dataLabel,I=c.visible===!1?"hidden":"visible",c=x[1],n>0?(w=M.pop(),E=w.i,B=w.y,(c>B&&null!==G[E+1]||B>c&&null!==G[E-1])&&(B=L(t(0,c),d.plotHeight))):B=c,y=e.justify?m[0]+(H?-1:1)*(o+n):a.getX(B===r-o-n||B===r+o+n?c:B,H),u._attr={visibility:I,align:x[6]},u._pos={x:y+e.x+({left:f,right:-f}[x[6]]||0),y:B+e.y-10},u.connX=y,u.connY=B,null===this.options.size&&(w=u.width,f>y-w?R[3]=t(v(w-y+f),R[3]):y+w>h-f&&(R[1]=t(v(y+w-h+f),R[1])),0>B-b/2?R[0]=t(v(-B+b/2),R[0]):B+b/2>i&&(R[2]=t(v(B+b/2-i),R[2])))}}(0===Ca(R)||this.verifyDataLabelOverflow(R))&&(this.placeDataLabels(),s&&g&&q(this.points,function(b){j=b.connector,x=b.labelPos,(u=b.dataLabel)&&u._pos?(I=u._attr.visibility,y=u.connX,B=u.connY,k=l?["M",y+("left"===x[6]?5:-5),B,"C",y,B,2*x[2]-x[4],2*x[3]-x[5],x[2],x[3],"L",x[4],x[5]]:["M",y+("left"===x[6]?5:-5),B,"L",x[2],x[3],"L",x[4],x[5]],j?(j.animate({d:k}),j.attr("visibility",I)):b.connector=j=a.chart.renderer.path(k).attr({"stroke-width":g,stroke:e.connectorColor||b.color||"#606060",visibility:I}).add(a.dataLabelsGroup)):j&&(b.connector=j.destroy())}))}},H.pie.prototype.placeDataLabels=function(){q(this.points,function(a){var b,a=a.dataLabel;a&&((b=a._pos)?(a.attr(a._attr),a[a.moved?"animate":"attr"](b),a.moved=!0):a&&a.attr({y:-999}))})},H.pie.prototype.alignDataLabel=sa,H.pie.prototype.verifyDataLabelOverflow=function(a){var f,b=this.center,c=this.options,d=c.center,e=c=c.minSize||80;return null!==d[0]?e=t(b[2]-t(a[1],a[3]),c):(e=t(b[2]-a[1]-a[3],c),b[0]+=(a[3]-a[1])/2),null!==d[1]?e=t(L(e,b[2]-t(a[0],a[2])),c):(e=t(L(e,b[2]-a[0]-a[2]),c),b[1]+=(a[0]-a[2])/2),e<b[2]?(b[2]=e,this.translate(b),q(this.points,function(a){a.dataLabel&&(a.dataLabel._pos=null)}),this.drawDataLabels&&this.drawDataLabels()):f=!0,f}),H.column&&(H.column.prototype.alignDataLabel=function(a,b,c,d,e){var f=this.chart,g=f.inverted,h=a.dlBox||a.shapeArgs,i=a.below||a.plotY>p(this.translatedThreshold,f.plotSizeY),j=p(c.inside,!!this.options.stacking);h&&(d=w(h),g&&(d={x:f.plotWidth-d.y-d.height,y:f.plotHeight-d.x-d.width,width:d.height,height:d.width}),!j)&&(g?(d.x+=i?0:d.width,d.width=0):(d.y+=i?d.height:0,d.height=0)),c.align=p(c.align,!g||j?"center":i?"right":"left"),c.verticalAlign=p(c.verticalAlign,g||j?"middle":i?"top":"bottom"),O.prototype.alignDataLabel.call(this,a,b,c,d,e)}),T=K.TrackerMixin={drawTrackerPoint:function(){var a=this,b=a.chart,c=b.pointer,d=a.options.cursor,e=d&&{cursor:d},f=function(c){var e,d=c.target;for(b.hoverSeries!==a&&a.onMouseOver();d&&!e;)e=d.point,d=d.parentNode;e!==u&&e!==b.hoverPoint&&e.onMouseOver(c)};q(a.points,function(a){a.graphic&&(a.graphic.element.point=a),a.dataLabel&&(a.dataLabel.element.point=a)}),a._hasTracking||(q(a.trackerGroups,function(b){a[b]&&(a[b].addClass("highcharts-tracker").on("mouseover",f).on("mouseout",function(a){c.onTrackerMouseOut(a)}).css(e),$a)&&a[b].on("touchstart",f)}),a._hasTracking=!0)},drawTrackerGraph:function(){var n,a=this,b=a.options,c=b.trackByArea,d=[].concat(c?a.areaPath:a.graphPath),e=d.length,f=a.chart,g=f.pointer,h=f.renderer,i=f.options.tooltip.snap,j=a.tracker,k=b.cursor,l=k&&{cursor:k},k=a.singlePoints,m=function(){f.hoverSeries!==a&&a.onMouseOver()},o="rgba(192,192,192,"+(ba?1e-4:.002)+")";if(e&&!c)for(n=e+1;n--;)"M"===d[n]&&d.splice(n+1,0,d[n+1]-i,d[n+2],"L"),(n&&"M"===d[n]||n===e)&&d.splice(n,0,"L",d[n-2]+i,d[n-1]);for(n=0;n<k.length;n++)e=k[n],d.push("M",e.plotX-i,e.plotY,"L",e.plotX+i,e.plotY);j?j.attr({d:d}):(a.tracker=h.path(d).attr({"stroke-linejoin":"round",visibility:a.visible?"visible":"hidden",stroke:o,fill:c?o:P,"stroke-width":b.lineWidth+(c?0:2*i),zIndex:2}).add(a.group),q([a.tracker,a.markerGroup],function(a){a.addClass("highcharts-tracker").on("mouseover",m).on("mouseout",function(a){g.onTrackerMouseOut(a)}).css(l),$a&&a.on("touchstart",m)}))}},H.column&&(ia.prototype.drawTracker=T.drawTrackerPoint),H.pie&&(H.pie.prototype.drawTracker=T.drawTrackerPoint),H.scatter&&(qa.prototype.drawTracker=T.drawTrackerPoint),r(lb.prototype,{setItemEvents:function(a,b,c,d,e){var f=this;(c?b:a.legendGroup).on("mouseover",function(){a.setState("hover"),b.css(f.options.itemHoverStyle)}).on("mouseout",function(){b.css(a.visible?d:e),a.setState()}).on("click",function(b){var c=function(){a.setVisible()},b={browserEvent:b};a.firePointEvent?a.firePointEvent("legendItemClick",b,c):I(a,"legendItemClick",b,c)})},createCheckboxForItem:function(a){a.checkbox=$("input",{type:"checkbox",checked:a.selected,defaultChecked:a.selected},this.options.itemCheckboxStyle,this.chart.container),N(a.checkbox,"click",function(b){I(a,"checkboxClick",{checked:b.target.checked},function(){a.select()})})}}),E.legend.itemStyle.cursor="pointer",r(Ya.prototype,{showResetZoom:function(){var a=this,b=E.lang,c=a.options.chart.resetZoomButton,d=c.theme,e=d.states,f="chart"===c.relativeTo?null:"plotBox";this.resetZoomButton=a.renderer.button(b.resetZoom,null,null,function(){a.zoomOut()},d,e&&e.hover).attr({align:c.position.align,title:b.resetZoomTitle}).add().align(c.position,!1,f)},zoomOut:function(){var a=this;I(a,"selection",{resetSelection:!0},function(){a.zoom()})},zoom:function(a){var b,e,c=this.pointer,d=!1;!a||a.resetSelection?q(this.axes,function(a){b=a.zoom()}):q(a.xAxis.concat(a.yAxis),function(a){var e=a.axis,h=e.isXAxis;(c[h?"zoomX":"zoomY"]||c[h?"pinchX":"pinchY"])&&(b=e.zoom(a.min,a.max),e.displayBtn&&(d=!0))}),e=this.resetZoomButton,d&&!e?this.showResetZoom():!d&&da(e)&&(this.resetZoomButton=e.destroy()),b&&this.redraw(p(this.options.chart.animation,a&&a.animation,this.pointCount<100))},pan:function(a,b){var e,c=this,d=c.hoverPoints;d&&q(d,function(a){a.setState()}),q("xy"===b?[1,0]:[1],function(b){var d=a[b?"chartX":"chartY"],h=c[b?"xAxis":"yAxis"][0],i=c[b?"mouseDownX":"mouseDownY"],j=(h.pointRange||0)/2,k=h.getExtremes(),l=h.toValue(i-d,!0)+j,i=h.toValue(i+c[b?"plotWidth":"plotHeight"]-d,!0)-j;h.series.length&&l>L(k.dataMin,k.min)&&i<t(k.dataMax,k.max)&&(h.setExtremes(l,i,!1,!1,{trigger:"pan"}),e=!0),c[b?"mouseDownX":"mouseDownY"]=d}),e&&c.redraw(!1),B(c.container,{cursor:"move"})}}),r(Fa.prototype,{select:function(a,b){var c=this,d=c.series,e=d.chart,a=p(a,!c.selected);c.firePointEvent(a?"select":"unselect",{accumulate:b},function(){c.selected=c.options.selected=a,d.options.data[Ma(c,d.data)]=c.options,c.setState(a&&"select"),b||q(e.getSelectedPoints(),function(a){a.selected&&a!==c&&(a.selected=a.options.selected=!1,d.options.data[Ma(a,d.data)]=a.options,a.setState(""),a.firePointEvent("unselect"))})})},onMouseOver:function(a){var b=this.series,c=b.chart,d=c.tooltip,e=c.hoverPoint;e&&e!==this&&e.onMouseOut(),this.firePointEvent("mouseOver"),d&&(!d.shared||b.noSharedTooltip)&&d.refresh(this,a),this.setState("hover"),c.hoverPoint=this},onMouseOut:function(){var a=this.series.chart,b=a.hoverPoints;this.firePointEvent("mouseOut"),b&&-1!==Ma(this,b)||(this.setState(),a.hoverPoint=null)},importEvents:function(){if(!this.hasImportedEvents){var b,a=w(this.series.options.point,this.options).events;this.events=a;for(b in a)N(this,b,a[b]);this.hasImportedEvents=!0}},setState:function(a,b){var o,c=this.plotX,d=this.plotY,e=this.series,f=e.options.states,g=ca[e.type].marker&&e.options.marker,h=g&&!g.enabled,i=g&&g.states[a],j=i&&i.enabled===!1,k=e.stateMarkerGraphic,l=this.marker||{},n=e.chart,m=e.halo,a=a||"";o=this.pointAttr[a]||e.pointAttr[a],a===this.state&&!b||this.selected&&"select"!==a||f[a]&&f[a].enabled===!1||a&&(j||h&&i.enabled===!1)||a&&l.states&&l.states[a]&&l.states[a].enabled===!1||(this.graphic?(g=g&&this.graphic.symbolName&&o.r,this.graphic.attr(w(o,g?{x:c-g,y:d-g,width:2*g,height:2*g}:{})),k&&k.hide()):(a&&i&&(g=i.radius,l=l.symbol||e.symbol,k&&k.currentSymbol!==l&&(k=k.destroy()),k?k[b?"animate":"attr"]({x:c-g,y:d-g}):l&&(e.stateMarkerGraphic=k=n.renderer.symbol(l,c-g,d-g,2*g,2*g).attr(o).add(e.markerGroup),k.currentSymbol=l)),k&&k[a&&n.isInsidePlot(c,d,n.inverted)?"show":"hide"]()),(c=f[a]&&f[a].halo)&&c.size?(m||(e.halo=m=n.renderer.path().add(e.seriesGroup)),m.attr(r({fill:ya(this.color||e.color).setOpacity(c.opacity).get()},c.attributes))[b?"animate":"attr"]({d:this.haloPath(c.size)})):m&&m.attr({d:[]}),this.state=a)},haloPath:function(a){var b=this.series,c=b.chart,d=b.getPlotBox(),e=c.inverted;return c.renderer.symbols.circle(d.translateX+(e?b.yAxis.len-this.plotY:this.plotX)-a,d.translateY+(e?b.xAxis.len-this.plotX:this.plotY)-a,2*a,2*a)}}),r(O.prototype,{onMouseOver:function(){var a=this.chart,b=a.hoverSeries;b&&b!==this&&b.onMouseOut(),this.options.events.mouseOver&&I(this,"mouseOver"),this.setState("hover"),a.hoverSeries=this},onMouseOut:function(){var a=this.options,b=this.chart,c=b.tooltip,d=b.hoverPoint;d&&d.onMouseOut(),this&&a.events.mouseOut&&I(this,"mouseOut"),c&&!a.stickyTracking&&(!c.shared||this.noSharedTooltip)&&c.hide(),this.setState(),b.hoverSeries=null},setState:function(a){var b=this.options,c=this.graph,d=this.graphNeg,e=b.states,b=b.lineWidth,a=a||"";this.state!==a&&(this.state=a,e[a]&&e[a].enabled===!1||(a&&(b=e[a].lineWidth||b+(e[a].lineWidthPlus||0)),c&&!c.dashstyle&&(a={"stroke-width":b},c.attr(a),d&&d.attr(a))))},setVisible:function(a,b){var f,c=this,d=c.chart,e=c.legendItem,g=d.options.chart.ignoreHiddenSeries,h=c.visible;f=(c.visible=a=c.userOptions.visible=a===u?!h:a)?"show":"hide",q(["group","dataLabelsGroup","markerGroup","tracker"],function(a){c[a]&&c[a][f]()}),d.hoverSeries===c&&c.onMouseOut(),e&&d.legend.colorizeItem(c,a),c.isDirty=!0,c.options.stacking&&q(d.series,function(a){a.options.stacking&&a.visible&&(a.isDirty=!0)}),q(c.linkedSeries,function(b){b.setVisible(a,!1)}),g&&(d.isDirtyBox=!0),b!==!1&&d.redraw(),I(c,f)},setTooltipPoints:function(a){var c,d,h,i,b=[],e=this.xAxis,f=e&&e.getExtremes(),g=e?e.tooltipLen||e.len:this.chart.plotSizeX,j=[];if(this.options.enableMouseTracking!==!1&&!this.singularTooltips){for(a&&(this.tooltipPoints=null),q(this.segments||this.points,function(a){b=b.concat(a)}),e&&e.reversed&&(b=b.reverse()),this.orderTooltipPoints&&this.orderTooltipPoints(b),a=b.length,i=0;a>i;i++)if(e=b[i],c=e.x,c>=f.min&&c<=f.max)for(h=b[i+1],c=d===u?0:d+1,d=b[i+1]?L(t(0,U((e.clientX+(h?h.wrappedClientX||h.clientX:g))/2)),g):g;c>=0&&d>=c;)j[c++]=e;this.tooltipPoints=j}},show:function(){this.setVisible(!0)},hide:function(){this.setVisible(!1)},select:function(a){this.selected=a=a===u?!this.selected:a,this.checkbox&&(this.checkbox.checked=a),I(this,a?"select":"unselect")},drawTracker:T.drawTrackerGraph}),r(K,{Axis:na,Chart:Ya,Color:ya,Point:Fa,Tick:Ta,Renderer:Za,Series:O,SVGElement:S,SVGRenderer:ta,arrayMin:Oa,arrayMax:Ca,charts:W,dateFormat:cb,format:Ja,pathAnim:vb,getOptions:function(){return E},hasBidiBug:Ob,isTouchDevice:Ib,numberFormat:Ba,seriesTypes:H,setOptions:function(a){return E=w(!0,E,a),Bb(),E},addEvent:N,removeEvent:X,createElement:$,discardElement:Qa,css:B,each:q,extend:r,map:Va,merge:w,pick:p,splat:ra,extendClass:ma,pInt:y,wrap:Na,svg:ba,canvas:ga,vml:!ba&&!ga,product:"Highcharts",version:"4.0.4"})}(),function(f){var y,A=f.Chart,t=f.addEvent,B=f.removeEvent,l=f.createElement,o=f.discardElement,v=f.css,k=f.merge,r=f.each,p=f.extend,D=Math.max,j=document,C=window,E=f.isTouchDevice,F=f.Renderer.prototype.symbols,s=f.getOptions();p(s.lang,{printChart:"Print chart",downloadPNG:"Download PNG image",downloadJPEG:"Download JPEG image",downloadPDF:"Download PDF document",downloadSVG:"Download SVG vector image",contextButtonTitle:"Chart context menu"}),s.navigation={menuStyle:{border:"1px solid #A0A0A0",background:"#FFFFFF",padding:"5px 0"},menuItemStyle:{padding:"0 10px",background:"none",color:"#303030",fontSize:E?"14px":"11px"},menuItemHoverStyle:{background:"#4572A5",color:"#FFFFFF"},buttonOptions:{symbolFill:"#E0E0E0",symbolSize:14,symbolStroke:"#666",symbolStrokeWidth:3,symbolX:12.5,symbolY:10.5,align:"right",buttonSpacing:3,height:22,theme:{fill:"white",stroke:"none"},verticalAlign:"top",width:24}},s.exporting={type:"image/png",url:"http://export.highcharts.com/",buttons:{contextButton:{menuClassName:"highcharts-contextmenu",symbol:"menu",_titleKey:"contextButtonTitle",menuItems:[{textKey:"printChart",onclick:function(){this.print()}},{separator:!0},{textKey:"downloadPNG",onclick:function(){this.exportChart()}},{textKey:"downloadJPEG",onclick:function(){this.exportChart({type:"image/jpeg"})}},{textKey:"downloadPDF",onclick:function(){this.exportChart({type:"application/pdf"})}},{textKey:"downloadSVG",onclick:function(){this.exportChart({type:"image/svg+xml"})}}]}}},f.post=function(b,a,d){var c,b=l("form",k({method:"post",action:b,enctype:"multipart/form-data"},d),{display:"none"},j.body);for(c in a)l("input",{type:"hidden",name:c,value:a[c]},null,b);b.submit(),o(b)},p(A.prototype,{getSVG:function(b){var d,c,z,h,a=this,g=k(a.options,b);return j.createElementNS||(j.createElementNS=function(a,b){return j.createElement(b)}),b=l("div",null,{position:"absolute",top:"-9999em",width:a.chartWidth+"px",height:a.chartHeight+"px"},j.body),c=a.renderTo.style.width,h=a.renderTo.style.height,c=g.exporting.sourceWidth||g.chart.width||/px$/.test(c)&&parseInt(c,10)||600,h=g.exporting.sourceHeight||g.chart.height||/px$/.test(h)&&parseInt(h,10)||400,p(g.chart,{animation:!1,renderTo:b,forExport:!0,width:c,height:h}),g.exporting.enabled=!1,g.series=[],r(a.series,function(a){z=k(a.options,{animation:!1,enableMouseTracking:!1,showCheckbox:!1,visible:a.visible}),z.isInternal||g.series.push(z)}),d=new f.Chart(g,a.callback),r(["xAxis","yAxis"],function(b){r(a[b],function(a,c){var g=d[b][c],f=a.getExtremes(),h=f.userMin,f=f.userMax;g&&(void 0!==h||void 0!==f)&&g.setExtremes(h,f,!0,!1)})}),c=d.container.innerHTML,g=null,d.destroy(),o(b),c=c.replace(/zIndex="[^"]+"/g,"").replace(/isShadow="[^"]+"/g,"").replace(/symbolName="[^"]+"/g,"").replace(/jQuery[0-9]+="[^"]+"/g,"").replace(/url\([^#]+#/g,"url(#").replace(/<svg /,'<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ href=/g," xlink:href=").replace(/\n/," ").replace(/<\/svg>.*?$/,"</svg>").replace(/(fill|stroke)="rgba\(([ 0-9]+,[ 0-9]+,[ 0-9]+),([ 0-9\.]+)\)"/g,'$1="rgb($2)" $1-opacity="$3"').replace(/&nbsp;/g," ").replace(/&shy;/g,"­").replace(/<IMG /g,"<image ").replace(/height=([^" ]+)/g,'height="$1"').replace(/width=([^" ]+)/g,'width="$1"').replace(/hc-svg-href="([^"]+)">/g,'xlink:href="$1"/>').replace(/id=([^" >]+)/g,'id="$1"').replace(/class=([^" >]+)/g,'class="$1"').replace(/ transform /g," ").replace(/:(path|rect)/g,"$1").replace(/style="([^"]+)"/g,function(a){return a.toLowerCase()}),c=c.replace(/(url\(#highcharts-[0-9]+)&quot;/g,"$1").replace(/&quot;/g,"'")},exportChart:function(b,a){var b=b||{},d=this.options.exporting,d=this.getSVG(k({chart:{borderRadius:0}},d.chartOptions,a,{exporting:{sourceWidth:b.sourceWidth||d.sourceWidth,sourceHeight:b.sourceHeight||d.sourceHeight}})),b=k(this.options.exporting,b);f.post(b.url,{filename:b.filename||"chart",type:b.type,width:b.width||0,scale:b.scale||2,svg:d},b.formAttributes)},print:function(){var b=this,a=b.container,d=[],c=a.parentNode,f=j.body,h=f.childNodes;b.isPrinting||(b.isPrinting=!0,r(h,function(a,b){1===a.nodeType&&(d[b]=a.style.display,a.style.display="none")}),f.appendChild(a),C.focus(),C.print(),setTimeout(function(){c.appendChild(a),r(h,function(a,b){1===a.nodeType&&(a.style.display=d[b])}),b.isPrinting=!1},1e3))},contextMenu:function(b,a,d,c,f,h,g){var w,x,o,e=this,k=e.options.navigation,q=k.menuItemStyle,m=e.chartWidth,n=e.chartHeight,j="cache-"+b,i=e[j],u=D(f,h),s=function(a){e.pointer.inClass(a.target,b)||x()};i||(e[j]=i=l("div",{className:b},{position:"absolute",zIndex:1e3,padding:u+"px"},e.container),w=l("div",null,p({MozBoxShadow:"3px 3px 10px #888",WebkitBoxShadow:"3px 3px 10px #888",boxShadow:"3px 3px 10px #888"},k.menuStyle),i),x=function(){v(i,{display:"none"}),g&&g.setState(0),e.openMenu=!1},t(i,"mouseleave",function(){o=setTimeout(x,500)}),t(i,"mouseenter",function(){clearTimeout(o)}),t(document,"mouseup",s),t(e,"destroy",function(){B(document,"mouseup",s)}),r(a,function(a){if(a){var b=a.separator?l("hr",null,null,w):l("div",{onmouseover:function(){v(this,k.menuItemHoverStyle)},onmouseout:function(){v(this,q)},onclick:function(){x(),a.onclick.apply(e,arguments)},innerHTML:a.text||e.options.lang[a.textKey]},p({cursor:"pointer"},q),w);e.exportDivElements.push(b)}}),e.exportDivElements.push(w,i),e.exportMenuWidth=i.offsetWidth,e.exportMenuHeight=i.offsetHeight),a={display:"block"},d+e.exportMenuWidth>m?a.right=m-d-f-u+"px":a.left=d-u+"px",c+h+e.exportMenuHeight>n&&"top"!==g.alignOptions.verticalAlign?a.bottom=n-c-u+"px":a.top=c+h-u+"px",v(i,a),e.openMenu=!0},addButton:function(b){var g,e,a=this,d=a.renderer,c=k(a.options.navigation.buttonOptions,b),j=c.onclick,h=c.menuItems,l={stroke:c.symbolStroke,fill:c.symbolFill},q=c.symbolSize||12;if(a.btnCount||(a.btnCount=0),a.exportDivElements||(a.exportDivElements=[],a.exportSVGElements=[]),c.enabled!==!1){var i,m=c.theme,n=m.states,o=n&&n.hover,n=n&&n.select;delete m.states,j?i=function(){j.apply(a,arguments)}:h&&(i=function(){a.contextMenu(e.menuClassName,h,e.translateX,e.translateY,e.width,e.height,e),e.setState(2)}),c.text&&c.symbol?m.paddingLeft=f.pick(m.paddingLeft,25):c.text||p(m,{width:c.width,height:c.height,padding:0}),e=d.button(c.text,0,0,i,m,o,n).attr({title:a.options.lang[c._titleKey],"stroke-linecap":"round"}),e.menuClassName=b.menuClassName||"highcharts-menu-"+a.btnCount++,c.symbol&&(g=d.symbol(c.symbol,c.symbolX-q/2,c.symbolY-q/2,q,q).attr(p(l,{"stroke-width":c.symbolStrokeWidth||1,zIndex:1})).add(e)),e.add().align(p(c,{width:e.width,x:f.pick(c.x,y)}),!0,"spacingBox"),y+=(e.width+c.buttonSpacing)*("right"===c.align?-1:1),a.exportSVGElements.push(e,g)}},destroyExport:function(b){var a,d,b=b.target;for(a=0;a<b.exportSVGElements.length;a++)(d=b.exportSVGElements[a])&&(d.onclick=d.ontouchstart=null,b.exportSVGElements[a]=d.destroy());for(a=0;a<b.exportDivElements.length;a++)d=b.exportDivElements[a],B(d,"mouseleave"),b.exportDivElements[a]=d.onmouseout=d.onmouseover=d.ontouchstart=d.onclick=null,o(d)}}),F.menu=function(b,a,d,c){return["M",b,a+2.5,"L",b+d,a+2.5,"M",b,a+c/2+.5,"L",b+d,a+c/2+.5,"M",b,a+c-1.5,"L",b+d,a+c-1.5]},A.prototype.callbacks.push(function(b){var a,d=b.options.exporting,c=d.buttons;if(y=0,d.enabled!==!1){for(a in c)b.addButton(c[a]);t(b,"destroy",b.destroyExport)}})}(Highcharts),function(a){var n,k=a.getOptions().plotOptions,q=a.pInt,r=a.pick,l=a.each;k.solidgauge=a.merge(k.gauge,{colorByPoint:!0}),n={initDataClasses:function(b){var c,h=this,e=this.chart,m=0,f=this.options;this.dataClasses=c=[],l(b.dataClasses,function(g,d){var i,g=a.merge(g);c.push(g),g.color||("category"===f.dataClassColor?(i=e.options.colors,g.color=i[m++],m===i.length&&(m=0)):g.color=h.tweenColors(a.Color(f.minColor),a.Color(f.maxColor),d/(b.dataClasses.length-1)))})},initStops:function(b){this.stops=b.stops||[[0,this.options.minColor],[1,this.options.maxColor]],l(this.stops,function(b){b.color=a.Color(b[1])})},toColor:function(b,h){var e,a,g,d,c=this.stops,f=this.dataClasses;if(f){for(d=f.length;d--;)if(g=f[d],a=g.from,c=g.to,(void 0===a||b>=a)&&(void 0===c||c>=b)){e=g.color,h&&(h.dataClass=d);break}}else{for(this.isLog&&(b=this.val2lin(b)),e=1-(this.max-b)/(this.max-this.min),d=c.length;d--&&!(e>c[d][0]););a=c[d]||c[d+1],c=c[d+1]||a,e=1-(c[0]-e)/(c[0]-a[0]||1),e=this.tweenColors(a.color,c.color,e)}return e},tweenColors:function(b,a,e){var c=1!==a.rgba[3]||1!==b.rgba[3];return 0===b.rgba.length||0===a.rgba.length?"none":(c?"rgba(":"rgb(")+Math.round(a.rgba[0]+(b.rgba[0]-a.rgba[0])*(1-e))+","+Math.round(a.rgba[1]+(b.rgba[1]-a.rgba[1])*(1-e))+","+Math.round(a.rgba[2]+(b.rgba[2]-a.rgba[2])*(1-e))+(c?","+(a.rgba[3]+(b.rgba[3]-a.rgba[3])*(1-e)):"")+")"}},a.seriesTypes.solidgauge=a.extendClass(a.seriesTypes.gauge,{type:"solidgauge",bindAxes:function(){var b;a.seriesTypes.gauge.prototype.bindAxes.call(this),b=this.yAxis,a.extend(b,n),b.options.dataClasses&&b.initDataClasses(b.options),b.initStops(b.options)},drawPoints:function(){var b=this,h=b.yAxis,e=h.center,c=b.options,m=b.chart.renderer;a.each(b.points,function(f){var k,g=f.graphic,d=h.startAngleRad+h.translate(f.y,null,null,null,!0),i=q(r(c.radius,100))*e[2]/200,o=q(r(c.innerRadius,60))*e[2]/200,p=h.toColor(f.y,f);"none"!==p&&(k=f.color,f.color=p),c.wrap===!1&&(d=Math.max(h.startAngleRad,Math.min(h.endAngleRad,d)));var d=180*d/Math.PI,j=d/(180/Math.PI),l=h.startAngleRad,d=Math.min(j,l),j=Math.max(j,l);j-d>2*Math.PI&&(j=d+2*Math.PI),i={x:e[0],y:e[1],r:i,innerR:o,start:d,end:j},g?(o=i.d,g.attr({fill:f.color}).animate(i,{step:function(b,c){g.attr("fill",n.tweenColors(a.Color(k),a.Color(p),c.pos))}}),i.d=o):f.graphic=m.arc(i).attr({stroke:c.borderColor||"none","stroke-width":c.borderWidth||0,fill:f.color,"sweep-flag":0}).add(b.group)})},animate:null})}(Highcharts),function(global,factory){"object"==typeof module&&"object"==typeof module.exports?module.exports=global.document?factory(global,!0):function(w){if(!w.document)throw new Error("jQuery requires a window with a document");return factory(w)}:factory(global)}("undefined"!=typeof window?window:this,function(window,noGlobal){function isArraylike(obj){var length=obj.length,type=jQuery.type(obj);return"function"===type||jQuery.isWindow(obj)?!1:1===obj.nodeType&&length?!0:"array"===type||0===length||"number"==typeof length&&length>0&&length-1 in obj}function winnow(elements,qualifier,not){if(jQuery.isFunction(qualifier))return jQuery.grep(elements,function(elem,i){return!!qualifier.call(elem,i,elem)!==not});if(qualifier.nodeType)return jQuery.grep(elements,function(elem){return elem===qualifier!==not
});if("string"==typeof qualifier){if(risSimple.test(qualifier))return jQuery.filter(qualifier,elements,not);qualifier=jQuery.filter(qualifier,elements)}return jQuery.grep(elements,function(elem){return indexOf.call(qualifier,elem)>=0!==not})}function sibling(cur,dir){for(;(cur=cur[dir])&&1!==cur.nodeType;);return cur}function createOptions(options){var object=optionsCache[options]={};return jQuery.each(options.match(rnotwhite)||[],function(_,flag){object[flag]=!0}),object}function completed(){document.removeEventListener("DOMContentLoaded",completed,!1),window.removeEventListener("load",completed,!1),jQuery.ready()}function Data(){Object.defineProperty(this.cache={},0,{get:function(){return{}}}),this.expando=jQuery.expando+Math.random()}function dataAttr(elem,key,data){var name;if(void 0===data&&1===elem.nodeType)if(name="data-"+key.replace(rmultiDash,"-$1").toLowerCase(),data=elem.getAttribute(name),"string"==typeof data){try{data="true"===data?!0:"false"===data?!1:"null"===data?null:+data+""===data?+data:rbrace.test(data)?jQuery.parseJSON(data):data}catch(e){}data_user.set(elem,key,data)}else data=void 0;return data}function returnTrue(){return!0}function returnFalse(){return!1}function safeActiveElement(){try{return document.activeElement}catch(err){}}function manipulationTarget(elem,content){return jQuery.nodeName(elem,"table")&&jQuery.nodeName(11!==content.nodeType?content:content.firstChild,"tr")?elem.getElementsByTagName("tbody")[0]||elem.appendChild(elem.ownerDocument.createElement("tbody")):elem}function disableScript(elem){return elem.type=(null!==elem.getAttribute("type"))+"/"+elem.type,elem}function restoreScript(elem){var match=rscriptTypeMasked.exec(elem.type);return match?elem.type=match[1]:elem.removeAttribute("type"),elem}function setGlobalEval(elems,refElements){for(var i=0,l=elems.length;l>i;i++)data_priv.set(elems[i],"globalEval",!refElements||data_priv.get(refElements[i],"globalEval"))}function cloneCopyEvent(src,dest){var i,l,type,pdataOld,pdataCur,udataOld,udataCur,events;if(1===dest.nodeType){if(data_priv.hasData(src)&&(pdataOld=data_priv.access(src),pdataCur=data_priv.set(dest,pdataOld),events=pdataOld.events)){delete pdataCur.handle,pdataCur.events={};for(type in events)for(i=0,l=events[type].length;l>i;i++)jQuery.event.add(dest,type,events[type][i])}data_user.hasData(src)&&(udataOld=data_user.access(src),udataCur=jQuery.extend({},udataOld),data_user.set(dest,udataCur))}}function getAll(context,tag){var ret=context.getElementsByTagName?context.getElementsByTagName(tag||"*"):context.querySelectorAll?context.querySelectorAll(tag||"*"):[];return void 0===tag||tag&&jQuery.nodeName(context,tag)?jQuery.merge([context],ret):ret}function fixInput(src,dest){var nodeName=dest.nodeName.toLowerCase();"input"===nodeName&&rcheckableType.test(src.type)?dest.checked=src.checked:("input"===nodeName||"textarea"===nodeName)&&(dest.defaultValue=src.defaultValue)}function actualDisplay(name,doc){var style,elem=jQuery(doc.createElement(name)).appendTo(doc.body),display=window.getDefaultComputedStyle&&(style=window.getDefaultComputedStyle(elem[0]))?style.display:jQuery.css(elem[0],"display");return elem.detach(),display}function defaultDisplay(nodeName){var doc=document,display=elemdisplay[nodeName];return display||(display=actualDisplay(nodeName,doc),"none"!==display&&display||(iframe=(iframe||jQuery("<iframe frameborder='0' width='0' height='0'/>")).appendTo(doc.documentElement),doc=iframe[0].contentDocument,doc.write(),doc.close(),display=actualDisplay(nodeName,doc),iframe.detach()),elemdisplay[nodeName]=display),display}function curCSS(elem,name,computed){var width,minWidth,maxWidth,ret,style=elem.style;return computed=computed||getStyles(elem),computed&&(ret=computed.getPropertyValue(name)||computed[name]),computed&&(""!==ret||jQuery.contains(elem.ownerDocument,elem)||(ret=jQuery.style(elem,name)),rnumnonpx.test(ret)&&rmargin.test(name)&&(width=style.width,minWidth=style.minWidth,maxWidth=style.maxWidth,style.minWidth=style.maxWidth=style.width=ret,ret=computed.width,style.width=width,style.minWidth=minWidth,style.maxWidth=maxWidth)),void 0!==ret?ret+"":ret}function addGetHookIf(conditionFn,hookFn){return{get:function(){return conditionFn()?void delete this.get:(this.get=hookFn).apply(this,arguments)}}}function vendorPropName(style,name){if(name in style)return name;for(var capName=name[0].toUpperCase()+name.slice(1),origName=name,i=cssPrefixes.length;i--;)if(name=cssPrefixes[i]+capName,name in style)return name;return origName}function setPositiveNumber(elem,value,subtract){var matches=rnumsplit.exec(value);return matches?Math.max(0,matches[1]-(subtract||0))+(matches[2]||"px"):value}function augmentWidthOrHeight(elem,name,extra,isBorderBox,styles){for(var i=extra===(isBorderBox?"border":"content")?4:"width"===name?1:0,val=0;4>i;i+=2)"margin"===extra&&(val+=jQuery.css(elem,extra+cssExpand[i],!0,styles)),isBorderBox?("content"===extra&&(val-=jQuery.css(elem,"padding"+cssExpand[i],!0,styles)),"margin"!==extra&&(val-=jQuery.css(elem,"border"+cssExpand[i]+"Width",!0,styles))):(val+=jQuery.css(elem,"padding"+cssExpand[i],!0,styles),"padding"!==extra&&(val+=jQuery.css(elem,"border"+cssExpand[i]+"Width",!0,styles)));return val}function getWidthOrHeight(elem,name,extra){var valueIsBorderBox=!0,val="width"===name?elem.offsetWidth:elem.offsetHeight,styles=getStyles(elem),isBorderBox="border-box"===jQuery.css(elem,"boxSizing",!1,styles);if(0>=val||null==val){if(val=curCSS(elem,name,styles),(0>val||null==val)&&(val=elem.style[name]),rnumnonpx.test(val))return val;valueIsBorderBox=isBorderBox&&(support.boxSizingReliable()||val===elem.style[name]),val=parseFloat(val)||0}return val+augmentWidthOrHeight(elem,name,extra||(isBorderBox?"border":"content"),valueIsBorderBox,styles)+"px"}function showHide(elements,show){for(var display,elem,hidden,values=[],index=0,length=elements.length;length>index;index++)elem=elements[index],elem.style&&(values[index]=data_priv.get(elem,"olddisplay"),display=elem.style.display,show?(values[index]||"none"!==display||(elem.style.display=""),""===elem.style.display&&isHidden(elem)&&(values[index]=data_priv.access(elem,"olddisplay",defaultDisplay(elem.nodeName)))):(hidden=isHidden(elem),"none"===display&&hidden||data_priv.set(elem,"olddisplay",hidden?display:jQuery.css(elem,"display"))));for(index=0;length>index;index++)elem=elements[index],elem.style&&(show&&"none"!==elem.style.display&&""!==elem.style.display||(elem.style.display=show?values[index]||"":"none"));return elements}function Tween(elem,options,prop,end,easing){return new Tween.prototype.init(elem,options,prop,end,easing)}function createFxNow(){return setTimeout(function(){fxNow=void 0}),fxNow=jQuery.now()}function genFx(type,includeWidth){var which,i=0,attrs={height:type};for(includeWidth=includeWidth?1:0;4>i;i+=2-includeWidth)which=cssExpand[i],attrs["margin"+which]=attrs["padding"+which]=type;return includeWidth&&(attrs.opacity=attrs.width=type),attrs}function createTween(value,prop,animation){for(var tween,collection=(tweeners[prop]||[]).concat(tweeners["*"]),index=0,length=collection.length;length>index;index++)if(tween=collection[index].call(animation,prop,value))return tween}function defaultPrefilter(elem,props,opts){var prop,value,toggle,tween,hooks,oldfire,display,checkDisplay,anim=this,orig={},style=elem.style,hidden=elem.nodeType&&isHidden(elem),dataShow=data_priv.get(elem,"fxshow");opts.queue||(hooks=jQuery._queueHooks(elem,"fx"),null==hooks.unqueued&&(hooks.unqueued=0,oldfire=hooks.empty.fire,hooks.empty.fire=function(){hooks.unqueued||oldfire()}),hooks.unqueued++,anim.always(function(){anim.always(function(){hooks.unqueued--,jQuery.queue(elem,"fx").length||hooks.empty.fire()})})),1===elem.nodeType&&("height"in props||"width"in props)&&(opts.overflow=[style.overflow,style.overflowX,style.overflowY],display=jQuery.css(elem,"display"),checkDisplay="none"===display?data_priv.get(elem,"olddisplay")||defaultDisplay(elem.nodeName):display,"inline"===checkDisplay&&"none"===jQuery.css(elem,"float")&&(style.display="inline-block")),opts.overflow&&(style.overflow="hidden",anim.always(function(){style.overflow=opts.overflow[0],style.overflowX=opts.overflow[1],style.overflowY=opts.overflow[2]}));for(prop in props)if(value=props[prop],rfxtypes.exec(value)){if(delete props[prop],toggle=toggle||"toggle"===value,value===(hidden?"hide":"show")){if("show"!==value||!dataShow||void 0===dataShow[prop])continue;hidden=!0}orig[prop]=dataShow&&dataShow[prop]||jQuery.style(elem,prop)}else display=void 0;if(jQuery.isEmptyObject(orig))"inline"===("none"===display?defaultDisplay(elem.nodeName):display)&&(style.display=display);else{dataShow?"hidden"in dataShow&&(hidden=dataShow.hidden):dataShow=data_priv.access(elem,"fxshow",{}),toggle&&(dataShow.hidden=!hidden),hidden?jQuery(elem).show():anim.done(function(){jQuery(elem).hide()}),anim.done(function(){var prop;data_priv.remove(elem,"fxshow");for(prop in orig)jQuery.style(elem,prop,orig[prop])});for(prop in orig)tween=createTween(hidden?dataShow[prop]:0,prop,anim),prop in dataShow||(dataShow[prop]=tween.start,hidden&&(tween.end=tween.start,tween.start="width"===prop||"height"===prop?1:0))}}function propFilter(props,specialEasing){var index,name,easing,value,hooks;for(index in props)if(name=jQuery.camelCase(index),easing=specialEasing[name],value=props[index],jQuery.isArray(value)&&(easing=value[1],value=props[index]=value[0]),index!==name&&(props[name]=value,delete props[index]),hooks=jQuery.cssHooks[name],hooks&&"expand"in hooks){value=hooks.expand(value),delete props[name];for(index in value)index in props||(props[index]=value[index],specialEasing[index]=easing)}else specialEasing[name]=easing}function Animation(elem,properties,options){var result,stopped,index=0,length=animationPrefilters.length,deferred=jQuery.Deferred().always(function(){delete tick.elem}),tick=function(){if(stopped)return!1;for(var currentTime=fxNow||createFxNow(),remaining=Math.max(0,animation.startTime+animation.duration-currentTime),temp=remaining/animation.duration||0,percent=1-temp,index=0,length=animation.tweens.length;length>index;index++)animation.tweens[index].run(percent);return deferred.notifyWith(elem,[animation,percent,remaining]),1>percent&&length?remaining:(deferred.resolveWith(elem,[animation]),!1)},animation=deferred.promise({elem:elem,props:jQuery.extend({},properties),opts:jQuery.extend(!0,{specialEasing:{}},options),originalProperties:properties,originalOptions:options,startTime:fxNow||createFxNow(),duration:options.duration,tweens:[],createTween:function(prop,end){var tween=jQuery.Tween(elem,animation.opts,prop,end,animation.opts.specialEasing[prop]||animation.opts.easing);return animation.tweens.push(tween),tween},stop:function(gotoEnd){var index=0,length=gotoEnd?animation.tweens.length:0;if(stopped)return this;for(stopped=!0;length>index;index++)animation.tweens[index].run(1);return gotoEnd?deferred.resolveWith(elem,[animation,gotoEnd]):deferred.rejectWith(elem,[animation,gotoEnd]),this}}),props=animation.props;for(propFilter(props,animation.opts.specialEasing);length>index;index++)if(result=animationPrefilters[index].call(animation,elem,props,animation.opts))return result;return jQuery.map(props,createTween,animation),jQuery.isFunction(animation.opts.start)&&animation.opts.start.call(elem,animation),jQuery.fx.timer(jQuery.extend(tick,{elem:elem,anim:animation,queue:animation.opts.queue})),animation.progress(animation.opts.progress).done(animation.opts.done,animation.opts.complete).fail(animation.opts.fail).always(animation.opts.always)}function addToPrefiltersOrTransports(structure){return function(dataTypeExpression,func){"string"!=typeof dataTypeExpression&&(func=dataTypeExpression,dataTypeExpression="*");var dataType,i=0,dataTypes=dataTypeExpression.toLowerCase().match(rnotwhite)||[];if(jQuery.isFunction(func))for(;dataType=dataTypes[i++];)"+"===dataType[0]?(dataType=dataType.slice(1)||"*",(structure[dataType]=structure[dataType]||[]).unshift(func)):(structure[dataType]=structure[dataType]||[]).push(func)}}function inspectPrefiltersOrTransports(structure,options,originalOptions,jqXHR){function inspect(dataType){var selected;return inspected[dataType]=!0,jQuery.each(structure[dataType]||[],function(_,prefilterOrFactory){var dataTypeOrTransport=prefilterOrFactory(options,originalOptions,jqXHR);return"string"!=typeof dataTypeOrTransport||seekingTransport||inspected[dataTypeOrTransport]?seekingTransport?!(selected=dataTypeOrTransport):void 0:(options.dataTypes.unshift(dataTypeOrTransport),inspect(dataTypeOrTransport),!1)}),selected}var inspected={},seekingTransport=structure===transports;return inspect(options.dataTypes[0])||!inspected["*"]&&inspect("*")}function ajaxExtend(target,src){var key,deep,flatOptions=jQuery.ajaxSettings.flatOptions||{};for(key in src)void 0!==src[key]&&((flatOptions[key]?target:deep||(deep={}))[key]=src[key]);return deep&&jQuery.extend(!0,target,deep),target}function ajaxHandleResponses(s,jqXHR,responses){for(var ct,type,finalDataType,firstDataType,contents=s.contents,dataTypes=s.dataTypes;"*"===dataTypes[0];)dataTypes.shift(),void 0===ct&&(ct=s.mimeType||jqXHR.getResponseHeader("Content-Type"));if(ct)for(type in contents)if(contents[type]&&contents[type].test(ct)){dataTypes.unshift(type);break}if(dataTypes[0]in responses)finalDataType=dataTypes[0];else{for(type in responses){if(!dataTypes[0]||s.converters[type+" "+dataTypes[0]]){finalDataType=type;break}firstDataType||(firstDataType=type)}finalDataType=finalDataType||firstDataType}return finalDataType?(finalDataType!==dataTypes[0]&&dataTypes.unshift(finalDataType),responses[finalDataType]):void 0}function ajaxConvert(s,response,jqXHR,isSuccess){var conv2,current,conv,tmp,prev,converters={},dataTypes=s.dataTypes.slice();if(dataTypes[1])for(conv in s.converters)converters[conv.toLowerCase()]=s.converters[conv];for(current=dataTypes.shift();current;)if(s.responseFields[current]&&(jqXHR[s.responseFields[current]]=response),!prev&&isSuccess&&s.dataFilter&&(response=s.dataFilter(response,s.dataType)),prev=current,current=dataTypes.shift())if("*"===current)current=prev;else if("*"!==prev&&prev!==current){if(conv=converters[prev+" "+current]||converters["* "+current],!conv)for(conv2 in converters)if(tmp=conv2.split(" "),tmp[1]===current&&(conv=converters[prev+" "+tmp[0]]||converters["* "+tmp[0]])){conv===!0?conv=converters[conv2]:converters[conv2]!==!0&&(current=tmp[0],dataTypes.unshift(tmp[1]));break}if(conv!==!0)if(conv&&s["throws"])response=conv(response);else try{response=conv(response)}catch(e){return{state:"parsererror",error:conv?e:"No conversion from "+prev+" to "+current}}}return{state:"success",data:response}}function buildParams(prefix,obj,traditional,add){var name;if(jQuery.isArray(obj))jQuery.each(obj,function(i,v){traditional||rbracket.test(prefix)?add(prefix,v):buildParams(prefix+"["+("object"==typeof v?i:"")+"]",v,traditional,add)});else if(traditional||"object"!==jQuery.type(obj))add(prefix,obj);else for(name in obj)buildParams(prefix+"["+name+"]",obj[name],traditional,add)}function getWindow(elem){return jQuery.isWindow(elem)?elem:9===elem.nodeType&&elem.defaultView}var arr=[],slice=arr.slice,concat=arr.concat,push=arr.push,indexOf=arr.indexOf,class2type={},toString=class2type.toString,hasOwn=class2type.hasOwnProperty,support={},document=window.document,version="2.1.1",jQuery=function(selector,context){return new jQuery.fn.init(selector,context)},rtrim=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,rmsPrefix=/^-ms-/,rdashAlpha=/-([\da-z])/gi,fcamelCase=function(all,letter){return letter.toUpperCase()};jQuery.fn=jQuery.prototype={jquery:version,constructor:jQuery,selector:"",length:0,toArray:function(){return slice.call(this)},get:function(num){return null!=num?0>num?this[num+this.length]:this[num]:slice.call(this)},pushStack:function(elems){var ret=jQuery.merge(this.constructor(),elems);return ret.prevObject=this,ret.context=this.context,ret},each:function(callback,args){return jQuery.each(this,callback,args)},map:function(callback){return this.pushStack(jQuery.map(this,function(elem,i){return callback.call(elem,i,elem)}))},slice:function(){return this.pushStack(slice.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(i){var len=this.length,j=+i+(0>i?len:0);return this.pushStack(j>=0&&len>j?[this[j]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:push,sort:arr.sort,splice:arr.splice},jQuery.extend=jQuery.fn.extend=function(){var options,name,src,copy,copyIsArray,clone,target=arguments[0]||{},i=1,length=arguments.length,deep=!1;for("boolean"==typeof target&&(deep=target,target=arguments[i]||{},i++),"object"==typeof target||jQuery.isFunction(target)||(target={}),i===length&&(target=this,i--);length>i;i++)if(null!=(options=arguments[i]))for(name in options)src=target[name],copy=options[name],target!==copy&&(deep&&copy&&(jQuery.isPlainObject(copy)||(copyIsArray=jQuery.isArray(copy)))?(copyIsArray?(copyIsArray=!1,clone=src&&jQuery.isArray(src)?src:[]):clone=src&&jQuery.isPlainObject(src)?src:{},target[name]=jQuery.extend(deep,clone,copy)):void 0!==copy&&(target[name]=copy));return target},jQuery.extend({expando:"jQuery"+(version+Math.random()).replace(/\D/g,""),isReady:!0,error:function(msg){throw new Error(msg)},noop:function(){},isFunction:function(obj){return"function"===jQuery.type(obj)},isArray:Array.isArray,isWindow:function(obj){return null!=obj&&obj===obj.window},isNumeric:function(obj){return!jQuery.isArray(obj)&&obj-parseFloat(obj)>=0},isPlainObject:function(obj){return"object"!==jQuery.type(obj)||obj.nodeType||jQuery.isWindow(obj)?!1:obj.constructor&&!hasOwn.call(obj.constructor.prototype,"isPrototypeOf")?!1:!0},isEmptyObject:function(obj){var name;for(name in obj)return!1;return!0},type:function(obj){return null==obj?obj+"":"object"==typeof obj||"function"==typeof obj?class2type[toString.call(obj)]||"object":typeof obj},globalEval:function(code){var script,indirect=eval;code=jQuery.trim(code),code&&(1===code.indexOf("use strict")?(script=document.createElement("script"),script.text=code,document.head.appendChild(script).parentNode.removeChild(script)):indirect(code))},camelCase:function(string){return string.replace(rmsPrefix,"ms-").replace(rdashAlpha,fcamelCase)},nodeName:function(elem,name){return elem.nodeName&&elem.nodeName.toLowerCase()===name.toLowerCase()},each:function(obj,callback,args){var value,i=0,length=obj.length,isArray=isArraylike(obj);if(args){if(isArray)for(;length>i&&(value=callback.apply(obj[i],args),value!==!1);i++);else for(i in obj)if(value=callback.apply(obj[i],args),value===!1)break}else if(isArray)for(;length>i&&(value=callback.call(obj[i],i,obj[i]),value!==!1);i++);else for(i in obj)if(value=callback.call(obj[i],i,obj[i]),value===!1)break;return obj},trim:function(text){return null==text?"":(text+"").replace(rtrim,"")},makeArray:function(arr,results){var ret=results||[];return null!=arr&&(isArraylike(Object(arr))?jQuery.merge(ret,"string"==typeof arr?[arr]:arr):push.call(ret,arr)),ret},inArray:function(elem,arr,i){return null==arr?-1:indexOf.call(arr,elem,i)},merge:function(first,second){for(var len=+second.length,j=0,i=first.length;len>j;j++)first[i++]=second[j];return first.length=i,first},grep:function(elems,callback,invert){for(var callbackInverse,matches=[],i=0,length=elems.length,callbackExpect=!invert;length>i;i++)callbackInverse=!callback(elems[i],i),callbackInverse!==callbackExpect&&matches.push(elems[i]);return matches},map:function(elems,callback,arg){var value,i=0,length=elems.length,isArray=isArraylike(elems),ret=[];if(isArray)for(;length>i;i++)value=callback(elems[i],i,arg),null!=value&&ret.push(value);else for(i in elems)value=callback(elems[i],i,arg),null!=value&&ret.push(value);return concat.apply([],ret)},guid:1,proxy:function(fn,context){var tmp,args,proxy;return"string"==typeof context&&(tmp=fn[context],context=fn,fn=tmp),jQuery.isFunction(fn)?(args=slice.call(arguments,2),proxy=function(){return fn.apply(context||this,args.concat(slice.call(arguments)))},proxy.guid=fn.guid=fn.guid||jQuery.guid++,proxy):void 0},now:Date.now,support:support}),jQuery.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(i,name){class2type["[object "+name+"]"]=name.toLowerCase()});var Sizzle=function(window){function Sizzle(selector,context,results,seed){var match,elem,m,nodeType,i,groups,old,nid,newContext,newSelector;if((context?context.ownerDocument||context:preferredDoc)!==document&&setDocument(context),context=context||document,results=results||[],!selector||"string"!=typeof selector)return results;if(1!==(nodeType=context.nodeType)&&9!==nodeType)return[];if(documentIsHTML&&!seed){if(match=rquickExpr.exec(selector))if(m=match[1]){if(9===nodeType){if(elem=context.getElementById(m),!elem||!elem.parentNode)return results;if(elem.id===m)return results.push(elem),results}else if(context.ownerDocument&&(elem=context.ownerDocument.getElementById(m))&&contains(context,elem)&&elem.id===m)return results.push(elem),results}else{if(match[2])return push.apply(results,context.getElementsByTagName(selector)),results;if((m=match[3])&&support.getElementsByClassName&&context.getElementsByClassName)return push.apply(results,context.getElementsByClassName(m)),results}if(support.qsa&&(!rbuggyQSA||!rbuggyQSA.test(selector))){if(nid=old=expando,newContext=context,newSelector=9===nodeType&&selector,1===nodeType&&"object"!==context.nodeName.toLowerCase()){for(groups=tokenize(selector),(old=context.getAttribute("id"))?nid=old.replace(rescape,"\\$&"):context.setAttribute("id",nid),nid="[id='"+nid+"'] ",i=groups.length;i--;)groups[i]=nid+toSelector(groups[i]);newContext=rsibling.test(selector)&&testContext(context.parentNode)||context,newSelector=groups.join(",")}if(newSelector)try{return push.apply(results,newContext.querySelectorAll(newSelector)),results}catch(qsaError){}finally{old||context.removeAttribute("id")}}}return select(selector.replace(rtrim,"$1"),context,results,seed)}function createCache(){function cache(key,value){return keys.push(key+" ")>Expr.cacheLength&&delete cache[keys.shift()],cache[key+" "]=value}var keys=[];return cache}function markFunction(fn){return fn[expando]=!0,fn}function assert(fn){var div=document.createElement("div");try{return!!fn(div)}catch(e){return!1}finally{div.parentNode&&div.parentNode.removeChild(div),div=null}}function addHandle(attrs,handler){for(var arr=attrs.split("|"),i=attrs.length;i--;)Expr.attrHandle[arr[i]]=handler}function siblingCheck(a,b){var cur=b&&a,diff=cur&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||MAX_NEGATIVE)-(~a.sourceIndex||MAX_NEGATIVE);if(diff)return diff;if(cur)for(;cur=cur.nextSibling;)if(cur===b)return-1;return a?1:-1}function createInputPseudo(type){return function(elem){var name=elem.nodeName.toLowerCase();return"input"===name&&elem.type===type}}function createButtonPseudo(type){return function(elem){var name=elem.nodeName.toLowerCase();return("input"===name||"button"===name)&&elem.type===type}}function createPositionalPseudo(fn){return markFunction(function(argument){return argument=+argument,markFunction(function(seed,matches){for(var j,matchIndexes=fn([],seed.length,argument),i=matchIndexes.length;i--;)seed[j=matchIndexes[i]]&&(seed[j]=!(matches[j]=seed[j]))})})}function testContext(context){return context&&typeof context.getElementsByTagName!==strundefined&&context}function setFilters(){}function toSelector(tokens){for(var i=0,len=tokens.length,selector="";len>i;i++)selector+=tokens[i].value;return selector}function addCombinator(matcher,combinator,base){var dir=combinator.dir,checkNonElements=base&&"parentNode"===dir,doneName=done++;return combinator.first?function(elem,context,xml){for(;elem=elem[dir];)if(1===elem.nodeType||checkNonElements)return matcher(elem,context,xml)}:function(elem,context,xml){var oldCache,outerCache,newCache=[dirruns,doneName];if(xml){for(;elem=elem[dir];)if((1===elem.nodeType||checkNonElements)&&matcher(elem,context,xml))return!0}else for(;elem=elem[dir];)if(1===elem.nodeType||checkNonElements){if(outerCache=elem[expando]||(elem[expando]={}),(oldCache=outerCache[dir])&&oldCache[0]===dirruns&&oldCache[1]===doneName)return newCache[2]=oldCache[2];if(outerCache[dir]=newCache,newCache[2]=matcher(elem,context,xml))return!0}}}function elementMatcher(matchers){return matchers.length>1?function(elem,context,xml){for(var i=matchers.length;i--;)if(!matchers[i](elem,context,xml))return!1;return!0}:matchers[0]}function multipleContexts(selector,contexts,results){for(var i=0,len=contexts.length;len>i;i++)Sizzle(selector,contexts[i],results);return results}function condense(unmatched,map,filter,context,xml){for(var elem,newUnmatched=[],i=0,len=unmatched.length,mapped=null!=map;len>i;i++)(elem=unmatched[i])&&(!filter||filter(elem,context,xml))&&(newUnmatched.push(elem),mapped&&map.push(i));return newUnmatched}function setMatcher(preFilter,selector,matcher,postFilter,postFinder,postSelector){return postFilter&&!postFilter[expando]&&(postFilter=setMatcher(postFilter)),postFinder&&!postFinder[expando]&&(postFinder=setMatcher(postFinder,postSelector)),markFunction(function(seed,results,context,xml){var temp,i,elem,preMap=[],postMap=[],preexisting=results.length,elems=seed||multipleContexts(selector||"*",context.nodeType?[context]:context,[]),matcherIn=!preFilter||!seed&&selector?elems:condense(elems,preMap,preFilter,context,xml),matcherOut=matcher?postFinder||(seed?preFilter:preexisting||postFilter)?[]:results:matcherIn;if(matcher&&matcher(matcherIn,matcherOut,context,xml),postFilter)for(temp=condense(matcherOut,postMap),postFilter(temp,[],context,xml),i=temp.length;i--;)(elem=temp[i])&&(matcherOut[postMap[i]]=!(matcherIn[postMap[i]]=elem));if(seed){if(postFinder||preFilter){if(postFinder){for(temp=[],i=matcherOut.length;i--;)(elem=matcherOut[i])&&temp.push(matcherIn[i]=elem);postFinder(null,matcherOut=[],temp,xml)}for(i=matcherOut.length;i--;)(elem=matcherOut[i])&&(temp=postFinder?indexOf.call(seed,elem):preMap[i])>-1&&(seed[temp]=!(results[temp]=elem))}}else matcherOut=condense(matcherOut===results?matcherOut.splice(preexisting,matcherOut.length):matcherOut),postFinder?postFinder(null,results,matcherOut,xml):push.apply(results,matcherOut)})}function matcherFromTokens(tokens){for(var checkContext,matcher,j,len=tokens.length,leadingRelative=Expr.relative[tokens[0].type],implicitRelative=leadingRelative||Expr.relative[" "],i=leadingRelative?1:0,matchContext=addCombinator(function(elem){return elem===checkContext},implicitRelative,!0),matchAnyContext=addCombinator(function(elem){return indexOf.call(checkContext,elem)>-1},implicitRelative,!0),matchers=[function(elem,context,xml){return!leadingRelative&&(xml||context!==outermostContext)||((checkContext=context).nodeType?matchContext(elem,context,xml):matchAnyContext(elem,context,xml))}];len>i;i++)if(matcher=Expr.relative[tokens[i].type])matchers=[addCombinator(elementMatcher(matchers),matcher)];else{if(matcher=Expr.filter[tokens[i].type].apply(null,tokens[i].matches),matcher[expando]){for(j=++i;len>j&&!Expr.relative[tokens[j].type];j++);return setMatcher(i>1&&elementMatcher(matchers),i>1&&toSelector(tokens.slice(0,i-1).concat({value:" "===tokens[i-2].type?"*":""})).replace(rtrim,"$1"),matcher,j>i&&matcherFromTokens(tokens.slice(i,j)),len>j&&matcherFromTokens(tokens=tokens.slice(j)),len>j&&toSelector(tokens))}matchers.push(matcher)}return elementMatcher(matchers)}function matcherFromGroupMatchers(elementMatchers,setMatchers){var bySet=setMatchers.length>0,byElement=elementMatchers.length>0,superMatcher=function(seed,context,xml,results,outermost){var elem,j,matcher,matchedCount=0,i="0",unmatched=seed&&[],setMatched=[],contextBackup=outermostContext,elems=seed||byElement&&Expr.find.TAG("*",outermost),dirrunsUnique=dirruns+=null==contextBackup?1:Math.random()||.1,len=elems.length;for(outermost&&(outermostContext=context!==document&&context);i!==len&&null!=(elem=elems[i]);i++){if(byElement&&elem){for(j=0;matcher=elementMatchers[j++];)if(matcher(elem,context,xml)){results.push(elem);break}outermost&&(dirruns=dirrunsUnique)}bySet&&((elem=!matcher&&elem)&&matchedCount--,seed&&unmatched.push(elem))}if(matchedCount+=i,bySet&&i!==matchedCount){for(j=0;matcher=setMatchers[j++];)matcher(unmatched,setMatched,context,xml);if(seed){if(matchedCount>0)for(;i--;)unmatched[i]||setMatched[i]||(setMatched[i]=pop.call(results));setMatched=condense(setMatched)}push.apply(results,setMatched),outermost&&!seed&&setMatched.length>0&&matchedCount+setMatchers.length>1&&Sizzle.uniqueSort(results)}return outermost&&(dirruns=dirrunsUnique,outermostContext=contextBackup),unmatched};return bySet?markFunction(superMatcher):superMatcher}var i,support,Expr,getText,isXML,tokenize,compile,select,outermostContext,sortInput,hasDuplicate,setDocument,document,docElem,documentIsHTML,rbuggyQSA,rbuggyMatches,matches,contains,expando="sizzle"+-new Date,preferredDoc=window.document,dirruns=0,done=0,classCache=createCache(),tokenCache=createCache(),compilerCache=createCache(),sortOrder=function(a,b){return a===b&&(hasDuplicate=!0),0},strundefined="undefined",MAX_NEGATIVE=1<<31,hasOwn={}.hasOwnProperty,arr=[],pop=arr.pop,push_native=arr.push,push=arr.push,slice=arr.slice,indexOf=arr.indexOf||function(elem){for(var i=0,len=this.length;len>i;i++)if(this[i]===elem)return i;return-1},booleans="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",whitespace="[\\x20\\t\\r\\n\\f]",characterEncoding="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",identifier=characterEncoding.replace("w","w#"),attributes="\\["+whitespace+"*("+characterEncoding+")(?:"+whitespace+"*([*^$|!~]?=)"+whitespace+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+identifier+"))|)"+whitespace+"*\\]",pseudos=":("+characterEncoding+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+attributes+")*)|.*)\\)|)",rtrim=new RegExp("^"+whitespace+"+|((?:^|[^\\\\])(?:\\\\.)*)"+whitespace+"+$","g"),rcomma=new RegExp("^"+whitespace+"*,"+whitespace+"*"),rcombinators=new RegExp("^"+whitespace+"*([>+~]|"+whitespace+")"+whitespace+"*"),rattributeQuotes=new RegExp("="+whitespace+"*([^\\]'\"]*?)"+whitespace+"*\\]","g"),rpseudo=new RegExp(pseudos),ridentifier=new RegExp("^"+identifier+"$"),matchExpr={ID:new RegExp("^#("+characterEncoding+")"),CLASS:new RegExp("^\\.("+characterEncoding+")"),TAG:new RegExp("^("+characterEncoding.replace("w","w*")+")"),ATTR:new RegExp("^"+attributes),PSEUDO:new RegExp("^"+pseudos),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+whitespace+"*(even|odd|(([+-]|)(\\d*)n|)"+whitespace+"*(?:([+-]|)"+whitespace+"*(\\d+)|))"+whitespace+"*\\)|)","i"),bool:new RegExp("^(?:"+booleans+")$","i"),needsContext:new RegExp("^"+whitespace+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+whitespace+"*((?:-\\d)?\\d*)"+whitespace+"*\\)|)(?=[^-]|$)","i")},rinputs=/^(?:input|select|textarea|button)$/i,rheader=/^h\d$/i,rnative=/^[^{]+\{\s*\[native \w/,rquickExpr=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,rsibling=/[+~]/,rescape=/'|\\/g,runescape=new RegExp("\\\\([\\da-f]{1,6}"+whitespace+"?|("+whitespace+")|.)","ig"),funescape=function(_,escaped,escapedWhitespace){var high="0x"+escaped-65536;return high!==high||escapedWhitespace?escaped:0>high?String.fromCharCode(high+65536):String.fromCharCode(high>>10|55296,1023&high|56320)};try{push.apply(arr=slice.call(preferredDoc.childNodes),preferredDoc.childNodes),arr[preferredDoc.childNodes.length].nodeType}catch(e){push={apply:arr.length?function(target,els){push_native.apply(target,slice.call(els))}:function(target,els){for(var j=target.length,i=0;target[j++]=els[i++];);target.length=j-1}}}support=Sizzle.support={},isXML=Sizzle.isXML=function(elem){var documentElement=elem&&(elem.ownerDocument||elem).documentElement;return documentElement?"HTML"!==documentElement.nodeName:!1},setDocument=Sizzle.setDocument=function(node){var hasCompare,doc=node?node.ownerDocument||node:preferredDoc,parent=doc.defaultView;
