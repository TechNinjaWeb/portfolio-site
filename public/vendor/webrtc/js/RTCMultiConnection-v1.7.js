...
(function () {
    ...
    window.RTCMultiConnection = function (channel, userid) {
        ...
        connection.open = function (args) {
            console.warn("CONNECTION ATTEMPTING TO OPEN MULTI CONNECTION -- args -->", args)
            ...
            function waitUntilRemoteStreamStartsFlowing(mediaElement, session, numberOfTimes) {
                ...
                if (!(mediaElement.readyState <= HTMLMediaElement.HAVE_CURRENT_DATA || mediaElement.paused || mediaElement.currentTime <= 0)) {
                    ...
                    if (numberOfTimes >= 60) { // wait 60 seconds while video is delivered!
                        ...
                        setTimeout(function () {
                            console.log('Waiting for incoming remote stream to be started flowing: ' + numberOfTimes + ' seconds.');
        ...
        return {
            ...
            init: function () {
                ...
                this.connection.ongatheringchange = function () {
                    ...
                    console.log('iceGatheringState', self.connection.iceGatheringState);
            ...
            setConstraints: function () {
                ...
                if(this.constraints.mandatory) {
                    console.log('sdp-mandatory-constraints', toStr(this.constraints.mandatory));
                }
                
                if(this.constraints.optional) {
                    console.log('sdp-optional-constraints', toStr(this.constraints.optional));
                }
...
console.log("RTCMULTICONNECTION-V1.7.js -- OPTIONS", options);
console.log("RTCMULTICONNECTION-V1.7.js -- OPTIONS.MEDIA", options.media)
    ...
    console.warn("From within RTCMultiConnection Script", this)
})();
